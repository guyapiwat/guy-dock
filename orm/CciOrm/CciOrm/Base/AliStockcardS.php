...
/**
 * Base class that represents a row from the 'ali_stockcard_s' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliStockcardS implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliStockcardSTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliStockcardS object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>AliStockcardS</code> instance.  If
     * <code>obj</code> is an instance of <code>AliStockcardS</code>, delegates to
     * <code>equals(AliStockcardS)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliStockcardS The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliStockcardS The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_ID] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_MCODE] = true;
        }
    ...
    public function setNameT($v)
    {
        ...
        if ($this->name_t !== $v) {
            $this->name_t = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_NAME_T] = true;
        }
    ...
    public function setInvCode($v)
    {
        ...
        if ($this->inv_code !== $v) {
            $this->inv_code = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_INV_CODE] = true;
        }
    ...
    public function setInvRef($v)
    {
        ...
        if ($this->inv_ref !== $v) {
            $this->inv_ref = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_INV_REF] = true;
        }
    ...
    public function setInvAction($v)
    {
        ...
        if ($this->inv_action !== $v) {
            $this->inv_action = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_INV_ACTION] = true;
        }
    ...
    public function setSano($v)
    {
        ...
        if ($this->sano !== $v) {
            $this->sano = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_SANO] = true;
        }
    ...
    public function setSanoRef($v)
    {
        ...
        if ($this->sano_ref !== $v) {
            $this->sano_ref = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_SANO_REF] = true;
        }
    ...
    public function setPcode($v)
    {
        ...
        if ($this->pcode !== $v) {
            $this->pcode = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_PCODE] = true;
        }
    ...
    public function setPdesc($v)
    {
        ...
        if ($this->pdesc !== $v) {
            $this->pdesc = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_PDESC] = true;
        }
    ...
    public function setInQty($v)
    {
        ...
        if ($this->in_qty !== $v) {
            $this->in_qty = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_IN_QTY] = true;
        }
    ...
    public function setInPrice($v)
    {
        ...
        if ($this->in_price !== $v) {
            $this->in_price = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_IN_PRICE] = true;
        }
    ...
    public function setInAmount($v)
    {
        ...
        if ($this->in_amount !== $v) {
            $this->in_amount = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_IN_AMOUNT] = true;
        }
    ...
    public function setOutQty($v)
    {
        ...
        if ($this->out_qty !== $v) {
            $this->out_qty = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_OUT_QTY] = true;
        }
    ...
    public function setOutPrice($v)
    {
        ...
        if ($this->out_price !== $v) {
            $this->out_price = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_OUT_PRICE] = true;
        }
    ...
    public function setOutAmount($v)
    {
        ...
        if ($this->out_amount !== $v) {
            $this->out_amount = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_OUT_AMOUNT] = true;
        }
    ...
    public function setSadate($v)
    {
        ...
        if ($this->sadate !== null || $dt !== null) {
            if ($this->sadate === null || $dt === null || $dt->format("Y-m-d") !== $this->sadate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliStockcardSTableMap::COL_SADATE] = true;
            }
    ...
    public function setRdate($v)
    {
        ...
        if ($this->rdate !== null || $dt !== null) {
            if ($this->rdate === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->rdate->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AliStockcardSTableMap::COL_RDATE] = true;
            }
        } // if either are not null
    ...
    public function setRccode($v)
    {
        ...
        if ($this->rccode !== $v) {
            $this->rccode = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_RCCODE] = true;
        }
    ...
    public function setYokma($v)
    {
        ...
        if ($this->yokma !== $v) {
            $this->yokma = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_YOKMA] = true;
        }
    ...
    public function setBalance($v)
    {
        ...
        if ($this->balance !== $v) {
            $this->balance = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_BALANCE] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_PRICE] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_AMOUNT] = true;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_UID] = true;
        }
    ...
    public function setAction($v)
    {
        ...
        if ($this->action !== $v) {
            $this->action = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_ACTION] = true;
        }
    ...
    public function setCancel($v)
    {
        ...
        if ($this->cancel !== $v) {
            $this->cancel = $v;
            $this->modifiedColumns[AliStockcardSTableMap::COL_CANCEL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliStockcardSTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliStockcardSTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliStockcardSTableMap::translateFieldName('NameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliStockcardSTableMap::translateFieldName('InvCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliStockcardSTableMap::translateFieldName('InvRef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_ref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliStockcardSTableMap::translateFieldName('InvAction', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_action = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliStockcardSTableMap::translateFieldName('Sano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliStockcardSTableMap::translateFieldName('SanoRef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano_ref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliStockcardSTableMap::translateFieldName('Pcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliStockcardSTableMap::translateFieldName('Pdesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pdesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliStockcardSTableMap::translateFieldName('InQty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->in_qty = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliStockcardSTableMap::translateFieldName('InPrice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->in_price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliStockcardSTableMap::translateFieldName('InAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->in_amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliStockcardSTableMap::translateFieldName('OutQty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->out_qty = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliStockcardSTableMap::translateFieldName('OutPrice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->out_price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliStockcardSTableMap::translateFieldName('OutAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->out_amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AliStockcardSTableMap::translateFieldName('Sadate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->sadate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AliStockcardSTableMap::translateFieldName('Rdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->rdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : AliStockcardSTableMap::translateFieldName('Rccode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rccode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : AliStockcardSTableMap::translateFieldName('Yokma', TableMap::TYPE_PHPNAME, $indexType)];
            $this->yokma = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : AliStockcardSTableMap::translateFieldName('Balance', TableMap::TYPE_PHPNAME, $indexType)];
            $this->balance = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : AliStockcardSTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : AliStockcardSTableMap::translateFieldName('Amount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : AliStockcardSTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : AliStockcardSTableMap::translateFieldName('Action', TableMap::TYPE_PHPNAME, $indexType)];
            $this->action = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : AliStockcardSTableMap::translateFieldName('Cancel', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 26; // 26 = AliStockcardSTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliStockcardS'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliStockcardSQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliStockcardS::setDeleted()
     * @see AliStockcardS::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliStockcardSQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliStockcardSTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliStockcardSTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_NAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'name_t';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_INV_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'inv_code';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_INV_REF)) {
            $modifiedColumns[':p' . $index++]  = 'inv_ref';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_INV_ACTION)) {
            $modifiedColumns[':p' . $index++]  = 'inv_action';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_SANO)) {
            $modifiedColumns[':p' . $index++]  = 'sano';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_SANO_REF)) {
            $modifiedColumns[':p' . $index++]  = 'sano_ref';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_PCODE)) {
            $modifiedColumns[':p' . $index++]  = 'pcode';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_PDESC)) {
            $modifiedColumns[':p' . $index++]  = 'pdesc';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_IN_QTY)) {
            $modifiedColumns[':p' . $index++]  = 'in_qty';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_IN_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'in_price';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_IN_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'in_amount';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_OUT_QTY)) {
            $modifiedColumns[':p' . $index++]  = 'out_qty';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_OUT_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'out_price';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_OUT_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'out_amount';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_SADATE)) {
            $modifiedColumns[':p' . $index++]  = 'sadate';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_RDATE)) {
            $modifiedColumns[':p' . $index++]  = 'rdate';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_RCCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rccode';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_YOKMA)) {
            $modifiedColumns[':p' . $index++]  = 'yokma';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_BALANCE)) {
            $modifiedColumns[':p' . $index++]  = 'balance';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'price';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'amount';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_ACTION)) {
            $modifiedColumns[':p' . $index++]  = 'action';
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'cancel';
        }

        $sql = sprintf(
            'INSERT INTO ali_stockcard_s (%s) VALUES (%s)',
    ...
    {
        $pos = AliStockcardSTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliStockcardS'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliStockcardS'][$this->hashCode()] = true;
        $keys = AliStockcardSTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliStockcardS
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliStockcardS The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliStockcardSTableMap::COL_ID)) {
            $criteria->add(AliStockcardSTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_MCODE)) {
            $criteria->add(AliStockcardSTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_NAME_T)) {
            $criteria->add(AliStockcardSTableMap::COL_NAME_T, $this->name_t);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_INV_CODE)) {
            $criteria->add(AliStockcardSTableMap::COL_INV_CODE, $this->inv_code);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_INV_REF)) {
            $criteria->add(AliStockcardSTableMap::COL_INV_REF, $this->inv_ref);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_INV_ACTION)) {
            $criteria->add(AliStockcardSTableMap::COL_INV_ACTION, $this->inv_action);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_SANO)) {
            $criteria->add(AliStockcardSTableMap::COL_SANO, $this->sano);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_SANO_REF)) {
            $criteria->add(AliStockcardSTableMap::COL_SANO_REF, $this->sano_ref);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_PCODE)) {
            $criteria->add(AliStockcardSTableMap::COL_PCODE, $this->pcode);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_PDESC)) {
            $criteria->add(AliStockcardSTableMap::COL_PDESC, $this->pdesc);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_IN_QTY)) {
            $criteria->add(AliStockcardSTableMap::COL_IN_QTY, $this->in_qty);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_IN_PRICE)) {
            $criteria->add(AliStockcardSTableMap::COL_IN_PRICE, $this->in_price);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_IN_AMOUNT)) {
            $criteria->add(AliStockcardSTableMap::COL_IN_AMOUNT, $this->in_amount);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_OUT_QTY)) {
            $criteria->add(AliStockcardSTableMap::COL_OUT_QTY, $this->out_qty);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_OUT_PRICE)) {
            $criteria->add(AliStockcardSTableMap::COL_OUT_PRICE, $this->out_price);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_OUT_AMOUNT)) {
            $criteria->add(AliStockcardSTableMap::COL_OUT_AMOUNT, $this->out_amount);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_SADATE)) {
            $criteria->add(AliStockcardSTableMap::COL_SADATE, $this->sadate);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_RDATE)) {
            $criteria->add(AliStockcardSTableMap::COL_RDATE, $this->rdate);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_RCCODE)) {
            $criteria->add(AliStockcardSTableMap::COL_RCCODE, $this->rccode);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_YOKMA)) {
            $criteria->add(AliStockcardSTableMap::COL_YOKMA, $this->yokma);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_BALANCE)) {
            $criteria->add(AliStockcardSTableMap::COL_BALANCE, $this->balance);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_PRICE)) {
            $criteria->add(AliStockcardSTableMap::COL_PRICE, $this->price);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_AMOUNT)) {
            $criteria->add(AliStockcardSTableMap::COL_AMOUNT, $this->amount);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_UID)) {
            $criteria->add(AliStockcardSTableMap::COL_UID, $this->uid);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_ACTION)) {
            $criteria->add(AliStockcardSTableMap::COL_ACTION, $this->action);
        }
        if ($this->isColumnModified(AliStockcardSTableMap::COL_CANCEL)) {
            $criteria->add(AliStockcardSTableMap::COL_CANCEL, $this->cancel);
        }
    ...
    {
        $criteria = ChildAliStockcardSQuery::create();
        $criteria->add(AliStockcardSTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliStockcardS (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliStockcardS Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliStockcardSTableMap::DEFAULT_STRING_FORMAT);
    }
