...
/**
 * Base class that represents a row from the 'ali_dround' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliDround implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliDroundTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliDround object.
     */
    ...
    /**
     * Compares this with another <code>AliDround</code> instance.  If
     * <code>obj</code> is an instance of <code>AliDround</code>, delegates to
     * <code>equals(AliDround)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliDround The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliDround The current object (for fluent API support)
     */
    public function setRid($v)
    {
        ...
        if ($this->rid !== $v) {
            $this->rid = $v;
            $this->modifiedColumns[AliDroundTableMap::COL_RID] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliDroundTableMap::COL_RCODE] = true;
        }
    ...
    public function setRdate($v)
    {
        ...
        if ($this->rdate !== null || $dt !== null) {
            if ($this->rdate === null || $dt === null || $dt->format("Y-m-d") !== $this->rdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliDroundTableMap::COL_RDATE] = true;
            }
    ...
    public function setFsano($v)
    {
        ...
        if ($this->fsano !== $v) {
            $this->fsano = $v;
            $this->modifiedColumns[AliDroundTableMap::COL_FSANO] = true;
        }
    ...
    public function setTsano($v)
    {
        ...
        if ($this->tsano !== $v) {
            $this->tsano = $v;
            $this->modifiedColumns[AliDroundTableMap::COL_TSANO] = true;
        }
    ...
    public function setPaydate($v)
    {
        ...
        if ($this->paydate !== null || $dt !== null) {
            if ($this->paydate === null || $dt === null || $dt->format("Y-m-d") !== $this->paydate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliDroundTableMap::COL_PAYDATE] = true;
            }
        } // if either are not null
    ...
    public function setCalc($v)
    {
        ...
        if ($this->calc !== $v) {
            $this->calc = $v;
            $this->modifiedColumns[AliDroundTableMap::COL_CALC] = true;
        }
    ...
    public function setRemark($v)
    {
        ...
        if ($this->remark !== $v) {
            $this->remark = $v;
            $this->modifiedColumns[AliDroundTableMap::COL_REMARK] = true;
        }
    ...
    public function setFdate($v)
    {
        ...
        if ($this->fdate !== null || $dt !== null) {
            if ($this->fdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliDroundTableMap::COL_FDATE] = true;
            }
        } // if either are not null
    ...
    public function setTdate($v)
    {
        ...
        if ($this->tdate !== null || $dt !== null) {
            if ($this->tdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliDroundTableMap::COL_TDATE] = true;
            }
        } // if either are not null
    ...
    public function setFpdate($v)
    {
        ...
        if ($this->fpdate !== null || $dt !== null) {
            if ($this->fpdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fpdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliDroundTableMap::COL_FPDATE] = true;
            }
        } // if either are not null
    ...
    public function setTpdate($v)
    {
        ...
        if ($this->tpdate !== null || $dt !== null) {
            if ($this->tpdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tpdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliDroundTableMap::COL_TPDATE] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliDroundTableMap::translateFieldName('Rid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliDroundTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliDroundTableMap::translateFieldName('Rdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->rdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliDroundTableMap::translateFieldName('Fsano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fsano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliDroundTableMap::translateFieldName('Tsano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tsano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliDroundTableMap::translateFieldName('Paydate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->paydate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliDroundTableMap::translateFieldName('Calc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->calc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliDroundTableMap::translateFieldName('Remark', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remark = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliDroundTableMap::translateFieldName('Fdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliDroundTableMap::translateFieldName('Tdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->tdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliDroundTableMap::translateFieldName('Fpdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fpdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliDroundTableMap::translateFieldName('Tpdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            ...
            return $startcol + 12; // 12 = AliDroundTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliDround'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliDroundQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliDround::setDeleted()
     * @see AliDround::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliDroundQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliDroundTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliDroundTableMap::COL_RID)) {
            $modifiedColumns[':p' . $index++]  = 'rid';
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_RDATE)) {
            $modifiedColumns[':p' . $index++]  = 'rdate';
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_FSANO)) {
            $modifiedColumns[':p' . $index++]  = 'fsano';
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_TSANO)) {
            $modifiedColumns[':p' . $index++]  = 'tsano';
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_PAYDATE)) {
            $modifiedColumns[':p' . $index++]  = 'paydate';
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_CALC)) {
            $modifiedColumns[':p' . $index++]  = 'calc';
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_REMARK)) {
            $modifiedColumns[':p' . $index++]  = 'remark';
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_FDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fdate';
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_TDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tdate';
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_FPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fpdate';
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_TPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tpdate';
        }

        $sql = sprintf(
            'INSERT INTO ali_dround (%s) VALUES (%s)',
    ...
    {
        $pos = AliDroundTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliDround'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliDround'][$this->hashCode()] = true;
        $keys = AliDroundTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliDround
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliDround The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliDroundTableMap::COL_RID)) {
            $criteria->add(AliDroundTableMap::COL_RID, $this->rid);
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_RCODE)) {
            $criteria->add(AliDroundTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_RDATE)) {
            $criteria->add(AliDroundTableMap::COL_RDATE, $this->rdate);
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_FSANO)) {
            $criteria->add(AliDroundTableMap::COL_FSANO, $this->fsano);
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_TSANO)) {
            $criteria->add(AliDroundTableMap::COL_TSANO, $this->tsano);
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_PAYDATE)) {
            $criteria->add(AliDroundTableMap::COL_PAYDATE, $this->paydate);
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_CALC)) {
            $criteria->add(AliDroundTableMap::COL_CALC, $this->calc);
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_REMARK)) {
            $criteria->add(AliDroundTableMap::COL_REMARK, $this->remark);
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_FDATE)) {
            $criteria->add(AliDroundTableMap::COL_FDATE, $this->fdate);
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_TDATE)) {
            $criteria->add(AliDroundTableMap::COL_TDATE, $this->tdate);
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_FPDATE)) {
            $criteria->add(AliDroundTableMap::COL_FPDATE, $this->fpdate);
        }
        if ($this->isColumnModified(AliDroundTableMap::COL_TPDATE)) {
            $criteria->add(AliDroundTableMap::COL_TPDATE, $this->tpdate);
        }
    ...
    {
        $criteria = ChildAliDroundQuery::create();
        $criteria->add(AliDroundTableMap::COL_RID, $this->rid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliDround (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliDround Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliDroundTableMap::DEFAULT_STRING_FORMAT);
    }
