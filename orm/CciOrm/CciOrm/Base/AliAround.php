...
/**
 * Base class that represents a row from the 'ali_around' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliAround implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliAroundTableMap';
    ...
    /**
     * The value for the countquery field.
     *
     * @var        int
     */
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliAround object.
     */
    ...
    /**
     * Compares this with another <code>AliAround</code> instance.  If
     * <code>obj</code> is an instance of <code>AliAround</code>, delegates to
     * <code>equals(AliAround)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliAround The current object, for fluid interface
     */
    ...
    /**
     * Get the [countquery] column value.
     *
     * @return int
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliAround The current object (for fluent API support)
     */
    public function setRid($v)
    {
        ...
        if ($this->rid !== $v) {
            $this->rid = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_RID] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_RCODE] = true;
        }
    ...
    public function setRdate($v)
    {
        ...
        if ($this->rdate !== null || $dt !== null) {
            if ($this->rdate === null || $dt === null || $dt->format("Y-m-d") !== $this->rdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliAroundTableMap::COL_RDATE] = true;
            }
    ...
    public function setFsano($v)
    {
        ...
        if ($this->fsano !== $v) {
            $this->fsano = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_FSANO] = true;
        }
    ...
    public function setTsano($v)
    {
        ...
        if ($this->tsano !== $v) {
            $this->tsano = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_TSANO] = true;
        }
    ...
    public function setPaydate($v)
    {
        ...
        if ($this->paydate !== null || $dt !== null) {
            if ($this->paydate === null || $dt === null || $dt->format("Y-m-d") !== $this->paydate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliAroundTableMap::COL_PAYDATE] = true;
            }
        } // if either are not null
    ...
    public function setCalc($v)
    {
        ...
        if ($this->calc !== $v) {
            $this->calc = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_CALC] = true;
        }
    ...
    public function setCalcDate($v)
    {
        ...
        if ($this->calc_date !== null || $dt !== null) {
            if ($this->calc_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->calc_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AliAroundTableMap::COL_CALC_DATE] = true;
            }
        } // if either are not null
    ...
    public function setRemark($v)
    {
        ...
        if ($this->remark !== $v) {
            $this->remark = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_REMARK] = true;
        }
    ...
    public function setFdate($v)
    {
        ...
        if ($this->fdate !== null || $dt !== null) {
            if ($this->fdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliAroundTableMap::COL_FDATE] = true;
            }
        } // if either are not null
    ...
    public function setTdate($v)
    {
        ...
        if ($this->tdate !== null || $dt !== null) {
            if ($this->tdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliAroundTableMap::COL_TDATE] = true;
            }
        } // if either are not null
    ...
    public function setFpdate($v)
    {
        ...
        if ($this->fpdate !== null || $dt !== null) {
            if ($this->fpdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fpdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliAroundTableMap::COL_FPDATE] = true;
            }
        } // if either are not null
    ...
    public function setTpdate($v)
    {
        ...
        if ($this->tpdate !== null || $dt !== null) {
            if ($this->tpdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tpdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliAroundTableMap::COL_TPDATE] = true;
            }
        } // if either are not null
    ...
    public function setTotalA($v)
    {
        ...
        if ($this->total_a !== $v) {
            $this->total_a = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_TOTAL_A] = true;
        }
    ...
    public function setTotalH($v)
    {
        ...
        if ($this->total_h !== $v) {
            $this->total_h = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_TOTAL_H] = true;
        }
    ...
    public function setFast($v)
    {
        ...
        if ($this->fast !== $v) {
            $this->fast = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_FAST] = true;
        }
    ...
    public function setInvent($v)
    {
        ...
        if ($this->invent !== $v) {
            $this->invent = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_INVENT] = true;
        }
    ...
    public function setBinaryt($v)
    {
        ...
        if ($this->binaryt !== $v) {
            $this->binaryt = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_BINARYT] = true;
        }
    ...
    public function setMatching($v)
    {
        ...
        if ($this->matching !== $v) {
            $this->matching = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_MATCHING] = true;
        }
    ...
    public function setPool($v)
    {
        ...
        if ($this->pool !== $v) {
            $this->pool = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_POOL] = true;
        }
    ...
    public function setAdjustBinary($v)
    {
        ...
        if ($this->adjust_binary !== $v) {
            ...
            $this->modifiedColumns[AliAroundTableMap::COL_ADJUST_BINARY] = true;
        }
    ...
    public function setAdjustMatching($v)
    {
        ...
        if ($this->adjust_matching !== $v) {
            ...
            $this->modifiedColumns[AliAroundTableMap::COL_ADJUST_MATCHING] = true;
        }
    ...
    public function setAdjustPool($v)
    {
        ...
        if ($this->adjust_pool !== $v) {
            $this->adjust_pool = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_ADJUST_POOL] = true;
        }
    ...
    public function setTimequery($v)
    {
        ...
        if ($this->timequery !== $v) {
            $this->timequery = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_TIMEQUERY] = true;
        }
    ...
    /**
     * Set the value of [countquery] column.
     *
     * @param int $v new value
     * @return $this|\CciOrm\CciOrm\AliAround The current object (for fluent API support)
     */
    public function setCountquery($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->countquery !== $v) {
            $this->countquery = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_COUNTQUERY] = true;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[AliAroundTableMap::COL_UID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliAroundTableMap::translateFieldName('Rid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliAroundTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliAroundTableMap::translateFieldName('Rdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->rdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliAroundTableMap::translateFieldName('Fsano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fsano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliAroundTableMap::translateFieldName('Tsano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tsano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliAroundTableMap::translateFieldName('Paydate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->paydate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliAroundTableMap::translateFieldName('Calc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->calc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliAroundTableMap::translateFieldName('CalcDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->calc_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliAroundTableMap::translateFieldName('Remark', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remark = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliAroundTableMap::translateFieldName('Fdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliAroundTableMap::translateFieldName('Tdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->tdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliAroundTableMap::translateFieldName('Fpdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fpdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliAroundTableMap::translateFieldName('Tpdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->tpdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliAroundTableMap::translateFieldName('TotalA', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_a = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliAroundTableMap::translateFieldName('TotalH', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_h = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliAroundTableMap::translateFieldName('Fast', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fast = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AliAroundTableMap::translateFieldName('Invent', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invent = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AliAroundTableMap::translateFieldName('Binaryt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->binaryt = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : AliAroundTableMap::translateFieldName('Matching', TableMap::TYPE_PHPNAME, $indexType)];
            $this->matching = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : AliAroundTableMap::translateFieldName('Pool', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pool = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : AliAroundTableMap::translateFieldName('AdjustBinary', TableMap::TYPE_PHPNAME, $indexType)];
            $this->adjust_binary = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : AliAroundTableMap::translateFieldName('AdjustMatching', TableMap::TYPE_PHPNAME, $indexType)];
            $this->adjust_matching = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : AliAroundTableMap::translateFieldName('AdjustPool', TableMap::TYPE_PHPNAME, $indexType)];
            $this->adjust_pool = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : AliAroundTableMap::translateFieldName('Timequery', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timequery = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : AliAroundTableMap::translateFieldName('Countquery', TableMap::TYPE_PHPNAME, $indexType)];
            $this->countquery = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : AliAroundTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 26; // 26 = AliAroundTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliAround'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliAroundQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliAround::setDeleted()
     * @see AliAround::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliAroundQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliAroundTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliAroundTableMap::COL_RID)) {
            $modifiedColumns[':p' . $index++]  = 'rid';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_RDATE)) {
            $modifiedColumns[':p' . $index++]  = 'rdate';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_FSANO)) {
            $modifiedColumns[':p' . $index++]  = 'fsano';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_TSANO)) {
            $modifiedColumns[':p' . $index++]  = 'tsano';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_PAYDATE)) {
            $modifiedColumns[':p' . $index++]  = 'paydate';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_CALC)) {
            $modifiedColumns[':p' . $index++]  = 'calc';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_CALC_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'calc_date';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_REMARK)) {
            $modifiedColumns[':p' . $index++]  = 'remark';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_FDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fdate';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_TDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tdate';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_FPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fpdate';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_TPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tpdate';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_TOTAL_A)) {
            $modifiedColumns[':p' . $index++]  = 'total_a';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_TOTAL_H)) {
            $modifiedColumns[':p' . $index++]  = 'total_h';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_FAST)) {
            $modifiedColumns[':p' . $index++]  = 'fast';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_INVENT)) {
            $modifiedColumns[':p' . $index++]  = 'invent';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_BINARYT)) {
            $modifiedColumns[':p' . $index++]  = 'binaryt';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_MATCHING)) {
            $modifiedColumns[':p' . $index++]  = 'matching';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_POOL)) {
            $modifiedColumns[':p' . $index++]  = 'pool';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_ADJUST_BINARY)) {
            $modifiedColumns[':p' . $index++]  = 'adjust_binary';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_ADJUST_MATCHING)) {
            $modifiedColumns[':p' . $index++]  = 'adjust_matching';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_ADJUST_POOL)) {
            $modifiedColumns[':p' . $index++]  = 'adjust_pool';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_TIMEQUERY)) {
            $modifiedColumns[':p' . $index++]  = 'timequery';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_COUNTQUERY)) {
            $modifiedColumns[':p' . $index++]  = 'countquery';
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }

        $sql = sprintf(
            'INSERT INTO ali_around (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'timequery':
                        ...
                        break;
                    case 'countquery':
                        $stmt->bindValue($identifier, $this->countquery, PDO::PARAM_INT);
                        break;
                    case 'uid':
    ...
    {
        $pos = AliAroundTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliAround'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliAround'][$this->hashCode()] = true;
        $keys = AliAroundTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRid(),
            ...
            $keys[23] => $this->getTimequery(),
            $keys[24] => $this->getCountquery(),
            $keys[25] => $this->getUid(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliAround
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[23], $arr)) {
            $this->setTimequery($arr[$keys[23]]);
        }
        if (array_key_exists($keys[24], $arr)) {
            $this->setCountquery($arr[$keys[24]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliAround The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliAroundTableMap::COL_RID)) {
            $criteria->add(AliAroundTableMap::COL_RID, $this->rid);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_RCODE)) {
            $criteria->add(AliAroundTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_RDATE)) {
            $criteria->add(AliAroundTableMap::COL_RDATE, $this->rdate);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_FSANO)) {
            $criteria->add(AliAroundTableMap::COL_FSANO, $this->fsano);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_TSANO)) {
            $criteria->add(AliAroundTableMap::COL_TSANO, $this->tsano);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_PAYDATE)) {
            $criteria->add(AliAroundTableMap::COL_PAYDATE, $this->paydate);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_CALC)) {
            $criteria->add(AliAroundTableMap::COL_CALC, $this->calc);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_CALC_DATE)) {
            $criteria->add(AliAroundTableMap::COL_CALC_DATE, $this->calc_date);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_REMARK)) {
            $criteria->add(AliAroundTableMap::COL_REMARK, $this->remark);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_FDATE)) {
            $criteria->add(AliAroundTableMap::COL_FDATE, $this->fdate);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_TDATE)) {
            $criteria->add(AliAroundTableMap::COL_TDATE, $this->tdate);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_FPDATE)) {
            $criteria->add(AliAroundTableMap::COL_FPDATE, $this->fpdate);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_TPDATE)) {
            $criteria->add(AliAroundTableMap::COL_TPDATE, $this->tpdate);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_TOTAL_A)) {
            $criteria->add(AliAroundTableMap::COL_TOTAL_A, $this->total_a);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_TOTAL_H)) {
            $criteria->add(AliAroundTableMap::COL_TOTAL_H, $this->total_h);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_FAST)) {
            $criteria->add(AliAroundTableMap::COL_FAST, $this->fast);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_INVENT)) {
            $criteria->add(AliAroundTableMap::COL_INVENT, $this->invent);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_BINARYT)) {
            $criteria->add(AliAroundTableMap::COL_BINARYT, $this->binaryt);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_MATCHING)) {
            $criteria->add(AliAroundTableMap::COL_MATCHING, $this->matching);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_POOL)) {
            $criteria->add(AliAroundTableMap::COL_POOL, $this->pool);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_ADJUST_BINARY)) {
            $criteria->add(AliAroundTableMap::COL_ADJUST_BINARY, $this->adjust_binary);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_ADJUST_MATCHING)) {
            $criteria->add(AliAroundTableMap::COL_ADJUST_MATCHING, $this->adjust_matching);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_ADJUST_POOL)) {
            $criteria->add(AliAroundTableMap::COL_ADJUST_POOL, $this->adjust_pool);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_TIMEQUERY)) {
            $criteria->add(AliAroundTableMap::COL_TIMEQUERY, $this->timequery);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_COUNTQUERY)) {
            $criteria->add(AliAroundTableMap::COL_COUNTQUERY, $this->countquery);
        }
        if ($this->isColumnModified(AliAroundTableMap::COL_UID)) {
            $criteria->add(AliAroundTableMap::COL_UID, $this->uid);
        }
    ...
    {
        $criteria = ChildAliAroundQuery::create();
        $criteria->add(AliAroundTableMap::COL_RID, $this->rid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliAround (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCountquery($this->getCountquery());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliAround Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliAroundTableMap::DEFAULT_STRING_FORMAT);
    }
