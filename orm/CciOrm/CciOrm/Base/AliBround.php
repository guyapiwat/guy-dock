...
/**
 * Base class that represents a row from the 'ali_bround' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliBround implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliBroundTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliBround object.
     */
    ...
    /**
     * Compares this with another <code>AliBround</code> instance.  If
     * <code>obj</code> is an instance of <code>AliBround</code>, delegates to
     * <code>equals(AliBround)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliBround The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliBround The current object (for fluent API support)
     */
    public function setRid($v)
    {
        ...
        if ($this->rid !== $v) {
            $this->rid = $v;
            $this->modifiedColumns[AliBroundTableMap::COL_RID] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliBroundTableMap::COL_RCODE] = true;
        }
    ...
    public function setRdate($v)
    {
        ...
        if ($this->rdate !== null || $dt !== null) {
            if ($this->rdate === null || $dt === null || $dt->format("Y-m-d") !== $this->rdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliBroundTableMap::COL_RDATE] = true;
            }
    ...
    public function setFsano($v)
    {
        ...
        if ($this->fsano !== $v) {
            $this->fsano = $v;
            $this->modifiedColumns[AliBroundTableMap::COL_FSANO] = true;
        }
    ...
    public function setTsano($v)
    {
        ...
        if ($this->tsano !== $v) {
            $this->tsano = $v;
            $this->modifiedColumns[AliBroundTableMap::COL_TSANO] = true;
        }
    ...
    public function setPaydate($v)
    {
        ...
        if ($this->paydate !== null || $dt !== null) {
            if ($this->paydate === null || $dt === null || $dt->format("Y-m-d") !== $this->paydate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliBroundTableMap::COL_PAYDATE] = true;
            }
        } // if either are not null
    ...
    public function setCalc($v)
    {
        ...
        if ($this->calc !== $v) {
            $this->calc = $v;
            $this->modifiedColumns[AliBroundTableMap::COL_CALC] = true;
        }
    ...
    public function setCalcDate($v)
    {
        ...
        if ($this->calc_date !== null || $dt !== null) {
            if ($this->calc_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->calc_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AliBroundTableMap::COL_CALC_DATE] = true;
            }
        } // if either are not null
    ...
    public function setRemark($v)
    {
        ...
        if ($this->remark !== $v) {
            $this->remark = $v;
            $this->modifiedColumns[AliBroundTableMap::COL_REMARK] = true;
        }
    ...
    public function setFdate($v)
    {
        ...
        if ($this->fdate !== null || $dt !== null) {
            if ($this->fdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliBroundTableMap::COL_FDATE] = true;
            }
        } // if either are not null
    ...
    public function setTdate($v)
    {
        ...
        if ($this->tdate !== null || $dt !== null) {
            if ($this->tdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliBroundTableMap::COL_TDATE] = true;
            }
        } // if either are not null
    ...
    public function setFpdate($v)
    {
        ...
        if ($this->fpdate !== null || $dt !== null) {
            if ($this->fpdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fpdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliBroundTableMap::COL_FPDATE] = true;
            }
        } // if either are not null
    ...
    public function setTpdate($v)
    {
        ...
        if ($this->tpdate !== null || $dt !== null) {
            if ($this->tpdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tpdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliBroundTableMap::COL_TPDATE] = true;
            }
        } // if either are not null
    ...
    public function setTimequery($v)
    {
        ...
        if ($this->timequery !== $v) {
            $this->timequery = $v;
            $this->modifiedColumns[AliBroundTableMap::COL_TIMEQUERY] = true;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[AliBroundTableMap::COL_UID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliBroundTableMap::translateFieldName('Rid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliBroundTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliBroundTableMap::translateFieldName('Rdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->rdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliBroundTableMap::translateFieldName('Fsano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fsano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliBroundTableMap::translateFieldName('Tsano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tsano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliBroundTableMap::translateFieldName('Paydate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->paydate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliBroundTableMap::translateFieldName('Calc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->calc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliBroundTableMap::translateFieldName('CalcDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->calc_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliBroundTableMap::translateFieldName('Remark', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remark = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliBroundTableMap::translateFieldName('Fdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliBroundTableMap::translateFieldName('Tdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->tdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliBroundTableMap::translateFieldName('Fpdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fpdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliBroundTableMap::translateFieldName('Tpdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->tpdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliBroundTableMap::translateFieldName('Timequery', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timequery = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliBroundTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 15; // 15 = AliBroundTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliBround'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliBroundQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliBround::setDeleted()
     * @see AliBround::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliBroundQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliBroundTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliBroundTableMap::COL_RID)) {
            $modifiedColumns[':p' . $index++]  = 'rid';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_RDATE)) {
            $modifiedColumns[':p' . $index++]  = 'rdate';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_FSANO)) {
            $modifiedColumns[':p' . $index++]  = 'fsano';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_TSANO)) {
            $modifiedColumns[':p' . $index++]  = 'tsano';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_PAYDATE)) {
            $modifiedColumns[':p' . $index++]  = 'paydate';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_CALC)) {
            $modifiedColumns[':p' . $index++]  = 'calc';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_CALC_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'calc_date';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_REMARK)) {
            $modifiedColumns[':p' . $index++]  = 'remark';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_FDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fdate';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_TDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tdate';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_FPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fpdate';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_TPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tpdate';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_TIMEQUERY)) {
            $modifiedColumns[':p' . $index++]  = 'timequery';
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }

        $sql = sprintf(
            'INSERT INTO ali_bround (%s) VALUES (%s)',
    ...
    {
        $pos = AliBroundTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliBround'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliBround'][$this->hashCode()] = true;
        $keys = AliBroundTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliBround
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliBround The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliBroundTableMap::COL_RID)) {
            $criteria->add(AliBroundTableMap::COL_RID, $this->rid);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_RCODE)) {
            $criteria->add(AliBroundTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_RDATE)) {
            $criteria->add(AliBroundTableMap::COL_RDATE, $this->rdate);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_FSANO)) {
            $criteria->add(AliBroundTableMap::COL_FSANO, $this->fsano);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_TSANO)) {
            $criteria->add(AliBroundTableMap::COL_TSANO, $this->tsano);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_PAYDATE)) {
            $criteria->add(AliBroundTableMap::COL_PAYDATE, $this->paydate);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_CALC)) {
            $criteria->add(AliBroundTableMap::COL_CALC, $this->calc);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_CALC_DATE)) {
            $criteria->add(AliBroundTableMap::COL_CALC_DATE, $this->calc_date);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_REMARK)) {
            $criteria->add(AliBroundTableMap::COL_REMARK, $this->remark);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_FDATE)) {
            $criteria->add(AliBroundTableMap::COL_FDATE, $this->fdate);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_TDATE)) {
            $criteria->add(AliBroundTableMap::COL_TDATE, $this->tdate);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_FPDATE)) {
            $criteria->add(AliBroundTableMap::COL_FPDATE, $this->fpdate);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_TPDATE)) {
            $criteria->add(AliBroundTableMap::COL_TPDATE, $this->tpdate);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_TIMEQUERY)) {
            $criteria->add(AliBroundTableMap::COL_TIMEQUERY, $this->timequery);
        }
        if ($this->isColumnModified(AliBroundTableMap::COL_UID)) {
            $criteria->add(AliBroundTableMap::COL_UID, $this->uid);
        }
    ...
    {
        $criteria = ChildAliBroundQuery::create();
        $criteria->add(AliBroundTableMap::COL_RID, $this->rid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliBround (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliBround Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliBroundTableMap::DEFAULT_STRING_FORMAT);
    }
