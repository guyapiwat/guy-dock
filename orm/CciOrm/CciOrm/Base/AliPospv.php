...
/**
 * Base class that represents a row from the 'ali_pospv' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliPospv implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliPospvTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliPospv object.
     */
    ...
    /**
     * Compares this with another <code>AliPospv</code> instance.  If
     * <code>obj</code> is an instance of <code>AliPospv</code>, delegates to
     * <code>equals(AliPospv)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliPospv The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliPospv The current object (for fluent API support)
     */
    public function setAid($v)
    {
        ...
        if ($this->aid !== $v) {
            $this->aid = $v;
            $this->modifiedColumns[AliPospvTableMap::COL_AID] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliPospvTableMap::COL_RCODE] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliPospvTableMap::COL_MCODE] = true;
        }
    ...
    public function setOpos($v)
    {
        ...
        if ($this->opos !== $v) {
            $this->opos = $v;
            $this->modifiedColumns[AliPospvTableMap::COL_OPOS] = true;
        }
    ...
    public function setNpos($v)
    {
        ...
        if ($this->npos !== $v) {
            $this->npos = $v;
            $this->modifiedColumns[AliPospvTableMap::COL_NPOS] = true;
        }
    ...
    public function setNameT($v)
    {
        ...
        if ($this->name_t !== $v) {
            $this->name_t = $v;
            $this->modifiedColumns[AliPospvTableMap::COL_NAME_T] = true;
        }
    ...
    public function setSpCode($v)
    {
        ...
        if ($this->sp_code !== $v) {
            $this->sp_code = $v;
            $this->modifiedColumns[AliPospvTableMap::COL_SP_CODE] = true;
        }
    ...
    public function setUpaCode($v)
    {
        ...
        if ($this->upa_code !== $v) {
            $this->upa_code = $v;
            $this->modifiedColumns[AliPospvTableMap::COL_UPA_CODE] = true;
        }
    ...
    public function setLr($v)
    {
        ...
        if ($this->lr !== $v) {
            $this->lr = $v;
            $this->modifiedColumns[AliPospvTableMap::COL_LR] = true;
        }
    ...
    public function setFdate($v)
    {
        ...
        if ($this->fdate !== null || $dt !== null) {
            if ($this->fdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliPospvTableMap::COL_FDATE] = true;
            }
    ...
    public function setTdate($v)
    {
        ...
        if ($this->tdate !== null || $dt !== null) {
            if ($this->tdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliPospvTableMap::COL_TDATE] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliPospvTableMap::translateFieldName('Aid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->aid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliPospvTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliPospvTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliPospvTableMap::translateFieldName('Opos', TableMap::TYPE_PHPNAME, $indexType)];
            $this->opos = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliPospvTableMap::translateFieldName('Npos', TableMap::TYPE_PHPNAME, $indexType)];
            $this->npos = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliPospvTableMap::translateFieldName('NameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliPospvTableMap::translateFieldName('SpCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliPospvTableMap::translateFieldName('UpaCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->upa_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliPospvTableMap::translateFieldName('Lr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliPospvTableMap::translateFieldName('Fdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliPospvTableMap::translateFieldName('Tdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            ...
            return $startcol + 11; // 11 = AliPospvTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliPospv'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliPospvQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliPospv::setDeleted()
     * @see AliPospv::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliPospvQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliPospvTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliPospvTableMap::COL_AID)) {
            $modifiedColumns[':p' . $index++]  = 'aid';
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_OPOS)) {
            $modifiedColumns[':p' . $index++]  = 'opos';
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_NPOS)) {
            $modifiedColumns[':p' . $index++]  = 'npos';
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_NAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'name_t';
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_SP_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'sp_code';
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_UPA_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'upa_code';
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_LR)) {
            $modifiedColumns[':p' . $index++]  = 'lr';
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_FDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fdate';
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_TDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tdate';
        }

        $sql = sprintf(
            'INSERT INTO ali_pospv (%s) VALUES (%s)',
    ...
    {
        $pos = AliPospvTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliPospv'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliPospv'][$this->hashCode()] = true;
        $keys = AliPospvTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getAid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliPospv
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) {
            $this->setUpaCode($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setLr($arr[$keys[8]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliPospv The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliPospvTableMap::COL_AID)) {
            $criteria->add(AliPospvTableMap::COL_AID, $this->aid);
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_RCODE)) {
            $criteria->add(AliPospvTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_MCODE)) {
            $criteria->add(AliPospvTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_OPOS)) {
            $criteria->add(AliPospvTableMap::COL_OPOS, $this->opos);
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_NPOS)) {
            $criteria->add(AliPospvTableMap::COL_NPOS, $this->npos);
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_NAME_T)) {
            $criteria->add(AliPospvTableMap::COL_NAME_T, $this->name_t);
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_SP_CODE)) {
            $criteria->add(AliPospvTableMap::COL_SP_CODE, $this->sp_code);
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_UPA_CODE)) {
            $criteria->add(AliPospvTableMap::COL_UPA_CODE, $this->upa_code);
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_LR)) {
            $criteria->add(AliPospvTableMap::COL_LR, $this->lr);
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_FDATE)) {
            $criteria->add(AliPospvTableMap::COL_FDATE, $this->fdate);
        }
        if ($this->isColumnModified(AliPospvTableMap::COL_TDATE)) {
            $criteria->add(AliPospvTableMap::COL_TDATE, $this->tdate);
        }
    ...
    {
        $criteria = ChildAliPospvQuery::create();
        $criteria->add(AliPospvTableMap::COL_AID, $this->aid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliPospv (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliPospv Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliPospvTableMap::DEFAULT_STRING_FORMAT);
    }
