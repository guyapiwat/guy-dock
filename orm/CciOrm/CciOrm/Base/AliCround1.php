...
/**
 * Base class that represents a row from the 'ali_cround1' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliCround1 implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliCround1TableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliCround1 object.
     */
    ...
    /**
     * Compares this with another <code>AliCround1</code> instance.  If
     * <code>obj</code> is an instance of <code>AliCround1</code>, delegates to
     * <code>equals(AliCround1)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliCround1 The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliCround1 The current object (for fluent API support)
     */
    public function setRid($v)
    {
        ...
        if ($this->rid !== $v) {
            $this->rid = $v;
            $this->modifiedColumns[AliCround1TableMap::COL_RID] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliCround1TableMap::COL_RCODE] = true;
        }
    ...
    public function setRdate($v)
    {
        ...
        if ($this->rdate !== null || $dt !== null) {
            if ($this->rdate === null || $dt === null || $dt->format("Y-m-d") !== $this->rdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliCround1TableMap::COL_RDATE] = true;
            }
    ...
    public function setFsano($v)
    {
        ...
        if ($this->fsano !== $v) {
            $this->fsano = $v;
            $this->modifiedColumns[AliCround1TableMap::COL_FSANO] = true;
        }
    ...
    public function setTsano($v)
    {
        ...
        if ($this->tsano !== $v) {
            $this->tsano = $v;
            $this->modifiedColumns[AliCround1TableMap::COL_TSANO] = true;
        }
    ...
    public function setPaydate($v)
    {
        ...
        if ($this->paydate !== null || $dt !== null) {
            if ($this->paydate === null || $dt === null || $dt->format("Y-m-d") !== $this->paydate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliCround1TableMap::COL_PAYDATE] = true;
            }
        } // if either are not null
    ...
    public function setCalc($v)
    {
        ...
        if ($this->calc !== $v) {
            $this->calc = $v;
            $this->modifiedColumns[AliCround1TableMap::COL_CALC] = true;
        }
    ...
    public function setRemark($v)
    {
        ...
        if ($this->remark !== $v) {
            $this->remark = $v;
            $this->modifiedColumns[AliCround1TableMap::COL_REMARK] = true;
        }
    ...
    public function setFdate($v)
    {
        ...
        if ($this->fdate !== null || $dt !== null) {
            if ($this->fdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliCround1TableMap::COL_FDATE] = true;
            }
        } // if either are not null
    ...
    public function setTdate($v)
    {
        ...
        if ($this->tdate !== null || $dt !== null) {
            if ($this->tdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliCround1TableMap::COL_TDATE] = true;
            }
        } // if either are not null
    ...
    public function setFpdate($v)
    {
        ...
        if ($this->fpdate !== null || $dt !== null) {
            if ($this->fpdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fpdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliCround1TableMap::COL_FPDATE] = true;
            }
        } // if either are not null
    ...
    public function setTpdate($v)
    {
        ...
        if ($this->tpdate !== null || $dt !== null) {
            if ($this->tpdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tpdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliCround1TableMap::COL_TPDATE] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliCround1TableMap::translateFieldName('Rid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliCround1TableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliCround1TableMap::translateFieldName('Rdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->rdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliCround1TableMap::translateFieldName('Fsano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fsano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliCround1TableMap::translateFieldName('Tsano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tsano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliCround1TableMap::translateFieldName('Paydate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->paydate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliCround1TableMap::translateFieldName('Calc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->calc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliCround1TableMap::translateFieldName('Remark', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remark = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliCround1TableMap::translateFieldName('Fdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliCround1TableMap::translateFieldName('Tdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->tdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliCround1TableMap::translateFieldName('Fpdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fpdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliCround1TableMap::translateFieldName('Tpdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            ...
            return $startcol + 12; // 12 = AliCround1TableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliCround1'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliCround1Query::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliCround1::setDeleted()
     * @see AliCround1::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliCround1Query::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliCround1TableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliCround1TableMap::COL_RID)) {
            $modifiedColumns[':p' . $index++]  = 'rid';
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_RDATE)) {
            $modifiedColumns[':p' . $index++]  = 'rdate';
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_FSANO)) {
            $modifiedColumns[':p' . $index++]  = 'fsano';
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_TSANO)) {
            $modifiedColumns[':p' . $index++]  = 'tsano';
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_PAYDATE)) {
            $modifiedColumns[':p' . $index++]  = 'paydate';
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_CALC)) {
            $modifiedColumns[':p' . $index++]  = 'calc';
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_REMARK)) {
            $modifiedColumns[':p' . $index++]  = 'remark';
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_FDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fdate';
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_TDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tdate';
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_FPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fpdate';
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_TPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tpdate';
        }

        $sql = sprintf(
            'INSERT INTO ali_cround1 (%s) VALUES (%s)',
    ...
    {
        $pos = AliCround1TableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliCround1'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliCround1'][$this->hashCode()] = true;
        $keys = AliCround1TableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliCround1
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliCround1 The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliCround1TableMap::COL_RID)) {
            $criteria->add(AliCround1TableMap::COL_RID, $this->rid);
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_RCODE)) {
            $criteria->add(AliCround1TableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_RDATE)) {
            $criteria->add(AliCround1TableMap::COL_RDATE, $this->rdate);
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_FSANO)) {
            $criteria->add(AliCround1TableMap::COL_FSANO, $this->fsano);
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_TSANO)) {
            $criteria->add(AliCround1TableMap::COL_TSANO, $this->tsano);
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_PAYDATE)) {
            $criteria->add(AliCround1TableMap::COL_PAYDATE, $this->paydate);
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_CALC)) {
            $criteria->add(AliCround1TableMap::COL_CALC, $this->calc);
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_REMARK)) {
            $criteria->add(AliCround1TableMap::COL_REMARK, $this->remark);
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_FDATE)) {
            $criteria->add(AliCround1TableMap::COL_FDATE, $this->fdate);
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_TDATE)) {
            $criteria->add(AliCround1TableMap::COL_TDATE, $this->tdate);
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_FPDATE)) {
            $criteria->add(AliCround1TableMap::COL_FPDATE, $this->fpdate);
        }
        if ($this->isColumnModified(AliCround1TableMap::COL_TPDATE)) {
            $criteria->add(AliCround1TableMap::COL_TPDATE, $this->tpdate);
        }
    ...
    {
        $criteria = ChildAliCround1Query::create();
        $criteria->add(AliCround1TableMap::COL_RID, $this->rid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliCround1 (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliCround1 Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliCround1TableMap::DEFAULT_STRING_FORMAT);
    }
