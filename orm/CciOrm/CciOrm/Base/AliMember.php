...
/**
 * Base class that represents a row from the 'ali_member' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliMember implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliMemberTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliMember object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>AliMember</code> instance.  If
     * <code>obj</code> is an instance of <code>AliMember</code>, delegates to
     * <code>equals(AliMember)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliMember The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliMember The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_ID] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_MCODE] = true;
        }
    ...
    public function setNameF($v)
    {
        ...
        if ($this->name_f !== $v) {
            $this->name_f = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_NAME_F] = true;
        }
    ...
    public function setNameT($v)
    {
        ...
        if ($this->name_t !== $v) {
            $this->name_t = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_NAME_T] = true;
        }
    ...
    public function setNameE($v)
    {
        ...
        if ($this->name_e !== $v) {
            $this->name_e = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_NAME_E] = true;
        }
    ...
    public function setPosid($v)
    {
        ...
        if ($this->posid !== $v) {
            $this->posid = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_POSID] = true;
        }
    ...
    public function setMdate($v)
    {
        ...
        if ($this->mdate !== $v) {
            $this->mdate = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_MDATE] = true;
        }
    ...
    public function setNational($v)
    {
        ...
        if ($this->national !== $v) {
            $this->national = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_NATIONAL] = true;
        }
    ...
    public function setIdCardImg($v)
    {
        ...
        if ($this->id_card_img !== $v) {
            $this->id_card_img = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_ID_CARD_IMG] = true;
        }
    ...
    public function setIdCardImgDate($v)
    {
        ...
        if ($this->id_card_img_date !== null || $dt !== null) {
            if ($this->id_card_img_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->id_card_img_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AliMemberTableMap::COL_ID_CARD_IMG_DATE] = true;
            }
    ...
    public function setHomeT($v)
    {
        ...
        if ($this->home_t !== $v) {
            $this->home_t = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_HOME_T] = true;
        }
    ...
    public function setOfficeT($v)
    {
        ...
        if ($this->office_t !== $v) {
            $this->office_t = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_OFFICE_T] = true;
        }
    ...
    public function setMcodeAcc($v)
    {
        ...
        if ($this->mcode_acc !== $v) {
            $this->mcode_acc = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_MCODE_ACC] = true;
        }
    ...
    public function setBonusrec($v)
    {
        ...
        if ($this->bonusrec !== $v) {
            $this->bonusrec = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_BONUSREC] = true;
        }
    ...
    public function setBankcode($v)
    {
        ...
        if ($this->bankcode !== $v) {
            $this->bankcode = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_BANKCODE] = true;
        }
    ...
    public function setAccType($v)
    {
        ...
        if ($this->acc_type !== $v) {
            $this->acc_type = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_ACC_TYPE] = true;
        }
    ...
    public function setAccNo($v)
    {
        ...
        if ($this->acc_no !== $v) {
            $this->acc_no = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_ACC_NO] = true;
        }
    ...
    public function setAccNoImg($v)
    {
        ...
        if ($this->acc_no_img !== $v) {
            $this->acc_no_img = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_ACC_NO_IMG] = true;
        }
    ...
    public function setAccNoImgDate($v)
    {
        ...
        if ($this->acc_no_img_date !== null || $dt !== null) {
            if ($this->acc_no_img_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->acc_no_img_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AliMemberTableMap::COL_ACC_NO_IMG_DATE] = true;
            }
        } // if either are not null
    ...
    public function setAccName($v)
    {
        ...
        if ($this->acc_name !== $v) {
            $this->acc_name = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_ACC_NAME] = true;
        }
    ...
    public function setAccProv($v)
    {
        ...
        if ($this->acc_prov !== $v) {
            $this->acc_prov = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_ACC_PROV] = true;
        }
    ...
    public function setSvCode($v)
    {
        ...
        if ($this->sv_code !== $v) {
            $this->sv_code = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_SV_CODE] = true;
        }
    ...
    public function setSpCode($v)
    {
        ...
        if ($this->sp_code !== $v) {
            $this->sp_code = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_SP_CODE] = true;
        }
    ...
    public function setSpName($v)
    {
        ...
        if ($this->sp_name !== $v) {
            $this->sp_name = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_SP_NAME] = true;
        }
    ...
    public function setSpName2($v)
    {
        ...
        if ($this->sp_name2 !== $v) {
            $this->sp_name2 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_SP_NAME2] = true;
        }
    ...
    public function setUpaCode($v)
    {
        ...
        if ($this->upa_code !== $v) {
            $this->upa_code = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_UPA_CODE] = true;
        }
    ...
    public function setUpaName($v)
    {
        ...
        if ($this->upa_name !== $v) {
            $this->upa_name = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_UPA_NAME] = true;
        }
    ...
    public function setLr($v)
    {
        ...
        if ($this->lr !== $v) {
            $this->lr = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_LR] = true;
        }
    ...
    public function setCompdate($v)
    {
        ...
        if ($this->compdate !== $v) {
            $this->compdate = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_COMPDATE] = true;
        }
    ...
    public function setModate($v)
    {
        ...
        if ($this->modate !== $v) {
            $this->modate = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_MODATE] = true;
        }
    ...
    public function setUsercode($v)
    {
        ...
        if ($this->usercode !== $v) {
            $this->usercode = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_USERCODE] = true;
        }
    ...
    public function setNameB($v)
    {
        ...
        if ($this->name_b !== $v) {
            $this->name_b = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_NAME_B] = true;
        }
    ...
    public function setOccupation($v)
    {
        ...
        if ($this->occupation !== $v) {
            $this->occupation = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_OCCUPATION] = true;
        }
    ...
    public function setMarAge($v)
    {
        ...
        if ($this->mar_age !== $v) {
            $this->mar_age = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_MAR_AGE] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_EMAIL] = true;
        }
    ...
    public function setBeneficiaries($v)
    {
        ...
        if ($this->beneficiaries !== $v) {
            ...
            $this->modifiedColumns[AliMemberTableMap::COL_BENEFICIARIES] = true;
        }
    ...
    public function setRelation($v)
    {
        ...
        if ($this->relation !== $v) {
            $this->relation = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_RELATION] = true;
        }
    ...
    public function setDistrictid($v)
    {
        ...
        if ($this->districtid !== $v) {
            $this->districtid = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_DISTRICTID] = true;
        }
    ...
    public function setAmphurid($v)
    {
        ...
        if ($this->amphurid !== $v) {
            $this->amphurid = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_AMPHURID] = true;
        }
    ...
    public function setProvinceid($v)
    {
        ...
        if ($this->provinceid !== $v) {
            $this->provinceid = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_PROVINCEID] = true;
        }
    ...
    public function setFax($v)
    {
        ...
        if ($this->fax !== $v) {
            $this->fax = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_FAX] = true;
        }
    ...
    public function setInvCode($v)
    {
        ...
        if ($this->inv_code !== $v) {
            $this->inv_code = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_INV_CODE] = true;
        }
    ...
    public function setPosCur($v)
    {
        ...
        if ($this->pos_cur !== $v) {
            $this->pos_cur = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_POS_CUR] = true;
        }
    ...
    public function setPosCur1($v)
    {
        ...
        if ($this->pos_cur1 !== $v) {
            $this->pos_cur1 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_POS_CUR1] = true;
        }
    ...
    public function setPosCur2($v)
    {
        ...
        if ($this->pos_cur2 !== $v) {
            $this->pos_cur2 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_POS_CUR2] = true;
        }
    ...
    public function setPosCurTmp($v)
    {
        ...
        if ($this->pos_cur_tmp !== $v) {
            $this->pos_cur_tmp = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_POS_CUR_TMP] = true;
        }
    ...
    public function setRposCur4($v)
    {
        ...
        if ($this->rpos_cur4 !== $v) {
            $this->rpos_cur4 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_RPOS_CUR4] = true;
        }
    ...
    public function setPosCur3Date($v)
    {
        ...
        if ($this->pos_cur3_date !== null || $dt !== null) {
            if ($this->pos_cur3_date === null || $dt === null || $dt->format("Y-m-d") !== $this->pos_cur3_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliMemberTableMap::COL_POS_CUR3_DATE] = true;
            }
        } // if either are not null
    ...
    public function setMemdesc($v)
    {
        ...
        if ($this->memdesc !== $v) {
            $this->memdesc = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_MEMDESC] = true;
        }
    ...
    public function setCmp($v)
    {
        ...
        if ($this->cmp !== $v) {
            $this->cmp = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CMP] = true;
        }
    ...
    public function setCmp2($v)
    {
        ...
        if ($this->cmp2 !== $v) {
            $this->cmp2 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CMP2] = true;
        }
    ...
    public function setCmp3($v)
    {
        ...
        if ($this->cmp3 !== $v) {
            $this->cmp3 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CMP3] = true;
        }
    ...
    public function setCcmp($v)
    {
        ...
        if ($this->ccmp !== $v) {
            $this->ccmp = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CCMP] = true;
        }
    ...
    public function setCcmp2($v)
    {
        ...
        if ($this->ccmp2 !== $v) {
            $this->ccmp2 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CCMP2] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_ADDRESS] = true;
        }
    ...
    public function setStreet($v)
    {
        ...
        if ($this->street !== $v) {
            $this->street = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_STREET] = true;
        }
    ...
    public function setVillage($v)
    {
        ...
        if ($this->village !== $v) {
            $this->village = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_VILLAGE] = true;
        }
    ...
    public function setSoi($v)
    {
        ...
        if ($this->soi !== $v) {
            $this->soi = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_SOI] = true;
        }
    ...
    public function setEwallet($v)
    {
        ...
        if ($this->ewallet !== $v) {
            $this->ewallet = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_EWALLET] = true;
        }
    ...
    public function setEatoship($v)
    {
        ...
        if ($this->eatoship !== $v) {
            $this->eatoship = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_EATOSHIP] = true;
        }
    ...
    public function setEcom($v)
    {
        ...
        if ($this->ecom !== $v) {
            $this->ecom = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_ECOM] = true;
        }
    ...
    public function setBmdate1($v)
    {
        ...
        if ($this->bmdate1 !== $v) {
            $this->bmdate1 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_BMDATE1] = true;
        }
    ...
    public function setBmdate2($v)
    {
        ...
        if ($this->bmdate2 !== $v) {
            $this->bmdate2 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_BMDATE2] = true;
        }
    ...
    public function setBmdate3($v)
    {
        ...
        if ($this->bmdate3 !== $v) {
            $this->bmdate3 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_BMDATE3] = true;
        }
    ...
    public function setCbmdate1($v)
    {
        ...
        if ($this->cbmdate1 !== $v) {
            $this->cbmdate1 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CBMDATE1] = true;
        }
    ...
    public function setCbmdate2($v)
    {
        ...
        if ($this->cbmdate2 !== $v) {
            $this->cbmdate2 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CBMDATE2] = true;
        }
    ...
    public function setCbmdate3($v)
    {
        ...
        if ($this->cbmdate3 !== $v) {
            $this->cbmdate3 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CBMDATE3] = true;
        }
    ...
    public function setCnameF($v)
    {
        ...
        if ($this->cname_f !== $v) {
            $this->cname_f = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CNAME_F] = true;
        }
    ...
    public function setCnameT($v)
    {
        ...
        if ($this->cname_t !== $v) {
            $this->cname_t = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CNAME_T] = true;
        }
    ...
    public function setCnameE($v)
    {
        ...
        if ($this->cname_e !== $v) {
            $this->cname_e = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CNAME_E] = true;
        }
    ...
    public function setCnameB($v)
    {
        ...
        if ($this->cname_b !== $v) {
            $this->cname_b = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CNAME_B] = true;
        }
    ...
    public function setCnational($v)
    {
        ...
        if ($this->cnational !== $v) {
            $this->cnational = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CNATIONAL] = true;
        }
    ...
    public function setCaddress($v)
    {
        ...
        if ($this->caddress !== $v) {
            $this->caddress = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CADDRESS] = true;
        }
    ...
    public function setCvillage($v)
    {
        ...
        if ($this->cvillage !== $v) {
            $this->cvillage = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CVILLAGE] = true;
        }
    ...
    public function setCstreet($v)
    {
        ...
        if ($this->cstreet !== $v) {
            $this->cstreet = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CSTREET] = true;
        }
    ...
    public function setCsoi($v)
    {
        ...
        if ($this->csoi !== $v) {
            $this->csoi = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CSOI] = true;
        }
    ...
    public function setCzip($v)
    {
        ...
        if ($this->czip !== $v) {
            $this->czip = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CZIP] = true;
        }
    ...
    public function setChomeT($v)
    {
        ...
        if ($this->chome_t !== $v) {
            $this->chome_t = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CHOME_T] = true;
        }
    ...
    public function setCofficeT($v)
    {
        ...
        if ($this->coffice_t !== $v) {
            $this->coffice_t = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_COFFICE_T] = true;
        }
    ...
    public function setCmobile($v)
    {
        ...
        if ($this->cmobile !== $v) {
            $this->cmobile = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CMOBILE] = true;
        }
    ...
    public function setCdistrictid($v)
    {
        ...
        if ($this->cdistrictid !== $v) {
            $this->cdistrictid = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CDISTRICTID] = true;
        }
    ...
    public function setCamphurid($v)
    {
        ...
        if ($this->camphurid !== $v) {
            $this->camphurid = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CAMPHURID] = true;
        }
    ...
    public function setCprovinceid($v)
    {
        ...
        if ($this->cprovinceid !== $v) {
            $this->cprovinceid = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CPROVINCEID] = true;
        }
    ...
    public function setInameF($v)
    {
        ...
        if ($this->iname_f !== $v) {
            $this->iname_f = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_INAME_F] = true;
        }
    ...
    public function setInameT($v)
    {
        ...
        if ($this->iname_t !== $v) {
            $this->iname_t = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_INAME_T] = true;
        }
    ...
    public function setIrelation($v)
    {
        ...
        if ($this->irelation !== $v) {
            $this->irelation = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_IRELATION] = true;
        }
    ...
    public function setIphone($v)
    {
        ...
        if ($this->iphone !== $v) {
            $this->iphone = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_IPHONE] = true;
        }
    ...
    public function setIidCard($v)
    {
        ...
        if ($this->iid_card !== $v) {
            $this->iid_card = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_IID_CARD] = true;
        }
    ...
    public function setStatusDoc($v)
    {
        ...
        if ($this->status_doc !== $v) {
            $this->status_doc = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_STATUS_DOC] = true;
        }
    ...
    public function setStatusExpire($v)
    {
        ...
        if ($this->status_expire !== $v) {
            ...
            $this->modifiedColumns[AliMemberTableMap::COL_STATUS_EXPIRE] = true;
        }
    ...
    public function setStatusTerminate($v)
    {
        ...
        if ($this->status_terminate !== $v) {
            ...
            $this->modifiedColumns[AliMemberTableMap::COL_STATUS_TERMINATE] = true;
        }
    ...
    public function setTerminateDate($v)
    {
        ...
        if ($this->terminate_date !== null || $dt !== null) {
            if ($this->terminate_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->terminate_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AliMemberTableMap::COL_TERMINATE_DATE] = true;
            }
        } // if either are not null
    ...
    public function setStatusBlacklist($v)
    {
        ...
        if ($this->status_blacklist !== $v) {
            ...
            $this->modifiedColumns[AliMemberTableMap::COL_STATUS_BLACKLIST] = true;
        }
    ...
    public function setStatusAto($v)
    {
        ...
        if ($this->status_ato !== $v) {
            $this->status_ato = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_STATUS_ATO] = true;
        }
    ...
    public function setSletter($v)
    {
        ...
        if ($this->sletter !== $v) {
            $this->sletter = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_SLETTER] = true;
        }
    ...
    public function setSinvCode($v)
    {
        ...
        if ($this->sinv_code !== $v) {
            $this->sinv_code = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_SINV_CODE] = true;
        }
    ...
    public function setTxtoption($v)
    {
        ...
        if ($this->txtoption !== $v) {
            $this->txtoption = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_TXTOPTION] = true;
        }
    ...
    public function setSetregis($v)
    {
        ...
        if ($this->setregis !== $v) {
            $this->setregis = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_SETREGIS] = true;
        }
    ...
    public function setLocationbase($v)
    {
        ...
        if ($this->locationbase !== $v) {
            $this->locationbase = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_LOCATIONBASE] = true;
        }
    ...
    public function setCidMobile($v)
    {
        ...
        if ($this->cid_mobile !== $v) {
            $this->cid_mobile = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CID_MOBILE] = true;
        }
    ...
    public function setBewallet($v)
    {
        ...
        if ($this->bewallet !== $v) {
            $this->bewallet = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_BEWALLET] = true;
        }
    ...
    public function setBvoucher($v)
    {
        ...
        if ($this->bvoucher !== $v) {
            $this->bvoucher = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_BVOUCHER] = true;
        }
    ...
    public function setVoucher($v)
    {
        ...
        if ($this->voucher !== $v) {
            $this->voucher = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_VOUCHER] = true;
        }
    ...
    public function setManager($v)
    {
        ...
        if ($this->manager !== $v) {
            $this->manager = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_MANAGER] = true;
        }
    ...
    public function setMtype($v)
    {
        ...
        if ($this->mtype !== $v) {
            $this->mtype = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_MTYPE] = true;
        }
    ...
    public function setMtype1($v)
    {
        ...
        if ($this->mtype1 !== $v) {
            $this->mtype1 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_MTYPE1] = true;
        }
    ...
    public function setMvat($v)
    {
        ...
        if ($this->mvat !== $v) {
            $this->mvat = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_MVAT] = true;
        }
    ...
    public function setExpDate($v)
    {
        ...
        if ($this->exp_date !== null || $dt !== null) {
            if ($this->exp_date === null || $dt === null || $dt->format("Y-m-d") !== $this->exp_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliMemberTableMap::COL_EXP_DATE] = true;
            }
        } // if either are not null
    ...
    public function setHeadCode($v)
    {
        ...
        if ($this->head_code !== $v) {
            $this->head_code = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_HEAD_CODE] = true;
        }
    ...
    public function setPvL($v)
    {
        ...
        if ($this->pv_l !== $v) {
            $this->pv_l = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_PV_L] = true;
        }
    ...
    public function setPvC($v)
    {
        ...
        if ($this->pv_c !== $v) {
            $this->pv_c = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_PV_C] = true;
        }
    ...
    public function setHpvL($v)
    {
        ...
        if ($this->hpv_l !== $v) {
            $this->hpv_l = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_HPV_L] = true;
        }
    ...
    public function setHpvC($v)
    {
        ...
        if ($this->hpv_c !== $v) {
            $this->hpv_c = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_HPV_C] = true;
        }
    ...
    public function setPvLNextmonth($v)
    {
        ...
        if ($this->pv_l_nextmonth !== $v) {
            ...
            $this->modifiedColumns[AliMemberTableMap::COL_PV_L_NEXTMONTH] = true;
        }
    ...
    public function setPvCNextmonth($v)
    {
        ...
        if ($this->pv_c_nextmonth !== $v) {
            ...
            $this->modifiedColumns[AliMemberTableMap::COL_PV_C_NEXTMONTH] = true;
        }
    ...
    public function setPvLLastmonth1($v)
    {
        ...
        if ($this->pv_l_lastmonth1 !== $v) {
            ...
            $this->modifiedColumns[AliMemberTableMap::COL_PV_L_LASTMONTH1] = true;
        }
    ...
    public function setPvCLastmonth1($v)
    {
        ...
        if ($this->pv_c_lastmonth1 !== $v) {
            ...
            $this->modifiedColumns[AliMemberTableMap::COL_PV_C_LASTMONTH1] = true;
        }
    ...
    public function setPvLLastmonth2($v)
    {
        ...
        if ($this->pv_l_lastmonth2 !== $v) {
            ...
            $this->modifiedColumns[AliMemberTableMap::COL_PV_L_LASTMONTH2] = true;
        }
    ...
    public function setPvCLastmonth2($v)
    {
        ...
        if ($this->pv_c_lastmonth2 !== $v) {
            ...
            $this->modifiedColumns[AliMemberTableMap::COL_PV_C_LASTMONTH2] = true;
        }
    ...
    public function setRcodeStar($v)
    {
        ...
        if ($this->rcode_star !== $v) {
            $this->rcode_star = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_RCODE_STAR] = true;
        }
    ...
    public function setBunit($v)
    {
        ...
        if ($this->bunit !== $v) {
            $this->bunit = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_BUNIT] = true;
        }
    ...
    public function setProvince($v)
    {
        ...
        if ($this->province !== $v) {
            $this->province = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_PROVINCE] = true;
        }
    ...
    public function setLineId($v)
    {
        ...
        if ($this->line_id !== $v) {
            $this->line_id = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_LINE_ID] = true;
        }
    ...
    public function setFacebookName($v)
    {
        ...
        if ($this->facebook_name !== $v) {
            ...
            $this->modifiedColumns[AliMemberTableMap::COL_FACEBOOK_NAME] = true;
        }
    ...
    public function setTypeCom($v)
    {
        ...
        if ($this->type_com !== $v) {
            $this->type_com = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_TYPE_COM] = true;
        }
    ...
    public function setExpPos($v)
    {
        ...
        if ($this->exp_pos !== null || $dt !== null) {
            if ($this->exp_pos === null || $dt === null || $dt->format("Y-m-d") !== $this->exp_pos->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliMemberTableMap::COL_EXP_POS] = true;
            }
        } // if either are not null
    ...
    public function setExpPos60($v)
    {
        ...
        if ($this->exp_pos_60 !== null || $dt !== null) {
            if ($this->exp_pos_60 === null || $dt === null || $dt->format("Y-m-d") !== $this->exp_pos_60->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliMemberTableMap::COL_EXP_POS_60] = true;
            }
        } // if either are not null
    ...
    public function setTripPrivate($v)
    {
        ...
        if ($this->trip_private !== $v) {
            $this->trip_private = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_TRIP_PRIVATE] = true;
        }
    ...
    public function setTripTeam($v)
    {
        ...
        if ($this->trip_team !== $v) {
            $this->trip_team = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_TRIP_TEAM] = true;
        }
    ...
    public function setMyfile1($v)
    {
        ...
        if ($this->myfile1 !== $v) {
            $this->myfile1 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_MYFILE1] = true;
        }
    ...
    public function setMyfile2($v)
    {
        ...
        if ($this->myfile2 !== $v) {
            $this->myfile2 = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_MYFILE2] = true;
        }
    ...
    public function setClineId($v)
    {
        ...
        if ($this->cline_id !== $v) {
            $this->cline_id = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_CLINE_ID] = true;
        }
    ...
    public function setCfacebookName($v)
    {
        ...
        if ($this->cfacebook_name !== $v) {
            ...
            $this->modifiedColumns[AliMemberTableMap::COL_CFACEBOOK_NAME] = true;
        }
    ...
    public function setHpv($v)
    {
        ...
        if ($this->hpv !== $v) {
            $this->hpv = $v;
            $this->modifiedColumns[AliMemberTableMap::COL_HPV] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliMemberTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliMemberTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliMemberTableMap::translateFieldName('NameF', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_f = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliMemberTableMap::translateFieldName('NameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliMemberTableMap::translateFieldName('NameE', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_e = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliMemberTableMap::translateFieldName('Posid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->posid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliMemberTableMap::translateFieldName('Mdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliMemberTableMap::translateFieldName('Birthday', TableMap::TYPE_PHPNAME, $indexType)];
            $this->birthday = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliMemberTableMap::translateFieldName('National', TableMap::TYPE_PHPNAME, $indexType)];
            $this->national = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliMemberTableMap::translateFieldName('IdTax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_tax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliMemberTableMap::translateFieldName('IdCard', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_card = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliMemberTableMap::translateFieldName('IdCardImg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_card_img = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliMemberTableMap::translateFieldName('IdCardImgDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->id_card_img_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliMemberTableMap::translateFieldName('Zip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->zip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliMemberTableMap::translateFieldName('HomeT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->home_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliMemberTableMap::translateFieldName('OfficeT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->office_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AliMemberTableMap::translateFieldName('Mobile', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mobile = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AliMemberTableMap::translateFieldName('McodeAcc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode_acc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : AliMemberTableMap::translateFieldName('Bonusrec', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bonusrec = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : AliMemberTableMap::translateFieldName('Bankcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bankcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : AliMemberTableMap::translateFieldName('Branch', TableMap::TYPE_PHPNAME, $indexType)];
            $this->branch = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : AliMemberTableMap::translateFieldName('AccType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->acc_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : AliMemberTableMap::translateFieldName('AccNo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->acc_no = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : AliMemberTableMap::translateFieldName('AccNoImg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->acc_no_img = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : AliMemberTableMap::translateFieldName('AccNoImgDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->acc_no_img_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : AliMemberTableMap::translateFieldName('AccName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->acc_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : AliMemberTableMap::translateFieldName('AccProv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->acc_prov = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : AliMemberTableMap::translateFieldName('SvCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sv_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : AliMemberTableMap::translateFieldName('SpCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : AliMemberTableMap::translateFieldName('SpName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : AliMemberTableMap::translateFieldName('SpCode2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp_code2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : AliMemberTableMap::translateFieldName('SpName2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp_name2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : AliMemberTableMap::translateFieldName('UpaCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->upa_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : AliMemberTableMap::translateFieldName('UpaName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->upa_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : AliMemberTableMap::translateFieldName('Lr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : AliMemberTableMap::translateFieldName('Complete', TableMap::TYPE_PHPNAME, $indexType)];
            $this->complete = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : AliMemberTableMap::translateFieldName('Compdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->compdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : AliMemberTableMap::translateFieldName('Modate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->modate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : AliMemberTableMap::translateFieldName('Usercode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usercode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : AliMemberTableMap::translateFieldName('NameB', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_b = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : AliMemberTableMap::translateFieldName('Sex', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sex = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : AliMemberTableMap::translateFieldName('Age', TableMap::TYPE_PHPNAME, $indexType)];
            $this->age = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : AliMemberTableMap::translateFieldName('Occupation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->occupation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : AliMemberTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : AliMemberTableMap::translateFieldName('MarName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mar_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : AliMemberTableMap::translateFieldName('MarAge', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mar_age = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : AliMemberTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : AliMemberTableMap::translateFieldName('Beneficiaries', TableMap::TYPE_PHPNAME, $indexType)];
            $this->beneficiaries = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : AliMemberTableMap::translateFieldName('Relation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->relation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : AliMemberTableMap::translateFieldName('Districtid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->districtid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : AliMemberTableMap::translateFieldName('Amphurid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amphurid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : AliMemberTableMap::translateFieldName('Provinceid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->provinceid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : AliMemberTableMap::translateFieldName('Fax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : AliMemberTableMap::translateFieldName('InvCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : AliMemberTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : AliMemberTableMap::translateFieldName('Oid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->oid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : AliMemberTableMap::translateFieldName('PosCur', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pos_cur = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : AliMemberTableMap::translateFieldName('PosCur1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pos_cur1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 58 + $startcol : AliMemberTableMap::translateFieldName('PosCur2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pos_cur2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 59 + $startcol : AliMemberTableMap::translateFieldName('PosCur3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pos_cur3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 60 + $startcol : AliMemberTableMap::translateFieldName('PosCur4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pos_cur4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 61 + $startcol : AliMemberTableMap::translateFieldName('PosCurTmp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pos_cur_tmp = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 62 + $startcol : AliMemberTableMap::translateFieldName('RposCur4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rpos_cur4 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 63 + $startcol : AliMemberTableMap::translateFieldName('PosCur3Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->pos_cur3_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 64 + $startcol : AliMemberTableMap::translateFieldName('Memdesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->memdesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 65 + $startcol : AliMemberTableMap::translateFieldName('Cmp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cmp = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 66 + $startcol : AliMemberTableMap::translateFieldName('Cmp2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cmp2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 67 + $startcol : AliMemberTableMap::translateFieldName('Cmp3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cmp3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 68 + $startcol : AliMemberTableMap::translateFieldName('Ccmp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ccmp = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 69 + $startcol : AliMemberTableMap::translateFieldName('Ccmp2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ccmp2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 70 + $startcol : AliMemberTableMap::translateFieldName('Ccmp3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ccmp3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 71 + $startcol : AliMemberTableMap::translateFieldName('Address', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 72 + $startcol : AliMemberTableMap::translateFieldName('Street', TableMap::TYPE_PHPNAME, $indexType)];
            $this->street = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 73 + $startcol : AliMemberTableMap::translateFieldName('Building', TableMap::TYPE_PHPNAME, $indexType)];
            $this->building = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 74 + $startcol : AliMemberTableMap::translateFieldName('Village', TableMap::TYPE_PHPNAME, $indexType)];
            $this->village = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 75 + $startcol : AliMemberTableMap::translateFieldName('Soi', TableMap::TYPE_PHPNAME, $indexType)];
            $this->soi = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 76 + $startcol : AliMemberTableMap::translateFieldName('Ewallet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 77 + $startcol : AliMemberTableMap::translateFieldName('Eatoship', TableMap::TYPE_PHPNAME, $indexType)];
            $this->eatoship = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 78 + $startcol : AliMemberTableMap::translateFieldName('Ecom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ecom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 79 + $startcol : AliMemberTableMap::translateFieldName('Bmdate1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bmdate1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 80 + $startcol : AliMemberTableMap::translateFieldName('Bmdate2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bmdate2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 81 + $startcol : AliMemberTableMap::translateFieldName('Bmdate3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bmdate3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 82 + $startcol : AliMemberTableMap::translateFieldName('Cbmdate1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cbmdate1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 83 + $startcol : AliMemberTableMap::translateFieldName('Cbmdate2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cbmdate2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 84 + $startcol : AliMemberTableMap::translateFieldName('Cbmdate3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cbmdate3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 85 + $startcol : AliMemberTableMap::translateFieldName('Online', TableMap::TYPE_PHPNAME, $indexType)];
            $this->online = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 86 + $startcol : AliMemberTableMap::translateFieldName('CnameF', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cname_f = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 87 + $startcol : AliMemberTableMap::translateFieldName('CnameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cname_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 88 + $startcol : AliMemberTableMap::translateFieldName('CnameE', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cname_e = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 89 + $startcol : AliMemberTableMap::translateFieldName('CnameB', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cname_b = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 90 + $startcol : AliMemberTableMap::translateFieldName('Cbirthday', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cbirthday = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 91 + $startcol : AliMemberTableMap::translateFieldName('Cnational', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cnational = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 92 + $startcol : AliMemberTableMap::translateFieldName('CidTax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cid_tax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 93 + $startcol : AliMemberTableMap::translateFieldName('CidCard', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cid_card = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 94 + $startcol : AliMemberTableMap::translateFieldName('Caddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->caddress = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 95 + $startcol : AliMemberTableMap::translateFieldName('Cbuilding', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cbuilding = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 96 + $startcol : AliMemberTableMap::translateFieldName('Cvillage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cvillage = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 97 + $startcol : AliMemberTableMap::translateFieldName('Cstreet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cstreet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 98 + $startcol : AliMemberTableMap::translateFieldName('Csoi', TableMap::TYPE_PHPNAME, $indexType)];
            $this->csoi = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 99 + $startcol : AliMemberTableMap::translateFieldName('Czip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->czip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 100 + $startcol : AliMemberTableMap::translateFieldName('ChomeT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chome_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 101 + $startcol : AliMemberTableMap::translateFieldName('CofficeT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->coffice_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 102 + $startcol : AliMemberTableMap::translateFieldName('Cmobile', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cmobile = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 103 + $startcol : AliMemberTableMap::translateFieldName('Cfax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cfax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 104 + $startcol : AliMemberTableMap::translateFieldName('Csex', TableMap::TYPE_PHPNAME, $indexType)];
            $this->csex = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 105 + $startcol : AliMemberTableMap::translateFieldName('Cemail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cemail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 106 + $startcol : AliMemberTableMap::translateFieldName('Cdistrictid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cdistrictid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 107 + $startcol : AliMemberTableMap::translateFieldName('Camphurid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->camphurid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 108 + $startcol : AliMemberTableMap::translateFieldName('Cprovinceid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cprovinceid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 109 + $startcol : AliMemberTableMap::translateFieldName('InameF', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iname_f = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 110 + $startcol : AliMemberTableMap::translateFieldName('InameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iname_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 111 + $startcol : AliMemberTableMap::translateFieldName('Irelation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->irelation = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 112 + $startcol : AliMemberTableMap::translateFieldName('Iphone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iphone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 113 + $startcol : AliMemberTableMap::translateFieldName('IidCard', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iid_card = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 114 + $startcol : AliMemberTableMap::translateFieldName('StatusDoc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_doc = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 115 + $startcol : AliMemberTableMap::translateFieldName('StatusExpire', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_expire = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 116 + $startcol : AliMemberTableMap::translateFieldName('StatusTerminate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_terminate = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 117 + $startcol : AliMemberTableMap::translateFieldName('TerminateDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->terminate_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 118 + $startcol : AliMemberTableMap::translateFieldName('StatusSuspend', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_suspend = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 119 + $startcol : AliMemberTableMap::translateFieldName('SuspendDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->suspend_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 120 + $startcol : AliMemberTableMap::translateFieldName('StatusBlacklist', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_blacklist = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 121 + $startcol : AliMemberTableMap::translateFieldName('StatusAto', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_ato = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 122 + $startcol : AliMemberTableMap::translateFieldName('Sletter', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sletter = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 123 + $startcol : AliMemberTableMap::translateFieldName('SinvCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sinv_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 124 + $startcol : AliMemberTableMap::translateFieldName('Txtoption', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtoption = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 125 + $startcol : AliMemberTableMap::translateFieldName('Setregis', TableMap::TYPE_PHPNAME, $indexType)];
            $this->setregis = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 126 + $startcol : AliMemberTableMap::translateFieldName('Slr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->slr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 127 + $startcol : AliMemberTableMap::translateFieldName('Locationbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->locationbase = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 128 + $startcol : AliMemberTableMap::translateFieldName('CidMobile', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cid_mobile = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 129 + $startcol : AliMemberTableMap::translateFieldName('Bewallet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bewallet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 130 + $startcol : AliMemberTableMap::translateFieldName('Bvoucher', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bvoucher = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 131 + $startcol : AliMemberTableMap::translateFieldName('Voucher', TableMap::TYPE_PHPNAME, $indexType)];
            $this->voucher = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 132 + $startcol : AliMemberTableMap::translateFieldName('Manager', TableMap::TYPE_PHPNAME, $indexType)];
            $this->manager = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 133 + $startcol : AliMemberTableMap::translateFieldName('Mtype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mtype = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 134 + $startcol : AliMemberTableMap::translateFieldName('Mtype1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mtype1 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 135 + $startcol : AliMemberTableMap::translateFieldName('Mtype2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mtype2 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 136 + $startcol : AliMemberTableMap::translateFieldName('Mvat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mvat = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 137 + $startcol : AliMemberTableMap::translateFieldName('Uidbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uidbase = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 138 + $startcol : AliMemberTableMap::translateFieldName('ExpDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->exp_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 139 + $startcol : AliMemberTableMap::translateFieldName('HeadCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->head_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 140 + $startcol : AliMemberTableMap::translateFieldName('PvL', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pv_l = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 141 + $startcol : AliMemberTableMap::translateFieldName('PvC', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pv_c = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 142 + $startcol : AliMemberTableMap::translateFieldName('HpvL', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hpv_l = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 143 + $startcol : AliMemberTableMap::translateFieldName('HpvC', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hpv_c = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 144 + $startcol : AliMemberTableMap::translateFieldName('PvLNextmonth', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pv_l_nextmonth = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 145 + $startcol : AliMemberTableMap::translateFieldName('PvCNextmonth', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pv_c_nextmonth = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 146 + $startcol : AliMemberTableMap::translateFieldName('PvLLastmonth1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pv_l_lastmonth1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 147 + $startcol : AliMemberTableMap::translateFieldName('PvCLastmonth1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pv_c_lastmonth1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 148 + $startcol : AliMemberTableMap::translateFieldName('PvLLastmonth2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pv_l_lastmonth2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 149 + $startcol : AliMemberTableMap::translateFieldName('PvCLastmonth2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pv_c_lastmonth2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 150 + $startcol : AliMemberTableMap::translateFieldName('RcodeStar', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode_star = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 151 + $startcol : AliMemberTableMap::translateFieldName('Bunit', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bunit = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 152 + $startcol : AliMemberTableMap::translateFieldName('Province', TableMap::TYPE_PHPNAME, $indexType)];
            $this->province = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 153 + $startcol : AliMemberTableMap::translateFieldName('LineId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->line_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 154 + $startcol : AliMemberTableMap::translateFieldName('FacebookName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->facebook_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 155 + $startcol : AliMemberTableMap::translateFieldName('TypeCom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type_com = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 156 + $startcol : AliMemberTableMap::translateFieldName('ExpPos', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->exp_pos = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 157 + $startcol : AliMemberTableMap::translateFieldName('ExpPos60', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->exp_pos_60 = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 158 + $startcol : AliMemberTableMap::translateFieldName('TripPrivate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->trip_private = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 159 + $startcol : AliMemberTableMap::translateFieldName('TripTeam', TableMap::TYPE_PHPNAME, $indexType)];
            $this->trip_team = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 160 + $startcol : AliMemberTableMap::translateFieldName('Myfile1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->myfile1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 161 + $startcol : AliMemberTableMap::translateFieldName('Myfile2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->myfile2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 162 + $startcol : AliMemberTableMap::translateFieldName('ClineId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cline_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 163 + $startcol : AliMemberTableMap::translateFieldName('CfacebookName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cfacebook_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 164 + $startcol : AliMemberTableMap::translateFieldName('ProfileImg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->profile_img = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 165 + $startcol : AliMemberTableMap::translateFieldName('Atocom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->atocom = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 166 + $startcol : AliMemberTableMap::translateFieldName('Hpv', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 167; // 167 = AliMemberTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliMember'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliMemberQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliMember::setDeleted()
     * @see AliMember::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliMemberQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliMemberTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliMemberTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_NAME_F)) {
            $modifiedColumns[':p' . $index++]  = 'name_f';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_NAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'name_t';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_NAME_E)) {
            $modifiedColumns[':p' . $index++]  = 'name_e';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POSID)) {
            $modifiedColumns[':p' . $index++]  = 'posid';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MDATE)) {
            $modifiedColumns[':p' . $index++]  = 'mdate';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BIRTHDAY)) {
            $modifiedColumns[':p' . $index++]  = 'birthday';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_NATIONAL)) {
            $modifiedColumns[':p' . $index++]  = 'national';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ID_TAX)) {
            $modifiedColumns[':p' . $index++]  = 'id_tax';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ID_CARD)) {
            $modifiedColumns[':p' . $index++]  = 'id_card';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ID_CARD_IMG)) {
            $modifiedColumns[':p' . $index++]  = 'id_card_img';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ID_CARD_IMG_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'id_card_img_date';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ZIP)) {
            $modifiedColumns[':p' . $index++]  = 'zip';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_HOME_T)) {
            $modifiedColumns[':p' . $index++]  = 'home_t';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_OFFICE_T)) {
            $modifiedColumns[':p' . $index++]  = 'office_t';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MOBILE)) {
            $modifiedColumns[':p' . $index++]  = 'mobile';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MCODE_ACC)) {
            $modifiedColumns[':p' . $index++]  = 'mcode_acc';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BONUSREC)) {
            $modifiedColumns[':p' . $index++]  = 'bonusrec';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BANKCODE)) {
            $modifiedColumns[':p' . $index++]  = 'bankcode';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BRANCH)) {
            $modifiedColumns[':p' . $index++]  = 'branch';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ACC_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'acc_type';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ACC_NO)) {
            $modifiedColumns[':p' . $index++]  = 'acc_no';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ACC_NO_IMG)) {
            $modifiedColumns[':p' . $index++]  = 'acc_no_img';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ACC_NO_IMG_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'acc_no_img_date';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ACC_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'acc_name';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ACC_PROV)) {
            $modifiedColumns[':p' . $index++]  = 'acc_prov';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SV_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'sv_code';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SP_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'sp_code';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SP_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'sp_name';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SP_CODE2)) {
            $modifiedColumns[':p' . $index++]  = 'sp_code2';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SP_NAME2)) {
            $modifiedColumns[':p' . $index++]  = 'sp_name2';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_UPA_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'upa_code';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_UPA_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'upa_name';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_LR)) {
            $modifiedColumns[':p' . $index++]  = 'lr';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_COMPLETE)) {
            $modifiedColumns[':p' . $index++]  = 'complete';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_COMPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'compdate';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MODATE)) {
            $modifiedColumns[':p' . $index++]  = 'modate';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_USERCODE)) {
            $modifiedColumns[':p' . $index++]  = 'usercode';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_NAME_B)) {
            $modifiedColumns[':p' . $index++]  = 'name_b';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SEX)) {
            $modifiedColumns[':p' . $index++]  = 'sex';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_AGE)) {
            $modifiedColumns[':p' . $index++]  = 'age';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_OCCUPATION)) {
            $modifiedColumns[':p' . $index++]  = 'occupation';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MAR_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'mar_name';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MAR_AGE)) {
            $modifiedColumns[':p' . $index++]  = 'mar_age';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BENEFICIARIES)) {
            $modifiedColumns[':p' . $index++]  = 'beneficiaries';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_RELATION)) {
            $modifiedColumns[':p' . $index++]  = 'relation';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_DISTRICTID)) {
            $modifiedColumns[':p' . $index++]  = 'districtId';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_AMPHURID)) {
            $modifiedColumns[':p' . $index++]  = 'amphurId';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PROVINCEID)) {
            $modifiedColumns[':p' . $index++]  = 'provinceId';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_FAX)) {
            $modifiedColumns[':p' . $index++]  = 'fax';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_INV_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'inv_code';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_OID)) {
            $modifiedColumns[':p' . $index++]  = 'oid';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR)) {
            $modifiedColumns[':p' . $index++]  = 'pos_cur';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR1)) {
            $modifiedColumns[':p' . $index++]  = 'pos_cur1';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR2)) {
            $modifiedColumns[':p' . $index++]  = 'pos_cur2';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR3)) {
            $modifiedColumns[':p' . $index++]  = 'pos_cur3';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR4)) {
            $modifiedColumns[':p' . $index++]  = 'pos_cur4';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR_TMP)) {
            $modifiedColumns[':p' . $index++]  = 'pos_cur_tmp';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_RPOS_CUR4)) {
            $modifiedColumns[':p' . $index++]  = 'rpos_cur4';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR3_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'pos_cur3_date';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MEMDESC)) {
            $modifiedColumns[':p' . $index++]  = 'memdesc';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CMP)) {
            $modifiedColumns[':p' . $index++]  = 'cmp';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CMP2)) {
            $modifiedColumns[':p' . $index++]  = 'cmp2';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CMP3)) {
            $modifiedColumns[':p' . $index++]  = 'cmp3';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CCMP)) {
            $modifiedColumns[':p' . $index++]  = 'ccmp';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CCMP2)) {
            $modifiedColumns[':p' . $index++]  = 'ccmp2';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CCMP3)) {
            $modifiedColumns[':p' . $index++]  = 'ccmp3';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'address';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STREET)) {
            $modifiedColumns[':p' . $index++]  = 'street';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BUILDING)) {
            $modifiedColumns[':p' . $index++]  = 'building';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_VILLAGE)) {
            $modifiedColumns[':p' . $index++]  = 'village';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SOI)) {
            $modifiedColumns[':p' . $index++]  = 'soi';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_EWALLET)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_EATOSHIP)) {
            $modifiedColumns[':p' . $index++]  = 'eatoship';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ECOM)) {
            $modifiedColumns[':p' . $index++]  = 'ecom';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BMDATE1)) {
            $modifiedColumns[':p' . $index++]  = 'bmdate1';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BMDATE2)) {
            $modifiedColumns[':p' . $index++]  = 'bmdate2';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BMDATE3)) {
            $modifiedColumns[':p' . $index++]  = 'bmdate3';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CBMDATE1)) {
            $modifiedColumns[':p' . $index++]  = 'cbmdate1';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CBMDATE2)) {
            $modifiedColumns[':p' . $index++]  = 'cbmdate2';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CBMDATE3)) {
            $modifiedColumns[':p' . $index++]  = 'cbmdate3';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ONLINE)) {
            $modifiedColumns[':p' . $index++]  = 'online';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CNAME_F)) {
            $modifiedColumns[':p' . $index++]  = 'cname_f';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CNAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'cname_t';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CNAME_E)) {
            $modifiedColumns[':p' . $index++]  = 'cname_e';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CNAME_B)) {
            $modifiedColumns[':p' . $index++]  = 'cname_b';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CBIRTHDAY)) {
            $modifiedColumns[':p' . $index++]  = 'cbirthday';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CNATIONAL)) {
            $modifiedColumns[':p' . $index++]  = 'cnational';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CID_TAX)) {
            $modifiedColumns[':p' . $index++]  = 'cid_tax';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CID_CARD)) {
            $modifiedColumns[':p' . $index++]  = 'cid_card';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'caddress';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CBUILDING)) {
            $modifiedColumns[':p' . $index++]  = 'cbuilding';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CVILLAGE)) {
            $modifiedColumns[':p' . $index++]  = 'cvillage';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CSTREET)) {
            $modifiedColumns[':p' . $index++]  = 'cstreet';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CSOI)) {
            $modifiedColumns[':p' . $index++]  = 'csoi';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CZIP)) {
            $modifiedColumns[':p' . $index++]  = 'czip';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CHOME_T)) {
            $modifiedColumns[':p' . $index++]  = 'chome_t';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_COFFICE_T)) {
            $modifiedColumns[':p' . $index++]  = 'coffice_t';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CMOBILE)) {
            $modifiedColumns[':p' . $index++]  = 'cmobile';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CFAX)) {
            $modifiedColumns[':p' . $index++]  = 'cfax';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CSEX)) {
            $modifiedColumns[':p' . $index++]  = 'csex';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CEMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'cemail';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CDISTRICTID)) {
            $modifiedColumns[':p' . $index++]  = 'cdistrictId';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CAMPHURID)) {
            $modifiedColumns[':p' . $index++]  = 'camphurId';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CPROVINCEID)) {
            $modifiedColumns[':p' . $index++]  = 'cprovinceId';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_INAME_F)) {
            $modifiedColumns[':p' . $index++]  = 'iname_f';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_INAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'iname_t';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_IRELATION)) {
            $modifiedColumns[':p' . $index++]  = 'irelation';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_IPHONE)) {
            $modifiedColumns[':p' . $index++]  = 'iphone';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_IID_CARD)) {
            $modifiedColumns[':p' . $index++]  = 'iid_card';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS_DOC)) {
            $modifiedColumns[':p' . $index++]  = 'status_doc';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS_EXPIRE)) {
            $modifiedColumns[':p' . $index++]  = 'status_expire';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS_TERMINATE)) {
            $modifiedColumns[':p' . $index++]  = 'status_terminate';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_TERMINATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'terminate_date';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS_SUSPEND)) {
            $modifiedColumns[':p' . $index++]  = 'status_suspend';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SUSPEND_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'suspend_date';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS_BLACKLIST)) {
            $modifiedColumns[':p' . $index++]  = 'status_blacklist';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS_ATO)) {
            $modifiedColumns[':p' . $index++]  = 'status_ato';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SLETTER)) {
            $modifiedColumns[':p' . $index++]  = 'sletter';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SINV_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'sinv_code';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_TXTOPTION)) {
            $modifiedColumns[':p' . $index++]  = 'txtoption';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SETREGIS)) {
            $modifiedColumns[':p' . $index++]  = 'setregis';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SLR)) {
            $modifiedColumns[':p' . $index++]  = 'slr';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_LOCATIONBASE)) {
            $modifiedColumns[':p' . $index++]  = 'locationbase';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CID_MOBILE)) {
            $modifiedColumns[':p' . $index++]  = 'cid_mobile';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BEWALLET)) {
            $modifiedColumns[':p' . $index++]  = 'bewallet';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BVOUCHER)) {
            $modifiedColumns[':p' . $index++]  = 'bvoucher';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_VOUCHER)) {
            $modifiedColumns[':p' . $index++]  = 'voucher';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MANAGER)) {
            $modifiedColumns[':p' . $index++]  = 'manager';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'mtype';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MTYPE1)) {
            $modifiedColumns[':p' . $index++]  = 'mtype1';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MTYPE2)) {
            $modifiedColumns[':p' . $index++]  = 'mtype2';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MVAT)) {
            $modifiedColumns[':p' . $index++]  = 'mvat';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_UIDBASE)) {
            $modifiedColumns[':p' . $index++]  = 'uidbase';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_EXP_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'exp_date';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_HEAD_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'head_code';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_L)) {
            $modifiedColumns[':p' . $index++]  = 'pv_l';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_C)) {
            $modifiedColumns[':p' . $index++]  = 'pv_c';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_HPV_L)) {
            $modifiedColumns[':p' . $index++]  = 'hpv_l';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_HPV_C)) {
            $modifiedColumns[':p' . $index++]  = 'hpv_c';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_L_NEXTMONTH)) {
            $modifiedColumns[':p' . $index++]  = 'pv_l_nextmonth';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_C_NEXTMONTH)) {
            $modifiedColumns[':p' . $index++]  = 'pv_c_nextmonth';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_L_LASTMONTH1)) {
            $modifiedColumns[':p' . $index++]  = 'pv_l_lastmonth1';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_C_LASTMONTH1)) {
            $modifiedColumns[':p' . $index++]  = 'pv_c_lastmonth1';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_L_LASTMONTH2)) {
            $modifiedColumns[':p' . $index++]  = 'pv_l_lastmonth2';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_C_LASTMONTH2)) {
            $modifiedColumns[':p' . $index++]  = 'pv_c_lastmonth2';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_RCODE_STAR)) {
            $modifiedColumns[':p' . $index++]  = 'rcode_star';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BUNIT)) {
            $modifiedColumns[':p' . $index++]  = 'bunit';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PROVINCE)) {
            $modifiedColumns[':p' . $index++]  = 'province';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_LINE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'line_id';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_FACEBOOK_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'facebook_name';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_TYPE_COM)) {
            $modifiedColumns[':p' . $index++]  = 'type_com';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_EXP_POS)) {
            $modifiedColumns[':p' . $index++]  = 'exp_pos';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_EXP_POS_60)) {
            $modifiedColumns[':p' . $index++]  = 'exp_pos_60';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_TRIP_PRIVATE)) {
            $modifiedColumns[':p' . $index++]  = 'trip_private';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_TRIP_TEAM)) {
            $modifiedColumns[':p' . $index++]  = 'trip_team';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MYFILE1)) {
            $modifiedColumns[':p' . $index++]  = 'myfile1';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MYFILE2)) {
            $modifiedColumns[':p' . $index++]  = 'myfile2';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CLINE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'cline_id';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CFACEBOOK_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'cfacebook_name';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PROFILE_IMG)) {
            $modifiedColumns[':p' . $index++]  = 'profile_img';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ATOCOM)) {
            $modifiedColumns[':p' . $index++]  = 'atocom';
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_HPV)) {
            $modifiedColumns[':p' . $index++]  = 'hpv';
        }

        $sql = sprintf(
            'INSERT INTO ali_member (%s) VALUES (%s)',
    ...
    {
        $pos = AliMemberTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliMember'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliMember'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliMember
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliMember The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliMemberTableMap::COL_ID)) {
            $criteria->add(AliMemberTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MCODE)) {
            $criteria->add(AliMemberTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_NAME_F)) {
            $criteria->add(AliMemberTableMap::COL_NAME_F, $this->name_f);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_NAME_T)) {
            $criteria->add(AliMemberTableMap::COL_NAME_T, $this->name_t);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_NAME_E)) {
            $criteria->add(AliMemberTableMap::COL_NAME_E, $this->name_e);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POSID)) {
            $criteria->add(AliMemberTableMap::COL_POSID, $this->posid);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MDATE)) {
            $criteria->add(AliMemberTableMap::COL_MDATE, $this->mdate);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BIRTHDAY)) {
            $criteria->add(AliMemberTableMap::COL_BIRTHDAY, $this->birthday);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_NATIONAL)) {
            $criteria->add(AliMemberTableMap::COL_NATIONAL, $this->national);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ID_TAX)) {
            $criteria->add(AliMemberTableMap::COL_ID_TAX, $this->id_tax);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ID_CARD)) {
            $criteria->add(AliMemberTableMap::COL_ID_CARD, $this->id_card);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ID_CARD_IMG)) {
            $criteria->add(AliMemberTableMap::COL_ID_CARD_IMG, $this->id_card_img);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ID_CARD_IMG_DATE)) {
            $criteria->add(AliMemberTableMap::COL_ID_CARD_IMG_DATE, $this->id_card_img_date);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ZIP)) {
            $criteria->add(AliMemberTableMap::COL_ZIP, $this->zip);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_HOME_T)) {
            $criteria->add(AliMemberTableMap::COL_HOME_T, $this->home_t);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_OFFICE_T)) {
            $criteria->add(AliMemberTableMap::COL_OFFICE_T, $this->office_t);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MOBILE)) {
            $criteria->add(AliMemberTableMap::COL_MOBILE, $this->mobile);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MCODE_ACC)) {
            $criteria->add(AliMemberTableMap::COL_MCODE_ACC, $this->mcode_acc);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BONUSREC)) {
            $criteria->add(AliMemberTableMap::COL_BONUSREC, $this->bonusrec);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BANKCODE)) {
            $criteria->add(AliMemberTableMap::COL_BANKCODE, $this->bankcode);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BRANCH)) {
            $criteria->add(AliMemberTableMap::COL_BRANCH, $this->branch);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ACC_TYPE)) {
            $criteria->add(AliMemberTableMap::COL_ACC_TYPE, $this->acc_type);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ACC_NO)) {
            $criteria->add(AliMemberTableMap::COL_ACC_NO, $this->acc_no);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ACC_NO_IMG)) {
            $criteria->add(AliMemberTableMap::COL_ACC_NO_IMG, $this->acc_no_img);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ACC_NO_IMG_DATE)) {
            $criteria->add(AliMemberTableMap::COL_ACC_NO_IMG_DATE, $this->acc_no_img_date);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ACC_NAME)) {
            $criteria->add(AliMemberTableMap::COL_ACC_NAME, $this->acc_name);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ACC_PROV)) {
            $criteria->add(AliMemberTableMap::COL_ACC_PROV, $this->acc_prov);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SV_CODE)) {
            $criteria->add(AliMemberTableMap::COL_SV_CODE, $this->sv_code);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SP_CODE)) {
            $criteria->add(AliMemberTableMap::COL_SP_CODE, $this->sp_code);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SP_NAME)) {
            $criteria->add(AliMemberTableMap::COL_SP_NAME, $this->sp_name);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SP_CODE2)) {
            $criteria->add(AliMemberTableMap::COL_SP_CODE2, $this->sp_code2);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SP_NAME2)) {
            $criteria->add(AliMemberTableMap::COL_SP_NAME2, $this->sp_name2);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_UPA_CODE)) {
            $criteria->add(AliMemberTableMap::COL_UPA_CODE, $this->upa_code);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_UPA_NAME)) {
            $criteria->add(AliMemberTableMap::COL_UPA_NAME, $this->upa_name);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_LR)) {
            $criteria->add(AliMemberTableMap::COL_LR, $this->lr);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_COMPLETE)) {
            $criteria->add(AliMemberTableMap::COL_COMPLETE, $this->complete);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_COMPDATE)) {
            $criteria->add(AliMemberTableMap::COL_COMPDATE, $this->compdate);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MODATE)) {
            $criteria->add(AliMemberTableMap::COL_MODATE, $this->modate);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_USERCODE)) {
            $criteria->add(AliMemberTableMap::COL_USERCODE, $this->usercode);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_NAME_B)) {
            $criteria->add(AliMemberTableMap::COL_NAME_B, $this->name_b);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SEX)) {
            $criteria->add(AliMemberTableMap::COL_SEX, $this->sex);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_AGE)) {
            $criteria->add(AliMemberTableMap::COL_AGE, $this->age);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_OCCUPATION)) {
            $criteria->add(AliMemberTableMap::COL_OCCUPATION, $this->occupation);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS)) {
            $criteria->add(AliMemberTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MAR_NAME)) {
            $criteria->add(AliMemberTableMap::COL_MAR_NAME, $this->mar_name);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MAR_AGE)) {
            $criteria->add(AliMemberTableMap::COL_MAR_AGE, $this->mar_age);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_EMAIL)) {
            $criteria->add(AliMemberTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BENEFICIARIES)) {
            $criteria->add(AliMemberTableMap::COL_BENEFICIARIES, $this->beneficiaries);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_RELATION)) {
            $criteria->add(AliMemberTableMap::COL_RELATION, $this->relation);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_DISTRICTID)) {
            $criteria->add(AliMemberTableMap::COL_DISTRICTID, $this->districtid);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_AMPHURID)) {
            $criteria->add(AliMemberTableMap::COL_AMPHURID, $this->amphurid);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PROVINCEID)) {
            $criteria->add(AliMemberTableMap::COL_PROVINCEID, $this->provinceid);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_FAX)) {
            $criteria->add(AliMemberTableMap::COL_FAX, $this->fax);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_INV_CODE)) {
            $criteria->add(AliMemberTableMap::COL_INV_CODE, $this->inv_code);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_UID)) {
            $criteria->add(AliMemberTableMap::COL_UID, $this->uid);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_OID)) {
            $criteria->add(AliMemberTableMap::COL_OID, $this->oid);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR)) {
            $criteria->add(AliMemberTableMap::COL_POS_CUR, $this->pos_cur);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR1)) {
            $criteria->add(AliMemberTableMap::COL_POS_CUR1, $this->pos_cur1);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR2)) {
            $criteria->add(AliMemberTableMap::COL_POS_CUR2, $this->pos_cur2);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR3)) {
            $criteria->add(AliMemberTableMap::COL_POS_CUR3, $this->pos_cur3);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR4)) {
            $criteria->add(AliMemberTableMap::COL_POS_CUR4, $this->pos_cur4);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR_TMP)) {
            $criteria->add(AliMemberTableMap::COL_POS_CUR_TMP, $this->pos_cur_tmp);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_RPOS_CUR4)) {
            $criteria->add(AliMemberTableMap::COL_RPOS_CUR4, $this->rpos_cur4);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_POS_CUR3_DATE)) {
            $criteria->add(AliMemberTableMap::COL_POS_CUR3_DATE, $this->pos_cur3_date);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MEMDESC)) {
            $criteria->add(AliMemberTableMap::COL_MEMDESC, $this->memdesc);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CMP)) {
            $criteria->add(AliMemberTableMap::COL_CMP, $this->cmp);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CMP2)) {
            $criteria->add(AliMemberTableMap::COL_CMP2, $this->cmp2);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CMP3)) {
            $criteria->add(AliMemberTableMap::COL_CMP3, $this->cmp3);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CCMP)) {
            $criteria->add(AliMemberTableMap::COL_CCMP, $this->ccmp);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CCMP2)) {
            $criteria->add(AliMemberTableMap::COL_CCMP2, $this->ccmp2);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CCMP3)) {
            $criteria->add(AliMemberTableMap::COL_CCMP3, $this->ccmp3);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ADDRESS)) {
            $criteria->add(AliMemberTableMap::COL_ADDRESS, $this->address);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STREET)) {
            $criteria->add(AliMemberTableMap::COL_STREET, $this->street);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BUILDING)) {
            $criteria->add(AliMemberTableMap::COL_BUILDING, $this->building);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_VILLAGE)) {
            $criteria->add(AliMemberTableMap::COL_VILLAGE, $this->village);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SOI)) {
            $criteria->add(AliMemberTableMap::COL_SOI, $this->soi);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_EWALLET)) {
            $criteria->add(AliMemberTableMap::COL_EWALLET, $this->ewallet);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_EATOSHIP)) {
            $criteria->add(AliMemberTableMap::COL_EATOSHIP, $this->eatoship);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ECOM)) {
            $criteria->add(AliMemberTableMap::COL_ECOM, $this->ecom);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BMDATE1)) {
            $criteria->add(AliMemberTableMap::COL_BMDATE1, $this->bmdate1);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BMDATE2)) {
            $criteria->add(AliMemberTableMap::COL_BMDATE2, $this->bmdate2);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BMDATE3)) {
            $criteria->add(AliMemberTableMap::COL_BMDATE3, $this->bmdate3);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CBMDATE1)) {
            $criteria->add(AliMemberTableMap::COL_CBMDATE1, $this->cbmdate1);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CBMDATE2)) {
            $criteria->add(AliMemberTableMap::COL_CBMDATE2, $this->cbmdate2);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CBMDATE3)) {
            $criteria->add(AliMemberTableMap::COL_CBMDATE3, $this->cbmdate3);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ONLINE)) {
            $criteria->add(AliMemberTableMap::COL_ONLINE, $this->online);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CNAME_F)) {
            $criteria->add(AliMemberTableMap::COL_CNAME_F, $this->cname_f);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CNAME_T)) {
            $criteria->add(AliMemberTableMap::COL_CNAME_T, $this->cname_t);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CNAME_E)) {
            $criteria->add(AliMemberTableMap::COL_CNAME_E, $this->cname_e);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CNAME_B)) {
            $criteria->add(AliMemberTableMap::COL_CNAME_B, $this->cname_b);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CBIRTHDAY)) {
            $criteria->add(AliMemberTableMap::COL_CBIRTHDAY, $this->cbirthday);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CNATIONAL)) {
            $criteria->add(AliMemberTableMap::COL_CNATIONAL, $this->cnational);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CID_TAX)) {
            $criteria->add(AliMemberTableMap::COL_CID_TAX, $this->cid_tax);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CID_CARD)) {
            $criteria->add(AliMemberTableMap::COL_CID_CARD, $this->cid_card);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CADDRESS)) {
            $criteria->add(AliMemberTableMap::COL_CADDRESS, $this->caddress);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CBUILDING)) {
            $criteria->add(AliMemberTableMap::COL_CBUILDING, $this->cbuilding);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CVILLAGE)) {
            $criteria->add(AliMemberTableMap::COL_CVILLAGE, $this->cvillage);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CSTREET)) {
            $criteria->add(AliMemberTableMap::COL_CSTREET, $this->cstreet);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CSOI)) {
            $criteria->add(AliMemberTableMap::COL_CSOI, $this->csoi);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CZIP)) {
            $criteria->add(AliMemberTableMap::COL_CZIP, $this->czip);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CHOME_T)) {
            $criteria->add(AliMemberTableMap::COL_CHOME_T, $this->chome_t);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_COFFICE_T)) {
            $criteria->add(AliMemberTableMap::COL_COFFICE_T, $this->coffice_t);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CMOBILE)) {
            $criteria->add(AliMemberTableMap::COL_CMOBILE, $this->cmobile);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CFAX)) {
            $criteria->add(AliMemberTableMap::COL_CFAX, $this->cfax);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CSEX)) {
            $criteria->add(AliMemberTableMap::COL_CSEX, $this->csex);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CEMAIL)) {
            $criteria->add(AliMemberTableMap::COL_CEMAIL, $this->cemail);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CDISTRICTID)) {
            $criteria->add(AliMemberTableMap::COL_CDISTRICTID, $this->cdistrictid);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CAMPHURID)) {
            $criteria->add(AliMemberTableMap::COL_CAMPHURID, $this->camphurid);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CPROVINCEID)) {
            $criteria->add(AliMemberTableMap::COL_CPROVINCEID, $this->cprovinceid);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_INAME_F)) {
            $criteria->add(AliMemberTableMap::COL_INAME_F, $this->iname_f);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_INAME_T)) {
            $criteria->add(AliMemberTableMap::COL_INAME_T, $this->iname_t);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_IRELATION)) {
            $criteria->add(AliMemberTableMap::COL_IRELATION, $this->irelation);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_IPHONE)) {
            $criteria->add(AliMemberTableMap::COL_IPHONE, $this->iphone);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_IID_CARD)) {
            $criteria->add(AliMemberTableMap::COL_IID_CARD, $this->iid_card);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS_DOC)) {
            $criteria->add(AliMemberTableMap::COL_STATUS_DOC, $this->status_doc);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS_EXPIRE)) {
            $criteria->add(AliMemberTableMap::COL_STATUS_EXPIRE, $this->status_expire);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS_TERMINATE)) {
            $criteria->add(AliMemberTableMap::COL_STATUS_TERMINATE, $this->status_terminate);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_TERMINATE_DATE)) {
            $criteria->add(AliMemberTableMap::COL_TERMINATE_DATE, $this->terminate_date);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS_SUSPEND)) {
            $criteria->add(AliMemberTableMap::COL_STATUS_SUSPEND, $this->status_suspend);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SUSPEND_DATE)) {
            $criteria->add(AliMemberTableMap::COL_SUSPEND_DATE, $this->suspend_date);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS_BLACKLIST)) {
            $criteria->add(AliMemberTableMap::COL_STATUS_BLACKLIST, $this->status_blacklist);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_STATUS_ATO)) {
            $criteria->add(AliMemberTableMap::COL_STATUS_ATO, $this->status_ato);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SLETTER)) {
            $criteria->add(AliMemberTableMap::COL_SLETTER, $this->sletter);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SINV_CODE)) {
            $criteria->add(AliMemberTableMap::COL_SINV_CODE, $this->sinv_code);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_TXTOPTION)) {
            $criteria->add(AliMemberTableMap::COL_TXTOPTION, $this->txtoption);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SETREGIS)) {
            $criteria->add(AliMemberTableMap::COL_SETREGIS, $this->setregis);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_SLR)) {
            $criteria->add(AliMemberTableMap::COL_SLR, $this->slr);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_LOCATIONBASE)) {
            $criteria->add(AliMemberTableMap::COL_LOCATIONBASE, $this->locationbase);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CID_MOBILE)) {
            $criteria->add(AliMemberTableMap::COL_CID_MOBILE, $this->cid_mobile);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BEWALLET)) {
            $criteria->add(AliMemberTableMap::COL_BEWALLET, $this->bewallet);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BVOUCHER)) {
            $criteria->add(AliMemberTableMap::COL_BVOUCHER, $this->bvoucher);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_VOUCHER)) {
            $criteria->add(AliMemberTableMap::COL_VOUCHER, $this->voucher);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MANAGER)) {
            $criteria->add(AliMemberTableMap::COL_MANAGER, $this->manager);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MTYPE)) {
            $criteria->add(AliMemberTableMap::COL_MTYPE, $this->mtype);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MTYPE1)) {
            $criteria->add(AliMemberTableMap::COL_MTYPE1, $this->mtype1);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MTYPE2)) {
            $criteria->add(AliMemberTableMap::COL_MTYPE2, $this->mtype2);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MVAT)) {
            $criteria->add(AliMemberTableMap::COL_MVAT, $this->mvat);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_UIDBASE)) {
            $criteria->add(AliMemberTableMap::COL_UIDBASE, $this->uidbase);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_EXP_DATE)) {
            $criteria->add(AliMemberTableMap::COL_EXP_DATE, $this->exp_date);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_HEAD_CODE)) {
            $criteria->add(AliMemberTableMap::COL_HEAD_CODE, $this->head_code);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_L)) {
            $criteria->add(AliMemberTableMap::COL_PV_L, $this->pv_l);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_C)) {
            $criteria->add(AliMemberTableMap::COL_PV_C, $this->pv_c);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_HPV_L)) {
            $criteria->add(AliMemberTableMap::COL_HPV_L, $this->hpv_l);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_HPV_C)) {
            $criteria->add(AliMemberTableMap::COL_HPV_C, $this->hpv_c);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_L_NEXTMONTH)) {
            $criteria->add(AliMemberTableMap::COL_PV_L_NEXTMONTH, $this->pv_l_nextmonth);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_C_NEXTMONTH)) {
            $criteria->add(AliMemberTableMap::COL_PV_C_NEXTMONTH, $this->pv_c_nextmonth);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_L_LASTMONTH1)) {
            $criteria->add(AliMemberTableMap::COL_PV_L_LASTMONTH1, $this->pv_l_lastmonth1);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_C_LASTMONTH1)) {
            $criteria->add(AliMemberTableMap::COL_PV_C_LASTMONTH1, $this->pv_c_lastmonth1);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_L_LASTMONTH2)) {
            $criteria->add(AliMemberTableMap::COL_PV_L_LASTMONTH2, $this->pv_l_lastmonth2);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PV_C_LASTMONTH2)) {
            $criteria->add(AliMemberTableMap::COL_PV_C_LASTMONTH2, $this->pv_c_lastmonth2);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_RCODE_STAR)) {
            $criteria->add(AliMemberTableMap::COL_RCODE_STAR, $this->rcode_star);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_BUNIT)) {
            $criteria->add(AliMemberTableMap::COL_BUNIT, $this->bunit);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PROVINCE)) {
            $criteria->add(AliMemberTableMap::COL_PROVINCE, $this->province);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_LINE_ID)) {
            $criteria->add(AliMemberTableMap::COL_LINE_ID, $this->line_id);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_FACEBOOK_NAME)) {
            $criteria->add(AliMemberTableMap::COL_FACEBOOK_NAME, $this->facebook_name);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_TYPE_COM)) {
            $criteria->add(AliMemberTableMap::COL_TYPE_COM, $this->type_com);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_EXP_POS)) {
            $criteria->add(AliMemberTableMap::COL_EXP_POS, $this->exp_pos);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_EXP_POS_60)) {
            $criteria->add(AliMemberTableMap::COL_EXP_POS_60, $this->exp_pos_60);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_TRIP_PRIVATE)) {
            $criteria->add(AliMemberTableMap::COL_TRIP_PRIVATE, $this->trip_private);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_TRIP_TEAM)) {
            $criteria->add(AliMemberTableMap::COL_TRIP_TEAM, $this->trip_team);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MYFILE1)) {
            $criteria->add(AliMemberTableMap::COL_MYFILE1, $this->myfile1);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_MYFILE2)) {
            $criteria->add(AliMemberTableMap::COL_MYFILE2, $this->myfile2);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CLINE_ID)) {
            $criteria->add(AliMemberTableMap::COL_CLINE_ID, $this->cline_id);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_CFACEBOOK_NAME)) {
            $criteria->add(AliMemberTableMap::COL_CFACEBOOK_NAME, $this->cfacebook_name);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_PROFILE_IMG)) {
            $criteria->add(AliMemberTableMap::COL_PROFILE_IMG, $this->profile_img);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_ATOCOM)) {
            $criteria->add(AliMemberTableMap::COL_ATOCOM, $this->atocom);
        }
        if ($this->isColumnModified(AliMemberTableMap::COL_HPV)) {
            $criteria->add(AliMemberTableMap::COL_HPV, $this->hpv);
        }
    ...
    {
        $criteria = ChildAliMemberQuery::create();
        $criteria->add(AliMemberTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliMember (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliMember Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliMemberTableMap::DEFAULT_STRING_FORMAT);
    }
