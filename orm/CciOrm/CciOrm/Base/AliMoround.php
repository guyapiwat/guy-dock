...
/**
 * Base class that represents a row from the 'ali_moround' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliMoround implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliMoroundTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliMoround object.
     */
    ...
    /**
     * Compares this with another <code>AliMoround</code> instance.  If
     * <code>obj</code> is an instance of <code>AliMoround</code>, delegates to
     * <code>equals(AliMoround)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliMoround The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliMoround The current object (for fluent API support)
     */
    public function setRid($v)
    {
        ...
        if ($this->rid !== $v) {
            $this->rid = $v;
            $this->modifiedColumns[AliMoroundTableMap::COL_RID] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliMoroundTableMap::COL_RCODE] = true;
        }
    ...
    public function setRdate($v)
    {
        ...
        if ($this->rdate !== null || $dt !== null) {
            if ($this->rdate === null || $dt === null || $dt->format("Y-m-d") !== $this->rdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliMoroundTableMap::COL_RDATE] = true;
            }
    ...
    public function setFsano($v)
    {
        ...
        if ($this->fsano !== $v) {
            $this->fsano = $v;
            $this->modifiedColumns[AliMoroundTableMap::COL_FSANO] = true;
        }
    ...
    public function setTsano($v)
    {
        ...
        if ($this->tsano !== $v) {
            $this->tsano = $v;
            $this->modifiedColumns[AliMoroundTableMap::COL_TSANO] = true;
        }
    ...
    public function setPaydate($v)
    {
        ...
        if ($this->paydate !== null || $dt !== null) {
            if ($this->paydate === null || $dt === null || $dt->format("Y-m-d") !== $this->paydate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliMoroundTableMap::COL_PAYDATE] = true;
            }
        } // if either are not null
    ...
    public function setCalc($v)
    {
        ...
        if ($this->calc !== $v) {
            $this->calc = $v;
            $this->modifiedColumns[AliMoroundTableMap::COL_CALC] = true;
        }
    ...
    public function setRemark($v)
    {
        ...
        if ($this->remark !== $v) {
            $this->remark = $v;
            $this->modifiedColumns[AliMoroundTableMap::COL_REMARK] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliMoroundTableMap::translateFieldName('Rid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliMoroundTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliMoroundTableMap::translateFieldName('Rdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->rdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliMoroundTableMap::translateFieldName('Fsano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fsano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliMoroundTableMap::translateFieldName('Tsano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tsano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliMoroundTableMap::translateFieldName('Paydate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->paydate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliMoroundTableMap::translateFieldName('Calc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->calc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliMoroundTableMap::translateFieldName('Remark', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = AliMoroundTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliMoround'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliMoroundQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliMoround::setDeleted()
     * @see AliMoround::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliMoroundQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliMoroundTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliMoroundTableMap::COL_RID)) {
            $modifiedColumns[':p' . $index++]  = 'rid';
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_RDATE)) {
            $modifiedColumns[':p' . $index++]  = 'rdate';
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_FSANO)) {
            $modifiedColumns[':p' . $index++]  = 'fsano';
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_TSANO)) {
            $modifiedColumns[':p' . $index++]  = 'tsano';
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_PAYDATE)) {
            $modifiedColumns[':p' . $index++]  = 'paydate';
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_CALC)) {
            $modifiedColumns[':p' . $index++]  = 'calc';
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_REMARK)) {
            $modifiedColumns[':p' . $index++]  = 'remark';
        }

        $sql = sprintf(
            'INSERT INTO ali_moround (%s) VALUES (%s)',
    ...
    {
        $pos = AliMoroundTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliMoround'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliMoround'][$this->hashCode()] = true;
        $keys = AliMoroundTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliMoround
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliMoround The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliMoroundTableMap::COL_RID)) {
            $criteria->add(AliMoroundTableMap::COL_RID, $this->rid);
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_RCODE)) {
            $criteria->add(AliMoroundTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_RDATE)) {
            $criteria->add(AliMoroundTableMap::COL_RDATE, $this->rdate);
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_FSANO)) {
            $criteria->add(AliMoroundTableMap::COL_FSANO, $this->fsano);
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_TSANO)) {
            $criteria->add(AliMoroundTableMap::COL_TSANO, $this->tsano);
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_PAYDATE)) {
            $criteria->add(AliMoroundTableMap::COL_PAYDATE, $this->paydate);
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_CALC)) {
            $criteria->add(AliMoroundTableMap::COL_CALC, $this->calc);
        }
        if ($this->isColumnModified(AliMoroundTableMap::COL_REMARK)) {
            $criteria->add(AliMoroundTableMap::COL_REMARK, $this->remark);
        }
    ...
    {
        $criteria = ChildAliMoroundQuery::create();
        $criteria->add(AliMoroundTableMap::COL_RID, $this->rid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliMoround (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliMoround Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliMoroundTableMap::DEFAULT_STRING_FORMAT);
    }
