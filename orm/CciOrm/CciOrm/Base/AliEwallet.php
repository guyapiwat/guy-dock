...
/**
 * Base class that represents a row from the 'ali_ewallet' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliEwallet implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliEwalletTableMap';
    ...
    /**
     * The value for the id_ecom field.
     *
     * @var        string
     */
    protected $id_ecom;
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliEwallet object.
     */
    ...
    /**
     * Compares this with another <code>AliEwallet</code> instance.  If
     * <code>obj</code> is an instance of <code>AliEwallet</code>, delegates to
     * <code>equals(AliEwallet)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliEwallet The current object, for fluid interface
     */
    ...
    /**
     * Get the [id_ecom] column value.
     *
     * @return string
     */
    public function getIdEcom()
    {
        return $this->id_ecom;
    }

    /**
     * Get the [cals] column value.
     *
     * @return string
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliEwallet The current object (for fluent API support)
     */
    public function setSano($v)
    {
        ...
        if ($this->sano !== $v) {
            $this->sano = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_SANO] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_RCODE] = true;
        }
    ...
    public function setSadate($v)
    {
        ...
        if ($this->sadate !== null || $dt !== null) {
            if ($this->sadate === null || $dt === null || $dt->format("Y-m-d") !== $this->sadate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliEwalletTableMap::COL_SADATE] = true;
            }
    ...
    public function setInvCode($v)
    {
        ...
        if ($this->inv_code !== $v) {
            $this->inv_code = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_INV_CODE] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_MCODE] = true;
        }
    ...
    public function setNameF($v)
    {
        ...
        if ($this->name_f !== $v) {
            $this->name_f = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_NAME_F] = true;
        }
    ...
    public function setNameT($v)
    {
        ...
        if ($this->name_t !== $v) {
            $this->name_t = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_NAME_T] = true;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TOTAL] = true;
        }
    ...
    public function setUsercode($v)
    {
        ...
        if ($this->usercode !== $v) {
            $this->usercode = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_USERCODE] = true;
        }
    ...
    public function setRemark($v)
    {
        ...
        if ($this->remark !== $v) {
            $this->remark = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_REMARK] = true;
        }
    ...
    public function setTrnf($v)
    {
        ...
        if ($this->trnf !== $v) {
            $this->trnf = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TRNF] = true;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_ID] = true;
        }
    ...
    public function setSaType($v)
    {
        ...
        if ($this->sa_type !== $v) {
            $this->sa_type = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_SA_TYPE] = true;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_UID] = true;
        }
    ...
    public function setLid($v)
    {
        ...
        if ($this->lid !== $v) {
            $this->lid = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_LID] = true;
        }
    ...
    public function setDl($v)
    {
        ...
        if ($this->dl !== $v) {
            $this->dl = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_DL] = true;
        }
    ...
    public function setCancel($v)
    {
        ...
        if ($this->cancel !== $v) {
            $this->cancel = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_CANCEL] = true;
        }
    ...
    public function setSend($v)
    {
        ...
        if ($this->send !== $v) {
            $this->send = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_SEND] = true;
        }
    ...
    public function setTxtmoney($v)
    {
        ...
        if ($this->txtmoney !== $v) {
            $this->txtmoney = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTMONEY] = true;
        }
    ...
    public function setChkcash($v)
    {
        ...
        if ($this->chkcash !== $v) {
            $this->chkcash = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_CHKCASH] = true;
        }
    ...
    public function setChkinternet($v)
    {
        ...
        if ($this->chkinternet !== $v) {
            $this->chkinternet = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_CHKINTERNET] = true;
        }
    ...
    public function setChkfuture($v)
    {
        ...
        if ($this->chkfuture !== $v) {
            $this->chkfuture = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_CHKFUTURE] = true;
        }
    ...
    public function setChktransfer($v)
    {
        ...
        if ($this->chktransfer !== $v) {
            $this->chktransfer = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_CHKTRANSFER] = true;
        }
    ...
    public function setChkcredit1($v)
    {
        ...
        if ($this->chkcredit1 !== $v) {
            $this->chkcredit1 = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_CHKCREDIT1] = true;
        }
    ...
    public function setChkcredit2($v)
    {
        ...
        if ($this->chkcredit2 !== $v) {
            $this->chkcredit2 = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_CHKCREDIT2] = true;
        }
    ...
    public function setChkcredit3($v)
    {
        ...
        if ($this->chkcredit3 !== $v) {
            $this->chkcredit3 = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_CHKCREDIT3] = true;
        }
    ...
    public function setChkwithdraw($v)
    {
        ...
        if ($this->chkwithdraw !== $v) {
            $this->chkwithdraw = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_CHKWITHDRAW] = true;
        }
    ...
    public function setTxtdiscount($v)
    {
        ...
        if ($this->txtdiscount !== $v) {
            $this->txtdiscount = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTDISCOUNT] = true;
        }
    ...
    public function setChktransferIn($v)
    {
        ...
        if ($this->chktransfer_in !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_CHKTRANSFER_IN] = true;
        }
    ...
    public function setChktransferOut($v)
    {
        ...
        if ($this->chktransfer_out !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_CHKTRANSFER_OUT] = true;
        }
    ...
    public function setTxtcash($v)
    {
        ...
        if ($this->txtcash !== $v) {
            $this->txtcash = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTCASH] = true;
        }
    ...
    public function setTxtfuture($v)
    {
        ...
        if ($this->txtfuture !== $v) {
            $this->txtfuture = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTFUTURE] = true;
        }
    ...
    public function setTxtinternet($v)
    {
        ...
        if ($this->txtinternet !== $v) {
            $this->txtinternet = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTINTERNET] = true;
        }
    ...
    public function setTxttransfer($v)
    {
        ...
        if ($this->txttransfer !== $v) {
            $this->txttransfer = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTTRANSFER] = true;
        }
    ...
    public function setTxtcredit1($v)
    {
        ...
        if ($this->txtcredit1 !== $v) {
            $this->txtcredit1 = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTCREDIT1] = true;
        }
    ...
    public function setTxtcredit2($v)
    {
        ...
        if ($this->txtcredit2 !== $v) {
            $this->txtcredit2 = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTCREDIT2] = true;
        }
    ...
    public function setTxtcredit3($v)
    {
        ...
        if ($this->txtcredit3 !== $v) {
            $this->txtcredit3 = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTCREDIT3] = true;
        }
    ...
    public function setTxtwithdraw($v)
    {
        ...
        if ($this->txtwithdraw !== $v) {
            $this->txtwithdraw = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTWITHDRAW] = true;
        }
    ...
    public function setTxttransferIn($v)
    {
        ...
        if ($this->txttransfer_in !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTTRANSFER_IN] = true;
        }
    ...
    public function setTxttransferOut($v)
    {
        ...
        if ($this->txttransfer_out !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTTRANSFER_OUT] = true;
        }
    ...
    public function setOptioncash($v)
    {
        ...
        if ($this->optioncash !== $v) {
            $this->optioncash = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONCASH] = true;
        }
    ...
    public function setOptionfuture($v)
    {
        ...
        if ($this->optionfuture !== $v) {
            $this->optionfuture = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONFUTURE] = true;
        }
    ...
    public function setOptiontransfer($v)
    {
        ...
        if ($this->optiontransfer !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONTRANSFER] = true;
        }
    ...
    public function setOptioncredit1($v)
    {
        ...
        if ($this->optioncredit1 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONCREDIT1] = true;
        }
    ...
    public function setOptioncredit2($v)
    {
        ...
        if ($this->optioncredit2 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONCREDIT2] = true;
        }
    ...
    public function setOptioncredit3($v)
    {
        ...
        if ($this->optioncredit3 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONCREDIT3] = true;
        }
    ...
    public function setOptionwithdraw($v)
    {
        ...
        if ($this->optionwithdraw !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONWITHDRAW] = true;
        }
    ...
    public function setOptiontransferIn($v)
    {
        ...
        if ($this->optiontransfer_in !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONTRANSFER_IN] = true;
        }
    ...
    public function setOptiontransferOut($v)
    {
        ...
        if ($this->optiontransfer_out !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONTRANSFER_OUT] = true;
        }
    ...
    public function setTxtoption($v)
    {
        ...
        if ($this->txtoption !== $v) {
            $this->txtoption = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTOPTION] = true;
        }
    ...
    public function setEwallet($v)
    {
        ...
        if ($this->ewallet !== $v) {
            $this->ewallet = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_EWALLET] = true;
        }
    ...
    public function setEwalletBefore($v)
    {
        ...
        if ($this->ewallet_before !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_EWALLET_BEFORE] = true;
        }
    ...
    public function setEwalletAfter($v)
    {
        ...
        if ($this->ewallet_after !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_EWALLET_AFTER] = true;
        }
    ...
    public function setIpay($v)
    {
        ...
        if ($this->ipay !== $v) {
            $this->ipay = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_IPAY] = true;
        }
    ...
    public function setCheckportal($v)
    {
        ...
        if ($this->checkportal !== $v) {
            $this->checkportal = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_CHECKPORTAL] = true;
        }
    ...
    public function setBprice($v)
    {
        ...
        if ($this->bprice !== $v) {
            $this->bprice = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_BPRICE] = true;
        }
    ...
    public function setCancelDate($v)
    {
        ...
        if ($this->cancel_date !== null || $dt !== null) {
            if ($this->cancel_date === null || $dt === null || $dt->format("Y-m-d") !== $this->cancel_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliEwalletTableMap::COL_CANCEL_DATE] = true;
            }
        } // if either are not null
    ...
    public function setUidCancel($v)
    {
        ...
        if ($this->uid_cancel !== $v) {
            $this->uid_cancel = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_UID_CANCEL] = true;
        }
    ...
    public function setLocationbase($v)
    {
        ...
        if ($this->locationbase !== $v) {
            $this->locationbase = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_LOCATIONBASE] = true;
        }
    ...
    public function setChkcommission($v)
    {
        ...
        if ($this->chkcommission !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_CHKCOMMISSION] = true;
        }
    ...
    public function setTxtcommission($v)
    {
        ...
        if ($this->txtcommission !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTCOMMISSION] = true;
        }
    ...
    public function setOptioncommission($v)
    {
        ...
        if ($this->optioncommission !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONCOMMISSION] = true;
        }
    ...
    public function setMbase($v)
    {
        ...
        if ($this->mbase !== $v) {
            $this->mbase = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_MBASE] = true;
        }
    ...
    public function setCrate($v)
    {
        ...
        if ($this->crate !== $v) {
            $this->crate = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_CRATE] = true;
        }
    ...
    public function setEcheck($v)
    {
        ...
        if ($this->echeck !== $v) {
            $this->echeck = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_ECHECK] = true;
        }
    ...
    public function setSanoTemp($v)
    {
        ...
        if ($this->sano_temp !== $v) {
            $this->sano_temp = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_SANO_TEMP] = true;
        }
    ...
    public function setSelectcash($v)
    {
        ...
        if ($this->selectcash !== $v) {
            $this->selectcash = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_SELECTCASH] = true;
        }
    ...
    public function setSelecttransfer($v)
    {
        ...
        if ($this->selecttransfer !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_SELECTTRANSFER] = true;
        }
    ...
    public function setSelectcredit1($v)
    {
        ...
        if ($this->selectcredit1 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_SELECTCREDIT1] = true;
        }
    ...
    public function setSelectcredit2($v)
    {
        ...
        if ($this->selectcredit2 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_SELECTCREDIT2] = true;
        }
    ...
    public function setSelectcredit3($v)
    {
        ...
        if ($this->selectcredit3 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_SELECTCREDIT3] = true;
        }
    ...
    public function setOptioninternet($v)
    {
        ...
        if ($this->optioninternet !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONINTERNET] = true;
        }
    ...
    public function setSelectinternet($v)
    {
        ...
        if ($this->selectinternet !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_SELECTINTERNET] = true;
        }
    ...
    public function setTxttransfer1($v)
    {
        ...
        if ($this->txttransfer1 !== $v) {
            $this->txttransfer1 = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTTRANSFER1] = true;
        }
    ...
    public function setOptiontransfer1($v)
    {
        ...
        if ($this->optiontransfer1 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONTRANSFER1] = true;
        }
    ...
    public function setSelecttransfer1($v)
    {
        ...
        if ($this->selecttransfer1 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_SELECTTRANSFER1] = true;
        }
    ...
    public function setTxttransfer2($v)
    {
        ...
        if ($this->txttransfer2 !== $v) {
            $this->txttransfer2 = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTTRANSFER2] = true;
        }
    ...
    public function setOptiontransfer2($v)
    {
        ...
        if ($this->optiontransfer2 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONTRANSFER2] = true;
        }
    ...
    public function setSelecttransfer2($v)
    {
        ...
        if ($this->selecttransfer2 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_SELECTTRANSFER2] = true;
        }
    ...
    public function setTxttransfer3($v)
    {
        ...
        if ($this->txttransfer3 !== $v) {
            $this->txttransfer3 = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTTRANSFER3] = true;
        }
    ...
    public function setOptiontransfer3($v)
    {
        ...
        if ($this->optiontransfer3 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_OPTIONTRANSFER3] = true;
        }
    ...
    public function setSelecttransfer3($v)
    {
        ...
        if ($this->selecttransfer3 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_SELECTTRANSFER3] = true;
        }
    ...
    public function setImageTransfer($v)
    {
        ...
        if ($this->image_transfer !== $v) {
            ...
            $this->modifiedColumns[AliEwalletTableMap::COL_IMAGE_TRANSFER] = true;
        }
    ...
    public function setTxtvoucher($v)
    {
        ...
        if ($this->txtvoucher !== $v) {
            $this->txtvoucher = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_TXTVOUCHER] = true;
        }
    ...
    /**
     * Set the value of [id_ecom] column.
     *
     * @param string $v new value
     * @return $this|\CciOrm\CciOrm\AliEwallet The current object (for fluent API support)
     */
    public function setIdEcom($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->id_ecom !== $v) {
            $this->id_ecom = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_ID_ECOM] = true;
        }
    ...
    /**
     * Set the value of [cals] column.
     *
     * @param string $v new value
     * @return $this|\CciOrm\CciOrm\AliEwallet The current object (for fluent API support)
     */
    public function setCals($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->cals !== $v) {
            $this->cals = $v;
            $this->modifiedColumns[AliEwalletTableMap::COL_CALS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliEwalletTableMap::translateFieldName('Sano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliEwalletTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliEwalletTableMap::translateFieldName('Sadate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->sadate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliEwalletTableMap::translateFieldName('InvCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliEwalletTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliEwalletTableMap::translateFieldName('NameF', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_f = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliEwalletTableMap::translateFieldName('NameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliEwalletTableMap::translateFieldName('Total', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliEwalletTableMap::translateFieldName('Usercode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usercode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliEwalletTableMap::translateFieldName('Remark', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remark = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliEwalletTableMap::translateFieldName('Trnf', TableMap::TYPE_PHPNAME, $indexType)];
            $this->trnf = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliEwalletTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliEwalletTableMap::translateFieldName('SaType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sa_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliEwalletTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliEwalletTableMap::translateFieldName('Lid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliEwalletTableMap::translateFieldName('Dl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AliEwalletTableMap::translateFieldName('Cancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cancel = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AliEwalletTableMap::translateFieldName('Send', TableMap::TYPE_PHPNAME, $indexType)];
            $this->send = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : AliEwalletTableMap::translateFieldName('Txtmoney', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtmoney = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : AliEwalletTableMap::translateFieldName('Chkcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : AliEwalletTableMap::translateFieldName('Chkinternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkinternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : AliEwalletTableMap::translateFieldName('Chkfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : AliEwalletTableMap::translateFieldName('Chktransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : AliEwalletTableMap::translateFieldName('Chkcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : AliEwalletTableMap::translateFieldName('Chkcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : AliEwalletTableMap::translateFieldName('Chkcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : AliEwalletTableMap::translateFieldName('Chkwithdraw', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkwithdraw = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : AliEwalletTableMap::translateFieldName('Txtdiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtdiscount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : AliEwalletTableMap::translateFieldName('ChktransferIn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer_in = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : AliEwalletTableMap::translateFieldName('ChktransferOut', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer_out = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : AliEwalletTableMap::translateFieldName('Txtcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : AliEwalletTableMap::translateFieldName('Txtfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : AliEwalletTableMap::translateFieldName('Txtinternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtinternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : AliEwalletTableMap::translateFieldName('Txttransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : AliEwalletTableMap::translateFieldName('Txtcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : AliEwalletTableMap::translateFieldName('Txtcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : AliEwalletTableMap::translateFieldName('Txtcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : AliEwalletTableMap::translateFieldName('Txtwithdraw', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtwithdraw = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : AliEwalletTableMap::translateFieldName('TxttransferIn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer_in = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : AliEwalletTableMap::translateFieldName('TxttransferOut', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer_out = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : AliEwalletTableMap::translateFieldName('Optioncash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : AliEwalletTableMap::translateFieldName('Optionfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : AliEwalletTableMap::translateFieldName('Optiontransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : AliEwalletTableMap::translateFieldName('Optioncredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : AliEwalletTableMap::translateFieldName('Optioncredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : AliEwalletTableMap::translateFieldName('Optioncredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : AliEwalletTableMap::translateFieldName('Optionwithdraw', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionwithdraw = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : AliEwalletTableMap::translateFieldName('OptiontransferIn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer_in = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : AliEwalletTableMap::translateFieldName('OptiontransferOut', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer_out = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : AliEwalletTableMap::translateFieldName('Txtoption', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtoption = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : AliEwalletTableMap::translateFieldName('Ewallet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : AliEwalletTableMap::translateFieldName('EwalletBefore', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_before = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : AliEwalletTableMap::translateFieldName('EwalletAfter', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_after = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : AliEwalletTableMap::translateFieldName('Ipay', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ipay = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : AliEwalletTableMap::translateFieldName('Checkportal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->checkportal = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : AliEwalletTableMap::translateFieldName('Bprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : AliEwalletTableMap::translateFieldName('CancelDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->cancel_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : AliEwalletTableMap::translateFieldName('UidCancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid_cancel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 58 + $startcol : AliEwalletTableMap::translateFieldName('Locationbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->locationbase = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 59 + $startcol : AliEwalletTableMap::translateFieldName('Chkcommission', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcommission = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 60 + $startcol : AliEwalletTableMap::translateFieldName('Txtcommission', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcommission = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 61 + $startcol : AliEwalletTableMap::translateFieldName('Optioncommission', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncommission = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 62 + $startcol : AliEwalletTableMap::translateFieldName('Mbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mbase = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 63 + $startcol : AliEwalletTableMap::translateFieldName('Crate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->crate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 64 + $startcol : AliEwalletTableMap::translateFieldName('Echeck', TableMap::TYPE_PHPNAME, $indexType)];
            $this->echeck = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 65 + $startcol : AliEwalletTableMap::translateFieldName('SanoTemp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano_temp = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 66 + $startcol : AliEwalletTableMap::translateFieldName('Selectcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->selectcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 67 + $startcol : AliEwalletTableMap::translateFieldName('Selecttransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->selecttransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 68 + $startcol : AliEwalletTableMap::translateFieldName('Selectcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->selectcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 69 + $startcol : AliEwalletTableMap::translateFieldName('Selectcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->selectcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 70 + $startcol : AliEwalletTableMap::translateFieldName('Selectcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->selectcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 71 + $startcol : AliEwalletTableMap::translateFieldName('Optioninternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioninternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 72 + $startcol : AliEwalletTableMap::translateFieldName('Selectinternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->selectinternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 73 + $startcol : AliEwalletTableMap::translateFieldName('Txttransfer1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 74 + $startcol : AliEwalletTableMap::translateFieldName('Optiontransfer1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 75 + $startcol : AliEwalletTableMap::translateFieldName('Selecttransfer1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->selecttransfer1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 76 + $startcol : AliEwalletTableMap::translateFieldName('Txttransfer2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 77 + $startcol : AliEwalletTableMap::translateFieldName('Optiontransfer2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 78 + $startcol : AliEwalletTableMap::translateFieldName('Selecttransfer2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->selecttransfer2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 79 + $startcol : AliEwalletTableMap::translateFieldName('Txttransfer3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 80 + $startcol : AliEwalletTableMap::translateFieldName('Optiontransfer3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 81 + $startcol : AliEwalletTableMap::translateFieldName('Selecttransfer3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->selecttransfer3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 82 + $startcol : AliEwalletTableMap::translateFieldName('ImageTransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->image_transfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 83 + $startcol : AliEwalletTableMap::translateFieldName('Txtvoucher', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtvoucher = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 84 + $startcol : AliEwalletTableMap::translateFieldName('IdEcom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_ecom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 85 + $startcol : AliEwalletTableMap::translateFieldName('Cals', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cals = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 86; // 86 = AliEwalletTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliEwallet'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliEwalletQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliEwallet::setDeleted()
     * @see AliEwallet::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliEwalletQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliEwalletTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliEwalletTableMap::COL_SANO)) {
            $modifiedColumns[':p' . $index++]  = 'sano';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SADATE)) {
            $modifiedColumns[':p' . $index++]  = 'sadate';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_INV_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'inv_code';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_NAME_F)) {
            $modifiedColumns[':p' . $index++]  = 'name_f';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_NAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'name_t';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'total';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_USERCODE)) {
            $modifiedColumns[':p' . $index++]  = 'usercode';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_REMARK)) {
            $modifiedColumns[':p' . $index++]  = 'remark';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TRNF)) {
            $modifiedColumns[':p' . $index++]  = 'trnf';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SA_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'sa_type';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_LID)) {
            $modifiedColumns[':p' . $index++]  = 'lid';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_DL)) {
            $modifiedColumns[':p' . $index++]  = 'dl';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'cancel';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SEND)) {
            $modifiedColumns[':p' . $index++]  = 'send';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTMONEY)) {
            $modifiedColumns[':p' . $index++]  = 'txtMoney';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKCASH)) {
            $modifiedColumns[':p' . $index++]  = 'chkCash';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'chkInternet';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'chkFuture';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit1';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit2';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit3';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKWITHDRAW)) {
            $modifiedColumns[':p' . $index++]  = 'chkWithdraw';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTDISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'txtDiscount';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKTRANSFER_IN)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer_in';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKTRANSFER_OUT)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer_out';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTCASH)) {
            $modifiedColumns[':p' . $index++]  = 'txtCash';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'txtFuture';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'txtInternet';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit1';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit2';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit3';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTWITHDRAW)) {
            $modifiedColumns[':p' . $index++]  = 'txtWithdraw';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTTRANSFER_IN)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer_in';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTTRANSFER_OUT)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer_out';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONCASH)) {
            $modifiedColumns[':p' . $index++]  = 'optionCash';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'optionFuture';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit1';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit2';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit3';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONWITHDRAW)) {
            $modifiedColumns[':p' . $index++]  = 'optionWithdraw';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONTRANSFER_IN)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer_in';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONTRANSFER_OUT)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer_out';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTOPTION)) {
            $modifiedColumns[':p' . $index++]  = 'txtoption';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_EWALLET)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_EWALLET_BEFORE)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_before';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_EWALLET_AFTER)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_after';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_IPAY)) {
            $modifiedColumns[':p' . $index++]  = 'ipay';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHECKPORTAL)) {
            $modifiedColumns[':p' . $index++]  = 'checkportal';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_BPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'bprice';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CANCEL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'cancel_date';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_UID_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'uid_cancel';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_LOCATIONBASE)) {
            $modifiedColumns[':p' . $index++]  = 'locationbase';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKCOMMISSION)) {
            $modifiedColumns[':p' . $index++]  = 'chkCommission';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTCOMMISSION)) {
            $modifiedColumns[':p' . $index++]  = 'txtCommission';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONCOMMISSION)) {
            $modifiedColumns[':p' . $index++]  = 'optionCommission';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_MBASE)) {
            $modifiedColumns[':p' . $index++]  = 'mbase';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CRATE)) {
            $modifiedColumns[':p' . $index++]  = 'crate';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_ECHECK)) {
            $modifiedColumns[':p' . $index++]  = 'echeck';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SANO_TEMP)) {
            $modifiedColumns[':p' . $index++]  = 'sano_temp';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTCASH)) {
            $modifiedColumns[':p' . $index++]  = 'selectCash';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'selectTransfer';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'selectCredit1';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'selectCredit2';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'selectCredit3';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'optionInternet';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'selectInternet';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTTRANSFER1)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer1';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONTRANSFER1)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer1';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTTRANSFER1)) {
            $modifiedColumns[':p' . $index++]  = 'selectTransfer1';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTTRANSFER2)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer2';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONTRANSFER2)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer2';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTTRANSFER2)) {
            $modifiedColumns[':p' . $index++]  = 'selectTransfer2';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTTRANSFER3)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer3';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONTRANSFER3)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer3';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTTRANSFER3)) {
            $modifiedColumns[':p' . $index++]  = 'selectTransfer3';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_IMAGE_TRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'image_transfer';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTVOUCHER)) {
            $modifiedColumns[':p' . $index++]  = 'txtVoucher';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_ID_ECOM)) {
            $modifiedColumns[':p' . $index++]  = 'id_ecom';
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CALS)) {
            $modifiedColumns[':p' . $index++]  = 'cals';
        }

        $sql = sprintf(
            'INSERT INTO ali_ewallet (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'txtVoucher':
                        ...
                        break;
                    case 'id_ecom':
                        $stmt->bindValue($identifier, $this->id_ecom, PDO::PARAM_STR);
                        break;
                    case 'cals':
                        $stmt->bindValue($identifier, $this->cals, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = AliEwalletTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliEwallet'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliEwallet'][$this->hashCode()] = true;
        $keys = AliEwalletTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSano(),
            ...
            $keys[27] => $this->getTxtdiscount(),
            $keys[28] => $this->getChktransferIn(),
            $keys[29] => $this->getChktransferOut(),
            $keys[30] => $this->getTxtcash(),
            $keys[31] => $this->getTxtfuture(),
            $keys[32] => $this->getTxtinternet(),
            $keys[33] => $this->getTxttransfer(),
            $keys[34] => $this->getTxtcredit1(),
            $keys[35] => $this->getTxtcredit2(),
            $keys[36] => $this->getTxtcredit3(),
            $keys[37] => $this->getTxtwithdraw(),
            $keys[38] => $this->getTxttransferIn(),
            $keys[39] => $this->getTxttransferOut(),
            $keys[40] => $this->getOptioncash(),
            $keys[41] => $this->getOptionfuture(),
            $keys[42] => $this->getOptiontransfer(),
            $keys[43] => $this->getOptioncredit1(),
            $keys[44] => $this->getOptioncredit2(),
            $keys[45] => $this->getOptioncredit3(),
            $keys[46] => $this->getOptionwithdraw(),
            $keys[47] => $this->getOptiontransferIn(),
            $keys[48] => $this->getOptiontransferOut(),
            $keys[49] => $this->getTxtoption(),
            $keys[50] => $this->getEwallet(),
            $keys[51] => $this->getEwalletBefore(),
            $keys[52] => $this->getEwalletAfter(),
            $keys[53] => $this->getIpay(),
            $keys[54] => $this->getCheckportal(),
            $keys[55] => $this->getBprice(),
            $keys[56] => $this->getCancelDate(),
            $keys[57] => $this->getUidCancel(),
            $keys[58] => $this->getLocationbase(),
            $keys[59] => $this->getChkcommission(),
            $keys[60] => $this->getTxtcommission(),
            $keys[61] => $this->getOptioncommission(),
            $keys[62] => $this->getMbase(),
            $keys[63] => $this->getCrate(),
            $keys[64] => $this->getEcheck(),
            $keys[65] => $this->getSanoTemp(),
            $keys[66] => $this->getSelectcash(),
            $keys[67] => $this->getSelecttransfer(),
            $keys[68] => $this->getSelectcredit1(),
            $keys[69] => $this->getSelectcredit2(),
            $keys[70] => $this->getSelectcredit3(),
            $keys[71] => $this->getOptioninternet(),
            $keys[72] => $this->getSelectinternet(),
            $keys[73] => $this->getTxttransfer1(),
            $keys[74] => $this->getOptiontransfer1(),
            $keys[75] => $this->getSelecttransfer1(),
            $keys[76] => $this->getTxttransfer2(),
            $keys[77] => $this->getOptiontransfer2(),
            $keys[78] => $this->getSelecttransfer2(),
            $keys[79] => $this->getTxttransfer3(),
            $keys[80] => $this->getOptiontransfer3(),
            $keys[81] => $this->getSelecttransfer3(),
            $keys[82] => $this->getImageTransfer(),
            $keys[83] => $this->getTxtvoucher(),
            $keys[84] => $this->getIdEcom(),
            $keys[85] => $this->getCals(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliEwallet
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[27], $arr)) {
            $this->setTxtdiscount($arr[$keys[27]]);
        }
        if (array_key_exists($keys[28], $arr)) {
            $this->setChktransferIn($arr[$keys[28]]);
        }
        if (array_key_exists($keys[29], $arr)) {
            $this->setChktransferOut($arr[$keys[29]]);
        }
        if (array_key_exists($keys[30], $arr)) {
            $this->setTxtcash($arr[$keys[30]]);
        }
        if (array_key_exists($keys[31], $arr)) {
            $this->setTxtfuture($arr[$keys[31]]);
        }
        if (array_key_exists($keys[32], $arr)) {
            $this->setTxtinternet($arr[$keys[32]]);
        }
        if (array_key_exists($keys[33], $arr)) {
            $this->setTxttransfer($arr[$keys[33]]);
        }
        if (array_key_exists($keys[34], $arr)) {
            $this->setTxtcredit1($arr[$keys[34]]);
        }
        if (array_key_exists($keys[35], $arr)) {
            $this->setTxtcredit2($arr[$keys[35]]);
        }
        if (array_key_exists($keys[36], $arr)) {
            $this->setTxtcredit3($arr[$keys[36]]);
        }
        if (array_key_exists($keys[37], $arr)) {
            $this->setTxtwithdraw($arr[$keys[37]]);
        }
        if (array_key_exists($keys[38], $arr)) {
            $this->setTxttransferIn($arr[$keys[38]]);
        }
        if (array_key_exists($keys[39], $arr)) {
            $this->setTxttransferOut($arr[$keys[39]]);
        }
        if (array_key_exists($keys[40], $arr)) {
            $this->setOptioncash($arr[$keys[40]]);
        }
        if (array_key_exists($keys[41], $arr)) {
            $this->setOptionfuture($arr[$keys[41]]);
        }
        if (array_key_exists($keys[42], $arr)) {
            $this->setOptiontransfer($arr[$keys[42]]);
        }
        if (array_key_exists($keys[43], $arr)) {
            $this->setOptioncredit1($arr[$keys[43]]);
        }
        if (array_key_exists($keys[44], $arr)) {
            $this->setOptioncredit2($arr[$keys[44]]);
        }
        if (array_key_exists($keys[45], $arr)) {
            $this->setOptioncredit3($arr[$keys[45]]);
        }
        if (array_key_exists($keys[46], $arr)) {
            $this->setOptionwithdraw($arr[$keys[46]]);
        }
        if (array_key_exists($keys[47], $arr)) {
            $this->setOptiontransferIn($arr[$keys[47]]);
        }
        if (array_key_exists($keys[48], $arr)) {
            $this->setOptiontransferOut($arr[$keys[48]]);
        }
        if (array_key_exists($keys[49], $arr)) {
            $this->setTxtoption($arr[$keys[49]]);
        }
        if (array_key_exists($keys[50], $arr)) {
            $this->setEwallet($arr[$keys[50]]);
        }
        if (array_key_exists($keys[51], $arr)) {
            $this->setEwalletBefore($arr[$keys[51]]);
        }
        if (array_key_exists($keys[52], $arr)) {
            $this->setEwalletAfter($arr[$keys[52]]);
        }
        if (array_key_exists($keys[53], $arr)) {
            $this->setIpay($arr[$keys[53]]);
        }
        if (array_key_exists($keys[54], $arr)) {
            $this->setCheckportal($arr[$keys[54]]);
        }
        if (array_key_exists($keys[55], $arr)) {
            $this->setBprice($arr[$keys[55]]);
        }
        if (array_key_exists($keys[56], $arr)) {
            $this->setCancelDate($arr[$keys[56]]);
        }
        if (array_key_exists($keys[57], $arr)) {
            $this->setUidCancel($arr[$keys[57]]);
        }
        if (array_key_exists($keys[58], $arr)) {
            $this->setLocationbase($arr[$keys[58]]);
        }
        if (array_key_exists($keys[59], $arr)) {
            $this->setChkcommission($arr[$keys[59]]);
        }
        if (array_key_exists($keys[60], $arr)) {
            $this->setTxtcommission($arr[$keys[60]]);
        }
        if (array_key_exists($keys[61], $arr)) {
            $this->setOptioncommission($arr[$keys[61]]);
        }
        if (array_key_exists($keys[62], $arr)) {
            $this->setMbase($arr[$keys[62]]);
        }
        if (array_key_exists($keys[63], $arr)) {
            $this->setCrate($arr[$keys[63]]);
        }
        if (array_key_exists($keys[64], $arr)) {
            $this->setEcheck($arr[$keys[64]]);
        }
        if (array_key_exists($keys[65], $arr)) {
            $this->setSanoTemp($arr[$keys[65]]);
        }
        if (array_key_exists($keys[66], $arr)) {
            $this->setSelectcash($arr[$keys[66]]);
        }
        if (array_key_exists($keys[67], $arr)) {
            $this->setSelecttransfer($arr[$keys[67]]);
        }
        if (array_key_exists($keys[68], $arr)) {
            $this->setSelectcredit1($arr[$keys[68]]);
        }
        if (array_key_exists($keys[69], $arr)) {
            $this->setSelectcredit2($arr[$keys[69]]);
        }
        if (array_key_exists($keys[70], $arr)) {
            $this->setSelectcredit3($arr[$keys[70]]);
        }
        if (array_key_exists($keys[71], $arr)) {
            $this->setOptioninternet($arr[$keys[71]]);
        }
        if (array_key_exists($keys[72], $arr)) {
            $this->setSelectinternet($arr[$keys[72]]);
        }
        if (array_key_exists($keys[73], $arr)) {
            $this->setTxttransfer1($arr[$keys[73]]);
        }
        if (array_key_exists($keys[74], $arr)) {
            $this->setOptiontransfer1($arr[$keys[74]]);
        }
        if (array_key_exists($keys[75], $arr)) {
            $this->setSelecttransfer1($arr[$keys[75]]);
        }
        if (array_key_exists($keys[76], $arr)) {
            $this->setTxttransfer2($arr[$keys[76]]);
        }
        if (array_key_exists($keys[77], $arr)) {
            $this->setOptiontransfer2($arr[$keys[77]]);
        }
        if (array_key_exists($keys[78], $arr)) {
            $this->setSelecttransfer2($arr[$keys[78]]);
        }
        if (array_key_exists($keys[79], $arr)) {
            $this->setTxttransfer3($arr[$keys[79]]);
        }
        if (array_key_exists($keys[80], $arr)) {
            $this->setOptiontransfer3($arr[$keys[80]]);
        }
        if (array_key_exists($keys[81], $arr)) {
            $this->setSelecttransfer3($arr[$keys[81]]);
        }
        if (array_key_exists($keys[82], $arr)) {
            $this->setImageTransfer($arr[$keys[82]]);
        }
        if (array_key_exists($keys[83], $arr)) {
            $this->setTxtvoucher($arr[$keys[83]]);
        }
        if (array_key_exists($keys[84], $arr)) {
            $this->setIdEcom($arr[$keys[84]]);
        }
        if (array_key_exists($keys[85], $arr)) {
            $this->setCals($arr[$keys[85]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliEwallet The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliEwalletTableMap::COL_SANO)) {
            $criteria->add(AliEwalletTableMap::COL_SANO, $this->sano);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_RCODE)) {
            $criteria->add(AliEwalletTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SADATE)) {
            $criteria->add(AliEwalletTableMap::COL_SADATE, $this->sadate);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_INV_CODE)) {
            $criteria->add(AliEwalletTableMap::COL_INV_CODE, $this->inv_code);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_MCODE)) {
            $criteria->add(AliEwalletTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_NAME_F)) {
            $criteria->add(AliEwalletTableMap::COL_NAME_F, $this->name_f);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_NAME_T)) {
            $criteria->add(AliEwalletTableMap::COL_NAME_T, $this->name_t);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TOTAL)) {
            $criteria->add(AliEwalletTableMap::COL_TOTAL, $this->total);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_USERCODE)) {
            $criteria->add(AliEwalletTableMap::COL_USERCODE, $this->usercode);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_REMARK)) {
            $criteria->add(AliEwalletTableMap::COL_REMARK, $this->remark);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TRNF)) {
            $criteria->add(AliEwalletTableMap::COL_TRNF, $this->trnf);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_ID)) {
            $criteria->add(AliEwalletTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SA_TYPE)) {
            $criteria->add(AliEwalletTableMap::COL_SA_TYPE, $this->sa_type);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_UID)) {
            $criteria->add(AliEwalletTableMap::COL_UID, $this->uid);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_LID)) {
            $criteria->add(AliEwalletTableMap::COL_LID, $this->lid);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_DL)) {
            $criteria->add(AliEwalletTableMap::COL_DL, $this->dl);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CANCEL)) {
            $criteria->add(AliEwalletTableMap::COL_CANCEL, $this->cancel);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SEND)) {
            $criteria->add(AliEwalletTableMap::COL_SEND, $this->send);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTMONEY)) {
            $criteria->add(AliEwalletTableMap::COL_TXTMONEY, $this->txtmoney);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKCASH)) {
            $criteria->add(AliEwalletTableMap::COL_CHKCASH, $this->chkcash);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKINTERNET)) {
            $criteria->add(AliEwalletTableMap::COL_CHKINTERNET, $this->chkinternet);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKFUTURE)) {
            $criteria->add(AliEwalletTableMap::COL_CHKFUTURE, $this->chkfuture);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKTRANSFER)) {
            $criteria->add(AliEwalletTableMap::COL_CHKTRANSFER, $this->chktransfer);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKCREDIT1)) {
            $criteria->add(AliEwalletTableMap::COL_CHKCREDIT1, $this->chkcredit1);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKCREDIT2)) {
            $criteria->add(AliEwalletTableMap::COL_CHKCREDIT2, $this->chkcredit2);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKCREDIT3)) {
            $criteria->add(AliEwalletTableMap::COL_CHKCREDIT3, $this->chkcredit3);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKWITHDRAW)) {
            $criteria->add(AliEwalletTableMap::COL_CHKWITHDRAW, $this->chkwithdraw);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTDISCOUNT)) {
            $criteria->add(AliEwalletTableMap::COL_TXTDISCOUNT, $this->txtdiscount);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKTRANSFER_IN)) {
            $criteria->add(AliEwalletTableMap::COL_CHKTRANSFER_IN, $this->chktransfer_in);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKTRANSFER_OUT)) {
            $criteria->add(AliEwalletTableMap::COL_CHKTRANSFER_OUT, $this->chktransfer_out);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTCASH)) {
            $criteria->add(AliEwalletTableMap::COL_TXTCASH, $this->txtcash);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTFUTURE)) {
            $criteria->add(AliEwalletTableMap::COL_TXTFUTURE, $this->txtfuture);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTINTERNET)) {
            $criteria->add(AliEwalletTableMap::COL_TXTINTERNET, $this->txtinternet);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTTRANSFER)) {
            $criteria->add(AliEwalletTableMap::COL_TXTTRANSFER, $this->txttransfer);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTCREDIT1)) {
            $criteria->add(AliEwalletTableMap::COL_TXTCREDIT1, $this->txtcredit1);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTCREDIT2)) {
            $criteria->add(AliEwalletTableMap::COL_TXTCREDIT2, $this->txtcredit2);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTCREDIT3)) {
            $criteria->add(AliEwalletTableMap::COL_TXTCREDIT3, $this->txtcredit3);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTWITHDRAW)) {
            $criteria->add(AliEwalletTableMap::COL_TXTWITHDRAW, $this->txtwithdraw);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTTRANSFER_IN)) {
            $criteria->add(AliEwalletTableMap::COL_TXTTRANSFER_IN, $this->txttransfer_in);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTTRANSFER_OUT)) {
            $criteria->add(AliEwalletTableMap::COL_TXTTRANSFER_OUT, $this->txttransfer_out);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONCASH)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONCASH, $this->optioncash);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONFUTURE)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONFUTURE, $this->optionfuture);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONTRANSFER)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONTRANSFER, $this->optiontransfer);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONCREDIT1)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONCREDIT1, $this->optioncredit1);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONCREDIT2)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONCREDIT2, $this->optioncredit2);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONCREDIT3)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONCREDIT3, $this->optioncredit3);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONWITHDRAW)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONWITHDRAW, $this->optionwithdraw);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONTRANSFER_IN)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONTRANSFER_IN, $this->optiontransfer_in);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONTRANSFER_OUT)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONTRANSFER_OUT, $this->optiontransfer_out);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTOPTION)) {
            $criteria->add(AliEwalletTableMap::COL_TXTOPTION, $this->txtoption);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_EWALLET)) {
            $criteria->add(AliEwalletTableMap::COL_EWALLET, $this->ewallet);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_EWALLET_BEFORE)) {
            $criteria->add(AliEwalletTableMap::COL_EWALLET_BEFORE, $this->ewallet_before);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_EWALLET_AFTER)) {
            $criteria->add(AliEwalletTableMap::COL_EWALLET_AFTER, $this->ewallet_after);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_IPAY)) {
            $criteria->add(AliEwalletTableMap::COL_IPAY, $this->ipay);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHECKPORTAL)) {
            $criteria->add(AliEwalletTableMap::COL_CHECKPORTAL, $this->checkportal);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_BPRICE)) {
            $criteria->add(AliEwalletTableMap::COL_BPRICE, $this->bprice);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CANCEL_DATE)) {
            $criteria->add(AliEwalletTableMap::COL_CANCEL_DATE, $this->cancel_date);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_UID_CANCEL)) {
            $criteria->add(AliEwalletTableMap::COL_UID_CANCEL, $this->uid_cancel);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_LOCATIONBASE)) {
            $criteria->add(AliEwalletTableMap::COL_LOCATIONBASE, $this->locationbase);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CHKCOMMISSION)) {
            $criteria->add(AliEwalletTableMap::COL_CHKCOMMISSION, $this->chkcommission);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTCOMMISSION)) {
            $criteria->add(AliEwalletTableMap::COL_TXTCOMMISSION, $this->txtcommission);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONCOMMISSION)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONCOMMISSION, $this->optioncommission);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_MBASE)) {
            $criteria->add(AliEwalletTableMap::COL_MBASE, $this->mbase);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CRATE)) {
            $criteria->add(AliEwalletTableMap::COL_CRATE, $this->crate);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_ECHECK)) {
            $criteria->add(AliEwalletTableMap::COL_ECHECK, $this->echeck);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SANO_TEMP)) {
            $criteria->add(AliEwalletTableMap::COL_SANO_TEMP, $this->sano_temp);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTCASH)) {
            $criteria->add(AliEwalletTableMap::COL_SELECTCASH, $this->selectcash);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTTRANSFER)) {
            $criteria->add(AliEwalletTableMap::COL_SELECTTRANSFER, $this->selecttransfer);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTCREDIT1)) {
            $criteria->add(AliEwalletTableMap::COL_SELECTCREDIT1, $this->selectcredit1);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTCREDIT2)) {
            $criteria->add(AliEwalletTableMap::COL_SELECTCREDIT2, $this->selectcredit2);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTCREDIT3)) {
            $criteria->add(AliEwalletTableMap::COL_SELECTCREDIT3, $this->selectcredit3);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONINTERNET)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONINTERNET, $this->optioninternet);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTINTERNET)) {
            $criteria->add(AliEwalletTableMap::COL_SELECTINTERNET, $this->selectinternet);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTTRANSFER1)) {
            $criteria->add(AliEwalletTableMap::COL_TXTTRANSFER1, $this->txttransfer1);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONTRANSFER1)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONTRANSFER1, $this->optiontransfer1);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTTRANSFER1)) {
            $criteria->add(AliEwalletTableMap::COL_SELECTTRANSFER1, $this->selecttransfer1);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTTRANSFER2)) {
            $criteria->add(AliEwalletTableMap::COL_TXTTRANSFER2, $this->txttransfer2);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONTRANSFER2)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONTRANSFER2, $this->optiontransfer2);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTTRANSFER2)) {
            $criteria->add(AliEwalletTableMap::COL_SELECTTRANSFER2, $this->selecttransfer2);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTTRANSFER3)) {
            $criteria->add(AliEwalletTableMap::COL_TXTTRANSFER3, $this->txttransfer3);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_OPTIONTRANSFER3)) {
            $criteria->add(AliEwalletTableMap::COL_OPTIONTRANSFER3, $this->optiontransfer3);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_SELECTTRANSFER3)) {
            $criteria->add(AliEwalletTableMap::COL_SELECTTRANSFER3, $this->selecttransfer3);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_IMAGE_TRANSFER)) {
            $criteria->add(AliEwalletTableMap::COL_IMAGE_TRANSFER, $this->image_transfer);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_TXTVOUCHER)) {
            $criteria->add(AliEwalletTableMap::COL_TXTVOUCHER, $this->txtvoucher);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_ID_ECOM)) {
            $criteria->add(AliEwalletTableMap::COL_ID_ECOM, $this->id_ecom);
        }
        if ($this->isColumnModified(AliEwalletTableMap::COL_CALS)) {
            $criteria->add(AliEwalletTableMap::COL_CALS, $this->cals);
        }
    ...
    {
        $criteria = ChildAliEwalletQuery::create();
        $criteria->add(AliEwalletTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliEwallet (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIdEcom($this->getIdEcom());
        $copyObj->setCals($this->getCals());
        if ($makeNew) {
            $copyObj->setNew(true);
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliEwallet Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliEwalletTableMap::DEFAULT_STRING_FORMAT);
    }
