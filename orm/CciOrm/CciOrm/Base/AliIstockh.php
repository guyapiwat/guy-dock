...
/**
 * Base class that represents a row from the 'ali_istockh' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliIstockh implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliIstockhTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliIstockh object.
     */
    ...
    /**
     * Compares this with another <code>AliIstockh</code> instance.  If
     * <code>obj</code> is an instance of <code>AliIstockh</code>, delegates to
     * <code>equals(AliIstockh)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliIstockh The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliIstockh The current object (for fluent API support)
     */
    public function setSano($v)
    {
        ...
        if ($this->sano !== $v) {
            $this->sano = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_SANO] = true;
        }
    ...
    public function setSano1($v)
    {
        ...
        if ($this->sano1 !== $v) {
            $this->sano1 = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_SANO1] = true;
        }
    ...
    public function setSadate($v)
    {
        ...
        if ($this->sadate !== null || $dt !== null) {
            if ($this->sadate === null || $dt === null || $dt->format("Y-m-d") !== $this->sadate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliIstockhTableMap::COL_SADATE] = true;
            }
    ...
    public function setInvCode($v)
    {
        ...
        if ($this->inv_code !== $v) {
            $this->inv_code = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_INV_CODE] = true;
        }
    ...
    public function setInvCoden($v)
    {
        ...
        if ($this->inv_coden !== $v) {
            $this->inv_coden = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_INV_CODEN] = true;
        }
    ...
    public function setInvRef($v)
    {
        ...
        if ($this->inv_ref !== $v) {
            $this->inv_ref = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_INV_REF] = true;
        }
    ...
    public function setInvRefn($v)
    {
        ...
        if ($this->inv_refn !== $v) {
            $this->inv_refn = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_INV_REFN] = true;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_TOTAL] = true;
        }
    ...
    public function setTotPv($v)
    {
        ...
        if ($this->tot_pv !== $v) {
            $this->tot_pv = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_TOT_PV] = true;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_ID] = true;
        }
    ...
    public function setSaType($v)
    {
        ...
        if ($this->sa_type !== $v) {
            $this->sa_type = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_SA_TYPE] = true;
        }
    ...
    public function setSaMtype($v)
    {
        ...
        if ($this->sa_mtype !== $v) {
            $this->sa_mtype = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_SA_MTYPE] = true;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_UID] = true;
        }
    ...
    public function setUidRef($v)
    {
        ...
        if ($this->uid_ref !== $v) {
            $this->uid_ref = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_UID_REF] = true;
        }
    ...
    public function setCancel($v)
    {
        ...
        if ($this->cancel !== $v) {
            $this->cancel = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_CANCEL] = true;
        }
    ...
    public function setTxtoption($v)
    {
        ...
        if ($this->txtoption !== $v) {
            $this->txtoption = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_TXTOPTION] = true;
        }
    ...
    public function setSender($v)
    {
        ...
        if ($this->sender !== $v) {
            $this->sender = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_SENDER] = true;
        }
    ...
    public function setSenderDate($v)
    {
        ...
        if ($this->sender_date !== null || $dt !== null) {
            if ($this->sender_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->sender_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AliIstockhTableMap::COL_SENDER_DATE] = true;
            }
        } // if either are not null
    ...
    public function setReceive($v)
    {
        ...
        if ($this->receive !== $v) {
            $this->receive = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_RECEIVE] = true;
        }
    ...
    public function setReceiveDate($v)
    {
        ...
        if ($this->receive_date !== null || $dt !== null) {
            if ($this->receive_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->receive_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AliIstockhTableMap::COL_RECEIVE_DATE] = true;
            }
        } // if either are not null
    ...
    public function setUidReceive($v)
    {
        ...
        if ($this->uid_receive !== $v) {
            $this->uid_receive = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_UID_RECEIVE] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_STATUS] = true;
        }
    ...
    public function setPrint($v)
    {
        ...
        if ($this->print !== $v) {
            $this->print = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_PRINT] = true;
        }
    ...
    public function setRccode($v)
    {
        ...
        if ($this->rccode !== $v) {
            $this->rccode = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_RCCODE] = true;
        }
    ...
    public function setUpdateDate($v)
    {
        ...
        if ($this->update_date !== null || $dt !== null) {
            if ($this->update_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->update_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AliIstockhTableMap::COL_UPDATE_DATE] = true;
            }
        } // if either are not null
    ...
    public function setMappingCode($v)
    {
        ...
        if ($this->mapping_code !== $v) {
            $this->mapping_code = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_MAPPING_CODE] = true;
        }
    ...
    public function setRrcode($v)
    {
        ...
        if ($this->rrcode !== $v) {
            $this->rrcode = $v;
            $this->modifiedColumns[AliIstockhTableMap::COL_RRCODE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliIstockhTableMap::translateFieldName('Sano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliIstockhTableMap::translateFieldName('Sano1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliIstockhTableMap::translateFieldName('Sadate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->sadate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliIstockhTableMap::translateFieldName('InvCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliIstockhTableMap::translateFieldName('InvCoden', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_coden = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliIstockhTableMap::translateFieldName('InvRef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_ref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliIstockhTableMap::translateFieldName('InvRefn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_refn = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliIstockhTableMap::translateFieldName('Total', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliIstockhTableMap::translateFieldName('TotPv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tot_pv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliIstockhTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliIstockhTableMap::translateFieldName('SaType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sa_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliIstockhTableMap::translateFieldName('SaMtype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sa_mtype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliIstockhTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliIstockhTableMap::translateFieldName('UidRef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid_ref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliIstockhTableMap::translateFieldName('Cancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cancel = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliIstockhTableMap::translateFieldName('Txtoption', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtoption = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AliIstockhTableMap::translateFieldName('Sender', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sender = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AliIstockhTableMap::translateFieldName('SenderDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->sender_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : AliIstockhTableMap::translateFieldName('Receive', TableMap::TYPE_PHPNAME, $indexType)];
            $this->receive = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : AliIstockhTableMap::translateFieldName('ReceiveDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->receive_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : AliIstockhTableMap::translateFieldName('UidReceive', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid_receive = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : AliIstockhTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : AliIstockhTableMap::translateFieldName('Print', TableMap::TYPE_PHPNAME, $indexType)];
            $this->print = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : AliIstockhTableMap::translateFieldName('Rccode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rccode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : AliIstockhTableMap::translateFieldName('UpdateDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->update_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : AliIstockhTableMap::translateFieldName('MappingCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mapping_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : AliIstockhTableMap::translateFieldName('Rrcode', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 27; // 27 = AliIstockhTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliIstockh'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliIstockhQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliIstockh::setDeleted()
     * @see AliIstockh::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliIstockhQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliIstockhTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliIstockhTableMap::COL_SANO)) {
            $modifiedColumns[':p' . $index++]  = 'sano';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_SANO1)) {
            $modifiedColumns[':p' . $index++]  = 'sano1';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_SADATE)) {
            $modifiedColumns[':p' . $index++]  = 'sadate';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_INV_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'inv_code';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_INV_CODEN)) {
            $modifiedColumns[':p' . $index++]  = 'inv_coden';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_INV_REF)) {
            $modifiedColumns[':p' . $index++]  = 'inv_ref';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_INV_REFN)) {
            $modifiedColumns[':p' . $index++]  = 'inv_refn';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'total';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_TOT_PV)) {
            $modifiedColumns[':p' . $index++]  = 'tot_pv';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_SA_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'sa_type';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_SA_MTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'sa_mtype';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_UID_REF)) {
            $modifiedColumns[':p' . $index++]  = 'uid_ref';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'cancel';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_TXTOPTION)) {
            $modifiedColumns[':p' . $index++]  = 'txtoption';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_SENDER)) {
            $modifiedColumns[':p' . $index++]  = 'sender';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_SENDER_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'sender_date';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_RECEIVE)) {
            $modifiedColumns[':p' . $index++]  = 'receive';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_RECEIVE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'receive_date';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_UID_RECEIVE)) {
            $modifiedColumns[':p' . $index++]  = 'uid_receive';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_PRINT)) {
            $modifiedColumns[':p' . $index++]  = 'print';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_RCCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rccode';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_UPDATE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'update_date';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_MAPPING_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'mapping_code';
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_RRCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rrcode';
        }

        $sql = sprintf(
            'INSERT INTO ali_istockh (%s) VALUES (%s)',
    ...
    {
        $pos = AliIstockhTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliIstockh'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliIstockh'][$this->hashCode()] = true;
        $keys = AliIstockhTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSano(),
            ...
            $keys[9] => $this->getId(),
            $keys[10] => $this->getSaType(),
            $keys[11] => $this->getSaMtype(),
            $keys[12] => $this->getUid(),
            $keys[13] => $this->getUidRef(),
            $keys[14] => $this->getCancel(),
            $keys[15] => $this->getTxtoption(),
            $keys[16] => $this->getSender(),
            $keys[17] => $this->getSenderDate(),
            $keys[18] => $this->getReceive(),
            $keys[19] => $this->getReceiveDate(),
            $keys[20] => $this->getUidReceive(),
            $keys[21] => $this->getStatus(),
            $keys[22] => $this->getPrint(),
            $keys[23] => $this->getRccode(),
            $keys[24] => $this->getUpdateDate(),
            $keys[25] => $this->getMappingCode(),
            $keys[26] => $this->getRrcode(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliIstockh
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[10], $arr)) {
            $this->setSaType($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setSaMtype($arr[$keys[11]]);
        }
        if (array_key_exists($keys[12], $arr)) {
            $this->setUid($arr[$keys[12]]);
        }
        if (array_key_exists($keys[13], $arr)) {
            $this->setUidRef($arr[$keys[13]]);
        }
        if (array_key_exists($keys[14], $arr)) {
            $this->setCancel($arr[$keys[14]]);
        }
        if (array_key_exists($keys[15], $arr)) {
            $this->setTxtoption($arr[$keys[15]]);
        }
        if (array_key_exists($keys[16], $arr)) {
            $this->setSender($arr[$keys[16]]);
        }
        if (array_key_exists($keys[17], $arr)) {
            $this->setSenderDate($arr[$keys[17]]);
        }
        if (array_key_exists($keys[18], $arr)) {
            $this->setReceive($arr[$keys[18]]);
        }
        if (array_key_exists($keys[19], $arr)) {
            $this->setReceiveDate($arr[$keys[19]]);
        }
        if (array_key_exists($keys[20], $arr)) {
            $this->setUidReceive($arr[$keys[20]]);
        }
        if (array_key_exists($keys[21], $arr)) {
            $this->setStatus($arr[$keys[21]]);
        }
        if (array_key_exists($keys[22], $arr)) {
            $this->setPrint($arr[$keys[22]]);
        }
        if (array_key_exists($keys[23], $arr)) {
            $this->setRccode($arr[$keys[23]]);
        }
        if (array_key_exists($keys[24], $arr)) {
            $this->setUpdateDate($arr[$keys[24]]);
        }
        if (array_key_exists($keys[25], $arr)) {
            $this->setMappingCode($arr[$keys[25]]);
        }
        if (array_key_exists($keys[26], $arr)) {
            $this->setRrcode($arr[$keys[26]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliIstockh The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliIstockhTableMap::COL_SANO)) {
            $criteria->add(AliIstockhTableMap::COL_SANO, $this->sano);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_SANO1)) {
            $criteria->add(AliIstockhTableMap::COL_SANO1, $this->sano1);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_SADATE)) {
            $criteria->add(AliIstockhTableMap::COL_SADATE, $this->sadate);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_INV_CODE)) {
            $criteria->add(AliIstockhTableMap::COL_INV_CODE, $this->inv_code);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_INV_CODEN)) {
            $criteria->add(AliIstockhTableMap::COL_INV_CODEN, $this->inv_coden);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_INV_REF)) {
            $criteria->add(AliIstockhTableMap::COL_INV_REF, $this->inv_ref);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_INV_REFN)) {
            $criteria->add(AliIstockhTableMap::COL_INV_REFN, $this->inv_refn);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_TOTAL)) {
            $criteria->add(AliIstockhTableMap::COL_TOTAL, $this->total);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_TOT_PV)) {
            $criteria->add(AliIstockhTableMap::COL_TOT_PV, $this->tot_pv);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_ID)) {
            $criteria->add(AliIstockhTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_SA_TYPE)) {
            $criteria->add(AliIstockhTableMap::COL_SA_TYPE, $this->sa_type);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_SA_MTYPE)) {
            $criteria->add(AliIstockhTableMap::COL_SA_MTYPE, $this->sa_mtype);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_UID)) {
            $criteria->add(AliIstockhTableMap::COL_UID, $this->uid);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_UID_REF)) {
            $criteria->add(AliIstockhTableMap::COL_UID_REF, $this->uid_ref);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_CANCEL)) {
            $criteria->add(AliIstockhTableMap::COL_CANCEL, $this->cancel);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_TXTOPTION)) {
            $criteria->add(AliIstockhTableMap::COL_TXTOPTION, $this->txtoption);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_SENDER)) {
            $criteria->add(AliIstockhTableMap::COL_SENDER, $this->sender);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_SENDER_DATE)) {
            $criteria->add(AliIstockhTableMap::COL_SENDER_DATE, $this->sender_date);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_RECEIVE)) {
            $criteria->add(AliIstockhTableMap::COL_RECEIVE, $this->receive);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_RECEIVE_DATE)) {
            $criteria->add(AliIstockhTableMap::COL_RECEIVE_DATE, $this->receive_date);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_UID_RECEIVE)) {
            $criteria->add(AliIstockhTableMap::COL_UID_RECEIVE, $this->uid_receive);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_STATUS)) {
            $criteria->add(AliIstockhTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_PRINT)) {
            $criteria->add(AliIstockhTableMap::COL_PRINT, $this->print);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_RCCODE)) {
            $criteria->add(AliIstockhTableMap::COL_RCCODE, $this->rccode);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_UPDATE_DATE)) {
            $criteria->add(AliIstockhTableMap::COL_UPDATE_DATE, $this->update_date);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_MAPPING_CODE)) {
            $criteria->add(AliIstockhTableMap::COL_MAPPING_CODE, $this->mapping_code);
        }
        if ($this->isColumnModified(AliIstockhTableMap::COL_RRCODE)) {
            $criteria->add(AliIstockhTableMap::COL_RRCODE, $this->rrcode);
        }
    ...
    {
        $criteria = ChildAliIstockhQuery::create();
        $criteria->add(AliIstockhTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliIstockh (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliIstockh Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliIstockhTableMap::DEFAULT_STRING_FORMAT);
    }
