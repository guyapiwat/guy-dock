...
/**
 * Base class that represents a row from the 'ali_esaleh' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliEsaleh implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliEsalehTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliEsaleh object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>AliEsaleh</code> instance.  If
     * <code>obj</code> is an instance of <code>AliEsaleh</code>, delegates to
     * <code>equals(AliEsaleh)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliEsaleh The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliEsaleh The current object (for fluent API support)
     */
    public function setSano($v)
    {
        ...
        if ($this->sano !== $v) {
            $this->sano = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_SANO] = true;
        }
    ...
    public function setSano1($v)
    {
        ...
        if ($this->sano1 !== $v) {
            $this->sano1 = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_SANO1] = true;
        }
    ...
    public function setSadate($v)
    {
        ...
        if ($this->sadate !== null || $dt !== null) {
            if ($this->sadate === null || $dt === null || $dt->format("Y-m-d") !== $this->sadate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliEsalehTableMap::COL_SADATE] = true;
            }
    ...
    public function setInvCode($v)
    {
        ...
        if ($this->inv_code !== $v) {
            $this->inv_code = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_INV_CODE] = true;
        }
    ...
    public function setInvRef($v)
    {
        ...
        if ($this->inv_ref !== $v) {
            $this->inv_ref = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_INV_REF] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_MCODE] = true;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TOTAL] = true;
        }
    ...
    public function setTotPv($v)
    {
        ...
        if ($this->tot_pv !== $v) {
            $this->tot_pv = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TOT_PV] = true;
        }
    ...
    public function setTotBv($v)
    {
        ...
        if ($this->tot_bv !== $v) {
            $this->tot_bv = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TOT_BV] = true;
        }
    ...
    public function setTotFv($v)
    {
        ...
        if ($this->tot_fv !== $v) {
            $this->tot_fv = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TOT_FV] = true;
        }
    ...
    public function setUsercode($v)
    {
        ...
        if ($this->usercode !== $v) {
            $this->usercode = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_USERCODE] = true;
        }
    ...
    public function setRemark($v)
    {
        ...
        if ($this->remark !== $v) {
            $this->remark = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_REMARK] = true;
        }
    ...
    public function setTrnf($v)
    {
        ...
        if ($this->trnf !== $v) {
            $this->trnf = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TRNF] = true;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_ID] = true;
        }
    ...
    public function setSaType($v)
    {
        ...
        if ($this->sa_type !== $v) {
            $this->sa_type = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_SA_TYPE] = true;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_UID] = true;
        }
    ...
    public function setDl($v)
    {
        ...
        if ($this->dl !== $v) {
            $this->dl = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_DL] = true;
        }
    ...
    public function setCancel($v)
    {
        ...
        if ($this->cancel !== $v) {
            $this->cancel = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_CANCEL] = true;
        }
    ...
    public function setSend($v)
    {
        ...
        if ($this->send !== $v) {
            $this->send = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_SEND] = true;
        }
    ...
    public function setTxtoption($v)
    {
        ...
        if ($this->txtoption !== $v) {
            $this->txtoption = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TXTOPTION] = true;
        }
    ...
    public function setChkcash($v)
    {
        ...
        if ($this->chkcash !== $v) {
            $this->chkcash = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_CHKCASH] = true;
        }
    ...
    public function setChkfuture($v)
    {
        ...
        if ($this->chkfuture !== $v) {
            $this->chkfuture = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_CHKFUTURE] = true;
        }
    ...
    public function setChktransfer($v)
    {
        ...
        if ($this->chktransfer !== $v) {
            $this->chktransfer = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_CHKTRANSFER] = true;
        }
    ...
    public function setChkcredit1($v)
    {
        ...
        if ($this->chkcredit1 !== $v) {
            $this->chkcredit1 = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_CHKCREDIT1] = true;
        }
    ...
    public function setChkcredit2($v)
    {
        ...
        if ($this->chkcredit2 !== $v) {
            $this->chkcredit2 = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_CHKCREDIT2] = true;
        }
    ...
    public function setChkcredit3($v)
    {
        ...
        if ($this->chkcredit3 !== $v) {
            $this->chkcredit3 = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_CHKCREDIT3] = true;
        }
    ...
    public function setChkinternet($v)
    {
        ...
        if ($this->chkinternet !== $v) {
            $this->chkinternet = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_CHKINTERNET] = true;
        }
    ...
    public function setChkdiscount($v)
    {
        ...
        if ($this->chkdiscount !== $v) {
            $this->chkdiscount = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_CHKDISCOUNT] = true;
        }
    ...
    public function setChkother($v)
    {
        ...
        if ($this->chkother !== $v) {
            $this->chkother = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_CHKOTHER] = true;
        }
    ...
    public function setTxtcash($v)
    {
        ...
        if ($this->txtcash !== $v) {
            $this->txtcash = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TXTCASH] = true;
        }
    ...
    public function setTxtfuture($v)
    {
        ...
        if ($this->txtfuture !== $v) {
            $this->txtfuture = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TXTFUTURE] = true;
        }
    ...
    public function setTxttransfer($v)
    {
        ...
        if ($this->txttransfer !== $v) {
            $this->txttransfer = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TXTTRANSFER] = true;
        }
    ...
    public function setEwallet($v)
    {
        ...
        if ($this->ewallet !== $v) {
            $this->ewallet = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_EWALLET] = true;
        }
    ...
    public function setTxtcredit1($v)
    {
        ...
        if ($this->txtcredit1 !== $v) {
            $this->txtcredit1 = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TXTCREDIT1] = true;
        }
    ...
    public function setTxtcredit2($v)
    {
        ...
        if ($this->txtcredit2 !== $v) {
            $this->txtcredit2 = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TXTCREDIT2] = true;
        }
    ...
    public function setTxtcredit3($v)
    {
        ...
        if ($this->txtcredit3 !== $v) {
            $this->txtcredit3 = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TXTCREDIT3] = true;
        }
    ...
    public function setTxtinternet($v)
    {
        ...
        if ($this->txtinternet !== $v) {
            $this->txtinternet = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TXTINTERNET] = true;
        }
    ...
    public function setTxtdiscount($v)
    {
        ...
        if ($this->txtdiscount !== $v) {
            $this->txtdiscount = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TXTDISCOUNT] = true;
        }
    ...
    public function setTxtother($v)
    {
        ...
        if ($this->txtother !== $v) {
            $this->txtother = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_TXTOTHER] = true;
        }
    ...
    public function setOptioncash($v)
    {
        ...
        if ($this->optioncash !== $v) {
            $this->optioncash = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_OPTIONCASH] = true;
        }
    ...
    public function setOptionfuture($v)
    {
        ...
        if ($this->optionfuture !== $v) {
            $this->optionfuture = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_OPTIONFUTURE] = true;
        }
    ...
    public function setOptiontransfer($v)
    {
        ...
        if ($this->optiontransfer !== $v) {
            ...
            $this->modifiedColumns[AliEsalehTableMap::COL_OPTIONTRANSFER] = true;
        }
    ...
    public function setOptioncredit1($v)
    {
        ...
        if ($this->optioncredit1 !== $v) {
            ...
            $this->modifiedColumns[AliEsalehTableMap::COL_OPTIONCREDIT1] = true;
        }
    ...
    public function setOptioncredit2($v)
    {
        ...
        if ($this->optioncredit2 !== $v) {
            ...
            $this->modifiedColumns[AliEsalehTableMap::COL_OPTIONCREDIT2] = true;
        }
    ...
    public function setOptioncredit3($v)
    {
        ...
        if ($this->optioncredit3 !== $v) {
            ...
            $this->modifiedColumns[AliEsalehTableMap::COL_OPTIONCREDIT3] = true;
        }
    ...
    public function setOptioninternet($v)
    {
        ...
        if ($this->optioninternet !== $v) {
            ...
            $this->modifiedColumns[AliEsalehTableMap::COL_OPTIONINTERNET] = true;
        }
    ...
    public function setOptiondiscount($v)
    {
        ...
        if ($this->optiondiscount !== $v) {
            ...
            $this->modifiedColumns[AliEsalehTableMap::COL_OPTIONDISCOUNT] = true;
        }
    ...
    public function setOptionother($v)
    {
        ...
        if ($this->optionother !== $v) {
            $this->optionother = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_OPTIONOTHER] = true;
        }
    ...
    public function setAsend($v)
    {
        ...
        if ($this->asend !== $v) {
            $this->asend = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_ASEND] = true;
        }
    ...
    public function setAsendDate($v)
    {
        ...
        if ($this->asend_date !== null || $dt !== null) {
            if ($this->asend_date === null || $dt === null || $dt->format("Y-m-d") !== $this->asend_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliEsalehTableMap::COL_ASEND_DATE] = true;
            }
        } // if either are not null
    ...
    public function setDiscount($v)
    {
        ...
        if ($this->discount !== $v) {
            $this->discount = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_DISCOUNT] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_STATUS] = true;
        }
    ...
    public function setEwalletBefore($v)
    {
        ...
        if ($this->ewallet_before !== $v) {
            ...
            $this->modifiedColumns[AliEsalehTableMap::COL_EWALLET_BEFORE] = true;
        }
    ...
    public function setEwalletAfter($v)
    {
        ...
        if ($this->ewallet_after !== $v) {
            ...
            $this->modifiedColumns[AliEsalehTableMap::COL_EWALLET_AFTER] = true;
        }
    ...
    public function setEwallettBefore($v)
    {
        ...
        if ($this->ewallett_before !== $v) {
            ...
            $this->modifiedColumns[AliEsalehTableMap::COL_EWALLETT_BEFORE] = true;
        }
    ...
    public function setEwallettAfter($v)
    {
        ...
        if ($this->ewallett_after !== $v) {
            ...
            $this->modifiedColumns[AliEsalehTableMap::COL_EWALLETT_AFTER] = true;
        }
    ...
    public function setPrint($v)
    {
        ...
        if ($this->print !== $v) {
            $this->print = $v;
            $this->modifiedColumns[AliEsalehTableMap::COL_PRINT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliEsalehTableMap::translateFieldName('Sano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliEsalehTableMap::translateFieldName('Sano1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliEsalehTableMap::translateFieldName('Sadate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->sadate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliEsalehTableMap::translateFieldName('InvCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliEsalehTableMap::translateFieldName('InvRef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_ref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliEsalehTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliEsalehTableMap::translateFieldName('Total', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliEsalehTableMap::translateFieldName('TotPv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tot_pv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliEsalehTableMap::translateFieldName('TotBv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tot_bv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliEsalehTableMap::translateFieldName('TotFv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tot_fv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliEsalehTableMap::translateFieldName('Usercode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usercode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliEsalehTableMap::translateFieldName('Remark', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remark = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliEsalehTableMap::translateFieldName('Trnf', TableMap::TYPE_PHPNAME, $indexType)];
            $this->trnf = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliEsalehTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliEsalehTableMap::translateFieldName('SaType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sa_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliEsalehTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AliEsalehTableMap::translateFieldName('Dl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AliEsalehTableMap::translateFieldName('Cancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cancel = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : AliEsalehTableMap::translateFieldName('Send', TableMap::TYPE_PHPNAME, $indexType)];
            $this->send = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : AliEsalehTableMap::translateFieldName('Txtoption', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtoption = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : AliEsalehTableMap::translateFieldName('Chkcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : AliEsalehTableMap::translateFieldName('Chkfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : AliEsalehTableMap::translateFieldName('Chktransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : AliEsalehTableMap::translateFieldName('Chkcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : AliEsalehTableMap::translateFieldName('Chkcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : AliEsalehTableMap::translateFieldName('Chkcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : AliEsalehTableMap::translateFieldName('Chkinternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkinternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : AliEsalehTableMap::translateFieldName('Chkdiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkdiscount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : AliEsalehTableMap::translateFieldName('Chkother', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkother = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : AliEsalehTableMap::translateFieldName('Txtcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : AliEsalehTableMap::translateFieldName('Txtfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : AliEsalehTableMap::translateFieldName('Txttransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : AliEsalehTableMap::translateFieldName('Ewallet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : AliEsalehTableMap::translateFieldName('Txtcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : AliEsalehTableMap::translateFieldName('Txtcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : AliEsalehTableMap::translateFieldName('Txtcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : AliEsalehTableMap::translateFieldName('Txtinternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtinternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : AliEsalehTableMap::translateFieldName('Txtdiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtdiscount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : AliEsalehTableMap::translateFieldName('Txtother', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtother = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : AliEsalehTableMap::translateFieldName('Optioncash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : AliEsalehTableMap::translateFieldName('Optionfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : AliEsalehTableMap::translateFieldName('Optiontransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : AliEsalehTableMap::translateFieldName('Optioncredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : AliEsalehTableMap::translateFieldName('Optioncredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : AliEsalehTableMap::translateFieldName('Optioncredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : AliEsalehTableMap::translateFieldName('Optioninternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioninternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : AliEsalehTableMap::translateFieldName('Optiondiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiondiscount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : AliEsalehTableMap::translateFieldName('Optionother', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionother = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : AliEsalehTableMap::translateFieldName('Asend', TableMap::TYPE_PHPNAME, $indexType)];
            $this->asend = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : AliEsalehTableMap::translateFieldName('AsendDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->asend_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : AliEsalehTableMap::translateFieldName('Discount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : AliEsalehTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : AliEsalehTableMap::translateFieldName('EwalletBefore', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_before = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : AliEsalehTableMap::translateFieldName('EwalletAfter', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_after = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : AliEsalehTableMap::translateFieldName('EwallettBefore', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallett_before = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : AliEsalehTableMap::translateFieldName('EwallettAfter', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallett_after = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : AliEsalehTableMap::translateFieldName('Print', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 57; // 57 = AliEsalehTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliEsaleh'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliEsalehQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliEsaleh::setDeleted()
     * @see AliEsaleh::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliEsalehQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliEsalehTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliEsalehTableMap::COL_SANO)) {
            $modifiedColumns[':p' . $index++]  = 'sano';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_SANO1)) {
            $modifiedColumns[':p' . $index++]  = 'sano1';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_SADATE)) {
            $modifiedColumns[':p' . $index++]  = 'sadate';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_INV_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'inv_code';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_INV_REF)) {
            $modifiedColumns[':p' . $index++]  = 'inv_ref';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'total';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TOT_PV)) {
            $modifiedColumns[':p' . $index++]  = 'tot_pv';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TOT_BV)) {
            $modifiedColumns[':p' . $index++]  = 'tot_bv';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TOT_FV)) {
            $modifiedColumns[':p' . $index++]  = 'tot_fv';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_USERCODE)) {
            $modifiedColumns[':p' . $index++]  = 'usercode';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_REMARK)) {
            $modifiedColumns[':p' . $index++]  = 'remark';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TRNF)) {
            $modifiedColumns[':p' . $index++]  = 'trnf';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_SA_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'sa_type';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_DL)) {
            $modifiedColumns[':p' . $index++]  = 'dl';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'cancel';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_SEND)) {
            $modifiedColumns[':p' . $index++]  = 'send';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTOPTION)) {
            $modifiedColumns[':p' . $index++]  = 'txtoption';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKCASH)) {
            $modifiedColumns[':p' . $index++]  = 'chkCash';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'chkFuture';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit1';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit2';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit3';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'chkInternet';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKDISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'chkDiscount';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKOTHER)) {
            $modifiedColumns[':p' . $index++]  = 'chkOther';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTCASH)) {
            $modifiedColumns[':p' . $index++]  = 'txtCash';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'txtFuture';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_EWALLET)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit1';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit2';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit3';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'txtInternet';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTDISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'txtDiscount';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTOTHER)) {
            $modifiedColumns[':p' . $index++]  = 'txtOther';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONCASH)) {
            $modifiedColumns[':p' . $index++]  = 'optionCash';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'optionFuture';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit1';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit2';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit3';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'optionInternet';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONDISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'optionDiscount';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONOTHER)) {
            $modifiedColumns[':p' . $index++]  = 'optionOther';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_ASEND)) {
            $modifiedColumns[':p' . $index++]  = 'asend';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_ASEND_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'asend_date';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_DISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'discount';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_EWALLET_BEFORE)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_before';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_EWALLET_AFTER)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_after';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_EWALLETT_BEFORE)) {
            $modifiedColumns[':p' . $index++]  = 'ewallett_before';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_EWALLETT_AFTER)) {
            $modifiedColumns[':p' . $index++]  = 'ewallett_after';
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_PRINT)) {
            $modifiedColumns[':p' . $index++]  = 'print';
        }

        $sql = sprintf(
            'INSERT INTO ali_esaleh (%s) VALUES (%s)',
    ...
    {
        $pos = AliEsalehTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliEsaleh'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliEsaleh'][$this->hashCode()] = true;
        $keys = AliEsalehTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSano(),
            ...
            $keys[51] => $this->getStatus(),
            $keys[52] => $this->getEwalletBefore(),
            $keys[53] => $this->getEwalletAfter(),
            $keys[54] => $this->getEwallettBefore(),
            $keys[55] => $this->getEwallettAfter(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliEsaleh
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[54], $arr)) {
            $this->setEwallettBefore($arr[$keys[54]]);
        }
        if (array_key_exists($keys[55], $arr)) {
            $this->setEwallettAfter($arr[$keys[55]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliEsaleh The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliEsalehTableMap::COL_SANO)) {
            $criteria->add(AliEsalehTableMap::COL_SANO, $this->sano);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_SANO1)) {
            $criteria->add(AliEsalehTableMap::COL_SANO1, $this->sano1);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_SADATE)) {
            $criteria->add(AliEsalehTableMap::COL_SADATE, $this->sadate);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_INV_CODE)) {
            $criteria->add(AliEsalehTableMap::COL_INV_CODE, $this->inv_code);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_INV_REF)) {
            $criteria->add(AliEsalehTableMap::COL_INV_REF, $this->inv_ref);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_MCODE)) {
            $criteria->add(AliEsalehTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TOTAL)) {
            $criteria->add(AliEsalehTableMap::COL_TOTAL, $this->total);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TOT_PV)) {
            $criteria->add(AliEsalehTableMap::COL_TOT_PV, $this->tot_pv);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TOT_BV)) {
            $criteria->add(AliEsalehTableMap::COL_TOT_BV, $this->tot_bv);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TOT_FV)) {
            $criteria->add(AliEsalehTableMap::COL_TOT_FV, $this->tot_fv);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_USERCODE)) {
            $criteria->add(AliEsalehTableMap::COL_USERCODE, $this->usercode);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_REMARK)) {
            $criteria->add(AliEsalehTableMap::COL_REMARK, $this->remark);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TRNF)) {
            $criteria->add(AliEsalehTableMap::COL_TRNF, $this->trnf);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_ID)) {
            $criteria->add(AliEsalehTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_SA_TYPE)) {
            $criteria->add(AliEsalehTableMap::COL_SA_TYPE, $this->sa_type);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_UID)) {
            $criteria->add(AliEsalehTableMap::COL_UID, $this->uid);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_DL)) {
            $criteria->add(AliEsalehTableMap::COL_DL, $this->dl);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CANCEL)) {
            $criteria->add(AliEsalehTableMap::COL_CANCEL, $this->cancel);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_SEND)) {
            $criteria->add(AliEsalehTableMap::COL_SEND, $this->send);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTOPTION)) {
            $criteria->add(AliEsalehTableMap::COL_TXTOPTION, $this->txtoption);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKCASH)) {
            $criteria->add(AliEsalehTableMap::COL_CHKCASH, $this->chkcash);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKFUTURE)) {
            $criteria->add(AliEsalehTableMap::COL_CHKFUTURE, $this->chkfuture);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKTRANSFER)) {
            $criteria->add(AliEsalehTableMap::COL_CHKTRANSFER, $this->chktransfer);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKCREDIT1)) {
            $criteria->add(AliEsalehTableMap::COL_CHKCREDIT1, $this->chkcredit1);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKCREDIT2)) {
            $criteria->add(AliEsalehTableMap::COL_CHKCREDIT2, $this->chkcredit2);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKCREDIT3)) {
            $criteria->add(AliEsalehTableMap::COL_CHKCREDIT3, $this->chkcredit3);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKINTERNET)) {
            $criteria->add(AliEsalehTableMap::COL_CHKINTERNET, $this->chkinternet);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKDISCOUNT)) {
            $criteria->add(AliEsalehTableMap::COL_CHKDISCOUNT, $this->chkdiscount);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_CHKOTHER)) {
            $criteria->add(AliEsalehTableMap::COL_CHKOTHER, $this->chkother);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTCASH)) {
            $criteria->add(AliEsalehTableMap::COL_TXTCASH, $this->txtcash);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTFUTURE)) {
            $criteria->add(AliEsalehTableMap::COL_TXTFUTURE, $this->txtfuture);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTTRANSFER)) {
            $criteria->add(AliEsalehTableMap::COL_TXTTRANSFER, $this->txttransfer);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_EWALLET)) {
            $criteria->add(AliEsalehTableMap::COL_EWALLET, $this->ewallet);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTCREDIT1)) {
            $criteria->add(AliEsalehTableMap::COL_TXTCREDIT1, $this->txtcredit1);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTCREDIT2)) {
            $criteria->add(AliEsalehTableMap::COL_TXTCREDIT2, $this->txtcredit2);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTCREDIT3)) {
            $criteria->add(AliEsalehTableMap::COL_TXTCREDIT3, $this->txtcredit3);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTINTERNET)) {
            $criteria->add(AliEsalehTableMap::COL_TXTINTERNET, $this->txtinternet);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTDISCOUNT)) {
            $criteria->add(AliEsalehTableMap::COL_TXTDISCOUNT, $this->txtdiscount);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_TXTOTHER)) {
            $criteria->add(AliEsalehTableMap::COL_TXTOTHER, $this->txtother);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONCASH)) {
            $criteria->add(AliEsalehTableMap::COL_OPTIONCASH, $this->optioncash);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONFUTURE)) {
            $criteria->add(AliEsalehTableMap::COL_OPTIONFUTURE, $this->optionfuture);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONTRANSFER)) {
            $criteria->add(AliEsalehTableMap::COL_OPTIONTRANSFER, $this->optiontransfer);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONCREDIT1)) {
            $criteria->add(AliEsalehTableMap::COL_OPTIONCREDIT1, $this->optioncredit1);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONCREDIT2)) {
            $criteria->add(AliEsalehTableMap::COL_OPTIONCREDIT2, $this->optioncredit2);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONCREDIT3)) {
            $criteria->add(AliEsalehTableMap::COL_OPTIONCREDIT3, $this->optioncredit3);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONINTERNET)) {
            $criteria->add(AliEsalehTableMap::COL_OPTIONINTERNET, $this->optioninternet);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONDISCOUNT)) {
            $criteria->add(AliEsalehTableMap::COL_OPTIONDISCOUNT, $this->optiondiscount);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_OPTIONOTHER)) {
            $criteria->add(AliEsalehTableMap::COL_OPTIONOTHER, $this->optionother);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_ASEND)) {
            $criteria->add(AliEsalehTableMap::COL_ASEND, $this->asend);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_ASEND_DATE)) {
            $criteria->add(AliEsalehTableMap::COL_ASEND_DATE, $this->asend_date);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_DISCOUNT)) {
            $criteria->add(AliEsalehTableMap::COL_DISCOUNT, $this->discount);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_STATUS)) {
            $criteria->add(AliEsalehTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_EWALLET_BEFORE)) {
            $criteria->add(AliEsalehTableMap::COL_EWALLET_BEFORE, $this->ewallet_before);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_EWALLET_AFTER)) {
            $criteria->add(AliEsalehTableMap::COL_EWALLET_AFTER, $this->ewallet_after);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_EWALLETT_BEFORE)) {
            $criteria->add(AliEsalehTableMap::COL_EWALLETT_BEFORE, $this->ewallett_before);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_EWALLETT_AFTER)) {
            $criteria->add(AliEsalehTableMap::COL_EWALLETT_AFTER, $this->ewallett_after);
        }
        if ($this->isColumnModified(AliEsalehTableMap::COL_PRINT)) {
            $criteria->add(AliEsalehTableMap::COL_PRINT, $this->print);
        }
    ...
    {
        $criteria = ChildAliEsalehQuery::create();
        $criteria->add(AliEsalehTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliEsaleh (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliEsaleh Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliEsalehTableMap::DEFAULT_STRING_FORMAT);
    }
