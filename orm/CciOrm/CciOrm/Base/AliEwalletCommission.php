...
/**
 * Base class that represents a row from the 'ali_ewallet_commission' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliEwalletCommission implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliEwalletCommissionTableMap';
    ...
    /**
     * The value for the cmbonus field.
     *
     * @var        int
     */
    protected $cmbonus;
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliEwalletCommission object.
     */
    ...
    /**
     * Compares this with another <code>AliEwalletCommission</code> instance.  If
     * <code>obj</code> is an instance of <code>AliEwalletCommission</code>, delegates to
     * <code>equals(AliEwalletCommission)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliEwalletCommission The current object, for fluid interface
     */
    ...
    /**
     * Get the [cmbonus] column value.
     *
     * @return int
     */
    public function getCmbonus()
    {
        return $this->cmbonus;
    }
     ...
     * @return $this|\CciOrm\CciOrm\AliEwalletCommission The current object (for fluent API support)
     */
    public function setSano($v)
    {
        ...
        if ($this->sano !== $v) {
            $this->sano = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_SANO] = true;
        }
    ...
    public function setSadate($v)
    {
        ...
        if ($this->sadate !== null || $dt !== null) {
            if ($this->sadate === null || $dt === null || $dt->format("Y-m-d") !== $this->sadate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliEwalletCommissionTableMap::COL_SADATE] = true;
            }
    ...
    public function setInvCode($v)
    {
        ...
        if ($this->inv_code !== $v) {
            $this->inv_code = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_INV_CODE] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_MCODE] = true;
        }
    ...
    public function setNameF($v)
    {
        ...
        if ($this->name_f !== $v) {
            $this->name_f = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_NAME_F] = true;
        }
    ...
    public function setNameT($v)
    {
        ...
        if ($this->name_t !== $v) {
            $this->name_t = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_NAME_T] = true;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TOTAL] = true;
        }
    ...
    public function setUsercode($v)
    {
        ...
        if ($this->usercode !== $v) {
            $this->usercode = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_USERCODE] = true;
        }
    ...
    public function setRemark($v)
    {
        ...
        if ($this->remark !== $v) {
            $this->remark = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_REMARK] = true;
        }
    ...
    public function setTrnf($v)
    {
        ...
        if ($this->trnf !== $v) {
            $this->trnf = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TRNF] = true;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_ID] = true;
        }
    ...
    public function setSaType($v)
    {
        ...
        if ($this->sa_type !== $v) {
            $this->sa_type = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_SA_TYPE] = true;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_UID] = true;
        }
    ...
    public function setLid($v)
    {
        ...
        if ($this->lid !== $v) {
            $this->lid = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_LID] = true;
        }
    ...
    public function setDl($v)
    {
        ...
        if ($this->dl !== $v) {
            $this->dl = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_DL] = true;
        }
    ...
    public function setCancel($v)
    {
        ...
        if ($this->cancel !== $v) {
            $this->cancel = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CANCEL] = true;
        }
    ...
    public function setSend($v)
    {
        ...
        if ($this->send !== $v) {
            $this->send = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_SEND] = true;
        }
    ...
    public function setTxtmoney($v)
    {
        ...
        if ($this->txtmoney !== $v) {
            $this->txtmoney = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TXTMONEY] = true;
        }
    ...
    public function setChkcash($v)
    {
        ...
        if ($this->chkcash !== $v) {
            $this->chkcash = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CHKCASH] = true;
        }
    ...
    public function setChkfuture($v)
    {
        ...
        if ($this->chkfuture !== $v) {
            $this->chkfuture = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CHKFUTURE] = true;
        }
    ...
    public function setChktransfer($v)
    {
        ...
        if ($this->chktransfer !== $v) {
            $this->chktransfer = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CHKTRANSFER] = true;
        }
    ...
    public function setChkcredit1($v)
    {
        ...
        if ($this->chkcredit1 !== $v) {
            $this->chkcredit1 = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CHKCREDIT1] = true;
        }
    ...
    public function setChkcredit2($v)
    {
        ...
        if ($this->chkcredit2 !== $v) {
            $this->chkcredit2 = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CHKCREDIT2] = true;
        }
    ...
    public function setChkcredit3($v)
    {
        ...
        if ($this->chkcredit3 !== $v) {
            $this->chkcredit3 = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CHKCREDIT3] = true;
        }
    ...
    public function setChkwithdraw($v)
    {
        ...
        if ($this->chkwithdraw !== $v) {
            $this->chkwithdraw = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CHKWITHDRAW] = true;
        }
    ...
    public function setChktransferIn($v)
    {
        ...
        if ($this->chktransfer_in !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CHKTRANSFER_IN] = true;
        }
    ...
    public function setChktransferOut($v)
    {
        ...
        if ($this->chktransfer_out !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CHKTRANSFER_OUT] = true;
        }
    ...
    public function setTxtcash($v)
    {
        ...
        if ($this->txtcash !== $v) {
            $this->txtcash = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TXTCASH] = true;
        }
    ...
    public function setTxtfuture($v)
    {
        ...
        if ($this->txtfuture !== $v) {
            $this->txtfuture = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TXTFUTURE] = true;
        }
    ...
    public function setTxttransfer($v)
    {
        ...
        if ($this->txttransfer !== $v) {
            $this->txttransfer = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TXTTRANSFER] = true;
        }
    ...
    public function setTxtcredit1($v)
    {
        ...
        if ($this->txtcredit1 !== $v) {
            $this->txtcredit1 = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TXTCREDIT1] = true;
        }
    ...
    public function setTxtcredit2($v)
    {
        ...
        if ($this->txtcredit2 !== $v) {
            $this->txtcredit2 = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TXTCREDIT2] = true;
        }
    ...
    public function setTxtcredit3($v)
    {
        ...
        if ($this->txtcredit3 !== $v) {
            $this->txtcredit3 = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TXTCREDIT3] = true;
        }
    ...
    public function setTxtwithdraw($v)
    {
        ...
        if ($this->txtwithdraw !== $v) {
            $this->txtwithdraw = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TXTWITHDRAW] = true;
        }
    ...
    public function setTxttransferIn($v)
    {
        ...
        if ($this->txttransfer_in !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TXTTRANSFER_IN] = true;
        }
    ...
    public function setTxttransferOut($v)
    {
        ...
        if ($this->txttransfer_out !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TXTTRANSFER_OUT] = true;
        }
    ...
    public function setOptioncash($v)
    {
        ...
        if ($this->optioncash !== $v) {
            $this->optioncash = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_OPTIONCASH] = true;
        }
    ...
    public function setOptionfuture($v)
    {
        ...
        if ($this->optionfuture !== $v) {
            $this->optionfuture = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_OPTIONFUTURE] = true;
        }
    ...
    public function setOptiontransfer($v)
    {
        ...
        if ($this->optiontransfer !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_OPTIONTRANSFER] = true;
        }
    ...
    public function setOptioncredit1($v)
    {
        ...
        if ($this->optioncredit1 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_OPTIONCREDIT1] = true;
        }
    ...
    public function setOptioncredit2($v)
    {
        ...
        if ($this->optioncredit2 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_OPTIONCREDIT2] = true;
        }
    ...
    public function setOptioncredit3($v)
    {
        ...
        if ($this->optioncredit3 !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_OPTIONCREDIT3] = true;
        }
    ...
    public function setOptionwithdraw($v)
    {
        ...
        if ($this->optionwithdraw !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_OPTIONWITHDRAW] = true;
        }
    ...
    public function setOptiontransferIn($v)
    {
        ...
        if ($this->optiontransfer_in !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_OPTIONTRANSFER_IN] = true;
        }
    ...
    public function setOptiontransferOut($v)
    {
        ...
        if ($this->optiontransfer_out !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_OPTIONTRANSFER_OUT] = true;
        }
    ...
    public function setTxtoption($v)
    {
        ...
        if ($this->txtoption !== $v) {
            $this->txtoption = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TXTOPTION] = true;
        }
    ...
    public function setEwallet($v)
    {
        ...
        if ($this->ewallet !== $v) {
            $this->ewallet = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_EWALLET] = true;
        }
    ...
    public function setEwalletBefore($v)
    {
        ...
        if ($this->ewallet_before !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_EWALLET_BEFORE] = true;
        }
    ...
    public function setEwalletAfter($v)
    {
        ...
        if ($this->ewallet_after !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_EWALLET_AFTER] = true;
        }
    ...
    public function setIpay($v)
    {
        ...
        if ($this->ipay !== $v) {
            $this->ipay = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_IPAY] = true;
        }
    ...
    public function setCheckportal($v)
    {
        ...
        if ($this->checkportal !== $v) {
            $this->checkportal = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CHECKPORTAL] = true;
        }
    ...
    public function setBprice($v)
    {
        ...
        if ($this->bprice !== $v) {
            $this->bprice = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_BPRICE] = true;
        }
    ...
    public function setCancelDate($v)
    {
        ...
        if ($this->cancel_date !== null || $dt !== null) {
            if ($this->cancel_date === null || $dt === null || $dt->format("Y-m-d") !== $this->cancel_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CANCEL_DATE] = true;
            }
        } // if either are not null
    ...
    public function setUidCancel($v)
    {
        ...
        if ($this->uid_cancel !== $v) {
            $this->uid_cancel = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_UID_CANCEL] = true;
        }
    ...
    public function setLocationbase($v)
    {
        ...
        if ($this->locationbase !== $v) {
            $this->locationbase = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_LOCATIONBASE] = true;
        }
    ...
    public function setChkcommission($v)
    {
        ...
        if ($this->chkcommission !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CHKCOMMISSION] = true;
        }
    ...
    public function setTxtcommission($v)
    {
        ...
        if ($this->txtcommission !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_TXTCOMMISSION] = true;
        }
    ...
    public function setOptioncommission($v)
    {
        ...
        if ($this->optioncommission !== $v) {
            ...
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_OPTIONCOMMISSION] = true;
        }
    ...
    public function setMbase($v)
    {
        ...
        if ($this->mbase !== $v) {
            $this->mbase = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_MBASE] = true;
        }
    ...
    public function setCrate($v)
    {
        ...
        if ($this->crate !== $v) {
            $this->crate = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CRATE] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_RCODE] = true;
        }
    ...
    public function setEcheck($v)
    {
        ...
        if ($this->echeck !== $v) {
            $this->echeck = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_ECHECK] = true;
        }
    ...
    /**
     * Set the value of [cmbonus] column.
     *
     * @param int $v new value
     * @return $this|\CciOrm\CciOrm\AliEwalletCommission The current object (for fluent API support)
     */
    public function setCmbonus($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->cmbonus !== $v) {
            $this->cmbonus = $v;
            $this->modifiedColumns[AliEwalletCommissionTableMap::COL_CMBONUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Sano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Sadate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->sadate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliEwalletCommissionTableMap::translateFieldName('InvCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliEwalletCommissionTableMap::translateFieldName('NameF', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_f = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliEwalletCommissionTableMap::translateFieldName('NameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Total', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Usercode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usercode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Remark', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remark = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Trnf', TableMap::TYPE_PHPNAME, $indexType)];
            $this->trnf = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliEwalletCommissionTableMap::translateFieldName('SaType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sa_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Lid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Dl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Cancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cancel = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Send', TableMap::TYPE_PHPNAME, $indexType)];
            $this->send = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Txtmoney', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtmoney = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Chkcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Chkfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Chktransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Chkcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Chkcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Chkcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Chkwithdraw', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkwithdraw = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : AliEwalletCommissionTableMap::translateFieldName('ChktransferIn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer_in = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : AliEwalletCommissionTableMap::translateFieldName('ChktransferOut', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer_out = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Txtcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Txtfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Txttransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Txtcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Txtcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Txtcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Txtwithdraw', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtwithdraw = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : AliEwalletCommissionTableMap::translateFieldName('TxttransferIn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer_in = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : AliEwalletCommissionTableMap::translateFieldName('TxttransferOut', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer_out = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Optioncash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Optionfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Optiontransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Optioncredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Optioncredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Optioncredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Optionwithdraw', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionwithdraw = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : AliEwalletCommissionTableMap::translateFieldName('OptiontransferIn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer_in = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : AliEwalletCommissionTableMap::translateFieldName('OptiontransferOut', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer_out = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Txtoption', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtoption = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Ewallet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : AliEwalletCommissionTableMap::translateFieldName('EwalletBefore', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_before = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : AliEwalletCommissionTableMap::translateFieldName('EwalletAfter', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_after = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Ipay', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ipay = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Checkportal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->checkportal = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Bprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : AliEwalletCommissionTableMap::translateFieldName('CancelDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->cancel_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : AliEwalletCommissionTableMap::translateFieldName('UidCancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid_cancel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Locationbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->locationbase = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Chkcommission', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcommission = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Txtcommission', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcommission = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Optioncommission', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncommission = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 58 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Mbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mbase = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 59 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Crate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->crate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 60 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 61 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Echeck', TableMap::TYPE_PHPNAME, $indexType)];
            $this->echeck = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 62 + $startcol : AliEwalletCommissionTableMap::translateFieldName('Cmbonus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cmbonus = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 63; // 63 = AliEwalletCommissionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliEwalletCommission'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliEwalletCommissionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliEwalletCommission::setDeleted()
     * @see AliEwalletCommission::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliEwalletCommissionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliEwalletCommissionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_SANO)) {
            $modifiedColumns[':p' . $index++]  = 'sano';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_SADATE)) {
            $modifiedColumns[':p' . $index++]  = 'sadate';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_INV_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'inv_code';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_NAME_F)) {
            $modifiedColumns[':p' . $index++]  = 'name_f';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_NAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'name_t';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'total';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_USERCODE)) {
            $modifiedColumns[':p' . $index++]  = 'usercode';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_REMARK)) {
            $modifiedColumns[':p' . $index++]  = 'remark';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TRNF)) {
            $modifiedColumns[':p' . $index++]  = 'trnf';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_SA_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'sa_type';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_LID)) {
            $modifiedColumns[':p' . $index++]  = 'lid';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_DL)) {
            $modifiedColumns[':p' . $index++]  = 'dl';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'cancel';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_SEND)) {
            $modifiedColumns[':p' . $index++]  = 'send';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTMONEY)) {
            $modifiedColumns[':p' . $index++]  = 'txtMoney';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKCASH)) {
            $modifiedColumns[':p' . $index++]  = 'chkCash';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'chkFuture';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit1';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit2';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit3';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKWITHDRAW)) {
            $modifiedColumns[':p' . $index++]  = 'chkWithdraw';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKTRANSFER_IN)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer_in';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKTRANSFER_OUT)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer_out';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTCASH)) {
            $modifiedColumns[':p' . $index++]  = 'txtCash';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'txtFuture';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit1';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit2';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit3';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTWITHDRAW)) {
            $modifiedColumns[':p' . $index++]  = 'txtWithdraw';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTTRANSFER_IN)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer_in';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTTRANSFER_OUT)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer_out';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONCASH)) {
            $modifiedColumns[':p' . $index++]  = 'optionCash';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'optionFuture';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit1';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit2';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit3';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONWITHDRAW)) {
            $modifiedColumns[':p' . $index++]  = 'optionWithdraw';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONTRANSFER_IN)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer_in';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONTRANSFER_OUT)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer_out';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTOPTION)) {
            $modifiedColumns[':p' . $index++]  = 'txtoption';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_EWALLET)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_EWALLET_BEFORE)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_before';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_EWALLET_AFTER)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_after';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_IPAY)) {
            $modifiedColumns[':p' . $index++]  = 'ipay';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHECKPORTAL)) {
            $modifiedColumns[':p' . $index++]  = 'checkportal';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_BPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'bprice';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CANCEL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'cancel_date';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_UID_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'uid_cancel';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_LOCATIONBASE)) {
            $modifiedColumns[':p' . $index++]  = 'locationbase';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKCOMMISSION)) {
            $modifiedColumns[':p' . $index++]  = 'chkCommission';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTCOMMISSION)) {
            $modifiedColumns[':p' . $index++]  = 'txtCommission';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONCOMMISSION)) {
            $modifiedColumns[':p' . $index++]  = 'optionCommission';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_MBASE)) {
            $modifiedColumns[':p' . $index++]  = 'mbase';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CRATE)) {
            $modifiedColumns[':p' . $index++]  = 'crate';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_ECHECK)) {
            $modifiedColumns[':p' . $index++]  = 'echeck';
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CMBONUS)) {
            $modifiedColumns[':p' . $index++]  = 'cmbonus';
        }

        $sql = sprintf(
            'INSERT INTO ali_ewallet_commission (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'echeck':
                        ...
                        break;
                    case 'cmbonus':
                        $stmt->bindValue($identifier, $this->cmbonus, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = AliEwalletCommissionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliEwalletCommission'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliEwalletCommission'][$this->hashCode()] = true;
        $keys = AliEwalletCommissionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSano(),
            ...
            $keys[24] => $this->getChkwithdraw(),
            $keys[25] => $this->getChktransferIn(),
            $keys[26] => $this->getChktransferOut(),
            $keys[27] => $this->getTxtcash(),
            $keys[28] => $this->getTxtfuture(),
            $keys[29] => $this->getTxttransfer(),
            $keys[30] => $this->getTxtcredit1(),
            $keys[31] => $this->getTxtcredit2(),
            $keys[32] => $this->getTxtcredit3(),
            $keys[33] => $this->getTxtwithdraw(),
            $keys[34] => $this->getTxttransferIn(),
            $keys[35] => $this->getTxttransferOut(),
            $keys[36] => $this->getOptioncash(),
            $keys[37] => $this->getOptionfuture(),
            $keys[38] => $this->getOptiontransfer(),
            $keys[39] => $this->getOptioncredit1(),
            $keys[40] => $this->getOptioncredit2(),
            $keys[41] => $this->getOptioncredit3(),
            $keys[42] => $this->getOptionwithdraw(),
            $keys[43] => $this->getOptiontransferIn(),
            $keys[44] => $this->getOptiontransferOut(),
            $keys[45] => $this->getTxtoption(),
            $keys[46] => $this->getEwallet(),
            $keys[47] => $this->getEwalletBefore(),
            $keys[48] => $this->getEwalletAfter(),
            $keys[49] => $this->getIpay(),
            $keys[50] => $this->getCheckportal(),
            $keys[51] => $this->getBprice(),
            $keys[52] => $this->getCancelDate(),
            $keys[53] => $this->getUidCancel(),
            $keys[54] => $this->getLocationbase(),
            $keys[55] => $this->getChkcommission(),
            $keys[56] => $this->getTxtcommission(),
            $keys[57] => $this->getOptioncommission(),
            $keys[58] => $this->getMbase(),
            $keys[59] => $this->getCrate(),
            $keys[60] => $this->getRcode(),
            $keys[61] => $this->getEcheck(),
            $keys[62] => $this->getCmbonus(),
        );
        ...
        if ($result[$keys[52]] instanceof \DateTimeInterface) {
            $result[$keys[52]] = $result[$keys[52]]->format('c');
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliEwalletCommission
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[24], $arr)) {
            $this->setChkwithdraw($arr[$keys[24]]);
        }
        if (array_key_exists($keys[25], $arr)) {
            $this->setChktransferIn($arr[$keys[25]]);
        }
        if (array_key_exists($keys[26], $arr)) {
            $this->setChktransferOut($arr[$keys[26]]);
        }
        if (array_key_exists($keys[27], $arr)) {
            $this->setTxtcash($arr[$keys[27]]);
        }
        if (array_key_exists($keys[28], $arr)) {
            $this->setTxtfuture($arr[$keys[28]]);
        }
        if (array_key_exists($keys[29], $arr)) {
            $this->setTxttransfer($arr[$keys[29]]);
        }
        if (array_key_exists($keys[30], $arr)) {
            $this->setTxtcredit1($arr[$keys[30]]);
        }
        if (array_key_exists($keys[31], $arr)) {
            $this->setTxtcredit2($arr[$keys[31]]);
        }
        if (array_key_exists($keys[32], $arr)) {
            $this->setTxtcredit3($arr[$keys[32]]);
        }
        if (array_key_exists($keys[33], $arr)) {
            $this->setTxtwithdraw($arr[$keys[33]]);
        }
        if (array_key_exists($keys[34], $arr)) {
            $this->setTxttransferIn($arr[$keys[34]]);
        }
        if (array_key_exists($keys[35], $arr)) {
            $this->setTxttransferOut($arr[$keys[35]]);
        }
        if (array_key_exists($keys[36], $arr)) {
            $this->setOptioncash($arr[$keys[36]]);
        }
        if (array_key_exists($keys[37], $arr)) {
            $this->setOptionfuture($arr[$keys[37]]);
        }
        if (array_key_exists($keys[38], $arr)) {
            $this->setOptiontransfer($arr[$keys[38]]);
        }
        if (array_key_exists($keys[39], $arr)) {
            $this->setOptioncredit1($arr[$keys[39]]);
        }
        if (array_key_exists($keys[40], $arr)) {
            $this->setOptioncredit2($arr[$keys[40]]);
        }
        if (array_key_exists($keys[41], $arr)) {
            $this->setOptioncredit3($arr[$keys[41]]);
        }
        if (array_key_exists($keys[42], $arr)) {
            $this->setOptionwithdraw($arr[$keys[42]]);
        }
        if (array_key_exists($keys[43], $arr)) {
            $this->setOptiontransferIn($arr[$keys[43]]);
        }
        if (array_key_exists($keys[44], $arr)) {
            $this->setOptiontransferOut($arr[$keys[44]]);
        }
        if (array_key_exists($keys[45], $arr)) {
            $this->setTxtoption($arr[$keys[45]]);
        }
        if (array_key_exists($keys[46], $arr)) {
            $this->setEwallet($arr[$keys[46]]);
        }
        if (array_key_exists($keys[47], $arr)) {
            $this->setEwalletBefore($arr[$keys[47]]);
        }
        if (array_key_exists($keys[48], $arr)) {
            $this->setEwalletAfter($arr[$keys[48]]);
        }
        if (array_key_exists($keys[49], $arr)) {
            $this->setIpay($arr[$keys[49]]);
        }
        if (array_key_exists($keys[50], $arr)) {
            $this->setCheckportal($arr[$keys[50]]);
        }
        if (array_key_exists($keys[51], $arr)) {
            $this->setBprice($arr[$keys[51]]);
        }
        if (array_key_exists($keys[52], $arr)) {
            $this->setCancelDate($arr[$keys[52]]);
        }
        if (array_key_exists($keys[53], $arr)) {
            $this->setUidCancel($arr[$keys[53]]);
        }
        if (array_key_exists($keys[54], $arr)) {
            $this->setLocationbase($arr[$keys[54]]);
        }
        if (array_key_exists($keys[55], $arr)) {
            $this->setChkcommission($arr[$keys[55]]);
        }
        if (array_key_exists($keys[56], $arr)) {
            $this->setTxtcommission($arr[$keys[56]]);
        }
        if (array_key_exists($keys[57], $arr)) {
            $this->setOptioncommission($arr[$keys[57]]);
        }
        if (array_key_exists($keys[58], $arr)) {
            $this->setMbase($arr[$keys[58]]);
        }
        if (array_key_exists($keys[59], $arr)) {
            $this->setCrate($arr[$keys[59]]);
        }
        if (array_key_exists($keys[60], $arr)) {
            $this->setRcode($arr[$keys[60]]);
        }
        if (array_key_exists($keys[61], $arr)) {
            $this->setEcheck($arr[$keys[61]]);
        }
        if (array_key_exists($keys[62], $arr)) {
            $this->setCmbonus($arr[$keys[62]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliEwalletCommission The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_SANO)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_SANO, $this->sano);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_SADATE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_SADATE, $this->sadate);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_INV_CODE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_INV_CODE, $this->inv_code);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_MCODE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_NAME_F)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_NAME_F, $this->name_f);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_NAME_T)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_NAME_T, $this->name_t);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TOTAL)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TOTAL, $this->total);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_USERCODE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_USERCODE, $this->usercode);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_REMARK)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_REMARK, $this->remark);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TRNF)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TRNF, $this->trnf);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_ID)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_SA_TYPE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_SA_TYPE, $this->sa_type);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_UID)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_UID, $this->uid);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_LID)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_LID, $this->lid);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_DL)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_DL, $this->dl);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CANCEL)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CANCEL, $this->cancel);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_SEND)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_SEND, $this->send);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTMONEY)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TXTMONEY, $this->txtmoney);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKCASH)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CHKCASH, $this->chkcash);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKFUTURE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CHKFUTURE, $this->chkfuture);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKTRANSFER)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CHKTRANSFER, $this->chktransfer);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKCREDIT1)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CHKCREDIT1, $this->chkcredit1);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKCREDIT2)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CHKCREDIT2, $this->chkcredit2);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKCREDIT3)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CHKCREDIT3, $this->chkcredit3);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKWITHDRAW)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CHKWITHDRAW, $this->chkwithdraw);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKTRANSFER_IN)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CHKTRANSFER_IN, $this->chktransfer_in);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKTRANSFER_OUT)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CHKTRANSFER_OUT, $this->chktransfer_out);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTCASH)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TXTCASH, $this->txtcash);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTFUTURE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TXTFUTURE, $this->txtfuture);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTTRANSFER)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TXTTRANSFER, $this->txttransfer);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTCREDIT1)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TXTCREDIT1, $this->txtcredit1);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTCREDIT2)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TXTCREDIT2, $this->txtcredit2);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTCREDIT3)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TXTCREDIT3, $this->txtcredit3);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTWITHDRAW)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TXTWITHDRAW, $this->txtwithdraw);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTTRANSFER_IN)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TXTTRANSFER_IN, $this->txttransfer_in);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTTRANSFER_OUT)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TXTTRANSFER_OUT, $this->txttransfer_out);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONCASH)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_OPTIONCASH, $this->optioncash);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONFUTURE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_OPTIONFUTURE, $this->optionfuture);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONTRANSFER)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_OPTIONTRANSFER, $this->optiontransfer);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONCREDIT1)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_OPTIONCREDIT1, $this->optioncredit1);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONCREDIT2)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_OPTIONCREDIT2, $this->optioncredit2);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONCREDIT3)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_OPTIONCREDIT3, $this->optioncredit3);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONWITHDRAW)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_OPTIONWITHDRAW, $this->optionwithdraw);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONTRANSFER_IN)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_OPTIONTRANSFER_IN, $this->optiontransfer_in);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONTRANSFER_OUT)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_OPTIONTRANSFER_OUT, $this->optiontransfer_out);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTOPTION)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TXTOPTION, $this->txtoption);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_EWALLET)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_EWALLET, $this->ewallet);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_EWALLET_BEFORE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_EWALLET_BEFORE, $this->ewallet_before);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_EWALLET_AFTER)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_EWALLET_AFTER, $this->ewallet_after);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_IPAY)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_IPAY, $this->ipay);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHECKPORTAL)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CHECKPORTAL, $this->checkportal);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_BPRICE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_BPRICE, $this->bprice);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CANCEL_DATE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CANCEL_DATE, $this->cancel_date);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_UID_CANCEL)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_UID_CANCEL, $this->uid_cancel);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_LOCATIONBASE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_LOCATIONBASE, $this->locationbase);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CHKCOMMISSION)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CHKCOMMISSION, $this->chkcommission);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_TXTCOMMISSION)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_TXTCOMMISSION, $this->txtcommission);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_OPTIONCOMMISSION)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_OPTIONCOMMISSION, $this->optioncommission);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_MBASE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_MBASE, $this->mbase);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CRATE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CRATE, $this->crate);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_RCODE)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_ECHECK)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_ECHECK, $this->echeck);
        }
        if ($this->isColumnModified(AliEwalletCommissionTableMap::COL_CMBONUS)) {
            $criteria->add(AliEwalletCommissionTableMap::COL_CMBONUS, $this->cmbonus);
        }
    ...
    {
        $criteria = ChildAliEwalletCommissionQuery::create();
        $criteria->add(AliEwalletCommissionTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliEwalletCommission (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCmbonus($this->getCmbonus());
        if ($makeNew) {
            $copyObj->setNew(true);
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliEwalletCommission Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliEwalletCommissionTableMap::DEFAULT_STRING_FORMAT);
    }
