...
//$pdf=new FPDF('P','mm','A4');
    ...
    for ($i = 0; $i < sizeof($bill); $i++) {
        ...
        for ($k = 0; $k < $npage; $k++) {
            ...
            $sql = "SELECT * FROM " . $dbprefix . "asaled WHERE sano='$bill[$i]' LIMIT " . $xpage[$k] . ", " . ($xpage[$k + 1] - $xpage[$k]) . "";
            $rs = mysql_query($sql);
            ...
            $pdf->Image('../logo.JPG', $offsetx + $offsettab - 10, $offsety + $offsetnline + 2, 30); //file,x,y,w=0,h=0
