...
$sql = "SELECT ".$dbprefix."product.pcode,".$dbprefix."product.pdesc,".$dbprefix."product.customer_price,".$dbprefix."product_invent.qty,".$dbprefix."product.pv,".$dbprefix."product.price as price,".$dbprefix."productgroup.groupname ";
