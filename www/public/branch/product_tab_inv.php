...
.ui-state-active a {color:#fff !important;}
  ...
  <div id="tabs">
    <ul>
		...
		<!--<li><a href="#tabs-2">สินค้า Promotion</a></li>
   --></ul>
	<div class="tab-border">
    <div id="tabs-1">
        <iframe width="580" height="605" frameborder="0" src="./product_show_inv.php" ></iframe>
    </div>	 <!--
    <div id="tabs-2">
       <iframe width="580" height="605" frameborder="0" src="./package_show_inv.php" ></iframe>
    </div>	-->
	</div>
