...
class chartGenerator{
    ...
    function multitree($mcode,$cm,$maxlv){
		...
		if($lrxx == '1'){$lr = "ซ้าย";}
		else if($lrxx == '2'){$lr = "ขวา";}
		else{$lr = "";}

		//if($lr == '1'){$lr = "ซ้าย";}
		//else if($lr == '2'){$lr = "ขวา";}
        
        $alt = "onmouseout=\"alt('')\" onmouseover=\"alt('<table><tr><td>ชื่อ<td> : </td></td><td>".$name_show."</td></tr><tr><td>PV สะสม</td><td> : </td><td>".number_format($scr->getAPV($mcode),0,'.',',')."</td></tr><tr><td>HPV</td><td> : </td><td>".number_format($sqlObj2->hpv,0,'.',',')."</td></tr><tr><td>ผู้แนะนำ<td> : </td></td><td>".$sqlObj2->sss."</td></tr><tr><td>ชื่อผู้แนะนำ<td> : </td></td><td>".$name_show1."</td></tr><tr><td>อัพไลน์<td> : </td></td><td>".$sqlObj2->upa."</td></tr><tr><td>ชื่ออัพไลน์<td> : </td></td><td>".$sqlObj2->upan."</td></tr><tr><td>ด้าน(อัพไลน์)</td><td> : </td><td>".$lr."</td></tr></table>')\"";
        if(mysql_num_rows($rs)<=0){
    ...
    //$stk_size = 0;
        ...
        if(mysql_result($rs,0,'sp_code')!=""){ //up arrow
            if($this->block==false){ 
                ...
                echo "alt='บน ".$this->upMost($xsp_code)."' \>";
