...
<form method="post" action="ewallet_operate_new.php?state=<?=$_GET['id']==""?0:1?>" name="frm" onsubmit="return checkFormsubmit(this)" >
  <table border="0">
  <tr valign="top">
    <td> 
                            ...
                            if(count($payment)){    
                             ...
                             <tr>
                              <td  align=center><input type="checkbox" name="chk<?=$payment[0]['payment_column']?>" id="chk<?=$payment[0]['payment_column']?>" onClick="caltotal(this.value,'txt<?=$payment[0]['payment_column']?>','chk<?=$payment[0]['payment_column']?>')"></td>
                               ...
                               <td  align=right><input type='number'  step="0.01" value="0" style="width: 62px;text-align:right;" onkeypress='checkinForm();' name="txt<?=$payment[0]['payment_column']?>" id="txt<?=$payment[0]['payment_column']?>" ></td>  
                               <td>
