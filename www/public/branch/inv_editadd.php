...
var wi=null;
	...
	function get_mem_listpicker_invcode(){
		if (wi) wi.close();
		//alert(this.getElementById('mcode_acc_name').innerHTML);
		wi=window.open("stockist_listpicker.php","list_picker_window","menubar=no,width=500,height=600,toolbar=no,scrollbars=1");
	}
	function cal(){
...
เลือกรูปแบบการซื้อ                  </option>                <option  value="I" <?=($satype=="T"?"selected":"")?>>
            ...
            <td width="40%"><input type="text" id="sadate" name="sadate" value="<?=$sadate==""?$_SESSION["datetimezone"]:$sadate?>">
            ...
            <tr valign="top">
              ...
              <td nowrap="nowrap"><input type="radio" name="radsend" id="radsend" value="1"  onClick="document.getElementById('inv_ref').disabled = true;document.getElementById('ccheckr').value = '1';document.getElementById('inv_ref').value = '';" <?=($radsend=="1"?"checked":"")?>>
&#3592;&#3633;&#3604;&#3626;&#3656;&#3591;
<input type="radio" name="radsend" id="radsend" value="2"   onClick="document.getElementById('inv_ref').disabled = false;document.getElementById('ccheckr').value = '2';document.getElementById('inv_ref').value='<?=$_SESSION["admininvent"]?>';"  <?=($radsend=="2"?"checked":"")?> >
&#3652;&#3617;&#3656;&#3592;&#3633;&#3604;&#3626;&#3656;&#3591; <br></td>
            </tr>
            <tr valign="top">
              <td width="16%" align="right">&nbsp;</td>
              <td><div id="inv_desc"></div></td>
              <td align="right" valign="top" nowrap="nowrap">&nbsp;รับที่สาขา</td>
              <td nowrap="nowrap">
<select name="inv_ref" id="inv_ref"  disabled="disabled">
<option value="">Main Branch</option>
        <?					
						$result1=mysql_query("select * from ".$dbprefix."invent where inv_code = '".$_SESSION["admininvent"]."' order by inv_code");
...
Voucher</td>
    ...
    <td>    สินค้า
      <iframe width="600" height="400" frameborder="0" src="./product_show_inv.php" ></iframe>
	<br><Br>
    แพคเก็จ<iframe width="600" height="200" frameborder="0" src="./package_show_inv.php" ></iframe></td>
  </tr>
</table>
  <br>
</form>
  ...
  <input  type="hidden" id="cvoucher" name="cvoucher" value="0">
