...
.ui-state-active a {color:#fff !important;}
  ...
  <div id="tabs">
    ...
    <div id="tabs-1"> 
        <iframe width="580" height="900" frameborder="0" src="../cart/product_show_branch.php" ></iframe>
    </div>  
	<div id="tabs-2">
       <iframe width="580" height="605" frameborder="0" src="../cart/package_show_branch.php" ></iframe>
    </div>	
    </div>
