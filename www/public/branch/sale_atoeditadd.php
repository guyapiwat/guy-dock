...
?>
<form method="post" action="atoasaleoperate.php?state=<?=$_GET['id']==""?0:1?>" id="frm" name="frm"  onsubmit="return checkForm(this)" onKeyDown="document.getElementById('ok').disabled=true;" >
  <table border="0">
  <tr valign="top">
    <td>
    <table width="600" border="0">
      <tr valign="top">
        <td>
            ...
            <input name="button2" type="button" onClick="sendget_sponsor(document.getElementById('mcode').value)" value="ตรวจสอบ" />   <!-- <input name="button2" type="button" onclick="sendget_sponsor(document.getElementById('mcode').value)" value="ค้น" />
<input type="button" onClick="get_mem_listpicker_mcode()" value="เลือก">--><div id="mname"></div> </td>
              <td align="right">&nbsp;</td>
              <td><input style="background-color:#FFFF99;display:none;" size="15" readonly="" type="text" id="inv_code" name="inv_code" value="<?=$inv_code?>">
            ...
            <tr valign="top">
              <td align="right">&#3619;&#3641;&#3611;&#3649;&#3610;&#3610;&#3585;&#3634;&#3619;&#3595;&#3639;&#3657;&#3629;&nbsp;</td>
      ...
      <tr>
        ...
        <? 
		if(!empty($_GET['id'])){
			$sql = "SELECT * FROM ".$dbprefix."atoasaled WHERE sano='".$_GET['id']."' ";
			$rs = mysql_query($sql);
			if(mysql_num_rows($rs)>0){
    ...
    <td><iframe width="400" height="200" frameborder="0" src="./package_show_ato.php" ></iframe></td></tr>
</table>
</form>
