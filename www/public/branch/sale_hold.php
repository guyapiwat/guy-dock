...
$sql .= "LEFT JOIN ".$dbprefix."member ON (".$dbprefix."asaleh.mcode=".$dbprefix."member.mcode) WHERE sa_type='H' and ".$dbprefix."asaleh.inv_code = '".$_SESSION['adminusercode']."' "; //WHERE smcode='".$_SESSION['usercode']."' 
//echo $sql;
//$wherecause = " WHERE ";
	...
	if($_GET['state']==1){
		...
		if(isset($page))
			$rec->setCurPage($page);
		$rec->setShowField("sano,smcode,name_t,sadate,tot_pv,total");
