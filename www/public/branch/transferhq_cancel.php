...
require_once ("function.log.inc.php");
	$bid = $_GET['bid'];
	$sql = "UPDATE ".$dbprefix."tsaleh SET cancel='1',cancel_date='".date('Y-m-d')."',uid_cancel='".$_SESSION["inv_usercode"]."' WHERE id='$bid' ";
	//====================LOG===========================
$text="uid=".$_SESSION["inv_usercode"]." action=tsale_cancel=>$sql";
writelogfile($text);
//=================END LOG===========================
	//echo $sql;
	mysql_query($sql);
