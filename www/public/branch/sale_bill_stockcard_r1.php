...
if($_GET['print_all']==true){
	...
	exit;
		...
		if(isset($page))
			$rec->setCurPage($page);
		$rec->setShowField("sadate,mcode,name,inv_code,inv_ref,inv_action,sano,pcode123,in_qty,out_qty,in_price,in_amount,yokma,balance,out_price,out_amount,type");
		if($acc->isAccess(4)){
