...
if($_GET['state']==0){
	...
	$sql="insert into ".$dbprefix."cround (rcode,  rdate, fdate,  tdate,paydate,  calc,remark,fpdate,  tpdate,cstatus) values ('$rcode' ,'$rdate' ,'$fdate' ,'$tdate' ,'$paydate' ,'$calc' ,'$remark' ,'$fdate' ,'$tdate','$cstatus') ";
	if (! mysql_query($sql)) {
