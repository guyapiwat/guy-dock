<script language="javascript" type="text/javascript">
	...
	//	if(confirm("Re Confirm?")){
			window.location='index.php?sessiontab=6&sub=36&ftrcode='+rcode;
	//	}
	}
</script><?
...
//$wherecause = " WHERE ";
	...
	if($_GET['state']==1){
		...
		$rec->setLink($PHP_SELF,"sessiontab=6&sub=25");
		...
		$rec->setFieldDesc($wording_lan["supervisor_28"].",".$wording_lan["supervisor_29"].",".$wording_lan["supervisor_30"].",".$wording_lan["supervisor_31"].",".$wording_lan["supervisor_32"].",".$wording_lan["supervisor_33"].",".$wording_lan["supervisor_34"].",".$wording_lan["supervisor_35"].",".$wording_lan["supervisor_36"]);
...
//		$rec->setFieldLink("index.php?sessiontab=6&sub=6&cmc=,");
		if($acc->isAccess(8)){
			$rec->setDel("index.php","rid","rid","sessiontab=6&sub=25");
			$rec->setFromDelAttr("maindel","./index.php?sessiontab=6&sub=25&state=1","post","delfield");
		}
	//	$rec->setSpecial("Calculate","","sale_status","rcode","","Calculate");
	///	$rec->setSpecial("รายงาน","","sale_status1","rcode","","รายงาน");
	//	if($acc->isAccess(2))
	//		$rec->setEdit("index.php","rid","rid","sessiontab=6&sub=25");
