...
//exit;
		...
		$rec->setLink($PHP_SELF,"sessiontab=6&sub=48f&ftrcode=$ftrcode&fmcode=$fmcode");
...
$rec->setFieldDesc($wording_lan["word"]["no."].",".$wording_lan["mcode"].",".$wording_lan["supervisor_56"].",".$wording_lan["acc_no"].",".$wording_lan["supervisor_53"].",".$wording_lan["Bill_7"].",".$wording_lan["word"]["id_tax"].",".$wording_lan["supervisor_54"].",".$wording_lan["supervisor_55"] .",".$wording_lan["word"]["email"].",".$wording_lan["word"]["mobile"].",".$wording_lan["bankcode"].",".$wording_lan["supervisor_57"].",".$wording_lan["supervisor_58"] .",".$wording_lan["supervisor_59"].",".$wording_lan["supervisor_60"].",".$wording_lan["Report_13"]);
...
<table width="50%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF7F00" align="center">
  <tr>
    <td colspan="2" align="center"><a href="index.php?sessiontab=6&sub=38" target="_blank"><?=$wording_lan["supervisor_52"]?></a></td>
  </tr>
  <tr>
