...
if($fdate){
       ...
       $rec->setShowField("sano,smcode,name_t,ability,sadate,tot_pv,total,total_net,total_vat".$colome.",uid,inv_ref,checkportal1,send,scheck");
        $rec->setFieldDesc("เลขบิล,รหัสผู้ซื้อ,ชื่อผู้ซื้อ,ประเภทบิล,วันที่ซื้อ,PV,ยอดขาย,ยอดขายก่อน&nbsp;Vat,Vat".$colome_text.",ผู้บันทึก,สาขา,ช่องทาง,จัดส่ง,ประเภท");
        ...
        if($_SESSION["admininvent"] == $GLOBALS["main_inv_code"])$rec->setSpecial("./images/Amber-Printer.gif","","sale_print","sano","IMAGE","พิมพ์");
