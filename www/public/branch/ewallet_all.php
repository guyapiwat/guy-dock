...
$sql .= " FROM ".$dbprefix."ewallet ewa where  locationbase = '".$_SESSION["inv_locationbase"]."' and txtTransfer_out = 0 and txtTransfer_in = 0 and txtWithdraw = 0 and sa_type <> 'TI' and sa_type <> 'TO' and sa_type <> 'CI'  and sa_type <> 'T' and sa_type <> 'W' ";
