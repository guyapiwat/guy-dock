...
if(isset($_POST["fdate"]))
		...
		$fdate = $_GET["fdate"];
$sql = "SELECT '".$_GET["sessiontab"]."' as sessiontab,'".$_GET["sub"]."' as sub,'".$_GET["chktype"]."' as chktype,".$dbprefix."isaleh.uid_receive,".$dbprefix."isaleh.uid_sender,'".$page."' as page,cancel,print,".$dbprefix."isaleh.id,".$dbprefix."isaleh.sender,".$dbprefix."isaleh.sender_date,".$dbprefix."isaleh.inv_code,".$dbprefix."isaleh.tot_pv/100 as discount,total+".$dbprefix."isaleh.tot_pv/100 as alltotal,sano,sadate,tot_pv,tot_bv,tot_fv,total,".$dbprefix."isaleh.mcode AS smcode ";
...
//echo $sql;
	...
	if($_GET['state']==1){
		...
		$rec->setShowField("sadate,sano,inv_code,inv_code,address123,mobile,tot_pv,total,sender1,receive1,remark,uid_sender,uid_receive,checkportal");
