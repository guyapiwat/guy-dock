...
if($radsend == '1' and $GLOBALS["sending"] == '1' ){
	$arr_sending = array();
	$arr_sending = searchsending($dbprefix,$_SESSION["inv_locationbase"],$stype,$sumpv,$tot_weight);
...
'.' '."<font color=#FF0000><b>ราคารวม $sumtotal บาท  PV รวม $tot_pv   น้ำหนักรวม $tot_weight1 กิโลกรัม    ค่าจัดส่ง $shipping บาท  " ;
if($_SESSION["ajaxcharge"]>0)$sss .= " Charge $shipping ";
$sss .= " ยอดรวมใหม่  $priceprice </b></font>";
