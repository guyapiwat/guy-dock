          ...
          if (req.readyState==4) {
               if (req.status==200) { //ได้รับการตอบกลับเรียบร้อย
				...
				//	alert(req.responseText);
					...
					//	alert(data);
						 document.getElementById("zip_1").value=data; //แสดงผล
					}
               }
          }
     };
     ...
     req.onreadystatechange = function() { //เหตุการณ์เมื่อมีการตอบกลับ
          if (req.readyState==4) {
               if (req.status==200) { //ได้รับการตอบกลับเรียบร้อย
					...
					//alert(data);
					if(data.tirm == 1234){
						 document.getElementById("czip_1").value.trim()=''; //แสดงผล
					}else{
					//alert(data);
						 document.getElementById("czip_1").value=data; //แสดงผล
					}
               }
          }
     };
...
<form name='frm' method="post" onKeyDown="document.getElementById('ok').disabled=true;" action="memoperate1.php?state=<?=$_GET['id']==""?0:1?>"  onsubmit="return checkForm(this)"  enctype="multipart/form-data">
...
<table width="100%" border="0" >
  <tr bgcolor="#FFCC33"  >
    ...
    <td colspan="2" align="center"><b>&#3586;&#3657;&#3629;&#3617;&#3641;&#3621;&#3629;&#3633;&#3614;&#3652;&#3621;&#3609;&#3660;</b></td>
  </tr>
  <tr <? //if(empty($_GET["id"])){echo'style="display:none';}?>>
	 <td colspan="2">วันที่สมัคร

      <input style="background-color:#CCCCCC" type="text" id="" tabindex="1" name="mdate" size="10" maxlength="10"  readonly  value="<?=($mdate==""?date("Y-m-d"):$mdate)?>" />
  ...
  <tr>
    ...
    <td width="34%"><input tabindex="2" style="background-color:#CCCCCC" type="text" name="sp_code" id="sp_code" size="20"  maxlength="20" readonly value="<?=$sp_code?>" />
          <input name="button2" disabled  id="upa_code_check" tabindex="3" type="button" onClick="sendget_sponsor(document.getElementById('sp_code').value)" value="ตรวจ" />
          <input name="button2" disabled  tabindex="4" type="button" onClick="document.getElementById('ok').disabled=true;get_mem_listpicker_sp_code()" value="เลือก" />
          <input name="button2" disabled  tabindex="5" type="button" onClick="document.getElementById('sp_code').value='';document.getElementById('sp_name').value='';" value="ลบ" />          </td>
    <td width="14%" align="right">รหัสอัพไลน์<font color="#ff0000">*</font></td>
    <td width="40%"><input style="background-color:#CCCCCC" readonly  tabindex="6"  type="text" name="upa_code"  id="upa_code" size="20"  maxlength="20" value="<?=$upa_code?>" />
    <input name="button2"  tabindex="7" type="button" disabled onClick="sendget_sponsor1(document.getElementById('upa_code').value,document.getElementById('sp_code').value)" value="ตรวจ" />
      <input name="button3" disabled  tabindex="8" type="button" onClick="document.getElementById('ok').disabled=true;get_mem_listpicker_upa_code()" value="เลือก" />
      <input name="button2" disabled tabindex="9" type="button" onClick="document.getElementById('upa_code').value='';document.getElementById('upa_name').value='';" value="ลบ" />      </td>
  </tr>
  <tr  >
  ...
  <tr  >
    ...
    <td><!--<?
					...
					for($i=0;$i<mysql_num_rows($rs);$i++){
						?>
      <input disabled tabindex="10" onClick="document.getElementById('ok').disabled=true;" type="radio" name="lr" id="lr"  <?=$lr==mysql_result($rs,$i,'lr_id')?"checked":""?> value="<?=mysql_result($rs,$i,'lr_id')?>" />
...
<table width="100%" border="0">
  ...
  <tr bgcolor="#FFCC33">
    <td colspan="2" align="center"><b>&#3586;&#3657;&#3629;&#3617;&#3641;&#3621;&#3629;&#3639;&#3656;&#3609;&#3654;</b></td>
  ...
  &#3610;&#3633;&#3605;&#3619;&#3648;&#3588;&#3619;&#3604;&#3636;&#3605;</td>
     <td colspan="2" rowspan="3" align="right"><table width="100%">
       <tr >
  ...
  &#3651;&#3610;&#3626;&#3617;&#3633;&#3588;&#3619;
  <input type="text" id="dateInput1" name="bmdate3" size="10" maxlength="10"  tabindex="73" value="<?=$bmdate3?>" /><br>
...
สำเนาบัตรประชาชนผู้สมัครร่วม
  <input type="text" id="dateInput4" name="cbmdate1" size="10" maxlength="10" tabindex="79" value="<?=$cbmdate1?>" /> <br>
  <br></td>
        </tr>
     </table></td>
   </tr>
