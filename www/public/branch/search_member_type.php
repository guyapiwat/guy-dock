...
if(!empty($value)){
  $sql = "SELECT cname,ewallet,voucher,mdate,pos_cur,mtype1,pos_cur2,name_t,name_f,mcode,caddress,cbuilding,cvillage,csoi,cstreet,czip,cprovinceId,cdistrictId,camphurId ";
