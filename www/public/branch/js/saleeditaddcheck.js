	...
	function autostartRQ(fieldcheck,fieldval,fieldskip,fieldarg,fielddesc,tb,panel,panel2,codeid){
		...
		autocreateRQ();
			pPanel = panel;
			nPanel = panel2;
		page = "saleeditaddcheck.php?fchk="+encodeURIComponent(fieldcheck)+"&farg="+encodeURIComponent(fieldarg)+"&fval="+encodeURIComponent(fieldval)+"&fskip="+encodeURIComponent(fieldskip)+"&fdesc="+encodeURIComponent(fielddesc)+"&tb="+tb+"&nchk="+encodeURIComponent(codeid);
		//alert(page);
