...
<script language="javascript" type="text/javascript">
	function saleadd(pcode,pdesc,price,pv,bv,fv,qty){
		...
		//alert(tag.length)
			...
			place += "<td style='"+style_l+style_bd+"' align='right'><input onKeyPress='return chknum(window.event.keyCode)' onkeyup='cal()' name='qty[]' style='text-align:right;' type='text' size='5' value='1'	></td>";
		...
		place += "</tr>";
		place += "<tr><td colspan='9' align='right'><input name='button' type='button' onclick='<?=(isset($_GET['id'])?"ebillcheck()":"ibillcheck()")?>' value='ตรวจสอบ' />&nbsp;<input type='submit' value='บันทึก' name='ok' id='ok'  disabled='disabled' />&nbsp;<input name='reset' type='reset'  onclick=\"window.location='index.php?sessiontab=3&sub=139'\" value='ยกเลิก' /></td></tr>";
		place += "</table>";
