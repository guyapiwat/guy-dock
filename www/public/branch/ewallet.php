...
//echo $where_bills;
rpdialog_sale_ewallet($_GET['sub'],$fdate,$tdate,$sale,$xinv_code);
?>
...
$sql = "SELECT cancel,ewa.id,ewa.uid,ewa.lid as lid,sano,concat(ewa.name_f,' ',ewa.name_t) as name_t,ewa.remark as remark,sadate,txtMoney ";
$sql .= $sqlx;
$sql .= ",CASE ewa.mcode WHEN '' THEN ewa.inv_code  ELSE ewa.mcode END AS smcode ";
$sql .= " FROM ".$dbprefix."ewallet ewa";
$sql .= " where ewa.lid  = '{$_SESSION["admininvent"]}' and txtTransfer_out = 0 and txtTransfer_in = 0 and sa_type <> 'TI' and sa_type <> 'TO' and sa_type <> 'CI' and sa_type <> 'T' and sa_type <> 'W' "; 
if(!empty($sale)){
