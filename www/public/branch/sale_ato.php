...
$sql .= "LEFT JOIN ".$dbprefix."member ON (".$dbprefix."atoasaleh.mcode=".$dbprefix."member.mcode) where ".$dbprefix."atoasaleh.inv_code = '".$_SESSION["admininvent"]."' "; //WHERE smcode='".$_SESSION['usercode']."' 
//echo $sql;
