...
$sql = "SELECT * FROM ".$dbprefix."product_package where bf = 1  and locationbase = '".$_SESSION["inv_locationbase"]."' and sa_type = 'A' ";
...
if(isset($page))
	$rec->setCurPage($page);
$rec->setShowField("pcode,pdesc,customer_price,price,qty,pv");
