...
<script language="javascript" type="text/javascript">
    function sale_print(id){
       // var wlink = 'invoice_eatoship.php?bid='+id;
 		var wlink = '../invoice/eaprint_sale_branch.php?bid='+id;
...
$sql = "SELECT cancel,".$dbprefix."eatoship.id,".$dbprefix."eatoship.lid as lid,sano,txtCash,txtFuture,txtTransfer,txtCredit1+txtCredit2+txtCredit3 as txtCredit,sadate,txtMoney ,concat(".$dbprefix."eatoship.name_f,' ',".$dbprefix."eatoship.name_t) as name_t ";
...
$sql .= " where ".$dbprefix."eatoship.lid  = '{$_SESSION["admininvent"]}' and ".$dbprefix."eatoship.sa_type ='I' "; 
if(!empty($sale)){
    if($sale=='A')$sale = 0;
$sql .= " and cancel = '$sale' ";
}
...
//$wherecause = " WHERE ";
    ...
    if($_GET['state']==1){
        ...
        $rec->setShowField("sadate,sano,smcode,name_t,txtMoney,txtCash,txtTransfer,txtCredit,lid");
        ...
        $rec->setSearch("sadate,sano,".$dbprefix."eatoship.mcode,name_t,txtMoney,txtCash,txtTransfer,lid");
