...
$xinv_code = $_SESSION["admininvent"];
...
$sql = "SELECT ".$dbprefix."asaleh.ref,".$dbprefix."asaleh.inv_code,cancel,print,".$dbprefix."asaleh.id,sano,DATE_FORMAT(sadate, '%Y-%m-%d') as sadate 
...
$sql .= " where   ".$dbprefix."asaleh.lid = '{$_SESSION["admininvent"]}'  "; //WHERE smcode='".$_SESSION['usercode']."'
...
//echo $sql;
	...
	//	$rec->setFieldDesc("P,วันที่ซื้อ,เลขบิล,รหัสผู้ซื้อ,ชื่อผู้ซื้อ,ชนิด, PV,จำนวนเงิน,ผู้คีย์,จัดส่ง,วันจัดส่ง,วันรับของ,อ้างอิง,รับของสาขา");
		$rec->setFieldDesc("P,".$wording_lan["Bill_1"].",".$wording_lan["Bill_2"].",".$wording_lan["Bill_3"].",".$wording_lan["Bill_4"].",".$wording_lan["Bill_5"].",".$wording_lan["Bill_6"].",".$wording_lan["Bill_7"].",".$wording_lan["Bill_8"].",".$wording_lan["Bill_9"].",".$wording_lan["Bill_10"].",".$wording_lan["Bill_11"].",".$wording_lan["Bill_14"].",หมายเหตุ");
