...
if($fdate != ''){
	...
	$sql  = "SELECT r.inv_code,r.pcode,r.sadate,r.in_qty,r.out_qty,r.qty,IFNULL((SELECT rr.qty FROM ali_product_invent_log_r rr WHERE rr.sadate = DATE_ADD(r.sadate, INTERVAL - 1 DAY) and rr.inv_code = r.inv_code and rr.pcode = r.pcode LIMIT 0,1 ";
	$sql .= "),0) as qty_before, p.pdesc as pdesc FROM ali_product_invent_log_r r ";
