...
function selectitem(inv_code,inv_desc,ewallet){
		doc= window.opener.document;
		//alert(document.listform.idx.value);
		doc.frm.inv_code.value=inv_code;
		doc.getElementById('inv_desc').innerHTML=inv_desc+' ( Ewallet : '+ewallet+' )';
	 	window.close();
}
</script>
...
<link href="./../style.css" rel="stylesheet" type="text/css">
<title>Stokist</title>
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center"><tr><td><fieldset><legend><strong><font color="#666666">Stokist</font></strong></legend>
<?
require("connectmysql.php");
require("./cls/repGenerator.php");
require("prefix.php");
if (isset($_GET["pg"])){$page=$_GET["pg"];} else {$page="1";}
$sql = "SELECT inv_code,inv_desc,'Stockist' AS inv_type,ewallet FROM ".$dbprefix."invent where inv_type = 2";
//$wherecause = " WHERE ";
	...
	if($_GET['state']==1){
		...
		$rec->setSearchDesc("รหัสStockist,ชื่อ Stockist");
		...
		$rec->setSpecial("./images/add_pic.gif","","selectitem","inv_code,inv_desc,ewallet","IMAGE","");
