...
echo "<script language='JavaScript'>window.location='index.php?sessiontab=5&sub=16&state=2'</script>";
exit;
}
...
if($_GET['state']==0){
	...
	'$txtTransfer','$txtCredit1','$txtCredit2','$txtCredit3','$txtInternet','$txtDiscount','$txtOther','$optionCash','$optionFuture','$optionTransfer','$optionCredit1','$optionCredit2','$optionCredit3','$optionInternet','$optionDiscount','$optionOther','3','".$arr_invent["locationbase"]."','".$barr_invent["crate"]."','$bprice','".$arr_invent["locationbase"]."') ";
...
//=================END LOG===========================
	...
	//$object_stocks->set_data($mid,"isale","receive","2"); 
...
$_SESSION["perbuy"] = 0;
echo "<script language='JavaScript'>window.location='index.php?sessiontab=5&sub=16'</script>";	
