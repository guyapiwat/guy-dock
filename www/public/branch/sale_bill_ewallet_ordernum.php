...
$sql .= "LEFT JOIN ".$dbprefix."invent ON (".$dbprefix."ewallet.inv_code=".$dbprefix."invent.inv_code) where cancel = 0 and txtTransfer_out = 0 and txtTransfer_in = 0 "; 
...
if($strtotal !=""){
	$strtot=explode('-',$strtotal);
	if(is_numeric($strtot[0]) and is_numeric($strtot[1])){
	 $sql .= " and  a.txtMoney >= ".$strtot[0]." and a.txtMoney <= ".$strtot[1]." ";
	}
}
if($struid !=""){
