...
$sql .= "LEFT JOIN ".$dbprefix."member ON (".$dbprefix."billhd.mcode=".$dbprefix."member.mcode) WHERE trf='0' "; //WHERE smcode='".$_SESSION['usercode']."' 
//echo $sql;
//$wherecause = " WHERE ";
	...
	if($_GET['state']==1){
		...
		if($acc->isAccess(2))
		$rec->setEdit("index.php","sano","sano","sessiontab=3&sub=3&state=2");
