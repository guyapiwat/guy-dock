...
<table style="margin-left:20;" width="562" border="0">
  <tr valign="top"><td width="600" align="center" ><fieldset>
	...
	<a href="javascript:NewCal('tdate','yyyymmdd',false,24)"><img src="./datetimepick/images/cal.gif" width="16" height="16" border="0" alt="เลือกวันที่" /></a> รหัสสาขา : <input type="text" name="inv_code" value="<?=$_SESSION["admininvent"];?>" readonly>
