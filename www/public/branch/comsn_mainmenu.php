...
<table width="98%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td  valign="top" colspan="2"><FONT SIZE="+2" ><B><?=$wording_lan["tab2_report_01"]?></B></FONT><br />
	      <br /></td>
	</tr>
	<tr>
		<td width="50%" valign="top"><table width="90%" border="1" bordercolor="#0099CC" cellSpacing="0" cellPadding="0" >
          <tr>
          ...
          <tr>
            ...
            <td width="84%"><FONT SIZE="+2" ><B>
              <?=$wording_lan["tab2_report_01"]?>
            </B></FONT></td>
          </tr>

          <tr>
            <td align="right">&nbsp;</td>
            <td><img src="./images/9_41_s.gif" align="absmiddle" />&nbsp;&nbsp;<a href="./index.php?sessiontab=<?=$sesstab?>&sub=8"><?=$wording_lan["tab2_report_02"]?></a></td>
          </tr>
          <tr>
            <td align="right">&nbsp;</td>
            <td><img src="./images/9_41_s.gif" align="absmiddle" />&nbsp;&nbsp;<a href="./index.php?sessiontab=<?=$sesstab?>&sub=17"><?=$wording_lan["tab2_report_03"]?></a></td>
          </tr>
		  <tr>
            <td align="right">&nbsp;</td>
            <td><img src="./images/9_41_s.gif" align="absmiddle" />&nbsp;&nbsp;<a href="./index.php?sessiontab=<?=$sesstab?>&sub=188"><?=$wording_lan["tab2_report_08"]?>
            </a></td>
            </tr>
          <tr>
            <td align="right">&nbsp;</td>
            <td><img src="./images/9_41_s.gif" align="absmiddle" />&nbsp;&nbsp;<a href="./index.php?sessiontab=<?=$sesstab?>&sub=18"><?=$wording_lan["tab2_report_04"]?>
            </a></td>
            </tr>
		 <tr style="display:none">
            <td align="right">&nbsp;</td>
            <td><img src="./images/9_41_s.gif" align="absmiddle" />&nbsp;&nbsp;<a  target="_blank"  href="./sell_print_uidp.php"><?=$wording_lan["tab2_report_06"]?>
            </a></td>
            </tr>
			<tr style="display:none">
            <td align="right">&nbsp;</td>
            <td><img src="./images/9_41_s.gif" align="absmiddle" />&nbsp;&nbsp;<a  target="_blank"  href="./sell_print_uidp_e.php"><?=$wording_lan["tab2_report_07"]?>
            </a></td>
            </tr>
            <!--   <tr>
            <td align="right">&nbsp;</td>
            <td><img src="./images/9_41_s.gif" align="absmiddle" />&nbsp;&nbsp;<a href="./sell_print_uidp.php" target="_blank"><?=$wording_lan["tab2_report_06"]?></a></td>
          </tr>
...
<?
		...
		switch($_GET['sub']){
			...
			case 8:
				?>
				<legend>
       			    <strong><font color="#666666"><?=$wording_lan["tab2_report_05"]?></font></strong>
                </legend>
				<?
		...
		<legend>
			...
			case 17:
				?>
				<legend>
       			    <strong><font color="#666666"><?=$wording_lan["tab2_report_46"]?></font></strong>
                </legend>
				<?
			...
			case 18:
				?>
				<legend>
       			    <strong><font color="#666666"><?=$wording_lan["tab2_report_04"]?></font></strong>
                </legend>
				<?
			...
			case 188:
				?>
				<legend>
       			    <strong><font color="#666666"><?=$wording_lan["tab2_report_08"]?></font></strong>
                </legend>
				<?
				include("sale_bill_eautoship.php");
				break;
			case 65:
				?>
				<legend>
			...
			case 115:
				?>
				<legend>
       			    <strong><font color="#666666"><?=$wording_lan["extendyear"]?></font></strong>
                <br>
				</legend>
                <?
				include("extend.php");
