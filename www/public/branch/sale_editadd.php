...
var wait_time=500;  // กำหนดเวลานับถอยหลัง เป็นวินาที  
     ...
     req.onreadystatechange = function() { //เหตุการณ์เมื่อมีการตอบกลับ
          if (req.readyState==4) {
               if (req.status==200) { //ได้รับการตอบกลับเรียบร้อย
					...
					//	alert('ไม่รักษายอด');
					if(strUser == 'C'){
							alert("คุณได้รักษายอดไปแล้ว กรุณาเลือกแผนใหม่");
...
var wi=null;
	...
	function saledel(pcode,pdesc,price,pv,bv,fv){
		...
		for(i=0;i<(tag.length-skip)/13;i++,l++){
			...
			//alert(num);
			place += "<td style='"+style_l+style_bd+"' align='right'><input style='text-align:right;' name='qty[]'  onkeyup='cal()' type='text' size='5' value='" + num + "' onKeyPress='return chknum(window.event.keyCode)' onChange=\"if(this.value == '' || this.value.substring(0,1) == '0'){alert('ไม่สามารถใส่ค่า 0 หรือ ช่องว่างได้');this.value=1;cal();}\" ></td>";
...
?>
<form method="post" action="saleoperate.php?state=<?=$_GET['id']==""?0:1?>" name="frm" id="frm" onSubmit="return checkForm(this)" onKeyDown="document.getElementById('ok').disabled=true;" >
  <table border="0">
  <tr valign="top">
    <td>
    <table width="600" border="0">
        ...
        <td>
            ...
            <tr valign="top">
              ...
              <td><input style="background-color:#FFFF99"  size="15" type="text" id="mcode" name="mcode" value="<?=$mcode?>">
                <input name="button2" type="button" onClick="sendget_sponsor(document.getElementById('mcode').value)" value="ค้น" />                <div id="mname"></div> </td>
	  ...
	  <tr><td><div id="checkstate" align="center"></div>  </td></tr>
              ...
              <option value="I" <?=($satype=="I"?"selected":"")?>>ส่งศูนย์</option>
                ...
                <td>รายละเอียด </td>
                <td><input name="optionCash" type="text" value="<?=$optionCash?>" size="50" >
                </td>
              </tr>
              <tr valign="top">
              <td><!--<select name="satype">
              ...
              <td>รายละเอียด</td>
               <td><input name="optionFuture"   value="<?=$optionFuture?>" type="text" size="50" ></td>
              </tr>
               <tr valign="top">
              <td><!--<select name="satype">
                <option  value="A" <?=($satype=="A"?"selected":"")?>>แผน A</option>
              ...
              <td>รายละเอียด</td>
               <td><input name="optionTransfer"   value="<?=$optionTransfer?>" type="text" size="50" ></td>
              </tr>
               <tr valign="top">
              <td><!--<select name="satype">
                <option  value="A" <?=($satype=="A"?"selected":"")?>>แผน A</option>
              ...
              <td>รายละเอียด</td>
               <td><input name="optionCredit1"   value="<?=$optionCredit1?>" type="text" size="50" ></td>
              </tr>
               <tr valign="top">
              <td><!--<select name="satype">
                <option  value="A" <?=($satype=="A"?"selected":"")?>>แผน A</option>
              ...
              <td>รายละเอียด</td>
               <td><input name="optionCredit2"   value="<?=$optionCredit2?>" type="text" size="50" ></td>
              </tr>
               <tr valign="top">
              <td>
              ...
              <td>รายละเอียด</td>
               <td><input name="optionCredit3"   value="<?=$optionCredit3?>" type="text" size="50" ></td>
              </tr>
              <tr valign="top" style="display:none">
              <td>
                <input type="checkbox" name="chkInternet" <?=($chkInternet=="on"?"checked":"")?>>
                Ewallet</td>
              <td><input type="text" name="txtInternet" size="10"  value="<?=$txtInternet?>"></td>
              <td>รายละเอียด</td>
               <td><input name="optionInternet"   value="<?=$optionInternet?>" type="text" size="50" ></td>
              </tr>
              <tr valign="top">
              <td>
              ...
              <td>รายละเอียด</td>
               <td><input name="optionDiscount"   value="<?=$optionDiscount?>" type="text" size="50" ></td>
              </tr>
                <tr valign="top">
              <td>
              ...
              <td>รายละเอียด</td>
               <td><input name="optionOther"   value="<?=$optionOther?>" type="text" size="50" ></td>
              </tr>
              </table><Br>
              หมายเหตุ : <br>
    ...
    <td><iframe width="400" height="300" frameborder="0" src="./product_show_sale.php" ></iframe><br><br>
	<iframe width="400" height="300" frameborder="0" src="./package_show_sale.php" >
	</iframe>
	</td>
  </tr>
</table>
