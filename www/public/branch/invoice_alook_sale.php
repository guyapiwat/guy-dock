...
for($i=0;$i<mysql_num_rows($rs);$i++){
	...
	if(!empty($optionCredit1[$i]))$optionCredit[$i] .= "$optionCredit1[$i] ";
	if(!empty($optionCredit2[$i]))$optionCredit[$i] .= "$optionCredit2[$i] ";
	if(!empty($optionCredit3[$i]))$optionCredit[$i] .= "$optionCredit3[$i] ";
	...
	if($chkCredit1[$i] == 'on' or $chkCredit2[$i] == 'on' or $chkCredit3[$i] == 'on') $txtShow[$i] .= ' Credit : '.$txtAllCredit[$i].' ('.$optionCredit[$i].')';
