...
$sql = "SELECT * FROM ".$dbprefix."product LEFT JOIN ".$dbprefix."productgroup  ON (".$dbprefix."productgroup.id=".$dbprefix."product.group_id) where bf = 1  and  sst = 1  and locationbase = '".$_SESSION["inv_locationbase"]."' ";
...
$rec->setFieldSpace("15%,40%,10%,10%,22%");
