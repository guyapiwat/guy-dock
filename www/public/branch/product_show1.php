...
function chknum(key){
	...
	function saleadd(pcode,pdesc,price,pv,bv,fv){
		...
		place += "<td style='"+style_l+style_t+style_b+"'>รวม PV</td>";
		place += "<td style='"+style_l+style_t+style_b+"'>รวม BV</td>";
		place += "<td style='"+style_l+style_t+style_b+"'>รวม FV</td>";
		place += "</tr>";
		for(i=0;i<(tag.length-skip)/12;i++){
			...
			place += "<td style='"+style_l+style_bd+"' align='right'><input size='8' readonly type='text' style='"+hidden+ "text-align:right;' name='bv[]' value='" + tag[++step].value + "'></td>";
			place += "<td style='"+style_l+style_bd+"' align='right'><input size='8' readonly type='text' style='"+hidden+ "text-align:right;' name='fv[]' value='" + tag[++step].value + "'></td>";
			...
			place += "<td style='"+style_l+style_bd+"' align='right'><input onkeyup='cal()' style='text-align:right;' name='qty[]' type='text' size='5' value='" + num + "'  readonly   onKeyPress='return chknum(window.event.keyCode)' onChange=\"if(this.value == '' || this.value.substring(0,1) == '0'){alert('ไม่สามารถใส่ค่า 0 หรือ ช่องว่างได้');this.value=1;cal();}\"></td>";
			step++;
		...
		//alert(tag.length)
			...
			place += "<td style='"+style_l+style_bd+"' align='right'><input size='8' readonly type='text' style='text-align:right;"+hidden+ "' name='bv[]' value='" + bv + "'></td>";
			place += "<td style='"+style_l+style_bd+"' align='right'><input size='8' readonly type='text' style='text-align:right;"+hidden+ "' name='fv[]' value='" + fv + "'></td>";
		...
		place += "<td style='"+style_l+style_t+style_b+"' align='right'><input size='8' readonly type='text' style='text-align:right;' name='sumbv' value='" + sumbv + "'></td>";
		place += "<td style='"+style_l+style_t+style_b+"' align='right'><input size='8' readonly type='text' style='text-align:right;' name='sumfv' value='" + sumfv + "'></td>";
		place += "</tr>";
