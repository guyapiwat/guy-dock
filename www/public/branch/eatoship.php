...
$inv = $_POST['inv_code']==""?$_GET['inv_code']:$_POST['inv_code'];
rpdialog_sale($_GET['sub'],$fdate,$tdate,$sale,$inv_code);
?>
...
if(!empty($inv)){
$sql .= " and ".$dbprefix."eatoship.lid = '$inv'  ";
}
...
//$wherecause = " WHERE ";
    ...
    if($_GET['state']==1){
        ...
        $rec->setLink($PHP_SELF,"sessiontab=".$sesstab."&sub=".$_GET["sub"]."&fdate=$fdate&tdate=$tdate&sale=$sale&inv_code=$inv_code");
