...
include("global.php");
	...
	mysql_query($sql);
	//====================LOG===========================
$text="uid=".$_SESSION["inv_usercode"]." action=sale_hcancel=>$sql";
writelogfile($text);
//=================END LOG===========================
	//echo $sql;
...
รหัสผ่านใหม่ของคุณคือ $sv_code";
					...
					if($clb == '1')sendsms($dbprefix,$msisdn,$message,$ScheduledDelivery="",$mcode);
				}
			//}
		}

	logtext(true,$_SESSION['inv_usercode'],'reset password',$bid);
