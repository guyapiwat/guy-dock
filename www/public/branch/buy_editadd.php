...
document.getElementById('frm').action='buyoperate.php?state=0';
...
document.getElementById('frm').action='buyoperate.php?state=1';
//alert(document.getElementById('frm').target);
//alert(document.getElementById('frm').action);
	document.getElementById('checkstate').innerHTML= "<img align='center' src='./images/loading.gif' />";
	//alert(skipval);
...
?>
<form method="post" action="buyoperate.php?state=<?=$_GET['id']==""?0:1?>" id="frm" name="frm"  onsubmit="return checkForm(this)" onKeyDown="document.getElementById('ok').disabled=true;" >
  <table border="0">
  <tr valign="top">
    <td>				
...
เลือกรูปแบบการซื้อ                  </option>                <option  value="I" <?=($satype=="T"?"selected":"")?>>
            ...
            <tr valign="top">
              <td width="16%" align="right">&#3626;&#3634;&#3586;&#3634;&#3607;&#3637;&#3656;&#3648;&#3610;&#3636;&#3585; </td>
...
<div id="inv_desc"></div> </td>
              ...
              <td nowrap="nowrap">
			    ...
			    &#3592;&#3633;&#3604;&#3626;&#3656;&#3591;
                <input type="radio" name="radsend" id="radsend" value="2"   onClick="document.getElementById('inv_ref').disabled = false;document.getElementById('ccheckr').value = '2';"  <?=($radsend=="2"?"checked":"")?> disabled >
&#3652;&#3617;&#3656;&#3592;&#3633;&#3604;&#3626;&#3656;&#3591; <br>
<br>
