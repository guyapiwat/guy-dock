        ...
        <td><table border="1" width="100%" align="center">
            ...
            <td width="38%"> 
			 ...
			 <select name="satype" id="satype" onChange="document.getElementById('ok').disabled=true;">
				...
				<?php		
					foreach($arr_satype_mm as $key => $value):			
					echo '<option value="'.$key.'"';
						if($satype==$key)echo "selected";
					echo'>'.$value.'</option>'; 
					endforeach;
            ...
            <tr valign="top">
              ...
              <td nowrap="nowrap"><input style="background-color:#FFFF99" size="15" type="text" id="mcode" name="mcode" value="" >
               <input name="button2" type="button" onClick="sendget_sponsor(document.getElementById('mcode').value);document.getElementById('ok').disabled=true;" value="<?=$wording_lan["tab4"]["1_26"]?>" />
