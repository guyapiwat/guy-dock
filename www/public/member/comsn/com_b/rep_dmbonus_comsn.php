...
if ($cmc=="") {
	$cmc=$_SESSION["usercode"];
		...
		$rec->setFieldDesc("".$wording_lan["rcode"].",".$wording_lan["mcode"].",".$wording_lan["name"].",".$wording_lan["acc_no"].",".$wording_lan["acc_type"].",".$wording_lan["commission"].",".$wording_lan["tax"]." 3%,".$wording_lan["Amount"]."");
