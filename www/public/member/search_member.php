...
$sql = "SELECT locationbase,ewallet,pos_cur,pos_cur1,name_t,name_f,mcode,caddress,cbuilding,cvillage,csoi,cstreet,czip,cprovinceId,cdistrictId,camphurId,status_terminate ";
$sql .= $sqlmtype;
