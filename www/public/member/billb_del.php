...
require_once ("function.log.inc.php");
	...
	for ($i=0;$i<$numpost;$i++) {
		...
		if (mysql_num_rows($rs)>0){
            ...
            <?
			//====================LOG===========================
$text="uid=".$_SESSION["adminuserid"]." action=sale_del=>delete from ".$dbprefix."holdhead where id='$id'";
writelogfile($text);
//=================END LOG===========================
			mysql_query("delete from ".$dbprefix."holdhead where id='$id' ");
			//====================LOG===========================
$text="uid=".$_SESSION["adminuserid"]." action=sale_del=>delete from ".$dbprefix."holddesc where sano='$id' ";
writelogfile($text);
//=================END LOG===========================
