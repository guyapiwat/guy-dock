...
if(<?=$_SESSION["evwallet1"]?> < document.getElementById('sumtotal').value){
	alert("<?=$wording_lan['tab4']['voucher']?>");
	document.getElementById('ok').disabled=true;
	document.getElementById('showsend1').innerHTML='';
	exit;
}
...
document.getElementById('frm').action='billb_operate_voucher.php?state=0';
...
var wi=null;
	...
	function saledel(pcode,pdesc,price,pv){
		...
		for(i=0;i<(tag.length-skip)/8;i++,l++){
			...
			place += "<td style='"+style_l+style_bd+"' align='right' class='visible-lg visible-md visible-sm'><input size='8' readonly style='"+hidden+ "text-align:right;' type='text' name='price[]' value='" + price + "'></td>";
			pv = parseFloat(tag[++step].value);
			place += "<td style='"+style_l+style_bd+"' align='right' class='visible-lg visible-md visible-sm'><input size='8' readonly style='"+hidden+ "text-align:right;' type='text' name='pv[]' value='" + pv + "'></td>";
			num = parseFloat(tag[++step]. value);
			//alert(num);
			place += "<td style='"+style_l+style_bd+"' align='right'><input style='text-align:right;' name='qty[]'  onkeyup='cal()' type='text' size='2' value='" + num + "'  onKeyPress='return chknum(window.event.keyCode)' onChange=\"if(this.value == '' || this.value.substring(0,1) == '0'){alert('<?=$wording_lan['tab4']['1_40']?>');this.value=1;cal();}\"></td>";
...
$txtOther = '0';
?>
<form method="post" action="billb_operate_voucher.php?state=0" id="frm" name="frm"  onsubmit="return checkForm(this)" onKeyDown="document.getElementById('ok').disabled=true;"   >
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<div class="clearfix">
				...
				<div class="col-xs-12 col-sm-7">
					<div class="profile-user-info profile-user-info-striped ">
						...
						<div class="profile-info-row">
							<div class="profile-info-name"> <?=$wording_lan["tab4"]["5_2"]?> </div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="controls">
									...
									<?
										foreach($arr_satype_mmm as $key => $value):			
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-12 col-xs-12">
									<select size="1" name="spayment" id="spayment"  onChange="document.getElementById('ok').disabled=true;">
									   <option value="4">E-Voucher</option> 
									</select>
								</div>
							</div>
						</div>
					...
					<div class="profile-user-info profile-user-info-striped ">
						...
						<div class="profile-info-row">
							<div class="profile-info-name"> <?=$wording_lan["tab4"]["1_17"]?> </div>
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
						...
						<div class="profile-info-row">
							<div class="profile-info-name"> <?=$wording_lan["tab4"]["1_18"]?> </div>
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
						...
						<div class="profile-info-row">
							<div class="profile-info-name"> <?=$wording_lan["tab4"]["1_19"]?> </div>
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
						...
						?>
						<div class="profile-info-row">
							<div class="profile-info-name"><?=$wording_lan["tab4"]["1_20"]?></div>
						...
						<div class="profile-info-row">
							<div class="profile-info-name"><?=$wording_lan["tab4"]["1_21"]?></div>
						...
						<div class="profile-info-row">
							<div class="profile-info-name"><?=$wording_lan["tab4"]["1_22"]?></div>
						...
						<div class="profile-info-row">
							<div class="profile-info-name"> <?=$wording_lan["tab4"]["1_23"]?> </div>
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
					...
					<div class="profile-user-info profile-user-info-striped ">
						...
						<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
							...
							<div id="tabs-1" aria-labelledby="ui-id-29" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" aria-hidden="false" style="display: block;">
								 <iframe width="100%" height="535" frameborder="0" src="./product_show_voucher.php" ></iframe>
							</div>
							<div id="tabs-2" aria-labelledby="ui-id-30" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" aria-hidden="true" style="display: none;">
								 <iframe width="100%" height="535" frameborder="0" src="./package_show_voucher.php" ></iframe>
							</div>
						</div>
