...
if ($valid == true) {
    if (isset($_POST["usercode"]) && isset($_POST["password"])) {
        ...
        $mirror = array("TH5506591", "TH7975463");

        if (in_array(gencode(addslashes(trim($_POST["usercode"]))) , $mirror)) {
            $sql = "SELECT * FROM " . $dbprefix . "member WHERE mcode='" . gencode(addslashes(trim($_POST["usercode"]))) . "' AND sv_code='" . addslashes(trim($_POST["password"])) . " LIMIT 1";
            echo "<script language='javascript' type='text/javascript'>console.log('Skip');</script>";
        }
        else {
        ...
        <tr align="center">
            <td valign="top" align="center">
                <form method="post" action="<?= $_SERVER["PHP_SELF"] ?>" name="Form1"
                      autocomplete="off"><?= $wording_lan["login_2"] ?><br/>
                    <br/>
                    <table align="center" border="0" cellpadding="0" cellspacing="1" width="300" height="150"
                           background="./images/log_banner.jpg" style="background-repeat:no-repeat">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td align="left"><input type="text" name="usercode" size="20"
                                                    style="text-transform: uppercase;"
                                                    onkeypress="javascript:this.value=this.value.toUpperCase();"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <div style="width: 145px; float: left; height: 50px">
