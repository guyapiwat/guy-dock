...
$sql .= "LEFT JOIN ".$dbprefix."invent i ON (e.inv_code=i.inv_code) where e.mcode = '".$_SESSION["usercode"]."' and cancel = 0 and sa_type <> 'TI' and sa_type <> 'TO' and sa_type <> 'T' and sa_type <> 'W' and sa_type <> 'CI' ";  
