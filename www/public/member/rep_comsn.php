...
<?
		...
		$sql = "SELECT *,".$dbprefix."ambonus.mcode AS scode,".$dbprefix."ambonus.rcode AS r FROM ".$dbprefix."ambonus ";
		$sql .= "LEFT JOIN ".$dbprefix."member ON (".$dbprefix."member.mcode=".$dbprefix."ambonus.mcode) ";
		...
		if(isset($page))
			$rec->setCurPage($page);
		$rec->setShowField("scode,name_t,r,tdate,total");
