...
$("#tabs").tabs();
 ...
 <style type='text/css'> 
	#tabs {width: 430px;	margin-left: 11px; border: 0;border-radius: 0;	}
...
.ui-state-active a {color:#fff !important;}
  ...
  <div id="tabs">
    ...
    <div id="tabs-1">
        <iframe width="400" height="935" frameborder="0" src="./product_show.php" ></iframe>
    </div>
    <!-- <div id="tabs-2">
       <iframe width="400" height="605" frameborder="0" src="./package_show3.php" ></iframe>
    </div> -->
	</div>
