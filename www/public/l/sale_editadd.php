        ...
        <td><table border="1" width="100%" align="center">
            ...
            <tr valign="top">
              ...
              <td nowrap="nowrap"><input style="background-color:#FFFF99" size="15" type="text" id="mcode" name="mcode" value="<?=$mcode?>">
               <input name="button2" type="button" onClick="sendget_sponsor(document.getElementById('mcode').value)" value="ตกลง" />
<!--<input type="button" onClick="get_mem_listpicker_mcode()" value="เลือก">--><div id="mname"></div> </td>
              <td colspan="2" align="left" valign="top" nowrap="nowrap"><input type="radio" name="radsend" value="1" onClick="document.getElementById('inv_code').disabled = true;document.getElementById('ccheckr').value = '1';document.getElementById('inv_code').value = '';" <?=($radsend=="1"?"checked":"")?>>
&#3592;&#3633;&#3604;&#3626;&#3656;&#3591;
...
&#3652;&#3617;&#3656;&#3592;&#3633;&#3604;&#3626;&#3656;&#3591;<br>
&#3619;&#3633;&#3610;&#3607;&#3637;&#3656;&#3626;&#3634;&#3586;&#3634;
<select size="1" name="inv_code" id="inv_code" >
  <?					
...
บัตรเครดิต 3</td>
    ...
    <Br>
     <font color="#FF0000"><B>กรณีจัดส่ง กรุณาใส่ชื่อ และ เบอร์โทรคนรับของด้วย </B></font>             หมายเหตุ : <br>
                <textarea name="txtoption" cols="100" rows="5"><?=$txtoption?></textarea>
    </td>
    <td><iframe width="400" height="400" frameborder="0" src="./product_show.php" >
	</iframe><iframe width="400" height="400" frameborder="0" src="./package_show1.php" >
	</iframe>
	<br><Br></td>
  </tr>
</table>
