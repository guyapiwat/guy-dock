...
,tot_pv,tot_bv,tot_fv,".$dbprefix."asaleh.txtoption,remark,total,".$dbprefix."member.name_t as name_t,".$dbprefix."asaleh.mcode AS smcode";
...
//	echo '<fieldset><legend><b>ข้อมูลการซื้อ</b></legend>';
	if($_GET['state']==1){
		...
		if(isset($page))
			$rec->setCurPage($page);
		$rec->setShowField("sadate,sano,ability,tot_pv,total,uid,sendsend,sender,receive,txtoption,lid");
		...
		$rec->setFieldAlign("center,center,center,right,right,right,center,center,center,left,center,center");
