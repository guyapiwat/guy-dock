...
<table width="81%" border="0" height="370">
   	<tr>
        ...
        <tr>
          <td><input type="radio" <?=$strType1?>  id="selfregis" name="selfregis" value="0"> 1 . ÊÅÑº«éÒÂ¢ÇÒ</td>
        </tr>
        <tr>      <td width="59%"><input type="radio" <?=$strType2?> id="selfregis" name="selfregis" value="1">2. ¤Ðá¹¹½Ñè§ÍèÍ¹</td>
       </tr><tr>    <td width="59%"><input type="radio" <?=$strType3?> id="selfregis" name="selfregis" value="2">3. ¤Ðá¹¹½Ñè§á¢ç§</td>
        </tr>
		<tr>    
		  <td width="59%">&nbsp;</td>
        </tr>
