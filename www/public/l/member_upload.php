...
<?
$data = query('id_card_img,cmp,acc_no_img,cmp2,bmdate1,bmdate2','ali_member',"mcode = '{$_SESSION["usercode"]}'");
$member = $data[0];
			...
			<div id="user-profile-1" class="user-profile row ">
					...
					<div class="widget-box">
						...
						<div class="widget-body">
							<div class="widget-main">
								<? if($member['cmp']=='¤Ãº' && file_exists('../uploads/member/'.$member['id_card_img']) && $member['id_card_img']<>''){ ?>
									<div class="file-preview ">
										<div class=" file-drop-zone"><img src="../uploads/member/<?=$member['id_card_img']?>" style="max-width:100%"/>						
										<div class="clearfix"></div>    
									</div>
									<div class="text-center"><?=$wording_lan["info_main_1"]["51"]?> : <?=$member['bmdate1']?></div>
								</div>
								<? }else{ ?>
				...
				<div class="col-xs-12 col-sm-6">
					<div class="widget-box">
						...
						<div class="widget-body">
							<div class="widget-main">
								 <? if($member['cmp2']=='¤Ãº' && file_exists('../uploads/member/'.$member['acc_no_img']) && $member['acc_no_img']<>''){ ?>
									<div class="file-preview ">
										<div class=" file-drop-zone"><img src="../uploads/member/<?=$member['acc_no_img']?>" style="max-width:100%"/>						
										<div class="clearfix"></div>    
									</div>
									<div class="text-center"><?=$wording_lan["info_main_1"]["51"]?> : <?=$member['bmdate2']?></div>
								</div>
