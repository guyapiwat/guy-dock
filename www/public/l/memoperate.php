...
if(isset($_GET['state'])){
	...
	if (isset($_POST["hid"])){$hid=$_POST["hid"];}else{$hid="";}
	if (isset($_POST["fmcode"])){$fmcode=$_POST["fmcode"];}else{$fmcode="";}
	if (isset($_POST["mcode"])){$mcode=$_POST["mcode"];}else{$mcode="";}
	if(isset($_POST["profile_img"])){$pathImgOld1=$_POST["profile_img"];}else{$pathImgOld1="";}
...
//exit;
	...
	if (isset($_POST["cid_mobile"])){$cid_mobile=$_POST["cid_mobile"];}else{$cid_mobile=$_SESSION["m_locationbase"];}
	...
	if (isset($_POST["sumtotal"])){$total=$_POST["sumtotal"];}else{$total=0;}
	if (isset($_POST["sumpv"])){$tot_pv=$_POST["sumpv"];}else{$tot_pv=0;}
...
$caddress1 = $caddress.' '.$cbuilding.' '.$cvillage.' '.$csoi.' '.$cstreet;
	...
	if($_GET['state']==0){
		...
		,'$street','$building','$village','$soi','$cstreet','$cbuilding','$cvillage','$csoi','".$_SESSION["m_locationbase"]."','$line_id','$facebook_name','$cline_id','$cfacebook_name'
		) ";
