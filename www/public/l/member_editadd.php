...
function func_check(){
	...
	if(mysql_num_rows($rs)<1){
		echo "<script language='JavaScript'>alert('Ewallet ไม่เพียงพอสมัครสมาชิก');window.location='index.php?sessiontab=1'</script>";	
		exit;
	}
}
				...
				<div class="col-xs-12 col-sm-6 ">
					...
					<div class="profile-user-info profile-user-info-striped ">
						...
						<!--?if($mcode != ''){?-->
							...
							<input class="span4" type="text" id="mcode" name="mcode" value="<?=$random_number?>" style="width:100px" maxlength="7" onKeyPress="checkMemberExit(); return chknum(window.event.keyCode);" onChange="checkMemberExit();"  /> <span class="chekMemberAlert"></span>
						<!--?}?--></td>
						</span>
							</div>
						</div>
							...
							<div class="input-group">
								<input class="form-control" type="text" id="sp_code" name="sp_code" value="<?=$datax["sp_code"]?>" maxlength="9" >
								<span class="input-group-btn">
								<button class="btn btn-sm btn-default" type="button" onclick="sendget_sponsor(document.getElementById('sp_code').value)" >
								<? if(!empty($datax["sp_code"])) { echo "<script> sendget_sponsor('".$datax["sp_code"]."')</script>";} ?>
									<i class="ace-icon fa fa-search bigger-110"></i>
									Search
								</button>
								</span>
					...
					<div class="profile-user-info profile-user-info-striped">
						...
						<div class="profile-info-row">
							...
							<div class="lr" style=" width: 100px;   float: left;">
								&nbsp;&nbsp;<input tabindex="6" onClick="document.getElementById('ok').disabled=true;" type="radio" name="lr"  id="lr"  <?=$datax["lr"]==mysql_result($rs,$i,'lr_id')?"checked":""?> value="<?=mysql_result($rs,$i,'lr_id')?>"  />&nbsp;&nbsp;<?=$name_lr;?><br><br>
							</div>
				...
				<div class="col-xs-12 col-sm-6">
					...
					<div class="profile-user-info profile-user-info-striped">
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="controls">
									...
									<input class="span4" type="text" name="name_ff" readonly id="name_ff" value="<?=$datax["name_ff"]?>" tabindex="24">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="name_t" name="name_t" value="<?=$datax["name_t"]?>" onKeyUp="document.getElementById('acc_name').value=document.getElementById('name_ff').value+' '+this.value;document.getElementById('name_b').value=this.value;">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="name_e" name="name_e" value="<?=$datax["name_e"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="name_b" name="name_b" value="<?=$datax["name_b"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="control-group">
								...
								<div class="radio">
									<label>
										<input type="radio" class="ace" id='sex'  name='sex' value="&#3594;&#3634;&#3618;"
										<? if($datax["sex"]=="ชาย") echo "checked=\"checked\""; ?>
										></input>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="id_card" name="id_card" value="<?=$datax["id_card"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="id_tax" name="id_tax" value="<?=$datax["id_tax"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="home_t" name="home_t" value="<?=$datax["home_t"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="mobile" name="mobile" value="<?=$datax["mobile"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="fax" name="fax" value="<?=$datax["fax"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="email" name="email" value="<?=$datax["email"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="line_id" name="line_id" value="<?=$datax["line_id"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="facebook_name" name="facebook_name" value="<?=$datax["facebook_name"]?>">
								</div>
							</div>
						</div>
				...
				<div class="col-xs-12 col-sm-6">
					...
					<div class="profile-user-info profile-user-info-striped">
						...
						<div class="profile-info-row table-header">
							...
							<input type="checkbox" name="chkcmem" id="chkcmem" value="1"  tabindex="53"   onClick="onclickcmems(this.value);" /></div>
							...
							<div class="profile-info-value">
								<div class="controls">
									<select class="span2" name="cname_f" id="cname_f" disabled onchange="getRadioValueByName1(this.value);document.getElementById('cname_ff').value=this.value;if(this.value == '123'){document.getElementById('cname_ff').value = ''; document.getElementById('cname_ff').readOnly  = false;document.getElementById('cname_ff').focus();}else {document.getElementById('cname_ff').readOnly  = true;}">
									  ...
									  <option value="" selected=""><?=$wording_lan["tab1_mem_13"];?></option>
									...
									<input class="span4" type="text" name="cname_ff" id="cname_ff" value="" tabindex="24" disabled>
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="cname_t" name="cname_t" value="" disabled>
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="cname_e" name="cname_e" value="" disabled>
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="cname_b" name="cname_b" disabled >
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="control-group">
								...
								<div class="radio">
									<label>
										<input type="radio" id="csex" name="csex" class="ace" value="&#3594;&#3634;&#3618;" disabled />
										<span class="lbl">&nbsp&nbsp <?=$wording_lan["tab1_mem_32"] ?></span>
									</label>
									<label>
										<input type="radio" id="csex" name="csex" class="ace" value="&#3627;&#3597;&#3636;&#3591;" disabled/>
										<span class="lbl">&nbsp&nbsp <?=$wording_lan["tab1_mem_33"] ?></span>
									</label>
								</div>
							</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="cid_card" name="cid_card" value="" disabled>
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="cid_tax" name="cid_tax" value="" disabled>
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="chome_t" name="chome_t" value="" disabled>
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="cmobile" name="cmobile" value="" disabled>
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="cfax" name="cfax" value="" disabled>
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="cemail" name="cemail" value="" disabled>
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="cline_id" name="cline_id" value="" disabled>
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="cfacebook_name" name="cfacebook_name" value="" disabled>
								</div>
							</div>
						</div>
				...
				<div class="col-xs-12 col-sm-6">
					...
					<div class="profile-user-info profile-user-info-striped">
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="address" name="address" value="<?=$datax["address"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="building" name="building" value="<?=$datax["building"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="village" name="village" value="<?=$datax["village"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="soi" name="soi" value="<?=$datax["soi"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="street" name="street" value="<?=$datax["street"]?>">
								</div>
							</div>
						</div>
						 <? 
						...
						<div class="profile-info-row">
							...
							<div class="input-group">
								<input class="form-control" type="text" id="zip" name="zip" value="<?=$datax["zip"]?>">
								<span class="input-group-btn">
				...
				<div class="col-xs-12 col-sm-6">
					...
					<div class="profile-user-info profile-user-info-striped">
						<div class="profile-info-row table-header">
							...
							<div class="profile-info-value">
								<label class="inline">
									<input type="checkbox" class="ace" name="chkaddress" id="chkaddress" value="1"  tabindex="53" onClick="onclickaddress(this.value);"  />
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="cprovince" name="cprovince" value="">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="camphur" name="camphur" value="">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="cdistrict" name="cdistrict" value="">
								</div>
							</div>
						</div>
						<? } ?>
				...
				<div class="col-xs-12 col-sm-6">
					...
					<div class="profile-user-info profile-user-info-striped">
							...
							<div class="profile-info-value">
								<div class="controls">
									...
									for ($i=1;$i<=mysql_num_rows($result1);$i++){
										...
										if ($datax["bankcode"]==$row1->bankcode) {echo "selected";}
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="branch" name="branch" value="<?=$datax["branch"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="acc_no" name="acc_no" value="<?=$datax["acc_no"]?>">
								</div>
							</div>
						</div>
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="acc_name" name="acc_name" value="<?=$datax["acc_name"]?>">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-xs-12 col-sm-6">
					...
					<div class="profile-user-info profile-user-info-striped">
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<div class="input-group col-sm-9 col-xs-9">
									<input class="form-control" type="text" id="iname_t" name="iname_t" value="">
								</div>
							</div>
						</div>
...
<!--input type="checkbox" name="chkpayment" id="chkpayment" value="checkbox" onChange="if(this.checked == true){document.getElementById('button').disabled = false;document.getElementById('ok').disabled = true;}else{document.getElementById('button').disabled = true;document.getElementById('ok').disabled = true;}" /> 
			  <a href="#">เงื่อนไขการสมัคร</a><br/><br/><br/-->
