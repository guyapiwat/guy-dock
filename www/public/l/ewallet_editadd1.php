...
?>
<form method="post" action="ewalletoperate1.php?state=<?=$_GET['id']==""?0:1?>" id="frm" name="frm"  onsubmit="return checkForm(this)" onKeyDown="document.getElementById('ok').disabled=true;" >
      ...
      <tr valign="top">
        <td><table border="1" width="100%" align="center">
          ...
          <tr valign="top">
            ...
            <td nowrap="nowrap"><input style="background-color:#FFFF99"   size="15" type="text" id="mcode" name="mcode" value="<?=$_SESSION["usercode"]?>" readonly><input style="display:none" name="button2"  type="button" onClick="sendget_sponsor(document.getElementById('mcode').value)" value="&#3605;&#3585;&#3621;&#3591;" />
          ...
          <tr valign="top">
            <td align="right"><?=$wording_lan["tab4"]["5_41"]?></td>
            ...
            <td><select size="1" name="spayment" id="spayment" onChange="if(this.value == '1'){document.getElementById('chkpayment').checked = false;document.getElementById('showpayment').style.visibility='visible';document.getElementById('ok').disabled = true;document.getElementById('button').disabled = true;}else {document.getElementById('chkpayment').checked = false;document.getElementById('showpayment').style.visibility='visible';document.getElementById('ok').disabled = true;document.getElementById('button').disabled = true;}" >
              <option value="2">ถอน Ewallet</option>
              <option value="1" style="display:none">
                <?=$wording_lan["tab4"]["5_15"]?>
                </option>
            </select></td>
          </tr>
          <tr valign="top">
