...
//$wherecause = " WHERE ";
	...
	if($_GET['state']==1){
		...
		$rec->setFieldDesc("เลขที่บิล,รหัสสาขา,วันที่ทำรายการ,รายการ,ค่าเช่า,ค่าน้ำ,ค่าไฟ,ค่าสินค้าเบ็ดเตล็ด,ยอดรวมทั้งหมด,ผู้บันทึก");
		...
		$rec->setSearchDesc("เลขบิล,รหัสสาขา,ผู้บันทึก");
