...
$sql .= ",(CASE WHEN object8>0 THEN '<img src=./images/true.gif>' ELSE '' END) AS object8r ";
$sql .= ",(CASE WHEN object9>0 THEN '<img src=./images/true.gif>' ELSE '' END) AS object9r ";
$sql .= ",(CASE WHEN object10>0 THEN '<img src=./images/true.gif>' ELSE '' END) AS object10r ";
$sql .= ",inv_ref ";
$sql .= "FROM ".$dbprefix."user WHERE usertype='1' and usercode <> 'support' ";
//echo $sql;
//$wherecause = " WHERE ";
