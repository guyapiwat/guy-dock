...
if($_GET['state']==0){
	logtext(true,$_SESSION['adminuserid'],'เพิ่มผู้ใช้ระบบ : '.$usercode);
	$sql="insert into ".$dbprefix."user (usercode, username,  password,  object1,  object2,  object3,  object4,  object5,object6,object7,object8,object9,object10,accessright,usertype,inv_ref) values ('$usercode' ,'$username','".EncodePwd($password)."' ,'$obj[1]','$obj[2]' ,'$obj[3]','$obj[4]' ,'$obj[5]','$obj[6]','$obj[7]','$obj[8]','$obj[9]','$obj[10]','$accessright','1','$inv_ref') ";
	//====================LOG===========================
...
//=================END LOG===========================
	...
	logtext(true,$_SESSION['adminuserid'],'แก้ไขผู้ใช้ระบบ : '.$usercode);
...
//=================END LOG===========================
	mysql_query($sql);
	$sql="update ".$dbprefix."user set  object1 ='$obj[1]', object2 ='$obj[2]', object3 ='$obj[3]', object4 ='$obj[4]', object5 ='$obj[5]',object6 ='$obj[6]',object7 ='$obj[7]',object8 ='$obj[8]', object9 ='$obj[9]', object10 ='$obj[10]',accessright='$accessright' where uid = '$oid' ";
	//====================LOG===========================
$text="uid=".$_SESSION["adminuserid"]." action=sysuseroperate =>$sql";
writelogfile($text);
//=================END LOG===========================
