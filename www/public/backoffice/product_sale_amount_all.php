...
if(empty($fdate))$fdate = date("Y-m").'-01';
if(empty($tdate))$tdate = date("Y-m-t");
...
echo '<center><font size=4>ﾃﾒﾂｧﾒｹﾂﾍｴ｢ﾒﾂﾊﾔｹ､鰓</font></center>';
if (isset($_GET["pg"])){$page=$_GET["pg"];} else {$page="1";}
...
//echo $sql;
		...
		$rec->setFieldDesc("ﾃﾋﾑﾊﾊﾔｹ､鰓,ﾃﾒﾂﾅﾐ猩ﾕﾂｴﾊﾔｹ､鰓,ﾃﾒ､ﾒ,ｨﾓｹﾇｹ,狃郢爰ﾔｹ");
		...
		//$rec->setSearchDesc("ﾃﾋﾑﾊﾊﾔｹ､鰓,ﾃﾒﾂﾅﾐ猩ﾕﾂｴﾊﾔｹ､鰓,ﾃﾒ､ﾒ,ｨﾓｹﾇｹ,狃郢爰ﾔｹ");
		//$rec->setEdit("index.php","id","id","sessiontab=1&sub=2");
		//$rec->setEdit("index.php","id","id","sessiontab=1&sub=2");
		$str2 = "<fieldset ><a href='".$rec->getParam()."&print_all=true' target='_blank'>";
		$str2 .= "<img border='0' src='./images/Amber-Printer.gif'>ｾﾔﾁｾ�ｷﾑ鬧ﾋﾁｴ</a></fieldset>";
		$rec->setSpace($str2);
...
echo '<center><font size=4>ﾃﾒﾂｧﾒｹﾂﾍｴ｢ﾒﾂ Package</font></center>';
if (isset($_GET["pg"])){$page=$_GET["pg"];} else {$page="1";}
$sql = "SELECT ".$dbprefix."asaled.pcode,".$dbprefix."asaled.price,";
$sql .= "CASE ifnull(".$dbprefix."product.pdesc,0) WHEN '0' THEN ".$dbprefix."product_package.pdesc ELSE ".$dbprefix."product.pdesc END AS pdesc, ";
...
echo '<center><font size=4>ﾃﾒﾂｧﾒｹﾂﾍｴ｢ﾒﾂﾊﾔｹ､鰓羯 Package</font></center>';
if (isset($_GET["pg"])){$page=$_GET["pg"];} else {$page="1";}
...
//echo $sql;
		...
		$rec->setFieldFloatFormat(",,2,0,2");
$rec->setFieldDesc("ﾃﾋﾑﾊﾊﾔｹ､鰓,ﾃﾒﾂﾅﾐ猩ﾕﾂｴﾊﾔｹ､鰓,ｨﾓｹﾇｹ");
		$rec->setFieldAlign("center,left,right,right,right");
...
echo '<center><font size=4>ﾃﾒﾂｧﾒｹﾂﾍｴ｢ﾒﾂﾊﾔｹ､鰓 眷ﾐ ﾊﾔｹ､鰓羯 Package</font></center>';
if (isset($_GET["pg"])){$page=$_GET["pg"];} else {$page="1";}
