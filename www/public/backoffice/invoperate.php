...
if($_GET['state']==0){
	...
	$sql = "SELECT inv_desc FROM ".$dbprefix."invent where inv_code = '$inv_code'   ";
	$rs = mysql_query($sql);
	...
	logtext(true,$_SESSION['adminusercode'],'เพิ่มบิล ID '.$mid.' สาขา : '.$inv_code,$mid);
...
//=================END LOG===========================
	...
	if($radsend == '2')$object_stocks->set_data($mid,"isale","sender","1"); 
