...
require_once ("function.log.inc.php");
	...
	for ($i=0;$i<$numpost;$i++) {
		...
		//	echo $sano;
			//echo "update ".$dbprefix."asaleh set sano1 = '$sano'  where id = '$id' ";
			//exit;
			/*echo "insert ".$dbprefix."asaleh_held(id,sano,sadate,mcode,name_t,sa_type,tot_pv,total)  values(
			'$id','$sano','$sadate','$mcode','$name_t','$sa_type','$tot_pv','$total'
			) ";*/
			mysql_query("insert ".$dbprefix."asaleh_held(id,sano,sadate,mcode,name_t,sa_type,tot_pv,total)  values(
			'$id','$sano','$sadate','$mcode','$name_t','$sa_type','$tot_pv','$total'
			) ";
			//====================LOG===========================
