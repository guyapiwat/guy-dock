...
if(boxName.checked == true) { ajaxshipping
	document.getElementById(divName).value=parseFloat(document.getElementById('sumtotal').value)+parseFloat(document.getElementById('ajaxshipping').value);
	} 
	else { 
...
document.getElementById('frm').action='saleoperate.php?state=0';
...
document.getElementById('frm').action='saleoperate.php?state=1';
//alert(document.getElementById('frm').target);
//alert(document.getElementById('frm').action);
	document.getElementById('checkstate').innerHTML= "<img align='center' src='./images/loading.gif' />";
	//alert(skipval);
...
?>
<form method="post" action="saleoperate.php?state=<?=$_GET['id']==""?0:1?>" id="frm" name="frm"  onsubmit="return checkForm(this)" onKeyDown="document.getElementById('ok').disabled=true;" >
  <table border="0">
  <tr valign="top">
    <td>				
        ...
        <td><table border="1" width="100%" align="center">
            ...
            <tr valign="top">
              ...
              <td><input style="background-color:#FFFF99" size="15" type="text" id="mcode" name="mcode" value="<?=$mcode?>">
               <input name="button2" type="button" onClick="sendget_sponsor(document.getElementById('mcode').value)" value="ตรวจสอบ" />
               <input name="button3" type="button" style="display:none" onClick="document.getElementById('ok').disabled = true;this.form.target = '_blank';this.form.action='b.php'; submit(); " value="ตรวจสอบค่าจัดส่ง">
               <!--<input type="button" onClick="get_mem_listpicker_mcode()" value="เลือก">-->
<div id="mname"></div> </td>
              <td align="right" valign="bottom" nowrap="nowrap">&nbsp;รับที่สาขา</td>
              <td nowrap="nowrap">
			    <input type="radio" name="radsend" id="radsend" value="1"  onClick="document.getElementById('inv_code').disabled = true;document.getElementById('ccheckr').value = '1';document.getElementById('inv_code').value = '';" <?=($radsend=="1"?"checked":"")?>>
			    &#3592;&#3633;&#3604;&#3626;&#3656;&#3591;
                <input type="radio" name="radsend" id="radsend" value="2"   onClick="document.getElementById('inv_code').disabled = false;document.getElementById('ccheckr').value = '2';"  <?=($radsend=="2"?"checked":"")?> >
&#3652;&#3617;&#3656;&#3592;&#3633;&#3604;&#3626;&#3656;&#3591; <br>
<br>
<select name="inv_code" id="inv_code"  disabled="disabled">
...
บัตรเครดิต 3</td>
               ...
               <td><input name="optionDiscount"   value="<?=$optionDiscount?>" type="text" size="60" ></td>
                ...
                <tr valign="top">
                  <td colspan="4" ><table width="100%"> 
                    <tr valign="top">
                      <td colspan="4"><font color="#FF0000">กรณีจ่ายด้วย Voucher ระบบจะไม่คิด PV ให้</font> </td>
                    </tr>
                    <tr valign="top" bgcolor="#FFCC33">
                  <td colspan="4"><b>&#3607;&#3637;&#3656;&#3629;&#3618;&#3641;&#3656;&#3626;&#3635;&#3627;&#3619;&#3633;&#3610;&#3592;&#3633;&#3604;&#3626;&#3656;&#3591; / &#3626;&#3656;&#3591;&#3648;&#3629;&#3585;&#3626;&#3634;&#3619; &#3605;&#3634;&#3617;&#3586;&#3657;&#3629;&#3617;&#3641;&#3621;&#3626;&#3617;&#3634;&#3594;&#3636;&#3585; 
    ...
    <td>    สินค้า
      <iframe width="600" height="400" frameborder="0" src="./product_show.php" ></iframe>
	<br><Br>
    แพคเก็จ<iframe width="600" height="200" frameborder="0" src="./package_show.php" ></iframe></td>
  </tr>
</table>
  <br>
</form>
