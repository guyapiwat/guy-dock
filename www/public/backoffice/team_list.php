...
<form name="rform" method="POST" action="./index.php?sessiontab=1&sub=23">
...
$sql = "select mcode_index from ".$dbprefix."structure_sponsor where mcode_ref = '$cmc' ";
$rs = mysql_query($sql);
...
$rec->setLink($PHP_SELF,"sessiontab=1&sub=23&lr=$lr&cmc=$cmc");
