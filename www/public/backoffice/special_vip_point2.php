...
/*    if(!$rs=mysql_query($sql)){
    ...
    $heal_mouth=$year.$month;
     ...
     $sql2 = "INSERT INTO ".$dbprefix."special_point_group (id,vip_id, sadate,  mcode,  sa_type, tot_pv, uid,heal_mouth ) VALUES ("
     ."'',"
     ."'".$newID."',"
     ."'".$vipinfo['mdate']."',"
     ."'".$vipinfo['sp_code']."',"
...
<form name="frm" method="post" action="./index.php?sessiontab=<?=$sesstab?>&sub=22" onSubmit='return check_form(frm)' ENCTYPE="multipart/form-data">
