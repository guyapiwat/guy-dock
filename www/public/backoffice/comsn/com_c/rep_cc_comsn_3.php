...
if($fdate != ''){
		...
		$rec->setShowField("rcode,id,mcode,total,pv,name_t,address,id_card");
		$rec->setFieldDesc("รอบ,ลำดับ,รหัส,จำนวนรวมโบนัส,หัก ณ ที่จ่าย,ชื่อ,ที่อยู่,เลขที่บัตรประชาชน");
		...
		if($acc->isAccess(4)){
		//	$rec->setDel("index.php","id","id","sessiontab=4&sub=3434");
		//	$rec->setFromDelAttr("maindel","./index.php?sessiontab=4&sub=3434&state=1&ftrcode=$ftrcode&fmcode=$fmcode","post","delfield");
		}
	/*	if(isset($_POST['skey']))
