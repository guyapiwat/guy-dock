...
require_once(dirname(__FILE__)."/../../logtext.php");
	...
	echo "<br>ลบข้อมูลรอบการคำนวณ promotion :";
	...
	<table width="50%" cellpadding="0" cellspacing="0">
        <tr bgcolor="#999999" align="center">
            ...
            <td style="<?=$style_l.$style_t.$style_b?>">วันที่เพิ่ม</td>
	...
	for ($i=0;$i<$numpost;$i++) {
		...
		$rs=mysql_query("SELECT * FROM ".$dbprefix."promotion WHERE rid='".$postval[$postkey[$i]]."' LIMIT 1");
		...
		$sql = "delete from ".$dbprefix."promotion where rid='$rid' ";
		//logtext(true,$_SESSION['adminuserid'],$sql);
		logtext(true,$_SESSION['adminuserid'],'ลบโปรโมชั่น',$row->name);
