...
<?
		...
		$sql = "SELECT a.*,a.percer*100  as percer FROM ".$dbprefix."ac a ";
 		if($ftrcode!=""&&$cmc!=""){
		...
		$rec->setFieldDesc("รอบที่,รหัสสมาชิก,ชื่อสมาชิก,รหัสผู้แนะนำ,คะแนน,ชั้น,%โบนัส,โบนัส,ตำแหน่ง");
		...
		/*edit showField table*/

		$rec->setShowField("rcode,mcode,name_t,upa_code,pos_cur,pv,level,gen,percer,total");
		$rec->setFieldDesc("รอบที่,รหัสสมาชิก,ชื่อสมาชิก,รหัสผู้แนะนำ,ตำแหน่ง,คะแนน,Level,Gen,%โบนัส,โบนัส");
		$rec->setFieldAlign("center,center,left,center,center,right,center,center,center,right");
		$rec->setFieldSpace("9%,9%,40%,9%,10%,9%,3%,3%,9%,7%");//10

		$rec->setFieldFloatFormat(",,,,,2,,0,2,2");
		$rec->setSum(true,false,",,,,,true,,,,true");
		/*---------------------------------------------------*/
