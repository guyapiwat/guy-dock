...
<form name="rform" method="post" action="./index.php?sessiontab=1&sub=2&state=6">
<table width="52%" border="1" cellpadding="0" cellspacing="0" bordercolor="#BEBEBE" align="center">
  <tr>
