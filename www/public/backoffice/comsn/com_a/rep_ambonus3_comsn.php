...
if($fdate != ''){
		...
		$sql = "SELECT a.pos_cur,a.fdate as fdate,a.tdate as tdate,a.rcode, a.mcode as smcode,lb.cshort,m.upa_code as mcode,m.name_t,m.acc_no,m.bankcode,b.bankname,a.total,a.tax,a.bonus ";
		$sql .= " FROM ".$dbprefix."ambonus3 a ";
...
//echo $sql;
		...
		$rec->setFieldLink(",,,,,index.php?sessiontab=4&sub=902&strfdate=,,");
		if($_GET['excel']==1){
