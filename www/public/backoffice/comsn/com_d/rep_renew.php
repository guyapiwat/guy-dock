...
require_once ("function.log.inc.php");
	...
	for ($i=0;$i<$numpost;$i++) {
		...
		if (mysql_num_rows($rs)>0){
            ...
            <?
			mysql_query("update ".$dbprefix."cmbonus1   set status = 1,total = pv+pvb  where id='$id' ");
			//====================LOG===========================
$text="uid=".$_SESSION["adminuserid"]." action=cmbonus1_update=>update ".$dbprefix."cmbonus1   set status = 1,total = pv+pvb  where id='$id'";
writelogfile($text);
//=================END LOG===========================
		}
