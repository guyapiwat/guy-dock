...
?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
รอบเดือน <? echo $strfdate .' ถึง '.$strtdate.'<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ยอดขายทั่วโลก : '.$data->pv_world.' จำนวน : '.$rows;?><!--a href="./comsn/com_a/rep_ac_comsn_print.php?ftrcode=<?=$ftrcode?>&fmcode=<?=$fmcode?>" target="_blank"><img border="0" src="./images/Amber-Printer.gif">พิมพ์ทั้งหมด</a-->
<?
		...
		$rec->setShowField("mcode,name_t,total1,total2,total3,total");
		$rec->setFieldDesc("รหัสสมาชิก,ชื่อสมาชิก,กองทุน VP (3%),กองทุน EVP (2%),กองทุน CEO(1%),รายได้");
