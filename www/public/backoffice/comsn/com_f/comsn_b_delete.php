...
<table width="95%" border="1" align="center">
  <tr>
    <td align="center"><br />
	<?
		$sql="select count(*) as cnt from ".$dbprefix."fround where rcode='$ro' ";
		$rs = mysql_query($sql);
		...
		//ปรับ CALC ให้เป็น ''
		$sql="update ".$dbprefix."fround set calc='' where rcode>= '$ro'   ";
		if(mysql_query($sql)){
			mysql_query("COMMIT");
		}else{
			echo "error $sql<BR>";
...
<form name="rform" method="post" action="./index.php?sessiontab=4&sub=40">
