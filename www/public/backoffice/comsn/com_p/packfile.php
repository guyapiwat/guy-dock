...
<?
		...
		$sql = "SELECT m.acc_no,m.bankcode,b.bankname,m.mobile,'N' as Yes,oon,a.total-oon as ttttt";
		...
		$rec->setFieldDesc("ลำดับ,ชื่อผู้รับเงิน,เลขที่บัญชี,จำนวนเงิน,ธนาคาร,Fax Number or Mobile,Beneficiary");
