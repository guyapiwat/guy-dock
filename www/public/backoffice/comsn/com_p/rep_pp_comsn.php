...
<?
		...
		$sql .= ",a.rcode,a.mcode,m.name_t,a.pv,a.pvb,a.total  ";
		...
		$rec->setLink($PHP_SELF,"sessiontab=4&sub=35&ftrcode=$ftrcode&fmcode=$fmcode");
...
<form name="rform" method="post" action="./index.php?sessiontab=4&sub=35">
