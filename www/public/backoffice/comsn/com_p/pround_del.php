...
require_once(dirname(__FILE__)."/../../logtext.php");
	...
	echo "<br>ลบข้อมูลรอบการคำนวณ Personal bonus :";
	...
	for ($i=0;$i<$numpost;$i++) {
		...
		$rs=mysql_query("SELECT * FROM ".$dbprefix."pround WHERE rid='".$postval[$postkey[$i]]."' LIMIT 1");
		...
		$sql = "delete from ".$dbprefix."pround where rid='$rid' ";
