...
?>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--a href="./comsn/com_d/rep_dc_comsn_print.php?ftrcode=<?=$ftrcode?>&fmcode=<?=$fmcode?>" target="_blank"><img border="0" src="./images/Amber-Printer.gif">พิมพ์ทั้งหมด</a-->
<?
		...
		$rec->setLink($PHP_SELF,"sessiontab=4&sub=27&ftrcode=$ftrcode&fmcode=$fmcode");
