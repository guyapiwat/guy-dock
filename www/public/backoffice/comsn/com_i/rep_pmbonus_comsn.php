...
<?
		...
		if($_GET['state']==1){
		include("comsn/com_i/rep_change.php");
		}
		...
		$rec->setLink($PHP_SELF,"sessiontab=4&sub=55&ftrcode=$ftrcode&fmcode=$fmcode");
		...
		if($acc->isAccess(4)){
			$rec->setDel("index.php","id","id","sessiontab=4&sub=55");
			$rec->setFromDelAttr("maindel","./index.php?sessiontab=4&sub=55&state=1&ftrcode=$ftrcode&fmcode=$fmcode","post","delfield");
		}
		if(isset($_POST['skey']))
...
<form name="rform" method="post" action="./index.php?sessiontab=4&sub=55">
