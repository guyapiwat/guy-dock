...
writelogfile($text);
//=================END LOG===========================
			logtext(true,$_SESSION['adminuserid'],'ย้ายการจ่ายตัง(renew) สาขา',$row->sano);
			mysql_free_result($rs);
			mysql_query("COMMIT");
		}else{
			echo "<tr ><td colspan='4'>ไม่สามารถย้ายการจ่ายตัง(renew) สาขา".$postval[$postkey[$i]].'</td></tr><br>';
		}
