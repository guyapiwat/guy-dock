...
<?
		...
		$sql = "SELECT b.rcode,b.mcode,taba.name_t,b.upa_code,tabb.upa_name,b.pv,b.level,b.percer,b.total FROM ".$dbprefix."sc b  ";
		...
		$rec->setLink($PHP_SELF,"sessiontab=4&sub=144&ftrcode=$ftrcode&fmcode=$fmcode");
