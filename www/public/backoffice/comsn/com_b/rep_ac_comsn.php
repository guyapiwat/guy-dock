...
<?
		...
		$sql = "SELECT a.rcode,a.mcode,taba.name_t,a.upa_code,tabb.upa_name,a.pv,a.level,a.percer,a.total FROM ".$dbprefix."ac a  ";
		...
		$rec->setLink($PHP_SELF,"sessiontab=4&sub=4&ftrcode=$ftrcode&fmcode=$fmcode");
