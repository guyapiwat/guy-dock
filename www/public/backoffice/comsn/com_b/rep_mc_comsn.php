...
<?
		...
		$sql = "SELECT DATE_FORMAT(a.fdate, '%d-%m-%Y') as fdate,a.gen as level,a.rcode,a.mcode,a.upa_code,a.gen,a.pv,a.percer*100 as percer,a.total,a.name_t,a.upa_name ";
	...
	$rec->setShowField("rcode,mcode,name_t,upa_code,upa_name,pv,level,gen,percer,total");
		$rec->setFieldDesc("รหัสรอบ,รหัสสมาชิก,ชื่อสมาชิก,รหัสอัพไลน์,ชื่ออัพไลน์,คะแนน,ชั้นที่,Gen,%โบนัส,ได้โบนัส");
		$rec->setFieldAlign("center,center,left,center,left,right,center,center,center,right");
		//$rec->setFieldSpace("2%,10%,15%,10%,15%,10%,9%,9%,10%,10%");//10
