...
<?
		...
		$sql = "SELECT *,a.mcode as mcode1,a.mcode as upa FROM ".$dbprefix."em a left join ".$dbprefix."member as m on (a.mcode=m.mcode) ";

		
 		if($ftrcode!=""&&$cmc!=""){
			$sql .= " WHERE a.mcode='".$cmc."' and a.fdate >='".$fdate."' and a.tdate <='".$tdate."'  ";
		}
	//echo $sql;
		...
		$rec->setFieldDesc("รอบที่,รหัสสมาชิก,ชื่อสมาชิก,โบนัส");
