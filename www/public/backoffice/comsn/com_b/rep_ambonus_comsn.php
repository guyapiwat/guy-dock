...
<?
		...
		$rec->setLink($PHP_SELF,"sessiontab=4&sub=50&strfdate=$strfdate&strtdate=$strtdate&fmcode=$fmcode");
		...
		$rec->setFieldLink(",,,,,index.php?sessiontab=4&sub=51&strfdate=,,");
		if($_GET['excel']==1){
