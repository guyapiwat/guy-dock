...
if($fdate != ''){
	...
	$sql = "SELECT DATE_FORMAT(a.fdate, '%Y-%m-%d') as fdate,DATE_FORMAT(a.tdate, '%Y-%m-%d') as tdate,a.rcode, a.mcode,a.name_t,lb.cshort,a.total,a.tax as tax,a.bonus as bonus,a.pos_cur ";
