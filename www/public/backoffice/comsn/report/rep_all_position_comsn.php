...
<form style="margin-bottom:0;" action="index.php?sessiontab=4&sub=103" method="post">
...
//echo $sql;
		...
		$rec->setLink($PHP_SELF,"sessiontab=4&sub=103&fdate=$fdate&tdate=$tdate");
		...
		$rec->setFieldDesc("รหัส,ชื่อ,รหัสธนาคาร,ธนาคาร,สาขา,ประเภท,เลขที่บัญชี,ชื่อบัญชี,รายได้,ค่าโอน,สุทธิ");
