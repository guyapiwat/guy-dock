        ...
        <td colspan="3" valign="top" ><fieldset>
          ...
          <table border="1" align="center" cellpadding="0" cellspacing="0">
            ...
            <? 
			  ...
			  $objdef = array("สมาชิก","vip","ขาย","คอมมิชชั่น","บริหารระบบ","Stock");
			  for($i=0;$i<6;$i++){
    ...
    <td width="45%">&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="2">&nbsp;
          ...
          &nbsp;
            <input type="reset" value="ยกเลิก" name="B2" onclick="window.location='index.php?sessiontab=5&sub=4'"/></td>
      </tr>
    </table>
</form>