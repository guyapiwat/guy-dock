...
if (isset($_GET["fdate"])){$xfdate=$_GET["fdate"];} else {$xfdate="";}
if (isset($_GET["tdate"])){$xtdate=$_GET["tdate"];} else {$xtdate="";}
$thisMonth = date("Y-m", strtotime("first day of $xfdate -1 month"));
...
if($xfdate!="") $sql.=" AND ah.sadate LIKE '$thisMonth%' ";
$sql.="
UNION ALL
...
if($xfdate!="") $sql.=" AND ho.sadate LIKE '$thisMonth%' ";
$sql.="
UNION ALL
...
if($xfdate!="") $sql.=" AND sp.sadate LIKE '$thisMonth%' ";
$sql.=") as a ";
