...
if (($_SESSION["adminusercode"] <> "") and ($_SESSION["adminobj9"] != 0)) {
    $bgtab9 = "images/menu_bar_01.gif";
}
if (($_SESSION["adminusercode"] <> "") and ($_SESSION["adminobj10"] != 0)) {
    $bgtab10 = "images/menu_bar_01.gif";
}
...
<table bgcolor="#FFFFFF" cellspacing="0" cellpadding="0" width="100%" border="0">
    <tr>
        ...
        <td align="right" valign="bottom"><font
                    size="6">Backoffice</font><? if (!empty($_SESSION["adminusercode"])) { ?>
                <br>&nbsp;<? echo "<strong>" . $wording_lan["header"]["user"] . "&nbsp;:&nbsp;</strong>" . TisToUtf($_SESSION["adminusercode"]) . "&nbsp;&nbsp;<strong>"
                    . $wording_lan["header"]["name"] . "&nbsp;:&nbsp;</strong>" . TisToUtf($_SESSION["adminusername"]) . "<br /><br />";
            } ?>
        ...
        <td align="right">
            <table width="100%" height="30" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    ...
                    <? if (($_SESSION["adminusercode"] == "")) { ?>
                        <td width="23">&nbsp;</td>
                        <td width="232"><b>BACK OFFICE</b></td>
                    <? } ?>
                    ...
                    <td width="125" align="center" nowrap background="<? echo $bgtab88; ?>">
                        &nbsp;
                        <? if ($_SESSION["adminusercode"] <> "") {
                            echo "<a href='" . $prefix . "logout.php?sessiontab=8'><font color='#000000'><b>" . $wording_lan["header"]["logout"] . "</b></font></a>&nbsp;";
                        } ?>
                    </td>
                    <td>&nbsp;</td>
                    ...
                    <td width="350" nowrap align="center"><? if (!empty($_SESSION["adminusername"])){ ?><b><span
                                    class="LinkD"><a href="index.php?sessiontab=0">แก้ไขรหัสผ่าน</a>&nbsp;&nbsp;&nbsp;<a
                                        href="logout.php?sessiontab=8">Logout</a></b><? } ?></span></td>
                </tr>
            </table>

            <table width="100%" height="5" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td height="5" colspan="3" bgcolor="#0099CC"></td>
                </tr>
                <tr>
                    <td height="5" colspan="3" background="images/bar_box_shadow.gif"></td>
                </tr>
            </table>
