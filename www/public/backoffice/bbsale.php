<script language="javascript" type="text/javascript">
	function sale_print(id){
		var wlink = 'invoice_aprintHQ.php?bid='+id;
...
$sql = "SELECT * ";
$sql .= "FROM ".$dbprefix."istockh where (sa_type = 'BR' or sa_type = 'HO' or sa_type='BRHO')  and cancel=0"; //WHERE smcode='".$_SESSION['usercode']."' 
//echo $sql;
...
//echo $sql;
	...
	if($_GET['state']==1){
		...
		$rec->setLink($PHP_SELF,"sessiontab=6&sub=23");
