...
$sql = "SELECT * FROM ".$dbprefix."product left join ".$dbprefix."location_base on (".$dbprefix."product.locationbase = ".$dbprefix."location_base.cid) where ".$dbprefix."product.pcode <> 'AS001' ";
...
$rec->setSearch("cshort,pcode,pdesc,price,pv");
$rec->setSearchDesc("LB,รหัส,รายละเอียด,คงเหลือ,ราคา,คะแนน");
