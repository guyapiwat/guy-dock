 ...
 if(isset($_GET['tstype'])){
	...
	$rsss = mysql_query($sql);
			...
			if (mysql_num_rows($result)>0 and mysql_num_rows($result123)>0 ) {
				...
				$sqlewallet = " select ewallet,mobile,name_f from ".$dbprefix."member where mcode = '".$mcode."'";
				//echo $sqlewallet;
				...
				optionCash,optionFuture,optionTransfer,optionCredit1,optionCredit2,optionCredit3,ewallet_before,ewallet_after,checkportal,bprice,locationbase,name_f
				...
				'$total','0','$txtCredit2','$txtCredit3','$optionCash','$optionFuture','$optionTransfer','$optionCredit1','$optionCredit2','$optionCredit3','".$ewallet_before."','".$ewallet_after."','1','$bprice','$locationbase','$name_f'
				) ";
