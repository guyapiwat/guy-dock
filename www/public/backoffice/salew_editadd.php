...
var wi=null;
	...
	function cal(){
		...
		for(i=0;i<(tag.length-skip)/12;i++){
			...
			bv = parseInt(tag[step+4].value);
			fv = parseInt(tag[step+5].value);
			num = parseInt(tag[step+6].value);
...
<form method="post" action="saleoperate.php?state=<?=$_GET['id']==""?0:1?>" name="frm">
  ...
  <tr valign="top">
	...
	<br><Br>
    <iframe width="400" height="300" frameborder="0" src="./package_show.php" ></iframe></td>
  </tr>
</table>
</form>
