...
$sql  = "SELECT mdate,national,name_f,id_card,irelation,".$dbprefix."location_base.cshort,iphone,mcode,name_t,'บริษัท ซัคเซสมอร์ บีอิ้งค์ จำกัด' as successmore  ";
...
$sql .= "left join ".$dbprefix."location_base on  ".$dbprefix."member.locationbase = ".$dbprefix."location_base.cid where 1=1  ";
...
//$wherecause = " WHERE ";
	...
	/*if($_GET['state']==1){
		...
		$rec->setLink($PHP_SELF,"sessiontab=1&sub=21&fdate=$fdate&tdate=$tdate&locationbase=$locationbase");
