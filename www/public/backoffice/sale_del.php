...
require_once ("function.log.inc.php");
	...
	for ($i=0;$i<$numpost;$i++) {
		...
		if (mysql_num_rows($rs)>0){
            ...
            <?
			//====================LOG===========================
$text="uid=".$_SESSION["adminusercode"]." action=sale_del=>delete from ".$dbprefix."asaleh where id='$id'";
writelogfile($text);
//=================END LOG===========================
			mysql_query("delete from ".$dbprefix."asaleh where id='$id' ");
			//====================LOG===========================
$text="uid=".$_SESSION["adminusercode"]." action=sale_del=>delete from ".$dbprefix."asaled where sano='$id' ";
writelogfile($text);
//=================END LOG===========================
		...
		logtext(true,$_SESSION['adminusercode'],'ลบบิล',$row->sano);
