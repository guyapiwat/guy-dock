...
<?
	...
	$rs = mysql_query($sql);
	?>
    <input size="5" style="border:0; text-align:right;" type="text" value="&#3629;&#3635;&#3648;&#3616;&#3629;"/>&nbsp;<select name="camphur" id="camphur" style="width:150px;" tabindex="60"  onChange="startAddressRQ('cdistrict',this.value)"><?
