...
?>
<form method="post" action="holdoperate.php?state=<?=$_GET['id']==""?0:1?>" name="frm" style="display:none">
  <table border="0">
  <tr valign="top">
    <td>
...
<center>
<iframe width="100%" height="600" frameborder="0" src="./hold_product_show.php?bid=<?=$_GET['bid']?>" ></iframe>
</center>