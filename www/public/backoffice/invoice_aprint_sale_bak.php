...
$typedef = array('A'=>"บิลขายปกติ",'Q'=>"รักษายอด",'H'=>"บิล BMC");
...
//info---------------------------------------
	...
	$pdf->Cell((3*$offsettab),10,'บิลใบเสร็จ',0,0,"L");
	...
	$pdf->SetY($offsety+(4*$offsetnline)-4);
	$pdf->SetX($offsetx+(12*$offsettab)+5);
