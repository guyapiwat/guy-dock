    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="50%">
      <tr>
        ...
        <table align="center"><tr>
          ...
          <tr>
              <td width="34%" align="right" valign="top" >Code<font color="#ff0000">*</font></td>
              <td colspan="2">&nbsp;<input type="text" name="code" value="<?=$code?>" /></td>
          </tr>
          </table>
      ...
      <tr>
        ...
        <td colspan="2">&nbsp;
          ...
          &nbsp;
            <input type="reset" value="ยกเลิก" name="B2" onclick="window.location='index.php?sessiontab=5&sub=3'"/></td>
      </tr>
    </table>
</form>