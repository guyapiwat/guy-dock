...
if(isset($_GET['bid']))
	$id = $_GET['bid'];
	$dbprefix = "ali_";
	$employee_name = " Jasmin Inter Network Co.,Ltd.";
?>
<?
...
for($i=0;$i<sizeof($bill);$i++){
	...
	$pdf->SetX($offsetx+(2*$offsettab)+5);
	$pdf->Cell((4*$offsettab),10,"72 Moo18 Kanjanapisek Rd,T.Meanang,A.Bangyai,Nontaburi 11140  ",0,0,"L"); 
	$pdf->SetY($offsety+3*$offsetnline);
	$pdf->SetX($offsetx+(2*$offsettab)+5);
	$pdf->Cell((4*$offsettab),10,"Tel 02-1922589-90, Fax 02-1922587",0,0,"L"); 
