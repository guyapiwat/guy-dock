...
$sql = "SELECT '".$_GET["sessiontab"]."' as sessiontab,'".$_GET["sub"]."' as sub,'".$_GET["chktype"]."' as chktype,'".$_GET["send"]."' as sendx ,'".$_GET["sano"]."' as sanox ,cancel,".$dbprefix."risaleh.id,".$dbprefix."risaleh.inv_code,hono,sano,DATE_FORMAT(".$dbprefix."risaleh.sadate, '%d-%m-%Y') as sadate,tot_pv,total,name_t,hstatus,".$dbprefix."risaleh.inv_code AS smcode";
...
//echo  $sql;
	...
	if($_GET['state']==1){
		...
		$rec->setLink($PHP_SELF,"sessiontab=".$_GET["sessiontab"]."&sub=24");
	...
	//	$rec->setFieldLink(",,index.php?sessiontab=1&sub=4&cmc=,");
		...
		$rec->setSpecial("./images/cancel.gif","","sale_cancel","id,chktype,sendx,sanox,sub,sessiontab","IMAGE","ยกเลิก");
