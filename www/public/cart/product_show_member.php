...
$sql = "SELECT 'add' as action,".$dbprefix."product.pcode,".$dbprefix."product.pdesc,".$dbprefix."product.customer_price,".$dbprefix."product.pv,".$dbprefix."product.price as price,".$dbprefix."productgroup.groupname ";
...
$sql .=" FROM ".$dbprefix."product LEFT JOIN ".$dbprefix."productgroup  ON (".$dbprefix."productgroup.id=".$dbprefix."product.group_id)  
where st = 1   and locationbase = '".$_SESSION["m_locationbase"]."'   ";
...
if(isset($page))
    $rec->setCurPage($page);
$rec->setShowField("pcode,pdesc1,customer_price,price,pv");
