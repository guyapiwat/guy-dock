...
$sqlmtype = ",CASE mtype1 WHEN '0' THEN '".$wording_lan["mtype"]["0"]."' WHEN '1' THEN '".$wording_lan["mtype"]["1"]."' WHEN '2' THEN '".$wording_lan["mtype"]["2"]."' WHEN '3' THEN '".$wording_lan["mtype"]["3"]."' END AS mtype ";
