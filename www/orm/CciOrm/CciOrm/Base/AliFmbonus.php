...
/**
 * Base class that represents a row from the 'ali_fmbonus' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliFmbonus implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliFmbonusTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliFmbonus object.
     */
    ...
    /**
     * Compares this with another <code>AliFmbonus</code> instance.  If
     * <code>obj</code> is an instance of <code>AliFmbonus</code>, delegates to
     * <code>equals(AliFmbonus)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliFmbonus The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliFmbonus The current object (for fluent API support)
     */
    public function setAid($v)
    {
        ...
        if ($this->aid !== $v) {
            $this->aid = $v;
            $this->modifiedColumns[AliFmbonusTableMap::COL_AID] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliFmbonusTableMap::COL_RCODE] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliFmbonusTableMap::COL_MCODE] = true;
        }
    ...
    public function setNameT($v)
    {
        ...
        if ($this->name_t !== $v) {
            $this->name_t = $v;
            $this->modifiedColumns[AliFmbonusTableMap::COL_NAME_T] = true;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[AliFmbonusTableMap::COL_TOTAL] = true;
        }
    ...
    public function setTotalR($v)
    {
        ...
        if ($this->total_r !== $v) {
            $this->total_r = $v;
            $this->modifiedColumns[AliFmbonusTableMap::COL_TOTAL_R] = true;
        }
    ...
    public function setTax($v)
    {
        ...
        if ($this->tax !== $v) {
            $this->tax = $v;
            $this->modifiedColumns[AliFmbonusTableMap::COL_TAX] = true;
        }
    ...
    public function setBonus($v)
    {
        ...
        if ($this->bonus !== $v) {
            $this->bonus = $v;
            $this->modifiedColumns[AliFmbonusTableMap::COL_BONUS] = true;
        }
    ...
    public function setFdate($v)
    {
        ...
        if ($this->fdate !== null || $dt !== null) {
            if ($this->fdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliFmbonusTableMap::COL_FDATE] = true;
            }
    ...
    public function setTdate($v)
    {
        ...
        if ($this->tdate !== null || $dt !== null) {
            if ($this->tdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliFmbonusTableMap::COL_TDATE] = true;
            }
        } // if either are not null
    ...
    public function setPosCur($v)
    {
        ...
        if ($this->pos_cur !== $v) {
            $this->pos_cur = $v;
            $this->modifiedColumns[AliFmbonusTableMap::COL_POS_CUR] = true;
        }
    ...
    public function setCrate($v)
    {
        ...
        if ($this->crate !== $v) {
            $this->crate = $v;
            $this->modifiedColumns[AliFmbonusTableMap::COL_CRATE] = true;
        }
    ...
    public function setLocationbase($v)
    {
        ...
        if ($this->locationbase !== $v) {
            $this->locationbase = $v;
            $this->modifiedColumns[AliFmbonusTableMap::COL_LOCATIONBASE] = true;
        }
    ...
    public function setPaydate($v)
    {
        ...
        if ($this->paydate !== null || $dt !== null) {
            if ($this->paydate === null || $dt === null || $dt->format("Y-m-d") !== $this->paydate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliFmbonusTableMap::COL_PAYDATE] = true;
            }
        } // if either are not null
    ...
    public function setInvCode($v)
    {
        ...
        if ($this->inv_code !== $v) {
            $this->inv_code = $v;
            $this->modifiedColumns[AliFmbonusTableMap::COL_INV_CODE] = true;
        }
    ...
    public function setPaytype($v)
    {
        ...
        if ($this->paytype !== $v) {
            $this->paytype = $v;
            $this->modifiedColumns[AliFmbonusTableMap::COL_PAYTYPE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliFmbonusTableMap::translateFieldName('Aid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->aid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliFmbonusTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliFmbonusTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliFmbonusTableMap::translateFieldName('NameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliFmbonusTableMap::translateFieldName('Total', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliFmbonusTableMap::translateFieldName('TotalR', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_r = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliFmbonusTableMap::translateFieldName('Tax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliFmbonusTableMap::translateFieldName('Bonus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bonus = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliFmbonusTableMap::translateFieldName('Fdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliFmbonusTableMap::translateFieldName('Tdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->tdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliFmbonusTableMap::translateFieldName('PosCur', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pos_cur = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliFmbonusTableMap::translateFieldName('Crate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->crate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliFmbonusTableMap::translateFieldName('Locationbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->locationbase = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliFmbonusTableMap::translateFieldName('Paydate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->paydate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliFmbonusTableMap::translateFieldName('InvCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliFmbonusTableMap::translateFieldName('Paytype', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 16; // 16 = AliFmbonusTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliFmbonus'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliFmbonusQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliFmbonus::setDeleted()
     * @see AliFmbonus::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliFmbonusQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliFmbonusTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliFmbonusTableMap::COL_AID)) {
            $modifiedColumns[':p' . $index++]  = 'aid';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_NAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'name_t';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'total';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_TOTAL_R)) {
            $modifiedColumns[':p' . $index++]  = 'total_r';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_TAX)) {
            $modifiedColumns[':p' . $index++]  = 'tax';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_BONUS)) {
            $modifiedColumns[':p' . $index++]  = 'bonus';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_FDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fdate';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_TDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tdate';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_POS_CUR)) {
            $modifiedColumns[':p' . $index++]  = 'pos_cur';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_CRATE)) {
            $modifiedColumns[':p' . $index++]  = 'crate';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_LOCATIONBASE)) {
            $modifiedColumns[':p' . $index++]  = 'locationbase';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_PAYDATE)) {
            $modifiedColumns[':p' . $index++]  = 'paydate';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_INV_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'inv_code';
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_PAYTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'paytype';
        }

        $sql = sprintf(
            'INSERT INTO ali_fmbonus (%s) VALUES (%s)',
    ...
    {
        $pos = AliFmbonusTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliFmbonus'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliFmbonus'][$this->hashCode()] = true;
        $keys = AliFmbonusTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getAid(),
            ...
            $keys[5] => $this->getTotalR(),
            $keys[6] => $this->getTax(),
            $keys[7] => $this->getBonus(),
            $keys[8] => $this->getFdate(),
            $keys[9] => $this->getTdate(),
            $keys[10] => $this->getPosCur(),
            $keys[11] => $this->getCrate(),
            $keys[12] => $this->getLocationbase(),
            $keys[13] => $this->getPaydate(),
            $keys[14] => $this->getInvCode(),
            $keys[15] => $this->getPaytype(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliFmbonus
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[11], $arr)) {
            $this->setCrate($arr[$keys[11]]);
        }
        if (array_key_exists($keys[12], $arr)) {
            $this->setLocationbase($arr[$keys[12]]);
        }
        if (array_key_exists($keys[13], $arr)) {
            $this->setPaydate($arr[$keys[13]]);
        }
        if (array_key_exists($keys[14], $arr)) {
            $this->setInvCode($arr[$keys[14]]);
        }
        if (array_key_exists($keys[15], $arr)) {
            $this->setPaytype($arr[$keys[15]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliFmbonus The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliFmbonusTableMap::COL_AID)) {
            $criteria->add(AliFmbonusTableMap::COL_AID, $this->aid);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_RCODE)) {
            $criteria->add(AliFmbonusTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_MCODE)) {
            $criteria->add(AliFmbonusTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_NAME_T)) {
            $criteria->add(AliFmbonusTableMap::COL_NAME_T, $this->name_t);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_TOTAL)) {
            $criteria->add(AliFmbonusTableMap::COL_TOTAL, $this->total);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_TOTAL_R)) {
            $criteria->add(AliFmbonusTableMap::COL_TOTAL_R, $this->total_r);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_TAX)) {
            $criteria->add(AliFmbonusTableMap::COL_TAX, $this->tax);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_BONUS)) {
            $criteria->add(AliFmbonusTableMap::COL_BONUS, $this->bonus);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_FDATE)) {
            $criteria->add(AliFmbonusTableMap::COL_FDATE, $this->fdate);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_TDATE)) {
            $criteria->add(AliFmbonusTableMap::COL_TDATE, $this->tdate);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_POS_CUR)) {
            $criteria->add(AliFmbonusTableMap::COL_POS_CUR, $this->pos_cur);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_CRATE)) {
            $criteria->add(AliFmbonusTableMap::COL_CRATE, $this->crate);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_LOCATIONBASE)) {
            $criteria->add(AliFmbonusTableMap::COL_LOCATIONBASE, $this->locationbase);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_PAYDATE)) {
            $criteria->add(AliFmbonusTableMap::COL_PAYDATE, $this->paydate);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_INV_CODE)) {
            $criteria->add(AliFmbonusTableMap::COL_INV_CODE, $this->inv_code);
        }
        if ($this->isColumnModified(AliFmbonusTableMap::COL_PAYTYPE)) {
            $criteria->add(AliFmbonusTableMap::COL_PAYTYPE, $this->paytype);
        }
    ...
    {
        $criteria = ChildAliFmbonusQuery::create();
        $criteria->add(AliFmbonusTableMap::COL_AID, $this->aid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliFmbonus (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliFmbonus Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliFmbonusTableMap::DEFAULT_STRING_FORMAT);
    }
