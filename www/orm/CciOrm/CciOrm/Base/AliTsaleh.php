...
/**
 * Base class that represents a row from the 'ali_tsaleh' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliTsaleh implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliTsalehTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliTsaleh object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>AliTsaleh</code> instance.  If
     * <code>obj</code> is an instance of <code>AliTsaleh</code>, delegates to
     * <code>equals(AliTsaleh)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliTsaleh The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliTsaleh The current object (for fluent API support)
     */
    public function setSano($v)
    {
        ...
        if ($this->sano !== $v) {
            $this->sano = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_SANO] = true;
        }
    ...
    public function setNameF($v)
    {
        ...
        if ($this->name_f !== $v) {
            $this->name_f = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_NAME_F] = true;
        }
    ...
    public function setNameT($v)
    {
        ...
        if ($this->name_t !== $v) {
            $this->name_t = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_NAME_T] = true;
        }
    ...
    public function setSadate($v)
    {
        ...
        if ($this->sadate !== null || $dt !== null) {
            if ($this->sadate === null || $dt === null || $dt->format("Y-m-d") !== $this->sadate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliTsalehTableMap::COL_SADATE] = true;
            }
    ...
    public function setSctime($v)
    {
        ...
        if ($this->sctime !== null || $dt !== null) {
            if ($this->sctime === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->sctime->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AliTsalehTableMap::COL_SCTIME] = true;
            }
        } // if either are not null
    ...
    public function setInvCode($v)
    {
        ...
        if ($this->inv_code !== $v) {
            $this->inv_code = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_INV_CODE] = true;
        }
    ...
    public function setLid($v)
    {
        ...
        if ($this->lid !== $v) {
            $this->lid = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_LID] = true;
        }
    ...
    public function setInvFrom($v)
    {
        ...
        if ($this->inv_from !== $v) {
            $this->inv_from = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_INV_FROM] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_MCODE] = true;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TOTAL] = true;
        }
    ...
    public function setTotPv($v)
    {
        ...
        if ($this->tot_pv !== $v) {
            $this->tot_pv = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TOT_PV] = true;
        }
    ...
    public function setTotBv($v)
    {
        ...
        if ($this->tot_bv !== $v) {
            $this->tot_bv = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TOT_BV] = true;
        }
    ...
    public function setTotFv($v)
    {
        ...
        if ($this->tot_fv !== $v) {
            $this->tot_fv = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TOT_FV] = true;
        }
    ...
    public function setUsercode($v)
    {
        ...
        if ($this->usercode !== $v) {
            $this->usercode = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_USERCODE] = true;
        }
    ...
    public function setRemark($v)
    {
        ...
        if ($this->remark !== $v) {
            $this->remark = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_REMARK] = true;
        }
    ...
    public function setTrnf($v)
    {
        ...
        if ($this->trnf !== $v) {
            $this->trnf = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TRNF] = true;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_ID] = true;
        }
    ...
    public function setSaType($v)
    {
        ...
        if ($this->sa_type !== $v) {
            $this->sa_type = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_SA_TYPE] = true;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_UID] = true;
        }
    ...
    public function setDl($v)
    {
        ...
        if ($this->dl !== $v) {
            $this->dl = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_DL] = true;
        }
    ...
    public function setCancel($v)
    {
        ...
        if ($this->cancel !== $v) {
            $this->cancel = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CANCEL] = true;
        }
    ...
    public function setSend($v)
    {
        ...
        if ($this->send !== $v) {
            $this->send = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_SEND] = true;
        }
    ...
    public function setTxtoption($v)
    {
        ...
        if ($this->txtoption !== $v) {
            $this->txtoption = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TXTOPTION] = true;
        }
    ...
    public function setChkcash($v)
    {
        ...
        if ($this->chkcash !== $v) {
            $this->chkcash = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CHKCASH] = true;
        }
    ...
    public function setChkfuture($v)
    {
        ...
        if ($this->chkfuture !== $v) {
            $this->chkfuture = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CHKFUTURE] = true;
        }
    ...
    public function setChktransfer($v)
    {
        ...
        if ($this->chktransfer !== $v) {
            $this->chktransfer = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CHKTRANSFER] = true;
        }
    ...
    public function setChkcredit1($v)
    {
        ...
        if ($this->chkcredit1 !== $v) {
            $this->chkcredit1 = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CHKCREDIT1] = true;
        }
    ...
    public function setChkcredit2($v)
    {
        ...
        if ($this->chkcredit2 !== $v) {
            $this->chkcredit2 = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CHKCREDIT2] = true;
        }
    ...
    public function setChkcredit3($v)
    {
        ...
        if ($this->chkcredit3 !== $v) {
            $this->chkcredit3 = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CHKCREDIT3] = true;
        }
    ...
    public function setChkinternet($v)
    {
        ...
        if ($this->chkinternet !== $v) {
            $this->chkinternet = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CHKINTERNET] = true;
        }
    ...
    public function setChkdiscount($v)
    {
        ...
        if ($this->chkdiscount !== $v) {
            $this->chkdiscount = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CHKDISCOUNT] = true;
        }
    ...
    public function setChkother($v)
    {
        ...
        if ($this->chkother !== $v) {
            $this->chkother = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CHKOTHER] = true;
        }
    ...
    public function setTxtcash($v)
    {
        ...
        if ($this->txtcash !== $v) {
            $this->txtcash = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TXTCASH] = true;
        }
    ...
    public function setTxtfuture($v)
    {
        ...
        if ($this->txtfuture !== $v) {
            $this->txtfuture = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TXTFUTURE] = true;
        }
    ...
    public function setTxttransfer($v)
    {
        ...
        if ($this->txttransfer !== $v) {
            $this->txttransfer = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TXTTRANSFER] = true;
        }
    ...
    public function setEwallet($v)
    {
        ...
        if ($this->ewallet !== $v) {
            $this->ewallet = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_EWALLET] = true;
        }
    ...
    public function setTxtcredit1($v)
    {
        ...
        if ($this->txtcredit1 !== $v) {
            $this->txtcredit1 = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TXTCREDIT1] = true;
        }
    ...
    public function setTxtcredit2($v)
    {
        ...
        if ($this->txtcredit2 !== $v) {
            $this->txtcredit2 = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TXTCREDIT2] = true;
        }
    ...
    public function setTxtcredit3($v)
    {
        ...
        if ($this->txtcredit3 !== $v) {
            $this->txtcredit3 = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TXTCREDIT3] = true;
        }
    ...
    public function setTxtinternet($v)
    {
        ...
        if ($this->txtinternet !== $v) {
            $this->txtinternet = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TXTINTERNET] = true;
        }
    ...
    public function setTxtdiscount($v)
    {
        ...
        if ($this->txtdiscount !== $v) {
            $this->txtdiscount = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TXTDISCOUNT] = true;
        }
    ...
    public function setTxtother($v)
    {
        ...
        if ($this->txtother !== $v) {
            $this->txtother = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_TXTOTHER] = true;
        }
    ...
    public function setOptioncash($v)
    {
        ...
        if ($this->optioncash !== $v) {
            $this->optioncash = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_OPTIONCASH] = true;
        }
    ...
    public function setOptionfuture($v)
    {
        ...
        if ($this->optionfuture !== $v) {
            $this->optionfuture = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_OPTIONFUTURE] = true;
        }
    ...
    public function setOptiontransfer($v)
    {
        ...
        if ($this->optiontransfer !== $v) {
            ...
            $this->modifiedColumns[AliTsalehTableMap::COL_OPTIONTRANSFER] = true;
        }
    ...
    public function setOptioncredit1($v)
    {
        ...
        if ($this->optioncredit1 !== $v) {
            ...
            $this->modifiedColumns[AliTsalehTableMap::COL_OPTIONCREDIT1] = true;
        }
    ...
    public function setOptioncredit2($v)
    {
        ...
        if ($this->optioncredit2 !== $v) {
            ...
            $this->modifiedColumns[AliTsalehTableMap::COL_OPTIONCREDIT2] = true;
        }
    ...
    public function setOptioncredit3($v)
    {
        ...
        if ($this->optioncredit3 !== $v) {
            ...
            $this->modifiedColumns[AliTsalehTableMap::COL_OPTIONCREDIT3] = true;
        }
    ...
    public function setOptioninternet($v)
    {
        ...
        if ($this->optioninternet !== $v) {
            ...
            $this->modifiedColumns[AliTsalehTableMap::COL_OPTIONINTERNET] = true;
        }
    ...
    public function setOptiondiscount($v)
    {
        ...
        if ($this->optiondiscount !== $v) {
            ...
            $this->modifiedColumns[AliTsalehTableMap::COL_OPTIONDISCOUNT] = true;
        }
    ...
    public function setOptionother($v)
    {
        ...
        if ($this->optionother !== $v) {
            $this->optionother = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_OPTIONOTHER] = true;
        }
    ...
    public function setDiscount($v)
    {
        ...
        if ($this->discount !== $v) {
            $this->discount = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_DISCOUNT] = true;
        }
    ...
    public function setSender($v)
    {
        ...
        if ($this->sender !== $v) {
            $this->sender = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_SENDER] = true;
        }
    ...
    public function setSenderDate($v)
    {
        ...
        if ($this->sender_date !== null || $dt !== null) {
            if ($this->sender_date === null || $dt === null || $dt->format("Y-m-d") !== $this->sender_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliTsalehTableMap::COL_SENDER_DATE] = true;
            }
        } // if either are not null
    ...
    public function setReceive($v)
    {
        ...
        if ($this->receive !== $v) {
            $this->receive = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_RECEIVE] = true;
        }
    ...
    public function setReceiveDate($v)
    {
        ...
        if ($this->receive_date !== null || $dt !== null) {
            if ($this->receive_date === null || $dt === null || $dt->format("Y-m-d") !== $this->receive_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliTsalehTableMap::COL_RECEIVE_DATE] = true;
            }
        } // if either are not null
    ...
    public function setPrint($v)
    {
        ...
        if ($this->print !== $v) {
            $this->print = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_PRINT] = true;
        }
    ...
    public function setEwalletBefore($v)
    {
        ...
        if ($this->ewallet_before !== $v) {
            ...
            $this->modifiedColumns[AliTsalehTableMap::COL_EWALLET_BEFORE] = true;
        }
    ...
    public function setEwalletAfter($v)
    {
        ...
        if ($this->ewallet_after !== $v) {
            ...
            $this->modifiedColumns[AliTsalehTableMap::COL_EWALLET_AFTER] = true;
        }
    ...
    public function setEwallettBefore($v)
    {
        ...
        if ($this->ewallett_before !== $v) {
            ...
            $this->modifiedColumns[AliTsalehTableMap::COL_EWALLETT_BEFORE] = true;
        }
    ...
    public function setEwallettAfter($v)
    {
        ...
        if ($this->ewallett_after !== $v) {
            ...
            $this->modifiedColumns[AliTsalehTableMap::COL_EWALLETT_AFTER] = true;
        }
    ...
    public function setCancelDate($v)
    {
        ...
        if ($this->cancel_date !== null || $dt !== null) {
            if ($this->cancel_date === null || $dt === null || $dt->format("Y-m-d") !== $this->cancel_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliTsalehTableMap::COL_CANCEL_DATE] = true;
            }
        } // if either are not null
    ...
    public function setUidCancel($v)
    {
        ...
        if ($this->uid_cancel !== $v) {
            $this->uid_cancel = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_UID_CANCEL] = true;
        }
    ...
    public function setMbase($v)
    {
        ...
        if ($this->mbase !== $v) {
            $this->mbase = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_MBASE] = true;
        }
    ...
    public function setBprice($v)
    {
        ...
        if ($this->bprice !== $v) {
            $this->bprice = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_BPRICE] = true;
        }
    ...
    public function setLocationbase($v)
    {
        ...
        if ($this->locationbase !== $v) {
            $this->locationbase = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_LOCATIONBASE] = true;
        }
    ...
    public function setCrate($v)
    {
        ...
        if ($this->crate !== $v) {
            $this->crate = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CRATE] = true;
        }
    ...
    public function setCheckportal($v)
    {
        ...
        if ($this->checkportal !== $v) {
            $this->checkportal = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CHECKPORTAL] = true;
        }
    ...
    public function setUidReceive($v)
    {
        ...
        if ($this->uid_receive !== $v) {
            $this->uid_receive = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_UID_RECEIVE] = true;
        }
    ...
    public function setUidSender($v)
    {
        ...
        if ($this->uid_sender !== $v) {
            $this->uid_sender = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_UID_SENDER] = true;
        }
    ...
    public function setCaddress($v)
    {
        ...
        if ($this->caddress !== $v) {
            $this->caddress = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CADDRESS] = true;
        }
    ...
    public function setCdistrictid($v)
    {
        ...
        if ($this->cdistrictid !== $v) {
            $this->cdistrictid = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CDISTRICTID] = true;
        }
    ...
    public function setCamphurid($v)
    {
        ...
        if ($this->camphurid !== $v) {
            $this->camphurid = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CAMPHURID] = true;
        }
    ...
    public function setCprovinceid($v)
    {
        ...
        if ($this->cprovinceid !== $v) {
            $this->cprovinceid = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CPROVINCEID] = true;
        }
    ...
    public function setCzip($v)
    {
        ...
        if ($this->czip !== $v) {
            $this->czip = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_CZIP] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[AliTsalehTableMap::COL_STATUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliTsalehTableMap::translateFieldName('Sano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliTsalehTableMap::translateFieldName('NameF', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_f = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliTsalehTableMap::translateFieldName('NameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliTsalehTableMap::translateFieldName('Sadate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->sadate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliTsalehTableMap::translateFieldName('Sctime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->sctime = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliTsalehTableMap::translateFieldName('InvCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliTsalehTableMap::translateFieldName('Lid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliTsalehTableMap::translateFieldName('InvFrom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_from = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliTsalehTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliTsalehTableMap::translateFieldName('Total', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliTsalehTableMap::translateFieldName('TotPv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tot_pv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliTsalehTableMap::translateFieldName('TotBv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tot_bv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliTsalehTableMap::translateFieldName('TotFv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tot_fv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliTsalehTableMap::translateFieldName('Usercode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usercode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliTsalehTableMap::translateFieldName('Remark', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remark = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliTsalehTableMap::translateFieldName('Trnf', TableMap::TYPE_PHPNAME, $indexType)];
            $this->trnf = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AliTsalehTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AliTsalehTableMap::translateFieldName('SaType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sa_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : AliTsalehTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : AliTsalehTableMap::translateFieldName('Dl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : AliTsalehTableMap::translateFieldName('Cancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cancel = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : AliTsalehTableMap::translateFieldName('Send', TableMap::TYPE_PHPNAME, $indexType)];
            $this->send = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : AliTsalehTableMap::translateFieldName('Txtoption', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtoption = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : AliTsalehTableMap::translateFieldName('Chkcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : AliTsalehTableMap::translateFieldName('Chkfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : AliTsalehTableMap::translateFieldName('Chktransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : AliTsalehTableMap::translateFieldName('Chkcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : AliTsalehTableMap::translateFieldName('Chkcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : AliTsalehTableMap::translateFieldName('Chkcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : AliTsalehTableMap::translateFieldName('Chkinternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkinternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : AliTsalehTableMap::translateFieldName('Chkdiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkdiscount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : AliTsalehTableMap::translateFieldName('Chkother', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkother = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : AliTsalehTableMap::translateFieldName('Txtcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : AliTsalehTableMap::translateFieldName('Txtfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : AliTsalehTableMap::translateFieldName('Txttransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : AliTsalehTableMap::translateFieldName('Ewallet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : AliTsalehTableMap::translateFieldName('Txtcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : AliTsalehTableMap::translateFieldName('Txtcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : AliTsalehTableMap::translateFieldName('Txtcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : AliTsalehTableMap::translateFieldName('Txtinternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtinternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : AliTsalehTableMap::translateFieldName('Txtdiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtdiscount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : AliTsalehTableMap::translateFieldName('Txtother', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtother = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : AliTsalehTableMap::translateFieldName('Optioncash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : AliTsalehTableMap::translateFieldName('Optionfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : AliTsalehTableMap::translateFieldName('Optiontransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : AliTsalehTableMap::translateFieldName('Optioncredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : AliTsalehTableMap::translateFieldName('Optioncredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : AliTsalehTableMap::translateFieldName('Optioncredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : AliTsalehTableMap::translateFieldName('Optioninternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioninternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : AliTsalehTableMap::translateFieldName('Optiondiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiondiscount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : AliTsalehTableMap::translateFieldName('Optionother', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionother = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : AliTsalehTableMap::translateFieldName('Discount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discount = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : AliTsalehTableMap::translateFieldName('Sender', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sender = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : AliTsalehTableMap::translateFieldName('SenderDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->sender_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : AliTsalehTableMap::translateFieldName('Receive', TableMap::TYPE_PHPNAME, $indexType)];
            $this->receive = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : AliTsalehTableMap::translateFieldName('ReceiveDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->receive_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : AliTsalehTableMap::translateFieldName('Print', TableMap::TYPE_PHPNAME, $indexType)];
            $this->print = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : AliTsalehTableMap::translateFieldName('EwalletBefore', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_before = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 58 + $startcol : AliTsalehTableMap::translateFieldName('EwalletAfter', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_after = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 59 + $startcol : AliTsalehTableMap::translateFieldName('EwallettBefore', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallett_before = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 60 + $startcol : AliTsalehTableMap::translateFieldName('EwallettAfter', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallett_after = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 61 + $startcol : AliTsalehTableMap::translateFieldName('CancelDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->cancel_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 62 + $startcol : AliTsalehTableMap::translateFieldName('UidCancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid_cancel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 63 + $startcol : AliTsalehTableMap::translateFieldName('Mbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mbase = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 64 + $startcol : AliTsalehTableMap::translateFieldName('Bprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 65 + $startcol : AliTsalehTableMap::translateFieldName('Locationbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->locationbase = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 66 + $startcol : AliTsalehTableMap::translateFieldName('Crate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->crate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 67 + $startcol : AliTsalehTableMap::translateFieldName('Checkportal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->checkportal = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 68 + $startcol : AliTsalehTableMap::translateFieldName('UidReceive', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid_receive = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 69 + $startcol : AliTsalehTableMap::translateFieldName('UidSender', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid_sender = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 70 + $startcol : AliTsalehTableMap::translateFieldName('Caddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->caddress = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 71 + $startcol : AliTsalehTableMap::translateFieldName('Cdistrictid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cdistrictid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 72 + $startcol : AliTsalehTableMap::translateFieldName('Camphurid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->camphurid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 73 + $startcol : AliTsalehTableMap::translateFieldName('Cprovinceid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cprovinceid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 74 + $startcol : AliTsalehTableMap::translateFieldName('Czip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->czip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 75 + $startcol : AliTsalehTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 76; // 76 = AliTsalehTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliTsaleh'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliTsalehQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliTsaleh::setDeleted()
     * @see AliTsaleh::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliTsalehQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliTsalehTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliTsalehTableMap::COL_SANO)) {
            $modifiedColumns[':p' . $index++]  = 'sano';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_NAME_F)) {
            $modifiedColumns[':p' . $index++]  = 'name_f';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_NAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'name_t';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_SADATE)) {
            $modifiedColumns[':p' . $index++]  = 'sadate';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_SCTIME)) {
            $modifiedColumns[':p' . $index++]  = 'sctime';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_INV_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'inv_code';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_LID)) {
            $modifiedColumns[':p' . $index++]  = 'lid';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_INV_FROM)) {
            $modifiedColumns[':p' . $index++]  = 'inv_from';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'total';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TOT_PV)) {
            $modifiedColumns[':p' . $index++]  = 'tot_pv';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TOT_BV)) {
            $modifiedColumns[':p' . $index++]  = 'tot_bv';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TOT_FV)) {
            $modifiedColumns[':p' . $index++]  = 'tot_fv';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_USERCODE)) {
            $modifiedColumns[':p' . $index++]  = 'usercode';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_REMARK)) {
            $modifiedColumns[':p' . $index++]  = 'remark';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TRNF)) {
            $modifiedColumns[':p' . $index++]  = 'trnf';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_SA_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'sa_type';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_DL)) {
            $modifiedColumns[':p' . $index++]  = 'dl';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'cancel';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_SEND)) {
            $modifiedColumns[':p' . $index++]  = 'send';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTOPTION)) {
            $modifiedColumns[':p' . $index++]  = 'txtoption';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKCASH)) {
            $modifiedColumns[':p' . $index++]  = 'chkCash';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'chkFuture';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit1';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit2';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit3';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'chkInternet';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKDISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'chkDiscount';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKOTHER)) {
            $modifiedColumns[':p' . $index++]  = 'chkOther';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTCASH)) {
            $modifiedColumns[':p' . $index++]  = 'txtCash';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'txtFuture';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_EWALLET)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit1';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit2';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit3';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'txtInternet';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTDISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'txtDiscount';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTOTHER)) {
            $modifiedColumns[':p' . $index++]  = 'txtOther';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONCASH)) {
            $modifiedColumns[':p' . $index++]  = 'optionCash';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'optionFuture';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit1';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit2';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit3';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'optionInternet';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONDISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'optionDiscount';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONOTHER)) {
            $modifiedColumns[':p' . $index++]  = 'optionOther';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_DISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'discount';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_SENDER)) {
            $modifiedColumns[':p' . $index++]  = 'sender';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_SENDER_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'sender_date';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_RECEIVE)) {
            $modifiedColumns[':p' . $index++]  = 'receive';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_RECEIVE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'receive_date';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_PRINT)) {
            $modifiedColumns[':p' . $index++]  = 'print';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_EWALLET_BEFORE)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_before';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_EWALLET_AFTER)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_after';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_EWALLETT_BEFORE)) {
            $modifiedColumns[':p' . $index++]  = 'ewallett_before';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_EWALLETT_AFTER)) {
            $modifiedColumns[':p' . $index++]  = 'ewallett_after';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CANCEL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'cancel_date';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_UID_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'uid_cancel';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_MBASE)) {
            $modifiedColumns[':p' . $index++]  = 'mbase';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_BPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'bprice';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_LOCATIONBASE)) {
            $modifiedColumns[':p' . $index++]  = 'locationbase';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CRATE)) {
            $modifiedColumns[':p' . $index++]  = 'crate';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHECKPORTAL)) {
            $modifiedColumns[':p' . $index++]  = 'checkportal';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_UID_RECEIVE)) {
            $modifiedColumns[':p' . $index++]  = 'uid_receive';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_UID_SENDER)) {
            $modifiedColumns[':p' . $index++]  = 'uid_sender';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'caddress';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CDISTRICTID)) {
            $modifiedColumns[':p' . $index++]  = 'cdistrictId';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CAMPHURID)) {
            $modifiedColumns[':p' . $index++]  = 'camphurId';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CPROVINCEID)) {
            $modifiedColumns[':p' . $index++]  = 'cprovinceId';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CZIP)) {
            $modifiedColumns[':p' . $index++]  = 'czip';
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }

        $sql = sprintf(
            'INSERT INTO ali_tsaleh (%s) VALUES (%s)',
    ...
    {
        $pos = AliTsalehTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliTsaleh'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliTsaleh'][$this->hashCode()] = true;
        $keys = AliTsalehTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSano(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliTsaleh
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliTsaleh The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliTsalehTableMap::COL_SANO)) {
            $criteria->add(AliTsalehTableMap::COL_SANO, $this->sano);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_NAME_F)) {
            $criteria->add(AliTsalehTableMap::COL_NAME_F, $this->name_f);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_NAME_T)) {
            $criteria->add(AliTsalehTableMap::COL_NAME_T, $this->name_t);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_SADATE)) {
            $criteria->add(AliTsalehTableMap::COL_SADATE, $this->sadate);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_SCTIME)) {
            $criteria->add(AliTsalehTableMap::COL_SCTIME, $this->sctime);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_INV_CODE)) {
            $criteria->add(AliTsalehTableMap::COL_INV_CODE, $this->inv_code);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_LID)) {
            $criteria->add(AliTsalehTableMap::COL_LID, $this->lid);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_INV_FROM)) {
            $criteria->add(AliTsalehTableMap::COL_INV_FROM, $this->inv_from);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_MCODE)) {
            $criteria->add(AliTsalehTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TOTAL)) {
            $criteria->add(AliTsalehTableMap::COL_TOTAL, $this->total);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TOT_PV)) {
            $criteria->add(AliTsalehTableMap::COL_TOT_PV, $this->tot_pv);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TOT_BV)) {
            $criteria->add(AliTsalehTableMap::COL_TOT_BV, $this->tot_bv);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TOT_FV)) {
            $criteria->add(AliTsalehTableMap::COL_TOT_FV, $this->tot_fv);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_USERCODE)) {
            $criteria->add(AliTsalehTableMap::COL_USERCODE, $this->usercode);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_REMARK)) {
            $criteria->add(AliTsalehTableMap::COL_REMARK, $this->remark);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TRNF)) {
            $criteria->add(AliTsalehTableMap::COL_TRNF, $this->trnf);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_ID)) {
            $criteria->add(AliTsalehTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_SA_TYPE)) {
            $criteria->add(AliTsalehTableMap::COL_SA_TYPE, $this->sa_type);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_UID)) {
            $criteria->add(AliTsalehTableMap::COL_UID, $this->uid);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_DL)) {
            $criteria->add(AliTsalehTableMap::COL_DL, $this->dl);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CANCEL)) {
            $criteria->add(AliTsalehTableMap::COL_CANCEL, $this->cancel);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_SEND)) {
            $criteria->add(AliTsalehTableMap::COL_SEND, $this->send);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTOPTION)) {
            $criteria->add(AliTsalehTableMap::COL_TXTOPTION, $this->txtoption);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKCASH)) {
            $criteria->add(AliTsalehTableMap::COL_CHKCASH, $this->chkcash);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKFUTURE)) {
            $criteria->add(AliTsalehTableMap::COL_CHKFUTURE, $this->chkfuture);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKTRANSFER)) {
            $criteria->add(AliTsalehTableMap::COL_CHKTRANSFER, $this->chktransfer);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKCREDIT1)) {
            $criteria->add(AliTsalehTableMap::COL_CHKCREDIT1, $this->chkcredit1);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKCREDIT2)) {
            $criteria->add(AliTsalehTableMap::COL_CHKCREDIT2, $this->chkcredit2);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKCREDIT3)) {
            $criteria->add(AliTsalehTableMap::COL_CHKCREDIT3, $this->chkcredit3);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKINTERNET)) {
            $criteria->add(AliTsalehTableMap::COL_CHKINTERNET, $this->chkinternet);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKDISCOUNT)) {
            $criteria->add(AliTsalehTableMap::COL_CHKDISCOUNT, $this->chkdiscount);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHKOTHER)) {
            $criteria->add(AliTsalehTableMap::COL_CHKOTHER, $this->chkother);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTCASH)) {
            $criteria->add(AliTsalehTableMap::COL_TXTCASH, $this->txtcash);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTFUTURE)) {
            $criteria->add(AliTsalehTableMap::COL_TXTFUTURE, $this->txtfuture);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTTRANSFER)) {
            $criteria->add(AliTsalehTableMap::COL_TXTTRANSFER, $this->txttransfer);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_EWALLET)) {
            $criteria->add(AliTsalehTableMap::COL_EWALLET, $this->ewallet);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTCREDIT1)) {
            $criteria->add(AliTsalehTableMap::COL_TXTCREDIT1, $this->txtcredit1);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTCREDIT2)) {
            $criteria->add(AliTsalehTableMap::COL_TXTCREDIT2, $this->txtcredit2);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTCREDIT3)) {
            $criteria->add(AliTsalehTableMap::COL_TXTCREDIT3, $this->txtcredit3);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTINTERNET)) {
            $criteria->add(AliTsalehTableMap::COL_TXTINTERNET, $this->txtinternet);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTDISCOUNT)) {
            $criteria->add(AliTsalehTableMap::COL_TXTDISCOUNT, $this->txtdiscount);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_TXTOTHER)) {
            $criteria->add(AliTsalehTableMap::COL_TXTOTHER, $this->txtother);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONCASH)) {
            $criteria->add(AliTsalehTableMap::COL_OPTIONCASH, $this->optioncash);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONFUTURE)) {
            $criteria->add(AliTsalehTableMap::COL_OPTIONFUTURE, $this->optionfuture);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONTRANSFER)) {
            $criteria->add(AliTsalehTableMap::COL_OPTIONTRANSFER, $this->optiontransfer);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONCREDIT1)) {
            $criteria->add(AliTsalehTableMap::COL_OPTIONCREDIT1, $this->optioncredit1);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONCREDIT2)) {
            $criteria->add(AliTsalehTableMap::COL_OPTIONCREDIT2, $this->optioncredit2);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONCREDIT3)) {
            $criteria->add(AliTsalehTableMap::COL_OPTIONCREDIT3, $this->optioncredit3);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONINTERNET)) {
            $criteria->add(AliTsalehTableMap::COL_OPTIONINTERNET, $this->optioninternet);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONDISCOUNT)) {
            $criteria->add(AliTsalehTableMap::COL_OPTIONDISCOUNT, $this->optiondiscount);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_OPTIONOTHER)) {
            $criteria->add(AliTsalehTableMap::COL_OPTIONOTHER, $this->optionother);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_DISCOUNT)) {
            $criteria->add(AliTsalehTableMap::COL_DISCOUNT, $this->discount);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_SENDER)) {
            $criteria->add(AliTsalehTableMap::COL_SENDER, $this->sender);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_SENDER_DATE)) {
            $criteria->add(AliTsalehTableMap::COL_SENDER_DATE, $this->sender_date);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_RECEIVE)) {
            $criteria->add(AliTsalehTableMap::COL_RECEIVE, $this->receive);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_RECEIVE_DATE)) {
            $criteria->add(AliTsalehTableMap::COL_RECEIVE_DATE, $this->receive_date);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_PRINT)) {
            $criteria->add(AliTsalehTableMap::COL_PRINT, $this->print);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_EWALLET_BEFORE)) {
            $criteria->add(AliTsalehTableMap::COL_EWALLET_BEFORE, $this->ewallet_before);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_EWALLET_AFTER)) {
            $criteria->add(AliTsalehTableMap::COL_EWALLET_AFTER, $this->ewallet_after);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_EWALLETT_BEFORE)) {
            $criteria->add(AliTsalehTableMap::COL_EWALLETT_BEFORE, $this->ewallett_before);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_EWALLETT_AFTER)) {
            $criteria->add(AliTsalehTableMap::COL_EWALLETT_AFTER, $this->ewallett_after);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CANCEL_DATE)) {
            $criteria->add(AliTsalehTableMap::COL_CANCEL_DATE, $this->cancel_date);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_UID_CANCEL)) {
            $criteria->add(AliTsalehTableMap::COL_UID_CANCEL, $this->uid_cancel);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_MBASE)) {
            $criteria->add(AliTsalehTableMap::COL_MBASE, $this->mbase);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_BPRICE)) {
            $criteria->add(AliTsalehTableMap::COL_BPRICE, $this->bprice);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_LOCATIONBASE)) {
            $criteria->add(AliTsalehTableMap::COL_LOCATIONBASE, $this->locationbase);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CRATE)) {
            $criteria->add(AliTsalehTableMap::COL_CRATE, $this->crate);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CHECKPORTAL)) {
            $criteria->add(AliTsalehTableMap::COL_CHECKPORTAL, $this->checkportal);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_UID_RECEIVE)) {
            $criteria->add(AliTsalehTableMap::COL_UID_RECEIVE, $this->uid_receive);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_UID_SENDER)) {
            $criteria->add(AliTsalehTableMap::COL_UID_SENDER, $this->uid_sender);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CADDRESS)) {
            $criteria->add(AliTsalehTableMap::COL_CADDRESS, $this->caddress);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CDISTRICTID)) {
            $criteria->add(AliTsalehTableMap::COL_CDISTRICTID, $this->cdistrictid);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CAMPHURID)) {
            $criteria->add(AliTsalehTableMap::COL_CAMPHURID, $this->camphurid);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CPROVINCEID)) {
            $criteria->add(AliTsalehTableMap::COL_CPROVINCEID, $this->cprovinceid);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_CZIP)) {
            $criteria->add(AliTsalehTableMap::COL_CZIP, $this->czip);
        }
        if ($this->isColumnModified(AliTsalehTableMap::COL_STATUS)) {
            $criteria->add(AliTsalehTableMap::COL_STATUS, $this->status);
        }
    ...
    {
        $criteria = ChildAliTsalehQuery::create();
        $criteria->add(AliTsalehTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliTsaleh (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliTsaleh Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliTsalehTableMap::DEFAULT_STRING_FORMAT);
    }
