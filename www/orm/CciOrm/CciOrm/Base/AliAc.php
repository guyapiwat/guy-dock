...
/**
 * Base class that represents a row from the 'ali_ac' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliAc implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliAcTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliAc object.
     */
    ...
    /**
     * Compares this with another <code>AliAc</code> instance.  If
     * <code>obj</code> is an instance of <code>AliAc</code>, delegates to
     * <code>equals(AliAc)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliAc The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliAc The current object (for fluent API support)
     */
    public function setAid($v)
    {
        ...
        if ($this->aid !== $v) {
            $this->aid = $v;
            $this->modifiedColumns[AliAcTableMap::COL_AID] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliAcTableMap::COL_RCODE] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliAcTableMap::COL_MCODE] = true;
        }
    ...
    public function setNameT($v)
    {
        ...
        if ($this->name_t !== $v) {
            $this->name_t = $v;
            $this->modifiedColumns[AliAcTableMap::COL_NAME_T] = true;
        }
    ...
    public function setMposi($v)
    {
        ...
        if ($this->mposi !== $v) {
            $this->mposi = $v;
            $this->modifiedColumns[AliAcTableMap::COL_MPOSI] = true;
        }
    ...
    public function setUpaCode($v)
    {
        ...
        if ($this->upa_code !== $v) {
            $this->upa_code = $v;
            $this->modifiedColumns[AliAcTableMap::COL_UPA_CODE] = true;
        }
    ...
    public function setUpaName($v)
    {
        ...
        if ($this->upa_name !== $v) {
            $this->upa_name = $v;
            $this->modifiedColumns[AliAcTableMap::COL_UPA_NAME] = true;
        }
    ...
    public function setBposi($v)
    {
        ...
        if ($this->bposi !== $v) {
            $this->bposi = $v;
            $this->modifiedColumns[AliAcTableMap::COL_BPOSI] = true;
        }
    ...
    public function setLevel($v)
    {
        ...
        if ($this->level !== $v) {
            $this->level = $v;
            $this->modifiedColumns[AliAcTableMap::COL_LEVEL] = true;
        }
    ...
    public function setGen($v)
    {
        ...
        if ($this->gen !== $v) {
            $this->gen = $v;
            $this->modifiedColumns[AliAcTableMap::COL_GEN] = true;
        }
    ...
    public function setBtype($v)
    {
        ...
        if ($this->btype !== $v) {
            $this->btype = $v;
            $this->modifiedColumns[AliAcTableMap::COL_BTYPE] = true;
        }
    ...
    public function setPv($v)
    {
        ...
        if ($this->pv !== $v) {
            $this->pv = $v;
            $this->modifiedColumns[AliAcTableMap::COL_PV] = true;
        }
    ...
    public function setPercer($v)
    {
        ...
        if ($this->percer !== $v) {
            $this->percer = $v;
            $this->modifiedColumns[AliAcTableMap::COL_PERCER] = true;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[AliAcTableMap::COL_TOTAL] = true;
        }
    ...
    public function setFdate($v)
    {
        ...
        if ($this->fdate !== null || $dt !== null) {
            if ($this->fdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliAcTableMap::COL_FDATE] = true;
            }
    ...
    public function setTdate($v)
    {
        ...
        if ($this->tdate !== null || $dt !== null) {
            if ($this->tdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliAcTableMap::COL_TDATE] = true;
            }
        } // if either are not null
    ...
    public function setPosCur($v)
    {
        ...
        if ($this->pos_cur !== $v) {
            $this->pos_cur = $v;
            $this->modifiedColumns[AliAcTableMap::COL_POS_CUR] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[AliAcTableMap::COL_TYPE] = true;
        }
    ...
    public function setCrate($v)
    {
        ...
        if ($this->crate !== $v) {
            $this->crate = $v;
            $this->modifiedColumns[AliAcTableMap::COL_CRATE] = true;
        }
    ...
    public function setLocationbase($v)
    {
        ...
        if ($this->locationbase !== $v) {
            $this->locationbase = $v;
            $this->modifiedColumns[AliAcTableMap::COL_LOCATIONBASE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliAcTableMap::translateFieldName('Aid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->aid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliAcTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliAcTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliAcTableMap::translateFieldName('NameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliAcTableMap::translateFieldName('Mposi', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mposi = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliAcTableMap::translateFieldName('UpaCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->upa_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliAcTableMap::translateFieldName('UpaName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->upa_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliAcTableMap::translateFieldName('Bposi', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bposi = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliAcTableMap::translateFieldName('Level', TableMap::TYPE_PHPNAME, $indexType)];
            $this->level = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliAcTableMap::translateFieldName('Gen', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gen = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliAcTableMap::translateFieldName('Btype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->btype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliAcTableMap::translateFieldName('Pv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliAcTableMap::translateFieldName('Percer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->percer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliAcTableMap::translateFieldName('Total', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliAcTableMap::translateFieldName('Fdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliAcTableMap::translateFieldName('Tdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->tdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AliAcTableMap::translateFieldName('PosCur', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pos_cur = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AliAcTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : AliAcTableMap::translateFieldName('Crate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->crate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : AliAcTableMap::translateFieldName('Locationbase', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 20; // 20 = AliAcTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliAc'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliAcQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliAcQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliAcTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliAcTableMap::COL_AID)) {
            $modifiedColumns[':p' . $index++]  = 'aid';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_NAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'name_t';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_MPOSI)) {
            $modifiedColumns[':p' . $index++]  = 'mposi';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_UPA_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'upa_code';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_UPA_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'upa_name';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_BPOSI)) {
            $modifiedColumns[':p' . $index++]  = 'bposi';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_LEVEL)) {
            $modifiedColumns[':p' . $index++]  = 'level';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_GEN)) {
            $modifiedColumns[':p' . $index++]  = 'gen';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_BTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'btype';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_PV)) {
            $modifiedColumns[':p' . $index++]  = 'pv';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_PERCER)) {
            $modifiedColumns[':p' . $index++]  = 'percer';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'total';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_FDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fdate';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_TDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tdate';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_POS_CUR)) {
            $modifiedColumns[':p' . $index++]  = 'pos_cur';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_CRATE)) {
            $modifiedColumns[':p' . $index++]  = 'crate';
        }
        if ($this->isColumnModified(AliAcTableMap::COL_LOCATIONBASE)) {
            $modifiedColumns[':p' . $index++]  = 'locationbase';
        }

        $sql = sprintf(
            'INSERT INTO ali_ac (%s) VALUES (%s)',
    ...
    {
        $pos = AliAcTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliAc'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliAc'][$this->hashCode()] = true;
        $keys = AliAcTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getAid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliAc
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliAc The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliAcTableMap::COL_AID)) {
            $criteria->add(AliAcTableMap::COL_AID, $this->aid);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_RCODE)) {
            $criteria->add(AliAcTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_MCODE)) {
            $criteria->add(AliAcTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_NAME_T)) {
            $criteria->add(AliAcTableMap::COL_NAME_T, $this->name_t);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_MPOSI)) {
            $criteria->add(AliAcTableMap::COL_MPOSI, $this->mposi);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_UPA_CODE)) {
            $criteria->add(AliAcTableMap::COL_UPA_CODE, $this->upa_code);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_UPA_NAME)) {
            $criteria->add(AliAcTableMap::COL_UPA_NAME, $this->upa_name);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_BPOSI)) {
            $criteria->add(AliAcTableMap::COL_BPOSI, $this->bposi);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_LEVEL)) {
            $criteria->add(AliAcTableMap::COL_LEVEL, $this->level);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_GEN)) {
            $criteria->add(AliAcTableMap::COL_GEN, $this->gen);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_BTYPE)) {
            $criteria->add(AliAcTableMap::COL_BTYPE, $this->btype);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_PV)) {
            $criteria->add(AliAcTableMap::COL_PV, $this->pv);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_PERCER)) {
            $criteria->add(AliAcTableMap::COL_PERCER, $this->percer);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_TOTAL)) {
            $criteria->add(AliAcTableMap::COL_TOTAL, $this->total);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_FDATE)) {
            $criteria->add(AliAcTableMap::COL_FDATE, $this->fdate);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_TDATE)) {
            $criteria->add(AliAcTableMap::COL_TDATE, $this->tdate);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_POS_CUR)) {
            $criteria->add(AliAcTableMap::COL_POS_CUR, $this->pos_cur);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_TYPE)) {
            $criteria->add(AliAcTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_CRATE)) {
            $criteria->add(AliAcTableMap::COL_CRATE, $this->crate);
        }
        if ($this->isColumnModified(AliAcTableMap::COL_LOCATIONBASE)) {
            $criteria->add(AliAcTableMap::COL_LOCATIONBASE, $this->locationbase);
        }
    ...
    {
        $criteria = ChildAliAcQuery::create();
        $criteria->add(AliAcTableMap::COL_AID, $this->aid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliAc (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliAc Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliAcTableMap::DEFAULT_STRING_FORMAT);
    }
