...
/**
 * Base class that represents a row from the 'ali_transfersale_h' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliTransfersaleH implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliTransfersaleHTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliTransfersaleH object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>AliTransfersaleH</code> instance.  If
     * <code>obj</code> is an instance of <code>AliTransfersaleH</code>, delegates to
     * <code>equals(AliTransfersaleH)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliTransfersaleH The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliTransfersaleH The current object (for fluent API support)
     */
    public function setSano($v)
    {
        ...
        if ($this->sano !== $v) {
            $this->sano = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_SANO] = true;
        }
    ...
    public function setSano1($v)
    {
        ...
        if ($this->sano1 !== $v) {
            $this->sano1 = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_SANO1] = true;
        }
    ...
    public function setSadate($v)
    {
        ...
        if ($this->sadate !== null || $dt !== null) {
            if ($this->sadate === null || $dt === null || $dt->format("Y-m-d") !== $this->sadate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliTransfersaleHTableMap::COL_SADATE] = true;
            }
    ...
    public function setSctime($v)
    {
        ...
        if ($this->sctime !== null || $dt !== null) {
            if ($this->sctime === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->sctime->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AliTransfersaleHTableMap::COL_SCTIME] = true;
            }
        } // if either are not null
    ...
    public function setInvCode($v)
    {
        ...
        if ($this->inv_code !== $v) {
            $this->inv_code = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_INV_CODE] = true;
        }
    ...
    public function setInvRef($v)
    {
        ...
        if ($this->inv_ref !== $v) {
            $this->inv_ref = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_INV_REF] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_MCODE] = true;
        }
    ...
    public function setNameF($v)
    {
        ...
        if ($this->name_f !== $v) {
            $this->name_f = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_NAME_F] = true;
        }
    ...
    public function setNameT($v)
    {
        ...
        if ($this->name_t !== $v) {
            $this->name_t = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_NAME_T] = true;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TOTAL] = true;
        }
    ...
    public function setTotPv($v)
    {
        ...
        if ($this->tot_pv !== $v) {
            $this->tot_pv = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TOT_PV] = true;
        }
    ...
    public function setTotBv($v)
    {
        ...
        if ($this->tot_bv !== $v) {
            $this->tot_bv = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TOT_BV] = true;
        }
    ...
    public function setTotFv($v)
    {
        ...
        if ($this->tot_fv !== $v) {
            $this->tot_fv = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TOT_FV] = true;
        }
    ...
    public function setTotWeight($v)
    {
        ...
        if ($this->tot_weight !== $v) {
            $this->tot_weight = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TOT_WEIGHT] = true;
        }
    ...
    public function setUsercode($v)
    {
        ...
        if ($this->usercode !== $v) {
            $this->usercode = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_USERCODE] = true;
        }
    ...
    public function setRemark($v)
    {
        ...
        if ($this->remark !== $v) {
            $this->remark = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_REMARK] = true;
        }
    ...
    public function setTrnf($v)
    {
        ...
        if ($this->trnf !== $v) {
            $this->trnf = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TRNF] = true;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_ID] = true;
        }
    ...
    public function setSaType($v)
    {
        ...
        if ($this->sa_type !== $v) {
            $this->sa_type = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_SA_TYPE] = true;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_UID] = true;
        }
    ...
    public function setLid($v)
    {
        ...
        if ($this->lid !== $v) {
            $this->lid = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_LID] = true;
        }
    ...
    public function setDl($v)
    {
        ...
        if ($this->dl !== $v) {
            $this->dl = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_DL] = true;
        }
    ...
    public function setCancel($v)
    {
        ...
        if ($this->cancel !== $v) {
            $this->cancel = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CANCEL] = true;
        }
    ...
    public function setSend($v)
    {
        ...
        if ($this->send !== $v) {
            $this->send = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_SEND] = true;
        }
    ...
    public function setTxtoption($v)
    {
        ...
        if ($this->txtoption !== $v) {
            $this->txtoption = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TXTOPTION] = true;
        }
    ...
    public function setChkcash($v)
    {
        ...
        if ($this->chkcash !== $v) {
            $this->chkcash = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CHKCASH] = true;
        }
    ...
    public function setChkfuture($v)
    {
        ...
        if ($this->chkfuture !== $v) {
            $this->chkfuture = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CHKFUTURE] = true;
        }
    ...
    public function setChktransfer($v)
    {
        ...
        if ($this->chktransfer !== $v) {
            $this->chktransfer = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CHKTRANSFER] = true;
        }
    ...
    public function setChkcredit1($v)
    {
        ...
        if ($this->chkcredit1 !== $v) {
            $this->chkcredit1 = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CHKCREDIT1] = true;
        }
    ...
    public function setChkcredit2($v)
    {
        ...
        if ($this->chkcredit2 !== $v) {
            $this->chkcredit2 = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CHKCREDIT2] = true;
        }
    ...
    public function setChkcredit3($v)
    {
        ...
        if ($this->chkcredit3 !== $v) {
            $this->chkcredit3 = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CHKCREDIT3] = true;
        }
    ...
    public function setChkinternet($v)
    {
        ...
        if ($this->chkinternet !== $v) {
            $this->chkinternet = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CHKINTERNET] = true;
        }
    ...
    public function setChkdiscount($v)
    {
        ...
        if ($this->chkdiscount !== $v) {
            $this->chkdiscount = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CHKDISCOUNT] = true;
        }
    ...
    public function setChkother($v)
    {
        ...
        if ($this->chkother !== $v) {
            $this->chkother = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CHKOTHER] = true;
        }
    ...
    public function setTxtcash($v)
    {
        ...
        if ($this->txtcash !== $v) {
            $this->txtcash = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TXTCASH] = true;
        }
    ...
    public function setTxtfuture($v)
    {
        ...
        if ($this->txtfuture !== $v) {
            $this->txtfuture = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TXTFUTURE] = true;
        }
    ...
    public function setTxttransfer($v)
    {
        ...
        if ($this->txttransfer !== $v) {
            $this->txttransfer = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TXTTRANSFER] = true;
        }
    ...
    public function setEwallet($v)
    {
        ...
        if ($this->ewallet !== $v) {
            $this->ewallet = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_EWALLET] = true;
        }
    ...
    public function setTxtcredit1($v)
    {
        ...
        if ($this->txtcredit1 !== $v) {
            $this->txtcredit1 = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TXTCREDIT1] = true;
        }
    ...
    public function setTxtcredit2($v)
    {
        ...
        if ($this->txtcredit2 !== $v) {
            $this->txtcredit2 = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TXTCREDIT2] = true;
        }
    ...
    public function setTxtcredit3($v)
    {
        ...
        if ($this->txtcredit3 !== $v) {
            $this->txtcredit3 = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TXTCREDIT3] = true;
        }
    ...
    public function setTxtinternet($v)
    {
        ...
        if ($this->txtinternet !== $v) {
            $this->txtinternet = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TXTINTERNET] = true;
        }
    ...
    public function setTxtdiscount($v)
    {
        ...
        if ($this->txtdiscount !== $v) {
            $this->txtdiscount = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TXTDISCOUNT] = true;
        }
    ...
    public function setTxtother($v)
    {
        ...
        if ($this->txtother !== $v) {
            $this->txtother = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TXTOTHER] = true;
        }
    ...
    public function setOptioncash($v)
    {
        ...
        if ($this->optioncash !== $v) {
            $this->optioncash = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_OPTIONCASH] = true;
        }
    ...
    public function setOptionfuture($v)
    {
        ...
        if ($this->optionfuture !== $v) {
            $this->optionfuture = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_OPTIONFUTURE] = true;
        }
    ...
    public function setOptiontransfer($v)
    {
        ...
        if ($this->optiontransfer !== $v) {
            ...
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_OPTIONTRANSFER] = true;
        }
    ...
    public function setOptioncredit1($v)
    {
        ...
        if ($this->optioncredit1 !== $v) {
            ...
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_OPTIONCREDIT1] = true;
        }
    ...
    public function setOptioncredit2($v)
    {
        ...
        if ($this->optioncredit2 !== $v) {
            ...
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_OPTIONCREDIT2] = true;
        }
    ...
    public function setOptioncredit3($v)
    {
        ...
        if ($this->optioncredit3 !== $v) {
            ...
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_OPTIONCREDIT3] = true;
        }
    ...
    public function setOptioninternet($v)
    {
        ...
        if ($this->optioninternet !== $v) {
            ...
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_OPTIONINTERNET] = true;
        }
    ...
    public function setOptiondiscount($v)
    {
        ...
        if ($this->optiondiscount !== $v) {
            ...
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_OPTIONDISCOUNT] = true;
        }
    ...
    public function setOptionother($v)
    {
        ...
        if ($this->optionother !== $v) {
            $this->optionother = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_OPTIONOTHER] = true;
        }
    ...
    public function setDiscount($v)
    {
        ...
        if ($this->discount !== $v) {
            $this->discount = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_DISCOUNT] = true;
        }
    ...
    public function setPrint($v)
    {
        ...
        if ($this->print !== $v) {
            $this->print = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_PRINT] = true;
        }
    ...
    public function setEwalletBefore($v)
    {
        ...
        if ($this->ewallet_before !== $v) {
            ...
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_EWALLET_BEFORE] = true;
        }
    ...
    public function setEwalletAfter($v)
    {
        ...
        if ($this->ewallet_after !== $v) {
            ...
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_EWALLET_AFTER] = true;
        }
    ...
    public function setIpay($v)
    {
        ...
        if ($this->ipay !== $v) {
            $this->ipay = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_IPAY] = true;
        }
    ...
    public function setPayType($v)
    {
        ...
        if ($this->pay_type !== $v) {
            $this->pay_type = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_PAY_TYPE] = true;
        }
    ...
    public function setHcancel($v)
    {
        ...
        if ($this->hcancel !== $v) {
            $this->hcancel = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_HCANCEL] = true;
        }
    ...
    public function setCaddress($v)
    {
        ...
        if ($this->caddress !== $v) {
            $this->caddress = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CADDRESS] = true;
        }
    ...
    public function setCdistrictid($v)
    {
        ...
        if ($this->cdistrictid !== $v) {
            $this->cdistrictid = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CDISTRICTID] = true;
        }
    ...
    public function setCamphurid($v)
    {
        ...
        if ($this->camphurid !== $v) {
            $this->camphurid = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CAMPHURID] = true;
        }
    ...
    public function setCprovinceid($v)
    {
        ...
        if ($this->cprovinceid !== $v) {
            $this->cprovinceid = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CPROVINCEID] = true;
        }
    ...
    public function setCzip($v)
    {
        ...
        if ($this->czip !== $v) {
            $this->czip = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CZIP] = true;
        }
    ...
    public function setSender($v)
    {
        ...
        if ($this->sender !== $v) {
            $this->sender = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_SENDER] = true;
        }
    ...
    public function setSenderDate($v)
    {
        ...
        if ($this->sender_date !== null || $dt !== null) {
            if ($this->sender_date === null || $dt === null || $dt->format("Y-m-d") !== $this->sender_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliTransfersaleHTableMap::COL_SENDER_DATE] = true;
            }
        } // if either are not null
    ...
    public function setReceive($v)
    {
        ...
        if ($this->receive !== $v) {
            $this->receive = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_RECEIVE] = true;
        }
    ...
    public function setReceiveDate($v)
    {
        ...
        if ($this->receive_date !== null || $dt !== null) {
            if ($this->receive_date === null || $dt === null || $dt->format("Y-m-d") !== $this->receive_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliTransfersaleHTableMap::COL_RECEIVE_DATE] = true;
            }
        } // if either are not null
    ...
    public function setAsend($v)
    {
        ...
        if ($this->asend !== $v) {
            $this->asend = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_ASEND] = true;
        }
    ...
    public function setAtoType($v)
    {
        ...
        if ($this->ato_type !== $v) {
            $this->ato_type = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_ATO_TYPE] = true;
        }
    ...
    public function setAtoId($v)
    {
        ...
        if ($this->ato_id !== $v) {
            $this->ato_id = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_ATO_ID] = true;
        }
    ...
    public function setOnline($v)
    {
        ...
        if ($this->online !== $v) {
            $this->online = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_ONLINE] = true;
        }
    ...
    public function setHpv($v)
    {
        ...
        if ($this->hpv !== $v) {
            $this->hpv = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_HPV] = true;
        }
    ...
    public function setHtotal($v)
    {
        ...
        if ($this->htotal !== $v) {
            $this->htotal = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_HTOTAL] = true;
        }
    ...
    public function setHdate($v)
    {
        ...
        if ($this->hdate !== null || $dt !== null) {
            if ($this->hdate === null || $dt === null || $dt->format("Y-m-d") !== $this->hdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliTransfersaleHTableMap::COL_HDATE] = true;
            }
        } // if either are not null
    ...
    public function setScheck($v)
    {
        ...
        if ($this->scheck !== $v) {
            $this->scheck = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_SCHECK] = true;
        }
    ...
    public function setCheckportal($v)
    {
        ...
        if ($this->checkportal !== $v) {
            $this->checkportal = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CHECKPORTAL] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_RCODE] = true;
        }
    ...
    public function setBmcauto($v)
    {
        ...
        if ($this->bmcauto !== $v) {
            $this->bmcauto = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_BMCAUTO] = true;
        }
    ...
    public function setTranstype($v)
    {
        ...
        if ($this->transtype !== $v) {
            $this->transtype = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_TRANSTYPE] = true;
        }
    ...
    public function setPaytype($v)
    {
        ...
        if ($this->paytype !== $v) {
            $this->paytype = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_PAYTYPE] = true;
        }
    ...
    public function setSendtype($v)
    {
        ...
        if ($this->sendtype !== $v) {
            $this->sendtype = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_SENDTYPE] = true;
        }
    ...
    public function setCredittype($v)
    {
        ...
        if ($this->credittype !== $v) {
            $this->credittype = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CREDITTYPE] = true;
        }
    ...
    public function setPaydate($v)
    {
        ...
        if ($this->paydate !== null || $dt !== null) {
            if ($this->paydate === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->paydate->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AliTransfersaleHTableMap::COL_PAYDATE] = true;
            }
        } // if either are not null
    ...
    public function setBprice($v)
    {
        ...
        if ($this->bprice !== $v) {
            $this->bprice = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_BPRICE] = true;
        }
    ...
    public function setLocationbase($v)
    {
        ...
        if ($this->locationbase !== $v) {
            $this->locationbase = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_LOCATIONBASE] = true;
        }
    ...
    public function setMbase($v)
    {
        ...
        if ($this->mbase !== $v) {
            $this->mbase = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_MBASE] = true;
        }
    ...
    public function setCname($v)
    {
        ...
        if ($this->cname !== $v) {
            $this->cname = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CNAME] = true;
        }
    ...
    public function setCmobile($v)
    {
        ...
        if ($this->cmobile !== $v) {
            $this->cmobile = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CMOBILE] = true;
        }
    ...
    public function setCrate($v)
    {
        ...
        if ($this->crate !== $v) {
            $this->crate = $v;
            $this->modifiedColumns[AliTransfersaleHTableMap::COL_CRATE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliTransfersaleHTableMap::translateFieldName('Sano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliTransfersaleHTableMap::translateFieldName('Sano1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliTransfersaleHTableMap::translateFieldName('Sadate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->sadate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliTransfersaleHTableMap::translateFieldName('Sctime', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->sctime = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliTransfersaleHTableMap::translateFieldName('InvCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliTransfersaleHTableMap::translateFieldName('InvRef', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_ref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliTransfersaleHTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliTransfersaleHTableMap::translateFieldName('NameF', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_f = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliTransfersaleHTableMap::translateFieldName('NameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliTransfersaleHTableMap::translateFieldName('Total', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliTransfersaleHTableMap::translateFieldName('TotPv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tot_pv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliTransfersaleHTableMap::translateFieldName('TotBv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tot_bv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliTransfersaleHTableMap::translateFieldName('TotFv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tot_fv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliTransfersaleHTableMap::translateFieldName('TotWeight', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tot_weight = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliTransfersaleHTableMap::translateFieldName('Usercode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usercode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliTransfersaleHTableMap::translateFieldName('Remark', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remark = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AliTransfersaleHTableMap::translateFieldName('Trnf', TableMap::TYPE_PHPNAME, $indexType)];
            $this->trnf = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AliTransfersaleHTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : AliTransfersaleHTableMap::translateFieldName('SaType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sa_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : AliTransfersaleHTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : AliTransfersaleHTableMap::translateFieldName('Lid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : AliTransfersaleHTableMap::translateFieldName('Dl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : AliTransfersaleHTableMap::translateFieldName('Cancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cancel = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : AliTransfersaleHTableMap::translateFieldName('Send', TableMap::TYPE_PHPNAME, $indexType)];
            $this->send = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : AliTransfersaleHTableMap::translateFieldName('Txtoption', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtoption = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : AliTransfersaleHTableMap::translateFieldName('Chkcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : AliTransfersaleHTableMap::translateFieldName('Chkfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : AliTransfersaleHTableMap::translateFieldName('Chktransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : AliTransfersaleHTableMap::translateFieldName('Chkcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : AliTransfersaleHTableMap::translateFieldName('Chkcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : AliTransfersaleHTableMap::translateFieldName('Chkcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : AliTransfersaleHTableMap::translateFieldName('Chkinternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkinternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : AliTransfersaleHTableMap::translateFieldName('Chkdiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkdiscount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : AliTransfersaleHTableMap::translateFieldName('Chkother', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkother = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : AliTransfersaleHTableMap::translateFieldName('Txtcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : AliTransfersaleHTableMap::translateFieldName('Txtfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : AliTransfersaleHTableMap::translateFieldName('Txttransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : AliTransfersaleHTableMap::translateFieldName('Ewallet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : AliTransfersaleHTableMap::translateFieldName('Txtcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : AliTransfersaleHTableMap::translateFieldName('Txtcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : AliTransfersaleHTableMap::translateFieldName('Txtcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : AliTransfersaleHTableMap::translateFieldName('Txtinternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtinternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : AliTransfersaleHTableMap::translateFieldName('Txtdiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtdiscount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : AliTransfersaleHTableMap::translateFieldName('Txtother', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtother = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : AliTransfersaleHTableMap::translateFieldName('Optioncash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : AliTransfersaleHTableMap::translateFieldName('Optionfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : AliTransfersaleHTableMap::translateFieldName('Optiontransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : AliTransfersaleHTableMap::translateFieldName('Optioncredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : AliTransfersaleHTableMap::translateFieldName('Optioncredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : AliTransfersaleHTableMap::translateFieldName('Optioncredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : AliTransfersaleHTableMap::translateFieldName('Optioninternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioninternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : AliTransfersaleHTableMap::translateFieldName('Optiondiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiondiscount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : AliTransfersaleHTableMap::translateFieldName('Optionother', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionother = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : AliTransfersaleHTableMap::translateFieldName('Discount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : AliTransfersaleHTableMap::translateFieldName('Print', TableMap::TYPE_PHPNAME, $indexType)];
            $this->print = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : AliTransfersaleHTableMap::translateFieldName('EwalletBefore', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_before = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : AliTransfersaleHTableMap::translateFieldName('EwalletAfter', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_after = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : AliTransfersaleHTableMap::translateFieldName('Ipay', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ipay = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 58 + $startcol : AliTransfersaleHTableMap::translateFieldName('PayType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pay_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 59 + $startcol : AliTransfersaleHTableMap::translateFieldName('Hcancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hcancel = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 60 + $startcol : AliTransfersaleHTableMap::translateFieldName('Caddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->caddress = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 61 + $startcol : AliTransfersaleHTableMap::translateFieldName('Cdistrictid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cdistrictid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 62 + $startcol : AliTransfersaleHTableMap::translateFieldName('Camphurid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->camphurid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 63 + $startcol : AliTransfersaleHTableMap::translateFieldName('Cprovinceid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cprovinceid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 64 + $startcol : AliTransfersaleHTableMap::translateFieldName('Czip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->czip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 65 + $startcol : AliTransfersaleHTableMap::translateFieldName('Sender', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sender = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 66 + $startcol : AliTransfersaleHTableMap::translateFieldName('SenderDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->sender_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 67 + $startcol : AliTransfersaleHTableMap::translateFieldName('Receive', TableMap::TYPE_PHPNAME, $indexType)];
            $this->receive = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 68 + $startcol : AliTransfersaleHTableMap::translateFieldName('ReceiveDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->receive_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 69 + $startcol : AliTransfersaleHTableMap::translateFieldName('Asend', TableMap::TYPE_PHPNAME, $indexType)];
            $this->asend = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 70 + $startcol : AliTransfersaleHTableMap::translateFieldName('AtoType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ato_type = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 71 + $startcol : AliTransfersaleHTableMap::translateFieldName('AtoId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ato_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 72 + $startcol : AliTransfersaleHTableMap::translateFieldName('Online', TableMap::TYPE_PHPNAME, $indexType)];
            $this->online = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 73 + $startcol : AliTransfersaleHTableMap::translateFieldName('Hpv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hpv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 74 + $startcol : AliTransfersaleHTableMap::translateFieldName('Htotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->htotal = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 75 + $startcol : AliTransfersaleHTableMap::translateFieldName('Hdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->hdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 76 + $startcol : AliTransfersaleHTableMap::translateFieldName('Scheck', TableMap::TYPE_PHPNAME, $indexType)];
            $this->scheck = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 77 + $startcol : AliTransfersaleHTableMap::translateFieldName('Checkportal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->checkportal = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 78 + $startcol : AliTransfersaleHTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 79 + $startcol : AliTransfersaleHTableMap::translateFieldName('Bmcauto', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bmcauto = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 80 + $startcol : AliTransfersaleHTableMap::translateFieldName('Transtype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->transtype = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 81 + $startcol : AliTransfersaleHTableMap::translateFieldName('Paytype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->paytype = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 82 + $startcol : AliTransfersaleHTableMap::translateFieldName('Sendtype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sendtype = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 83 + $startcol : AliTransfersaleHTableMap::translateFieldName('Credittype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->credittype = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 84 + $startcol : AliTransfersaleHTableMap::translateFieldName('Paydate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->paydate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 85 + $startcol : AliTransfersaleHTableMap::translateFieldName('Bprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 86 + $startcol : AliTransfersaleHTableMap::translateFieldName('Locationbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->locationbase = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 87 + $startcol : AliTransfersaleHTableMap::translateFieldName('Mbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mbase = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 88 + $startcol : AliTransfersaleHTableMap::translateFieldName('Cname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 89 + $startcol : AliTransfersaleHTableMap::translateFieldName('Cmobile', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cmobile = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 90 + $startcol : AliTransfersaleHTableMap::translateFieldName('Crate', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 91; // 91 = AliTransfersaleHTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliTransfersaleH'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliTransfersaleHQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliTransfersaleH::setDeleted()
     * @see AliTransfersaleH::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliTransfersaleHQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliTransfersaleHTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SANO)) {
            $modifiedColumns[':p' . $index++]  = 'sano';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SANO1)) {
            $modifiedColumns[':p' . $index++]  = 'sano1';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SADATE)) {
            $modifiedColumns[':p' . $index++]  = 'sadate';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SCTIME)) {
            $modifiedColumns[':p' . $index++]  = 'sctime';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_INV_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'inv_code';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_INV_REF)) {
            $modifiedColumns[':p' . $index++]  = 'inv_ref';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_NAME_F)) {
            $modifiedColumns[':p' . $index++]  = 'name_f';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_NAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'name_t';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'total';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TOT_PV)) {
            $modifiedColumns[':p' . $index++]  = 'tot_pv';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TOT_BV)) {
            $modifiedColumns[':p' . $index++]  = 'tot_bv';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TOT_FV)) {
            $modifiedColumns[':p' . $index++]  = 'tot_fv';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TOT_WEIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'tot_weight';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_USERCODE)) {
            $modifiedColumns[':p' . $index++]  = 'usercode';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_REMARK)) {
            $modifiedColumns[':p' . $index++]  = 'remark';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TRNF)) {
            $modifiedColumns[':p' . $index++]  = 'trnf';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SA_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'sa_type';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_LID)) {
            $modifiedColumns[':p' . $index++]  = 'lid';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_DL)) {
            $modifiedColumns[':p' . $index++]  = 'dl';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'cancel';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SEND)) {
            $modifiedColumns[':p' . $index++]  = 'send';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTOPTION)) {
            $modifiedColumns[':p' . $index++]  = 'txtoption';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKCASH)) {
            $modifiedColumns[':p' . $index++]  = 'chkCash';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'chkFuture';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit1';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit2';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit3';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'chkInternet';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKDISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'chkDiscount';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKOTHER)) {
            $modifiedColumns[':p' . $index++]  = 'chkOther';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTCASH)) {
            $modifiedColumns[':p' . $index++]  = 'txtCash';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'txtFuture';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_EWALLET)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit1';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit2';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit3';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'txtInternet';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTDISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'txtDiscount';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTOTHER)) {
            $modifiedColumns[':p' . $index++]  = 'txtOther';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONCASH)) {
            $modifiedColumns[':p' . $index++]  = 'optionCash';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'optionFuture';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit1';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit2';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit3';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'optionInternet';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONDISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'optionDiscount';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONOTHER)) {
            $modifiedColumns[':p' . $index++]  = 'optionOther';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_DISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'discount';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_PRINT)) {
            $modifiedColumns[':p' . $index++]  = 'print';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_EWALLET_BEFORE)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_before';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_EWALLET_AFTER)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_after';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_IPAY)) {
            $modifiedColumns[':p' . $index++]  = 'ipay';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_PAY_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'pay_type';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_HCANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'hcancel';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'caddress';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CDISTRICTID)) {
            $modifiedColumns[':p' . $index++]  = 'cdistrictId';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CAMPHURID)) {
            $modifiedColumns[':p' . $index++]  = 'camphurId';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CPROVINCEID)) {
            $modifiedColumns[':p' . $index++]  = 'cprovinceId';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CZIP)) {
            $modifiedColumns[':p' . $index++]  = 'czip';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SENDER)) {
            $modifiedColumns[':p' . $index++]  = 'sender';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SENDER_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'sender_date';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_RECEIVE)) {
            $modifiedColumns[':p' . $index++]  = 'receive';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_RECEIVE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'receive_date';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_ASEND)) {
            $modifiedColumns[':p' . $index++]  = 'asend';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_ATO_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'ato_type';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_ATO_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ato_id';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_ONLINE)) {
            $modifiedColumns[':p' . $index++]  = 'online';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_HPV)) {
            $modifiedColumns[':p' . $index++]  = 'hpv';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_HTOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'htotal';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_HDATE)) {
            $modifiedColumns[':p' . $index++]  = 'hdate';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SCHECK)) {
            $modifiedColumns[':p' . $index++]  = 'scheck';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHECKPORTAL)) {
            $modifiedColumns[':p' . $index++]  = 'checkportal';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_BMCAUTO)) {
            $modifiedColumns[':p' . $index++]  = 'bmcauto';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TRANSTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'transtype';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_PAYTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'paytype';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SENDTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'sendtype';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CREDITTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'credittype';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_PAYDATE)) {
            $modifiedColumns[':p' . $index++]  = 'paydate';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_BPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'bprice';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_LOCATIONBASE)) {
            $modifiedColumns[':p' . $index++]  = 'locationbase';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_MBASE)) {
            $modifiedColumns[':p' . $index++]  = 'mbase';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CNAME)) {
            $modifiedColumns[':p' . $index++]  = 'cname';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CMOBILE)) {
            $modifiedColumns[':p' . $index++]  = 'cmobile';
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CRATE)) {
            $modifiedColumns[':p' . $index++]  = 'crate';
        }

        $sql = sprintf(
            'INSERT INTO ali_transfersale_h (%s) VALUES (%s)',
    ...
    {
        $pos = AliTransfersaleHTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliTransfersaleH'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliTransfersaleH'][$this->hashCode()] = true;
        $keys = AliTransfersaleHTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSano(),
            ...
            $keys[85] => $this->getBprice(),
            $keys[86] => $this->getLocationbase(),
            $keys[87] => $this->getMbase(),
            $keys[88] => $this->getCname(),
            $keys[89] => $this->getCmobile(),
            $keys[90] => $this->getCrate(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliTransfersaleH
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliTransfersaleH The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SANO)) {
            $criteria->add(AliTransfersaleHTableMap::COL_SANO, $this->sano);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SANO1)) {
            $criteria->add(AliTransfersaleHTableMap::COL_SANO1, $this->sano1);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SADATE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_SADATE, $this->sadate);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SCTIME)) {
            $criteria->add(AliTransfersaleHTableMap::COL_SCTIME, $this->sctime);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_INV_CODE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_INV_CODE, $this->inv_code);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_INV_REF)) {
            $criteria->add(AliTransfersaleHTableMap::COL_INV_REF, $this->inv_ref);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_MCODE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_NAME_F)) {
            $criteria->add(AliTransfersaleHTableMap::COL_NAME_F, $this->name_f);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_NAME_T)) {
            $criteria->add(AliTransfersaleHTableMap::COL_NAME_T, $this->name_t);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TOTAL)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TOTAL, $this->total);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TOT_PV)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TOT_PV, $this->tot_pv);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TOT_BV)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TOT_BV, $this->tot_bv);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TOT_FV)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TOT_FV, $this->tot_fv);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TOT_WEIGHT)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TOT_WEIGHT, $this->tot_weight);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_USERCODE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_USERCODE, $this->usercode);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_REMARK)) {
            $criteria->add(AliTransfersaleHTableMap::COL_REMARK, $this->remark);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TRNF)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TRNF, $this->trnf);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_ID)) {
            $criteria->add(AliTransfersaleHTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SA_TYPE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_SA_TYPE, $this->sa_type);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_UID)) {
            $criteria->add(AliTransfersaleHTableMap::COL_UID, $this->uid);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_LID)) {
            $criteria->add(AliTransfersaleHTableMap::COL_LID, $this->lid);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_DL)) {
            $criteria->add(AliTransfersaleHTableMap::COL_DL, $this->dl);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CANCEL)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CANCEL, $this->cancel);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SEND)) {
            $criteria->add(AliTransfersaleHTableMap::COL_SEND, $this->send);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTOPTION)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TXTOPTION, $this->txtoption);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKCASH)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CHKCASH, $this->chkcash);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKFUTURE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CHKFUTURE, $this->chkfuture);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKTRANSFER)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CHKTRANSFER, $this->chktransfer);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKCREDIT1)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CHKCREDIT1, $this->chkcredit1);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKCREDIT2)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CHKCREDIT2, $this->chkcredit2);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKCREDIT3)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CHKCREDIT3, $this->chkcredit3);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKINTERNET)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CHKINTERNET, $this->chkinternet);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKDISCOUNT)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CHKDISCOUNT, $this->chkdiscount);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHKOTHER)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CHKOTHER, $this->chkother);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTCASH)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TXTCASH, $this->txtcash);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTFUTURE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TXTFUTURE, $this->txtfuture);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTTRANSFER)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TXTTRANSFER, $this->txttransfer);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_EWALLET)) {
            $criteria->add(AliTransfersaleHTableMap::COL_EWALLET, $this->ewallet);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTCREDIT1)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TXTCREDIT1, $this->txtcredit1);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTCREDIT2)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TXTCREDIT2, $this->txtcredit2);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTCREDIT3)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TXTCREDIT3, $this->txtcredit3);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTINTERNET)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TXTINTERNET, $this->txtinternet);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTDISCOUNT)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TXTDISCOUNT, $this->txtdiscount);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TXTOTHER)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TXTOTHER, $this->txtother);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONCASH)) {
            $criteria->add(AliTransfersaleHTableMap::COL_OPTIONCASH, $this->optioncash);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONFUTURE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_OPTIONFUTURE, $this->optionfuture);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONTRANSFER)) {
            $criteria->add(AliTransfersaleHTableMap::COL_OPTIONTRANSFER, $this->optiontransfer);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONCREDIT1)) {
            $criteria->add(AliTransfersaleHTableMap::COL_OPTIONCREDIT1, $this->optioncredit1);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONCREDIT2)) {
            $criteria->add(AliTransfersaleHTableMap::COL_OPTIONCREDIT2, $this->optioncredit2);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONCREDIT3)) {
            $criteria->add(AliTransfersaleHTableMap::COL_OPTIONCREDIT3, $this->optioncredit3);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONINTERNET)) {
            $criteria->add(AliTransfersaleHTableMap::COL_OPTIONINTERNET, $this->optioninternet);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONDISCOUNT)) {
            $criteria->add(AliTransfersaleHTableMap::COL_OPTIONDISCOUNT, $this->optiondiscount);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_OPTIONOTHER)) {
            $criteria->add(AliTransfersaleHTableMap::COL_OPTIONOTHER, $this->optionother);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_DISCOUNT)) {
            $criteria->add(AliTransfersaleHTableMap::COL_DISCOUNT, $this->discount);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_PRINT)) {
            $criteria->add(AliTransfersaleHTableMap::COL_PRINT, $this->print);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_EWALLET_BEFORE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_EWALLET_BEFORE, $this->ewallet_before);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_EWALLET_AFTER)) {
            $criteria->add(AliTransfersaleHTableMap::COL_EWALLET_AFTER, $this->ewallet_after);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_IPAY)) {
            $criteria->add(AliTransfersaleHTableMap::COL_IPAY, $this->ipay);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_PAY_TYPE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_PAY_TYPE, $this->pay_type);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_HCANCEL)) {
            $criteria->add(AliTransfersaleHTableMap::COL_HCANCEL, $this->hcancel);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CADDRESS)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CADDRESS, $this->caddress);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CDISTRICTID)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CDISTRICTID, $this->cdistrictid);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CAMPHURID)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CAMPHURID, $this->camphurid);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CPROVINCEID)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CPROVINCEID, $this->cprovinceid);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CZIP)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CZIP, $this->czip);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SENDER)) {
            $criteria->add(AliTransfersaleHTableMap::COL_SENDER, $this->sender);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SENDER_DATE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_SENDER_DATE, $this->sender_date);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_RECEIVE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_RECEIVE, $this->receive);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_RECEIVE_DATE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_RECEIVE_DATE, $this->receive_date);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_ASEND)) {
            $criteria->add(AliTransfersaleHTableMap::COL_ASEND, $this->asend);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_ATO_TYPE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_ATO_TYPE, $this->ato_type);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_ATO_ID)) {
            $criteria->add(AliTransfersaleHTableMap::COL_ATO_ID, $this->ato_id);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_ONLINE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_ONLINE, $this->online);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_HPV)) {
            $criteria->add(AliTransfersaleHTableMap::COL_HPV, $this->hpv);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_HTOTAL)) {
            $criteria->add(AliTransfersaleHTableMap::COL_HTOTAL, $this->htotal);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_HDATE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_HDATE, $this->hdate);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SCHECK)) {
            $criteria->add(AliTransfersaleHTableMap::COL_SCHECK, $this->scheck);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CHECKPORTAL)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CHECKPORTAL, $this->checkportal);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_RCODE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_BMCAUTO)) {
            $criteria->add(AliTransfersaleHTableMap::COL_BMCAUTO, $this->bmcauto);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_TRANSTYPE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_TRANSTYPE, $this->transtype);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_PAYTYPE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_PAYTYPE, $this->paytype);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_SENDTYPE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_SENDTYPE, $this->sendtype);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CREDITTYPE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CREDITTYPE, $this->credittype);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_PAYDATE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_PAYDATE, $this->paydate);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_BPRICE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_BPRICE, $this->bprice);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_LOCATIONBASE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_LOCATIONBASE, $this->locationbase);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_MBASE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_MBASE, $this->mbase);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CNAME)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CNAME, $this->cname);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CMOBILE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CMOBILE, $this->cmobile);
        }
        if ($this->isColumnModified(AliTransfersaleHTableMap::COL_CRATE)) {
            $criteria->add(AliTransfersaleHTableMap::COL_CRATE, $this->crate);
        }
    ...
    {
        $criteria = ChildAliTransfersaleHQuery::create();
        $criteria->add(AliTransfersaleHTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliTransfersaleH (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliTransfersaleH Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliTransfersaleHTableMap::DEFAULT_STRING_FORMAT);
    }
