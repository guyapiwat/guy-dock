...
/**
 * Base class that represents a row from the 'ali_eatoship' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliEatoship implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliEatoshipTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliEatoship object.
     */
    ...
    /**
     * Compares this with another <code>AliEatoship</code> instance.  If
     * <code>obj</code> is an instance of <code>AliEatoship</code>, delegates to
     * <code>equals(AliEatoship)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliEatoship The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliEatoship The current object (for fluent API support)
     */
    public function setSano($v)
    {
        ...
        if ($this->sano !== $v) {
            $this->sano = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_SANO] = true;
        }
    ...
    public function setSadate($v)
    {
        ...
        if ($this->sadate !== null || $dt !== null) {
            if ($this->sadate === null || $dt === null || $dt->format("Y-m-d") !== $this->sadate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliEatoshipTableMap::COL_SADATE] = true;
            }
    ...
    public function setInvCode($v)
    {
        ...
        if ($this->inv_code !== $v) {
            $this->inv_code = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_INV_CODE] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_MCODE] = true;
        }
    ...
    public function setNameF($v)
    {
        ...
        if ($this->name_f !== $v) {
            $this->name_f = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_NAME_F] = true;
        }
    ...
    public function setNameT($v)
    {
        ...
        if ($this->name_t !== $v) {
            $this->name_t = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_NAME_T] = true;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TOTAL] = true;
        }
    ...
    public function setPv($v)
    {
        ...
        if ($this->pv !== $v) {
            $this->pv = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_PV] = true;
        }
    ...
    public function setUsercode($v)
    {
        ...
        if ($this->usercode !== $v) {
            $this->usercode = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_USERCODE] = true;
        }
    ...
    public function setRemark($v)
    {
        ...
        if ($this->remark !== $v) {
            $this->remark = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_REMARK] = true;
        }
    ...
    public function setTrnf($v)
    {
        ...
        if ($this->trnf !== $v) {
            $this->trnf = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TRNF] = true;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_ID] = true;
        }
    ...
    public function setSaType($v)
    {
        ...
        if ($this->sa_type !== $v) {
            $this->sa_type = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_SA_TYPE] = true;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_UID] = true;
        }
    ...
    public function setLid($v)
    {
        ...
        if ($this->lid !== $v) {
            $this->lid = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_LID] = true;
        }
    ...
    public function setDl($v)
    {
        ...
        if ($this->dl !== $v) {
            $this->dl = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_DL] = true;
        }
    ...
    public function setCancel($v)
    {
        ...
        if ($this->cancel !== $v) {
            $this->cancel = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_CANCEL] = true;
        }
    ...
    public function setSend($v)
    {
        ...
        if ($this->send !== $v) {
            $this->send = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_SEND] = true;
        }
    ...
    public function setTxtmoney($v)
    {
        ...
        if ($this->txtmoney !== $v) {
            $this->txtmoney = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTMONEY] = true;
        }
    ...
    public function setChkcash($v)
    {
        ...
        if ($this->chkcash !== $v) {
            $this->chkcash = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_CHKCASH] = true;
        }
    ...
    public function setChkfuture($v)
    {
        ...
        if ($this->chkfuture !== $v) {
            $this->chkfuture = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_CHKFUTURE] = true;
        }
    ...
    public function setChkinternet($v)
    {
        ...
        if ($this->chkinternet !== $v) {
            $this->chkinternet = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_CHKINTERNET] = true;
        }
    ...
    public function setChktransfer($v)
    {
        ...
        if ($this->chktransfer !== $v) {
            $this->chktransfer = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_CHKTRANSFER] = true;
        }
    ...
    public function setChkcredit1($v)
    {
        ...
        if ($this->chkcredit1 !== $v) {
            $this->chkcredit1 = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_CHKCREDIT1] = true;
        }
    ...
    public function setChkcredit2($v)
    {
        ...
        if ($this->chkcredit2 !== $v) {
            $this->chkcredit2 = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_CHKCREDIT2] = true;
        }
    ...
    public function setChkcredit3($v)
    {
        ...
        if ($this->chkcredit3 !== $v) {
            $this->chkcredit3 = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_CHKCREDIT3] = true;
        }
    ...
    public function setChkwithdraw($v)
    {
        ...
        if ($this->chkwithdraw !== $v) {
            $this->chkwithdraw = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_CHKWITHDRAW] = true;
        }
    ...
    public function setChktransferIn($v)
    {
        ...
        if ($this->chktransfer_in !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_CHKTRANSFER_IN] = true;
        }
    ...
    public function setChktransferOut($v)
    {
        ...
        if ($this->chktransfer_out !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_CHKTRANSFER_OUT] = true;
        }
    ...
    public function setTxtcash($v)
    {
        ...
        if ($this->txtcash !== $v) {
            $this->txtcash = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTCASH] = true;
        }
    ...
    public function setTxtfuture($v)
    {
        ...
        if ($this->txtfuture !== $v) {
            $this->txtfuture = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTFUTURE] = true;
        }
    ...
    public function setTxtinternet($v)
    {
        ...
        if ($this->txtinternet !== $v) {
            $this->txtinternet = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTINTERNET] = true;
        }
    ...
    public function setTxttransfer($v)
    {
        ...
        if ($this->txttransfer !== $v) {
            $this->txttransfer = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTTRANSFER] = true;
        }
    ...
    public function setTxtcredit1($v)
    {
        ...
        if ($this->txtcredit1 !== $v) {
            $this->txtcredit1 = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTCREDIT1] = true;
        }
    ...
    public function setTxtcredit2($v)
    {
        ...
        if ($this->txtcredit2 !== $v) {
            $this->txtcredit2 = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTCREDIT2] = true;
        }
    ...
    public function setTxtcredit3($v)
    {
        ...
        if ($this->txtcredit3 !== $v) {
            $this->txtcredit3 = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTCREDIT3] = true;
        }
    ...
    public function setTxtwithdraw($v)
    {
        ...
        if ($this->txtwithdraw !== $v) {
            $this->txtwithdraw = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTWITHDRAW] = true;
        }
    ...
    public function setTxtdiscount($v)
    {
        ...
        if ($this->txtdiscount !== $v) {
            $this->txtdiscount = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTDISCOUNT] = true;
        }
    ...
    public function setTxttransferIn($v)
    {
        ...
        if ($this->txttransfer_in !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTTRANSFER_IN] = true;
        }
    ...
    public function setTxttransferOut($v)
    {
        ...
        if ($this->txttransfer_out !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTTRANSFER_OUT] = true;
        }
    ...
    public function setTxtvoucher($v)
    {
        ...
        if ($this->txtvoucher !== $v) {
            $this->txtvoucher = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTVOUCHER] = true;
        }
    ...
    public function setOptioncash($v)
    {
        ...
        if ($this->optioncash !== $v) {
            $this->optioncash = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_OPTIONCASH] = true;
        }
    ...
    public function setOptionfuture($v)
    {
        ...
        if ($this->optionfuture !== $v) {
            $this->optionfuture = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_OPTIONFUTURE] = true;
        }
    ...
    public function setOptiontransfer($v)
    {
        ...
        if ($this->optiontransfer !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_OPTIONTRANSFER] = true;
        }
    ...
    public function setOptioncredit1($v)
    {
        ...
        if ($this->optioncredit1 !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_OPTIONCREDIT1] = true;
        }
    ...
    public function setOptioncredit2($v)
    {
        ...
        if ($this->optioncredit2 !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_OPTIONCREDIT2] = true;
        }
    ...
    public function setOptioncredit3($v)
    {
        ...
        if ($this->optioncredit3 !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_OPTIONCREDIT3] = true;
        }
    ...
    public function setOptionwithdraw($v)
    {
        ...
        if ($this->optionwithdraw !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_OPTIONWITHDRAW] = true;
        }
    ...
    public function setOptiontransferIn($v)
    {
        ...
        if ($this->optiontransfer_in !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_OPTIONTRANSFER_IN] = true;
        }
    ...
    public function setOptiontransferOut($v)
    {
        ...
        if ($this->optiontransfer_out !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_OPTIONTRANSFER_OUT] = true;
        }
    ...
    public function setTxtoption($v)
    {
        ...
        if ($this->txtoption !== $v) {
            $this->txtoption = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTOPTION] = true;
        }
    ...
    public function setEwallet($v)
    {
        ...
        if ($this->ewallet !== $v) {
            $this->ewallet = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_EWALLET] = true;
        }
    ...
    public function setEwalletBefore($v)
    {
        ...
        if ($this->ewallet_before !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_EWALLET_BEFORE] = true;
        }
    ...
    public function setEwalletAfter($v)
    {
        ...
        if ($this->ewallet_after !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_EWALLET_AFTER] = true;
        }
    ...
    public function setIpay($v)
    {
        ...
        if ($this->ipay !== $v) {
            $this->ipay = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_IPAY] = true;
        }
    ...
    public function setCheckportal($v)
    {
        ...
        if ($this->checkportal !== $v) {
            $this->checkportal = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_CHECKPORTAL] = true;
        }
    ...
    public function setBprice($v)
    {
        ...
        if ($this->bprice !== $v) {
            $this->bprice = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_BPRICE] = true;
        }
    ...
    public function setCancelDate($v)
    {
        ...
        if ($this->cancel_date !== null || $dt !== null) {
            if ($this->cancel_date === null || $dt === null || $dt->format("Y-m-d") !== $this->cancel_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliEatoshipTableMap::COL_CANCEL_DATE] = true;
            }
        } // if either are not null
    ...
    public function setUidCancel($v)
    {
        ...
        if ($this->uid_cancel !== $v) {
            $this->uid_cancel = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_UID_CANCEL] = true;
        }
    ...
    public function setLocationbase($v)
    {
        ...
        if ($this->locationbase !== $v) {
            $this->locationbase = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_LOCATIONBASE] = true;
        }
    ...
    public function setChkcommission($v)
    {
        ...
        if ($this->chkcommission !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_CHKCOMMISSION] = true;
        }
    ...
    public function setTxtcommission($v)
    {
        ...
        if ($this->txtcommission !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_TXTCOMMISSION] = true;
        }
    ...
    public function setOptioncommission($v)
    {
        ...
        if ($this->optioncommission !== $v) {
            ...
            $this->modifiedColumns[AliEatoshipTableMap::COL_OPTIONCOMMISSION] = true;
        }
    ...
    public function setMbase($v)
    {
        ...
        if ($this->mbase !== $v) {
            $this->mbase = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_MBASE] = true;
        }
    ...
    public function setCrate($v)
    {
        ...
        if ($this->crate !== $v) {
            $this->crate = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_CRATE] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_RCODE] = true;
        }
    ...
    public function setEcheck($v)
    {
        ...
        if ($this->echeck !== $v) {
            $this->echeck = $v;
            $this->modifiedColumns[AliEatoshipTableMap::COL_ECHECK] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliEatoshipTableMap::translateFieldName('Sano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliEatoshipTableMap::translateFieldName('Sadate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->sadate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliEatoshipTableMap::translateFieldName('InvCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliEatoshipTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliEatoshipTableMap::translateFieldName('NameF', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_f = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliEatoshipTableMap::translateFieldName('NameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliEatoshipTableMap::translateFieldName('Total', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliEatoshipTableMap::translateFieldName('Pv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pv = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliEatoshipTableMap::translateFieldName('Usercode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usercode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliEatoshipTableMap::translateFieldName('Remark', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remark = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliEatoshipTableMap::translateFieldName('Trnf', TableMap::TYPE_PHPNAME, $indexType)];
            $this->trnf = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliEatoshipTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliEatoshipTableMap::translateFieldName('SaType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sa_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliEatoshipTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliEatoshipTableMap::translateFieldName('Lid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliEatoshipTableMap::translateFieldName('Dl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AliEatoshipTableMap::translateFieldName('Cancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cancel = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AliEatoshipTableMap::translateFieldName('Send', TableMap::TYPE_PHPNAME, $indexType)];
            $this->send = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : AliEatoshipTableMap::translateFieldName('Txtmoney', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtmoney = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : AliEatoshipTableMap::translateFieldName('Chkcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : AliEatoshipTableMap::translateFieldName('Chkfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : AliEatoshipTableMap::translateFieldName('Chkinternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkinternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : AliEatoshipTableMap::translateFieldName('Chktransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : AliEatoshipTableMap::translateFieldName('Chkcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : AliEatoshipTableMap::translateFieldName('Chkcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : AliEatoshipTableMap::translateFieldName('Chkcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : AliEatoshipTableMap::translateFieldName('Chkwithdraw', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkwithdraw = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : AliEatoshipTableMap::translateFieldName('ChktransferIn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer_in = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : AliEatoshipTableMap::translateFieldName('ChktransferOut', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer_out = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : AliEatoshipTableMap::translateFieldName('Txtcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : AliEatoshipTableMap::translateFieldName('Txtfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : AliEatoshipTableMap::translateFieldName('Txtinternet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtinternet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : AliEatoshipTableMap::translateFieldName('Txttransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : AliEatoshipTableMap::translateFieldName('Txtcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : AliEatoshipTableMap::translateFieldName('Txtcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : AliEatoshipTableMap::translateFieldName('Txtcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : AliEatoshipTableMap::translateFieldName('Txtwithdraw', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtwithdraw = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : AliEatoshipTableMap::translateFieldName('Txtdiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtdiscount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : AliEatoshipTableMap::translateFieldName('TxttransferIn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer_in = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : AliEatoshipTableMap::translateFieldName('TxttransferOut', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer_out = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : AliEatoshipTableMap::translateFieldName('Txtvoucher', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtvoucher = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : AliEatoshipTableMap::translateFieldName('Optioncash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : AliEatoshipTableMap::translateFieldName('Optionfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : AliEatoshipTableMap::translateFieldName('Optiontransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : AliEatoshipTableMap::translateFieldName('Optioncredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : AliEatoshipTableMap::translateFieldName('Optioncredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : AliEatoshipTableMap::translateFieldName('Optioncredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : AliEatoshipTableMap::translateFieldName('Optionwithdraw', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionwithdraw = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : AliEatoshipTableMap::translateFieldName('OptiontransferIn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer_in = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : AliEatoshipTableMap::translateFieldName('OptiontransferOut', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer_out = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : AliEatoshipTableMap::translateFieldName('Txtoption', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtoption = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : AliEatoshipTableMap::translateFieldName('Ewallet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : AliEatoshipTableMap::translateFieldName('EwalletBefore', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_before = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : AliEatoshipTableMap::translateFieldName('EwalletAfter', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_after = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : AliEatoshipTableMap::translateFieldName('Ipay', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ipay = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : AliEatoshipTableMap::translateFieldName('Checkportal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->checkportal = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : AliEatoshipTableMap::translateFieldName('Bprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : AliEatoshipTableMap::translateFieldName('CancelDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->cancel_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 58 + $startcol : AliEatoshipTableMap::translateFieldName('UidCancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid_cancel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 59 + $startcol : AliEatoshipTableMap::translateFieldName('Locationbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->locationbase = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 60 + $startcol : AliEatoshipTableMap::translateFieldName('Chkcommission', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcommission = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 61 + $startcol : AliEatoshipTableMap::translateFieldName('Txtcommission', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcommission = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 62 + $startcol : AliEatoshipTableMap::translateFieldName('Optioncommission', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncommission = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 63 + $startcol : AliEatoshipTableMap::translateFieldName('Mbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mbase = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 64 + $startcol : AliEatoshipTableMap::translateFieldName('Crate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->crate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 65 + $startcol : AliEatoshipTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 66 + $startcol : AliEatoshipTableMap::translateFieldName('Echeck', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 67; // 67 = AliEatoshipTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliEatoship'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliEatoshipQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliEatoship::setDeleted()
     * @see AliEatoship::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliEatoshipQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliEatoshipTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliEatoshipTableMap::COL_SANO)) {
            $modifiedColumns[':p' . $index++]  = 'sano';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_SADATE)) {
            $modifiedColumns[':p' . $index++]  = 'sadate';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_INV_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'inv_code';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_NAME_F)) {
            $modifiedColumns[':p' . $index++]  = 'name_f';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_NAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'name_t';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'total';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_PV)) {
            $modifiedColumns[':p' . $index++]  = 'pv';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_USERCODE)) {
            $modifiedColumns[':p' . $index++]  = 'usercode';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_REMARK)) {
            $modifiedColumns[':p' . $index++]  = 'remark';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TRNF)) {
            $modifiedColumns[':p' . $index++]  = 'trnf';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_SA_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'sa_type';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_LID)) {
            $modifiedColumns[':p' . $index++]  = 'lid';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_DL)) {
            $modifiedColumns[':p' . $index++]  = 'dl';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'cancel';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_SEND)) {
            $modifiedColumns[':p' . $index++]  = 'send';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTMONEY)) {
            $modifiedColumns[':p' . $index++]  = 'txtMoney';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKCASH)) {
            $modifiedColumns[':p' . $index++]  = 'chkCash';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'chkFuture';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'chkInternet';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit1';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit2';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit3';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKWITHDRAW)) {
            $modifiedColumns[':p' . $index++]  = 'chkWithdraw';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKTRANSFER_IN)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer_in';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKTRANSFER_OUT)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer_out';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTCASH)) {
            $modifiedColumns[':p' . $index++]  = 'txtCash';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'txtFuture';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTINTERNET)) {
            $modifiedColumns[':p' . $index++]  = 'txtInternet';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit1';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit2';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit3';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTWITHDRAW)) {
            $modifiedColumns[':p' . $index++]  = 'txtWithdraw';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTDISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'txtDiscount';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTTRANSFER_IN)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer_in';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTTRANSFER_OUT)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer_out';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTVOUCHER)) {
            $modifiedColumns[':p' . $index++]  = 'txtVoucher';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONCASH)) {
            $modifiedColumns[':p' . $index++]  = 'optionCash';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'optionFuture';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit1';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit2';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit3';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONWITHDRAW)) {
            $modifiedColumns[':p' . $index++]  = 'optionWithdraw';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONTRANSFER_IN)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer_in';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONTRANSFER_OUT)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer_out';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTOPTION)) {
            $modifiedColumns[':p' . $index++]  = 'txtoption';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_EWALLET)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_EWALLET_BEFORE)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_before';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_EWALLET_AFTER)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_after';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_IPAY)) {
            $modifiedColumns[':p' . $index++]  = 'ipay';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHECKPORTAL)) {
            $modifiedColumns[':p' . $index++]  = 'checkportal';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_BPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'bprice';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CANCEL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'cancel_date';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_UID_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'uid_cancel';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_LOCATIONBASE)) {
            $modifiedColumns[':p' . $index++]  = 'locationbase';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKCOMMISSION)) {
            $modifiedColumns[':p' . $index++]  = 'chkCommission';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTCOMMISSION)) {
            $modifiedColumns[':p' . $index++]  = 'txtCommission';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONCOMMISSION)) {
            $modifiedColumns[':p' . $index++]  = 'optionCommission';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_MBASE)) {
            $modifiedColumns[':p' . $index++]  = 'mbase';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CRATE)) {
            $modifiedColumns[':p' . $index++]  = 'crate';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_ECHECK)) {
            $modifiedColumns[':p' . $index++]  = 'echeck';
        }

        $sql = sprintf(
            'INSERT INTO ali_eatoship (%s) VALUES (%s)',
    ...
    {
        $pos = AliEatoshipTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliEatoship'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliEatoship'][$this->hashCode()] = true;
        $keys = AliEatoshipTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSano(),
            ...
            $keys[40] => $this->getTxtvoucher(),
            $keys[41] => $this->getOptioncash(),
            $keys[42] => $this->getOptionfuture(),
            $keys[43] => $this->getOptiontransfer(),
            $keys[44] => $this->getOptioncredit1(),
            $keys[45] => $this->getOptioncredit2(),
            $keys[46] => $this->getOptioncredit3(),
            $keys[47] => $this->getOptionwithdraw(),
            $keys[48] => $this->getOptiontransferIn(),
            $keys[49] => $this->getOptiontransferOut(),
            $keys[50] => $this->getTxtoption(),
            $keys[51] => $this->getEwallet(),
            $keys[52] => $this->getEwalletBefore(),
            $keys[53] => $this->getEwalletAfter(),
            $keys[54] => $this->getIpay(),
            $keys[55] => $this->getCheckportal(),
            $keys[56] => $this->getBprice(),
            $keys[57] => $this->getCancelDate(),
            $keys[58] => $this->getUidCancel(),
            $keys[59] => $this->getLocationbase(),
            $keys[60] => $this->getChkcommission(),
            $keys[61] => $this->getTxtcommission(),
            $keys[62] => $this->getOptioncommission(),
            $keys[63] => $this->getMbase(),
            $keys[64] => $this->getCrate(),
            $keys[65] => $this->getRcode(),
            $keys[66] => $this->getEcheck(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliEatoship
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[21], $arr)) {
            $this->setChkinternet($arr[$keys[21]]);
        }
        ...
        if (array_key_exists($keys[40], $arr)) {
            $this->setTxtvoucher($arr[$keys[40]]);
        }
        if (array_key_exists($keys[41], $arr)) {
            $this->setOptioncash($arr[$keys[41]]);
        }
        if (array_key_exists($keys[42], $arr)) {
            $this->setOptionfuture($arr[$keys[42]]);
        }
        if (array_key_exists($keys[43], $arr)) {
            $this->setOptiontransfer($arr[$keys[43]]);
        }
        if (array_key_exists($keys[44], $arr)) {
            $this->setOptioncredit1($arr[$keys[44]]);
        }
        if (array_key_exists($keys[45], $arr)) {
            $this->setOptioncredit2($arr[$keys[45]]);
        }
        if (array_key_exists($keys[46], $arr)) {
            $this->setOptioncredit3($arr[$keys[46]]);
        }
        if (array_key_exists($keys[47], $arr)) {
            $this->setOptionwithdraw($arr[$keys[47]]);
        }
        if (array_key_exists($keys[48], $arr)) {
            $this->setOptiontransferIn($arr[$keys[48]]);
        }
        if (array_key_exists($keys[49], $arr)) {
            $this->setOptiontransferOut($arr[$keys[49]]);
        }
        if (array_key_exists($keys[50], $arr)) {
            $this->setTxtoption($arr[$keys[50]]);
        }
        if (array_key_exists($keys[51], $arr)) {
            $this->setEwallet($arr[$keys[51]]);
        }
        ...
        if (array_key_exists($keys[54], $arr)) {
            $this->setIpay($arr[$keys[54]]);
        }
        if (array_key_exists($keys[55], $arr)) {
            $this->setCheckportal($arr[$keys[55]]);
        }
        if (array_key_exists($keys[56], $arr)) {
            $this->setBprice($arr[$keys[56]]);
        }
        ...
        if (array_key_exists($keys[59], $arr)) {
            $this->setLocationbase($arr[$keys[59]]);
        }
        if (array_key_exists($keys[60], $arr)) {
            $this->setChkcommission($arr[$keys[60]]);
        }
        if (array_key_exists($keys[61], $arr)) {
            $this->setTxtcommission($arr[$keys[61]]);
        }
        if (array_key_exists($keys[62], $arr)) {
            $this->setOptioncommission($arr[$keys[62]]);
        }
        if (array_key_exists($keys[63], $arr)) {
            $this->setMbase($arr[$keys[63]]);
        }
        if (array_key_exists($keys[64], $arr)) {
            $this->setCrate($arr[$keys[64]]);
        }
        if (array_key_exists($keys[65], $arr)) {
            $this->setRcode($arr[$keys[65]]);
        }
        if (array_key_exists($keys[66], $arr)) {
            $this->setEcheck($arr[$keys[66]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliEatoship The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliEatoshipTableMap::COL_SANO)) {
            $criteria->add(AliEatoshipTableMap::COL_SANO, $this->sano);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_SADATE)) {
            $criteria->add(AliEatoshipTableMap::COL_SADATE, $this->sadate);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_INV_CODE)) {
            $criteria->add(AliEatoshipTableMap::COL_INV_CODE, $this->inv_code);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_MCODE)) {
            $criteria->add(AliEatoshipTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_NAME_F)) {
            $criteria->add(AliEatoshipTableMap::COL_NAME_F, $this->name_f);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_NAME_T)) {
            $criteria->add(AliEatoshipTableMap::COL_NAME_T, $this->name_t);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TOTAL)) {
            $criteria->add(AliEatoshipTableMap::COL_TOTAL, $this->total);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_PV)) {
            $criteria->add(AliEatoshipTableMap::COL_PV, $this->pv);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_USERCODE)) {
            $criteria->add(AliEatoshipTableMap::COL_USERCODE, $this->usercode);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_REMARK)) {
            $criteria->add(AliEatoshipTableMap::COL_REMARK, $this->remark);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TRNF)) {
            $criteria->add(AliEatoshipTableMap::COL_TRNF, $this->trnf);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_ID)) {
            $criteria->add(AliEatoshipTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_SA_TYPE)) {
            $criteria->add(AliEatoshipTableMap::COL_SA_TYPE, $this->sa_type);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_UID)) {
            $criteria->add(AliEatoshipTableMap::COL_UID, $this->uid);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_LID)) {
            $criteria->add(AliEatoshipTableMap::COL_LID, $this->lid);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_DL)) {
            $criteria->add(AliEatoshipTableMap::COL_DL, $this->dl);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CANCEL)) {
            $criteria->add(AliEatoshipTableMap::COL_CANCEL, $this->cancel);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_SEND)) {
            $criteria->add(AliEatoshipTableMap::COL_SEND, $this->send);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTMONEY)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTMONEY, $this->txtmoney);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKCASH)) {
            $criteria->add(AliEatoshipTableMap::COL_CHKCASH, $this->chkcash);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKFUTURE)) {
            $criteria->add(AliEatoshipTableMap::COL_CHKFUTURE, $this->chkfuture);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKINTERNET)) {
            $criteria->add(AliEatoshipTableMap::COL_CHKINTERNET, $this->chkinternet);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKTRANSFER)) {
            $criteria->add(AliEatoshipTableMap::COL_CHKTRANSFER, $this->chktransfer);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKCREDIT1)) {
            $criteria->add(AliEatoshipTableMap::COL_CHKCREDIT1, $this->chkcredit1);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKCREDIT2)) {
            $criteria->add(AliEatoshipTableMap::COL_CHKCREDIT2, $this->chkcredit2);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKCREDIT3)) {
            $criteria->add(AliEatoshipTableMap::COL_CHKCREDIT3, $this->chkcredit3);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKWITHDRAW)) {
            $criteria->add(AliEatoshipTableMap::COL_CHKWITHDRAW, $this->chkwithdraw);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKTRANSFER_IN)) {
            $criteria->add(AliEatoshipTableMap::COL_CHKTRANSFER_IN, $this->chktransfer_in);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKTRANSFER_OUT)) {
            $criteria->add(AliEatoshipTableMap::COL_CHKTRANSFER_OUT, $this->chktransfer_out);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTCASH)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTCASH, $this->txtcash);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTFUTURE)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTFUTURE, $this->txtfuture);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTINTERNET)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTINTERNET, $this->txtinternet);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTTRANSFER)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTTRANSFER, $this->txttransfer);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTCREDIT1)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTCREDIT1, $this->txtcredit1);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTCREDIT2)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTCREDIT2, $this->txtcredit2);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTCREDIT3)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTCREDIT3, $this->txtcredit3);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTWITHDRAW)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTWITHDRAW, $this->txtwithdraw);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTDISCOUNT)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTDISCOUNT, $this->txtdiscount);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTTRANSFER_IN)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTTRANSFER_IN, $this->txttransfer_in);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTTRANSFER_OUT)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTTRANSFER_OUT, $this->txttransfer_out);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTVOUCHER)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTVOUCHER, $this->txtvoucher);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONCASH)) {
            $criteria->add(AliEatoshipTableMap::COL_OPTIONCASH, $this->optioncash);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONFUTURE)) {
            $criteria->add(AliEatoshipTableMap::COL_OPTIONFUTURE, $this->optionfuture);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONTRANSFER)) {
            $criteria->add(AliEatoshipTableMap::COL_OPTIONTRANSFER, $this->optiontransfer);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONCREDIT1)) {
            $criteria->add(AliEatoshipTableMap::COL_OPTIONCREDIT1, $this->optioncredit1);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONCREDIT2)) {
            $criteria->add(AliEatoshipTableMap::COL_OPTIONCREDIT2, $this->optioncredit2);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONCREDIT3)) {
            $criteria->add(AliEatoshipTableMap::COL_OPTIONCREDIT3, $this->optioncredit3);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONWITHDRAW)) {
            $criteria->add(AliEatoshipTableMap::COL_OPTIONWITHDRAW, $this->optionwithdraw);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONTRANSFER_IN)) {
            $criteria->add(AliEatoshipTableMap::COL_OPTIONTRANSFER_IN, $this->optiontransfer_in);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONTRANSFER_OUT)) {
            $criteria->add(AliEatoshipTableMap::COL_OPTIONTRANSFER_OUT, $this->optiontransfer_out);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTOPTION)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTOPTION, $this->txtoption);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_EWALLET)) {
            $criteria->add(AliEatoshipTableMap::COL_EWALLET, $this->ewallet);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_EWALLET_BEFORE)) {
            $criteria->add(AliEatoshipTableMap::COL_EWALLET_BEFORE, $this->ewallet_before);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_EWALLET_AFTER)) {
            $criteria->add(AliEatoshipTableMap::COL_EWALLET_AFTER, $this->ewallet_after);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_IPAY)) {
            $criteria->add(AliEatoshipTableMap::COL_IPAY, $this->ipay);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHECKPORTAL)) {
            $criteria->add(AliEatoshipTableMap::COL_CHECKPORTAL, $this->checkportal);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_BPRICE)) {
            $criteria->add(AliEatoshipTableMap::COL_BPRICE, $this->bprice);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CANCEL_DATE)) {
            $criteria->add(AliEatoshipTableMap::COL_CANCEL_DATE, $this->cancel_date);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_UID_CANCEL)) {
            $criteria->add(AliEatoshipTableMap::COL_UID_CANCEL, $this->uid_cancel);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_LOCATIONBASE)) {
            $criteria->add(AliEatoshipTableMap::COL_LOCATIONBASE, $this->locationbase);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CHKCOMMISSION)) {
            $criteria->add(AliEatoshipTableMap::COL_CHKCOMMISSION, $this->chkcommission);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_TXTCOMMISSION)) {
            $criteria->add(AliEatoshipTableMap::COL_TXTCOMMISSION, $this->txtcommission);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_OPTIONCOMMISSION)) {
            $criteria->add(AliEatoshipTableMap::COL_OPTIONCOMMISSION, $this->optioncommission);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_MBASE)) {
            $criteria->add(AliEatoshipTableMap::COL_MBASE, $this->mbase);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_CRATE)) {
            $criteria->add(AliEatoshipTableMap::COL_CRATE, $this->crate);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_RCODE)) {
            $criteria->add(AliEatoshipTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliEatoshipTableMap::COL_ECHECK)) {
            $criteria->add(AliEatoshipTableMap::COL_ECHECK, $this->echeck);
        }
    ...
    {
        $criteria = ChildAliEatoshipQuery::create();
        $criteria->add(AliEatoshipTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliEatoship (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliEatoship Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliEatoshipTableMap::DEFAULT_STRING_FORMAT);
    }
