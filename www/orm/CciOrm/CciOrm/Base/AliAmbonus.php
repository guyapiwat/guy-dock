...
/**
 * Base class that represents a row from the 'ali_ambonus' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliAmbonus implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliAmbonusTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliAmbonus object.
     */
    ...
    /**
     * Compares this with another <code>AliAmbonus</code> instance.  If
     * <code>obj</code> is an instance of <code>AliAmbonus</code>, delegates to
     * <code>equals(AliAmbonus)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliAmbonus The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliAmbonus The current object (for fluent API support)
     */
    public function setAid($v)
    {
        ...
        if ($this->aid !== $v) {
            $this->aid = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_AID] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_RCODE] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_MCODE] = true;
        }
    ...
    public function setNameT($v)
    {
        ...
        if ($this->name_t !== $v) {
            $this->name_t = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_NAME_T] = true;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_TOTAL] = true;
        }
    ...
    public function setTotPv($v)
    {
        ...
        if ($this->tot_pv !== $v) {
            $this->tot_pv = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_TOT_PV] = true;
        }
    ...
    public function setTax($v)
    {
        ...
        if ($this->tax !== $v) {
            $this->tax = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_TAX] = true;
        }
    ...
    public function setBonus($v)
    {
        ...
        if ($this->bonus !== $v) {
            $this->bonus = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_BONUS] = true;
        }
    ...
    public function setFdate($v)
    {
        ...
        if ($this->fdate !== null || $dt !== null) {
            if ($this->fdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliAmbonusTableMap::COL_FDATE] = true;
            }
    ...
    public function setTdate($v)
    {
        ...
        if ($this->tdate !== null || $dt !== null) {
            if ($this->tdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliAmbonusTableMap::COL_TDATE] = true;
            }
        } // if either are not null
    ...
    public function setPosCur($v)
    {
        ...
        if ($this->pos_cur !== $v) {
            $this->pos_cur = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_POS_CUR] = true;
        }
    ...
    public function setPstatus($v)
    {
        ...
        if ($this->pstatus !== $v) {
            $this->pstatus = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_PSTATUS] = true;
        }
    ...
    public function setPrcode($v)
    {
        ...
        if ($this->prcode !== $v) {
            $this->prcode = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_PRCODE] = true;
        }
    ...
    public function setCrate($v)
    {
        ...
        if ($this->crate !== $v) {
            $this->crate = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_CRATE] = true;
        }
    ...
    public function setLocationbase($v)
    {
        ...
        if ($this->locationbase !== $v) {
            $this->locationbase = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_LOCATIONBASE] = true;
        }
    ...
    public function setPaytype($v)
    {
        ...
        if ($this->paytype !== $v) {
            $this->paytype = $v;
            $this->modifiedColumns[AliAmbonusTableMap::COL_PAYTYPE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliAmbonusTableMap::translateFieldName('Aid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->aid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliAmbonusTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliAmbonusTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliAmbonusTableMap::translateFieldName('NameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliAmbonusTableMap::translateFieldName('Total', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliAmbonusTableMap::translateFieldName('TotPv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tot_pv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliAmbonusTableMap::translateFieldName('Tax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliAmbonusTableMap::translateFieldName('Bonus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bonus = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliAmbonusTableMap::translateFieldName('Fdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliAmbonusTableMap::translateFieldName('Tdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->tdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliAmbonusTableMap::translateFieldName('PosCur', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pos_cur = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliAmbonusTableMap::translateFieldName('Pstatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pstatus = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliAmbonusTableMap::translateFieldName('Prcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliAmbonusTableMap::translateFieldName('Crate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->crate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliAmbonusTableMap::translateFieldName('Locationbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->locationbase = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliAmbonusTableMap::translateFieldName('Paytype', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 16; // 16 = AliAmbonusTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliAmbonus'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliAmbonusQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliAmbonus::setDeleted()
     * @see AliAmbonus::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliAmbonusQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliAmbonusTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliAmbonusTableMap::COL_AID)) {
            $modifiedColumns[':p' . $index++]  = 'aid';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_NAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'name_t';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'total';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_TOT_PV)) {
            $modifiedColumns[':p' . $index++]  = 'tot_pv';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_TAX)) {
            $modifiedColumns[':p' . $index++]  = 'tax';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_BONUS)) {
            $modifiedColumns[':p' . $index++]  = 'bonus';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_FDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fdate';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_TDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tdate';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_POS_CUR)) {
            $modifiedColumns[':p' . $index++]  = 'pos_cur';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_PSTATUS)) {
            $modifiedColumns[':p' . $index++]  = 'pstatus';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_PRCODE)) {
            $modifiedColumns[':p' . $index++]  = 'prcode';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_CRATE)) {
            $modifiedColumns[':p' . $index++]  = 'crate';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_LOCATIONBASE)) {
            $modifiedColumns[':p' . $index++]  = 'locationbase';
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_PAYTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'paytype';
        }

        $sql = sprintf(
            'INSERT INTO ali_ambonus (%s) VALUES (%s)',
    ...
    {
        $pos = AliAmbonusTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliAmbonus'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliAmbonus'][$this->hashCode()] = true;
        $keys = AliAmbonusTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getAid(),
            ...
            $keys[13] => $this->getCrate(),
            $keys[14] => $this->getLocationbase(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliAmbonus
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[13], $arr)) {
            $this->setCrate($arr[$keys[13]]);
        }
        if (array_key_exists($keys[14], $arr)) {
            $this->setLocationbase($arr[$keys[14]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliAmbonus The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliAmbonusTableMap::COL_AID)) {
            $criteria->add(AliAmbonusTableMap::COL_AID, $this->aid);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_RCODE)) {
            $criteria->add(AliAmbonusTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_MCODE)) {
            $criteria->add(AliAmbonusTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_NAME_T)) {
            $criteria->add(AliAmbonusTableMap::COL_NAME_T, $this->name_t);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_TOTAL)) {
            $criteria->add(AliAmbonusTableMap::COL_TOTAL, $this->total);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_TOT_PV)) {
            $criteria->add(AliAmbonusTableMap::COL_TOT_PV, $this->tot_pv);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_TAX)) {
            $criteria->add(AliAmbonusTableMap::COL_TAX, $this->tax);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_BONUS)) {
            $criteria->add(AliAmbonusTableMap::COL_BONUS, $this->bonus);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_FDATE)) {
            $criteria->add(AliAmbonusTableMap::COL_FDATE, $this->fdate);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_TDATE)) {
            $criteria->add(AliAmbonusTableMap::COL_TDATE, $this->tdate);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_POS_CUR)) {
            $criteria->add(AliAmbonusTableMap::COL_POS_CUR, $this->pos_cur);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_PSTATUS)) {
            $criteria->add(AliAmbonusTableMap::COL_PSTATUS, $this->pstatus);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_PRCODE)) {
            $criteria->add(AliAmbonusTableMap::COL_PRCODE, $this->prcode);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_CRATE)) {
            $criteria->add(AliAmbonusTableMap::COL_CRATE, $this->crate);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_LOCATIONBASE)) {
            $criteria->add(AliAmbonusTableMap::COL_LOCATIONBASE, $this->locationbase);
        }
        if ($this->isColumnModified(AliAmbonusTableMap::COL_PAYTYPE)) {
            $criteria->add(AliAmbonusTableMap::COL_PAYTYPE, $this->paytype);
        }
    ...
    {
        $criteria = ChildAliAmbonusQuery::create();
        $criteria->add(AliAmbonusTableMap::COL_AID, $this->aid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliAmbonus (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliAmbonus Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliAmbonusTableMap::DEFAULT_STRING_FORMAT);
    }
