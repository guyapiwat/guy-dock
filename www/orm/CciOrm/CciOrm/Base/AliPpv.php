...
/**
 * Base class that represents a row from the 'ali_ppv' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliPpv implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliPpvTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliPpv object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>AliPpv</code> instance.  If
     * <code>obj</code> is an instance of <code>AliPpv</code>, delegates to
     * <code>equals(AliPpv)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliPpv The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliPpv The current object (for fluent API support)
     */
    public function setAid($v)
    {
        ...
        if ($this->aid !== $v) {
            $this->aid = $v;
            $this->modifiedColumns[AliPpvTableMap::COL_AID] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliPpvTableMap::COL_RCODE] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliPpvTableMap::COL_MCODE] = true;
        }
    ...
    public function setTotalPv($v)
    {
        ...
        if ($this->total_pv !== $v) {
            $this->total_pv = $v;
            $this->modifiedColumns[AliPpvTableMap::COL_TOTAL_PV] = true;
        }
    ...
    public function setMpos($v)
    {
        ...
        if ($this->mpos !== $v) {
            $this->mpos = $v;
            $this->modifiedColumns[AliPpvTableMap::COL_MPOS] = true;
        }
    ...
    public function setNpos($v)
    {
        ...
        if ($this->npos !== $v) {
            $this->npos = $v;
            $this->modifiedColumns[AliPpvTableMap::COL_NPOS] = true;
        }
    ...
    public function setFdate($v)
    {
        ...
        if ($this->fdate !== null || $dt !== null) {
            if ($this->fdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliPpvTableMap::COL_FDATE] = true;
            }
    ...
    public function setTdate($v)
    {
        ...
        if ($this->tdate !== null || $dt !== null) {
            if ($this->tdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliPpvTableMap::COL_TDATE] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliPpvTableMap::translateFieldName('Aid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->aid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliPpvTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliPpvTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliPpvTableMap::translateFieldName('TotalPv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_pv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliPpvTableMap::translateFieldName('Mpos', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mpos = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliPpvTableMap::translateFieldName('Npos', TableMap::TYPE_PHPNAME, $indexType)];
            $this->npos = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliPpvTableMap::translateFieldName('Fdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliPpvTableMap::translateFieldName('Tdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            ...
            return $startcol + 8; // 8 = AliPpvTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliPpv'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliPpvQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliPpv::setDeleted()
     * @see AliPpv::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliPpvQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliPpvTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliPpvTableMap::COL_AID)) {
            $modifiedColumns[':p' . $index++]  = 'aid';
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_TOTAL_PV)) {
            $modifiedColumns[':p' . $index++]  = 'total_pv';
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_MPOS)) {
            $modifiedColumns[':p' . $index++]  = 'mpos';
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_NPOS)) {
            $modifiedColumns[':p' . $index++]  = 'npos';
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_FDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fdate';
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_TDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tdate';
        }

        $sql = sprintf(
            'INSERT INTO ali_ppv (%s) VALUES (%s)',
    ...
    {
        $pos = AliPpvTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliPpv'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliPpv'][$this->hashCode()] = true;
        $keys = AliPpvTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getAid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliPpv
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliPpv The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliPpvTableMap::COL_AID)) {
            $criteria->add(AliPpvTableMap::COL_AID, $this->aid);
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_RCODE)) {
            $criteria->add(AliPpvTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_MCODE)) {
            $criteria->add(AliPpvTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_TOTAL_PV)) {
            $criteria->add(AliPpvTableMap::COL_TOTAL_PV, $this->total_pv);
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_MPOS)) {
            $criteria->add(AliPpvTableMap::COL_MPOS, $this->mpos);
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_NPOS)) {
            $criteria->add(AliPpvTableMap::COL_NPOS, $this->npos);
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_FDATE)) {
            $criteria->add(AliPpvTableMap::COL_FDATE, $this->fdate);
        }
        if ($this->isColumnModified(AliPpvTableMap::COL_TDATE)) {
            $criteria->add(AliPpvTableMap::COL_TDATE, $this->tdate);
        }
    ...
    {
        $criteria = ChildAliPpvQuery::create();
        $criteria->add(AliPpvTableMap::COL_AID, $this->aid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliPpv (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliPpv Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliPpvTableMap::DEFAULT_STRING_FORMAT);
    }
