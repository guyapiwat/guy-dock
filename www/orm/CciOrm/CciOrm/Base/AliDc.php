...
/**
 * Base class that represents a row from the 'ali_dc' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliDc implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliDcTableMap';
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliDc object.
     */
    ...
    /**
     * Compares this with another <code>AliDc</code> instance.  If
     * <code>obj</code> is an instance of <code>AliDc</code>, delegates to
     * <code>equals(AliDc)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliDc The current object, for fluid interface
     */
     ...
     * @return $this|\CciOrm\CciOrm\AliDc The current object (for fluent API support)
     */
    public function setAid($v)
    {
        ...
        if ($this->aid !== $v) {
            $this->aid = $v;
            $this->modifiedColumns[AliDcTableMap::COL_AID] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliDcTableMap::COL_RCODE] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliDcTableMap::COL_MCODE] = true;
        }
    ...
    public function setNameT($v)
    {
        ...
        if ($this->name_t !== $v) {
            $this->name_t = $v;
            $this->modifiedColumns[AliDcTableMap::COL_NAME_T] = true;
        }
    ...
    public function setMposi($v)
    {
        ...
        if ($this->mposi !== $v) {
            $this->mposi = $v;
            $this->modifiedColumns[AliDcTableMap::COL_MPOSI] = true;
        }
    ...
    public function setUpaCode($v)
    {
        ...
        if ($this->upa_code !== $v) {
            $this->upa_code = $v;
            $this->modifiedColumns[AliDcTableMap::COL_UPA_CODE] = true;
        }
    ...
    public function setUpaName($v)
    {
        ...
        if ($this->upa_name !== $v) {
            $this->upa_name = $v;
            $this->modifiedColumns[AliDcTableMap::COL_UPA_NAME] = true;
        }
    ...
    public function setBposi($v)
    {
        ...
        if ($this->bposi !== $v) {
            $this->bposi = $v;
            $this->modifiedColumns[AliDcTableMap::COL_BPOSI] = true;
        }
    ...
    public function setLevel($v)
    {
        ...
        if ($this->level !== $v) {
            $this->level = $v;
            $this->modifiedColumns[AliDcTableMap::COL_LEVEL] = true;
        }
    ...
    public function setGen($v)
    {
        ...
        if ($this->gen !== $v) {
            $this->gen = $v;
            $this->modifiedColumns[AliDcTableMap::COL_GEN] = true;
        }
    ...
    public function setBtype($v)
    {
        ...
        if ($this->btype !== $v) {
            $this->btype = $v;
            $this->modifiedColumns[AliDcTableMap::COL_BTYPE] = true;
        }
    ...
    public function setPv($v)
    {
        ...
        if ($this->pv !== $v) {
            $this->pv = $v;
            $this->modifiedColumns[AliDcTableMap::COL_PV] = true;
        }
    ...
    public function setPercer($v)
    {
        ...
        if ($this->percer !== $v) {
            $this->percer = $v;
            $this->modifiedColumns[AliDcTableMap::COL_PERCER] = true;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[AliDcTableMap::COL_TOTAL] = true;
        }
    ...
    public function setFdate($v)
    {
        ...
        if ($this->fdate !== null || $dt !== null) {
            if ($this->fdate === null || $dt === null || $dt->format("Y-m-d") !== $this->fdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliDcTableMap::COL_FDATE] = true;
            }
    ...
    public function setTdate($v)
    {
        ...
        if ($this->tdate !== null || $dt !== null) {
            if ($this->tdate === null || $dt === null || $dt->format("Y-m-d") !== $this->tdate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliDcTableMap::COL_TDATE] = true;
            }
        } // if either are not null
    ...
    public function setCrate($v)
    {
        ...
        if ($this->crate !== $v) {
            $this->crate = $v;
            $this->modifiedColumns[AliDcTableMap::COL_CRATE] = true;
        }
    ...
    public function setLocationbase($v)
    {
        ...
        if ($this->locationbase !== $v) {
            $this->locationbase = $v;
            $this->modifiedColumns[AliDcTableMap::COL_LOCATIONBASE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliDcTableMap::translateFieldName('Aid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->aid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliDcTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliDcTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliDcTableMap::translateFieldName('NameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliDcTableMap::translateFieldName('Mposi', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mposi = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliDcTableMap::translateFieldName('UpaCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->upa_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliDcTableMap::translateFieldName('UpaName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->upa_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliDcTableMap::translateFieldName('Bposi', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bposi = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliDcTableMap::translateFieldName('Level', TableMap::TYPE_PHPNAME, $indexType)];
            $this->level = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliDcTableMap::translateFieldName('Gen', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gen = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliDcTableMap::translateFieldName('Btype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->btype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliDcTableMap::translateFieldName('Pv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliDcTableMap::translateFieldName('Percer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->percer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliDcTableMap::translateFieldName('Total', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliDcTableMap::translateFieldName('Fdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliDcTableMap::translateFieldName('Tdate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->tdate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AliDcTableMap::translateFieldName('Crate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->crate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AliDcTableMap::translateFieldName('Locationbase', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 18; // 18 = AliDcTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliDc'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliDcQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliDcQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliDcTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliDcTableMap::COL_AID)) {
            $modifiedColumns[':p' . $index++]  = 'aid';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_NAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'name_t';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_MPOSI)) {
            $modifiedColumns[':p' . $index++]  = 'mposi';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_UPA_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'upa_code';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_UPA_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'upa_name';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_BPOSI)) {
            $modifiedColumns[':p' . $index++]  = 'bposi';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_LEVEL)) {
            $modifiedColumns[':p' . $index++]  = 'level';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_GEN)) {
            $modifiedColumns[':p' . $index++]  = 'gen';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_BTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'btype';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_PV)) {
            $modifiedColumns[':p' . $index++]  = 'pv';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_PERCER)) {
            $modifiedColumns[':p' . $index++]  = 'percer';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'total';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_FDATE)) {
            $modifiedColumns[':p' . $index++]  = 'fdate';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_TDATE)) {
            $modifiedColumns[':p' . $index++]  = 'tdate';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_CRATE)) {
            $modifiedColumns[':p' . $index++]  = 'crate';
        }
        if ($this->isColumnModified(AliDcTableMap::COL_LOCATIONBASE)) {
            $modifiedColumns[':p' . $index++]  = 'locationbase';
        }

        $sql = sprintf(
            'INSERT INTO ali_dc (%s) VALUES (%s)',
    ...
    {
        $pos = AliDcTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliDc'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliDc'][$this->hashCode()] = true;
        $keys = AliDcTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getAid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliDc
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliDc The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliDcTableMap::COL_AID)) {
            $criteria->add(AliDcTableMap::COL_AID, $this->aid);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_RCODE)) {
            $criteria->add(AliDcTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_MCODE)) {
            $criteria->add(AliDcTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_NAME_T)) {
            $criteria->add(AliDcTableMap::COL_NAME_T, $this->name_t);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_MPOSI)) {
            $criteria->add(AliDcTableMap::COL_MPOSI, $this->mposi);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_UPA_CODE)) {
            $criteria->add(AliDcTableMap::COL_UPA_CODE, $this->upa_code);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_UPA_NAME)) {
            $criteria->add(AliDcTableMap::COL_UPA_NAME, $this->upa_name);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_BPOSI)) {
            $criteria->add(AliDcTableMap::COL_BPOSI, $this->bposi);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_LEVEL)) {
            $criteria->add(AliDcTableMap::COL_LEVEL, $this->level);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_GEN)) {
            $criteria->add(AliDcTableMap::COL_GEN, $this->gen);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_BTYPE)) {
            $criteria->add(AliDcTableMap::COL_BTYPE, $this->btype);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_PV)) {
            $criteria->add(AliDcTableMap::COL_PV, $this->pv);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_PERCER)) {
            $criteria->add(AliDcTableMap::COL_PERCER, $this->percer);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_TOTAL)) {
            $criteria->add(AliDcTableMap::COL_TOTAL, $this->total);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_FDATE)) {
            $criteria->add(AliDcTableMap::COL_FDATE, $this->fdate);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_TDATE)) {
            $criteria->add(AliDcTableMap::COL_TDATE, $this->tdate);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_CRATE)) {
            $criteria->add(AliDcTableMap::COL_CRATE, $this->crate);
        }
        if ($this->isColumnModified(AliDcTableMap::COL_LOCATIONBASE)) {
            $criteria->add(AliDcTableMap::COL_LOCATIONBASE, $this->locationbase);
        }
    ...
    {
        $criteria = ChildAliDcQuery::create();
        $criteria->add(AliDcTableMap::COL_AID, $this->aid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliDc (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliDc Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliDcTableMap::DEFAULT_STRING_FORMAT);
    }
