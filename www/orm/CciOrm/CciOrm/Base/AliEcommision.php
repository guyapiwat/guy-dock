...
/**
 * Base class that represents a row from the 'ali_ecommision' table.
 *
 *
 *
 * @package    propel.generator.CciOrm.CciOrm.Base
 */
abstract class AliEcommision implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CciOrm\\CciOrm\\Map\\AliEcommisionTableMap';
    ...
    /**
     * The value for the status_tranfer field.
     *
     * @var        int
     */
    protected $status_tranfer;
    ...
    /**
     * Initializes internal state of CciOrm\CciOrm\Base\AliEcommision object.
     */
    ...
    /**
     * Compares this with another <code>AliEcommision</code> instance.  If
     * <code>obj</code> is an instance of <code>AliEcommision</code>, delegates to
     * <code>equals(AliEcommision)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AliEcommision The current object, for fluid interface
     */
    ...
    /**
     * Get the [status_tranfer] column value.
     *
     * @return int
     */
    public function getStatusTranfer()
    {
        return $this->status_tranfer;
    }
     ...
     * @return $this|\CciOrm\CciOrm\AliEcommision The current object (for fluent API support)
     */
    public function setSano($v)
    {
        ...
        if ($this->sano !== $v) {
            $this->sano = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_SANO] = true;
        }
    ...
    public function setRcode($v)
    {
        ...
        if ($this->rcode !== $v) {
            $this->rcode = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_RCODE] = true;
        }
    ...
    public function setSadate($v)
    {
        ...
        if ($this->sadate !== null || $dt !== null) {
            if ($this->sadate === null || $dt === null || $dt->format("Y-m-d") !== $this->sadate->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliEcommisionTableMap::COL_SADATE] = true;
            }
    ...
    public function setInvCode($v)
    {
        ...
        if ($this->inv_code !== $v) {
            $this->inv_code = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_INV_CODE] = true;
        }
    ...
    public function setMcode($v)
    {
        ...
        if ($this->mcode !== $v) {
            $this->mcode = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_MCODE] = true;
        }
    ...
    public function setNameF($v)
    {
        ...
        if ($this->name_f !== $v) {
            $this->name_f = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_NAME_F] = true;
        }
    ...
    public function setNameT($v)
    {
        ...
        if ($this->name_t !== $v) {
            $this->name_t = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_NAME_T] = true;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_TOTAL] = true;
        }
    ...
    public function setUsercode($v)
    {
        ...
        if ($this->usercode !== $v) {
            $this->usercode = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_USERCODE] = true;
        }
    ...
    public function setRemark($v)
    {
        ...
        if ($this->remark !== $v) {
            $this->remark = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_REMARK] = true;
        }
    ...
    public function setTrnf($v)
    {
        ...
        if ($this->trnf !== $v) {
            $this->trnf = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_TRNF] = true;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_ID] = true;
        }
    ...
    public function setSaType($v)
    {
        ...
        if ($this->sa_type !== $v) {
            $this->sa_type = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_SA_TYPE] = true;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_UID] = true;
        }
    ...
    public function setLid($v)
    {
        ...
        if ($this->lid !== $v) {
            $this->lid = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_LID] = true;
        }
    ...
    public function setDl($v)
    {
        ...
        if ($this->dl !== $v) {
            $this->dl = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_DL] = true;
        }
    ...
    public function setCancel($v)
    {
        ...
        if ($this->cancel !== $v) {
            $this->cancel = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_CANCEL] = true;
        }
    ...
    public function setSend($v)
    {
        ...
        if ($this->send !== $v) {
            $this->send = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_SEND] = true;
        }
    ...
    public function setTxtmoney($v)
    {
        ...
        if ($this->txtmoney !== $v) {
            $this->txtmoney = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_TXTMONEY] = true;
        }
    ...
    public function setChkcash($v)
    {
        ...
        if ($this->chkcash !== $v) {
            $this->chkcash = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_CHKCASH] = true;
        }
    ...
    public function setChkfuture($v)
    {
        ...
        if ($this->chkfuture !== $v) {
            $this->chkfuture = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_CHKFUTURE] = true;
        }
    ...
    public function setChktransfer($v)
    {
        ...
        if ($this->chktransfer !== $v) {
            $this->chktransfer = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_CHKTRANSFER] = true;
        }
    ...
    public function setChkcredit1($v)
    {
        ...
        if ($this->chkcredit1 !== $v) {
            $this->chkcredit1 = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_CHKCREDIT1] = true;
        }
    ...
    public function setChkcredit2($v)
    {
        ...
        if ($this->chkcredit2 !== $v) {
            $this->chkcredit2 = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_CHKCREDIT2] = true;
        }
    ...
    public function setChkcredit3($v)
    {
        ...
        if ($this->chkcredit3 !== $v) {
            $this->chkcredit3 = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_CHKCREDIT3] = true;
        }
    ...
    public function setChkwithdraw($v)
    {
        ...
        if ($this->chkwithdraw !== $v) {
            $this->chkwithdraw = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_CHKWITHDRAW] = true;
        }
    ...
    public function setChktransferIn($v)
    {
        ...
        if ($this->chktransfer_in !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_CHKTRANSFER_IN] = true;
        }
    ...
    public function setChktransferOut($v)
    {
        ...
        if ($this->chktransfer_out !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_CHKTRANSFER_OUT] = true;
        }
    ...
    public function setTxtcash($v)
    {
        ...
        if ($this->txtcash !== $v) {
            $this->txtcash = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_TXTCASH] = true;
        }
    ...
    public function setTxtfuture($v)
    {
        ...
        if ($this->txtfuture !== $v) {
            $this->txtfuture = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_TXTFUTURE] = true;
        }
    ...
    public function setTxttransfer($v)
    {
        ...
        if ($this->txttransfer !== $v) {
            $this->txttransfer = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_TXTTRANSFER] = true;
        }
    ...
    public function setTxtcredit1($v)
    {
        ...
        if ($this->txtcredit1 !== $v) {
            $this->txtcredit1 = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_TXTCREDIT1] = true;
        }
    ...
    public function setTxtcredit2($v)
    {
        ...
        if ($this->txtcredit2 !== $v) {
            $this->txtcredit2 = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_TXTCREDIT2] = true;
        }
    ...
    public function setTxtcredit3($v)
    {
        ...
        if ($this->txtcredit3 !== $v) {
            $this->txtcredit3 = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_TXTCREDIT3] = true;
        }
    ...
    public function setTxtwithdraw($v)
    {
        ...
        if ($this->txtwithdraw !== $v) {
            $this->txtwithdraw = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_TXTWITHDRAW] = true;
        }
    ...
    public function setTxttransferIn($v)
    {
        ...
        if ($this->txttransfer_in !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_TXTTRANSFER_IN] = true;
        }
    ...
    public function setTxttransferOut($v)
    {
        ...
        if ($this->txttransfer_out !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_TXTTRANSFER_OUT] = true;
        }
    ...
    public function setOptioncash($v)
    {
        ...
        if ($this->optioncash !== $v) {
            $this->optioncash = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_OPTIONCASH] = true;
        }
    ...
    public function setOptionfuture($v)
    {
        ...
        if ($this->optionfuture !== $v) {
            $this->optionfuture = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_OPTIONFUTURE] = true;
        }
    ...
    public function setOptiontransfer($v)
    {
        ...
        if ($this->optiontransfer !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_OPTIONTRANSFER] = true;
        }
    ...
    public function setOptioncredit1($v)
    {
        ...
        if ($this->optioncredit1 !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_OPTIONCREDIT1] = true;
        }
    ...
    public function setOptioncredit2($v)
    {
        ...
        if ($this->optioncredit2 !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_OPTIONCREDIT2] = true;
        }
    ...
    public function setOptioncredit3($v)
    {
        ...
        if ($this->optioncredit3 !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_OPTIONCREDIT3] = true;
        }
    ...
    public function setOptionwithdraw($v)
    {
        ...
        if ($this->optionwithdraw !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_OPTIONWITHDRAW] = true;
        }
    ...
    public function setOptiontransferIn($v)
    {
        ...
        if ($this->optiontransfer_in !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_OPTIONTRANSFER_IN] = true;
        }
    ...
    public function setOptiontransferOut($v)
    {
        ...
        if ($this->optiontransfer_out !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_OPTIONTRANSFER_OUT] = true;
        }
    ...
    public function setTxtoption($v)
    {
        ...
        if ($this->txtoption !== $v) {
            $this->txtoption = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_TXTOPTION] = true;
        }
    ...
    public function setEwallet($v)
    {
        ...
        if ($this->ewallet !== $v) {
            $this->ewallet = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_EWALLET] = true;
        }
    ...
    public function setEwalletBefore($v)
    {
        ...
        if ($this->ewallet_before !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_EWALLET_BEFORE] = true;
        }
    ...
    public function setEwalletAfter($v)
    {
        ...
        if ($this->ewallet_after !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_EWALLET_AFTER] = true;
        }
    ...
    public function setIpay($v)
    {
        ...
        if ($this->ipay !== $v) {
            $this->ipay = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_IPAY] = true;
        }
    ...
    public function setCheckportal($v)
    {
        ...
        if ($this->checkportal !== $v) {
            $this->checkportal = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_CHECKPORTAL] = true;
        }
    ...
    public function setBprice($v)
    {
        ...
        if ($this->bprice !== $v) {
            $this->bprice = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_BPRICE] = true;
        }
    ...
    public function setCancelDate($v)
    {
        ...
        if ($this->cancel_date !== null || $dt !== null) {
            if ($this->cancel_date === null || $dt === null || $dt->format("Y-m-d") !== $this->cancel_date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[AliEcommisionTableMap::COL_CANCEL_DATE] = true;
            }
        } // if either are not null
    ...
    public function setUidCancel($v)
    {
        ...
        if ($this->uid_cancel !== $v) {
            $this->uid_cancel = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_UID_CANCEL] = true;
        }
    ...
    public function setLocationbase($v)
    {
        ...
        if ($this->locationbase !== $v) {
            $this->locationbase = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_LOCATIONBASE] = true;
        }
    ...
    public function setChkcommission($v)
    {
        ...
        if ($this->chkcommission !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_CHKCOMMISSION] = true;
        }
    ...
    public function setTxtcommission($v)
    {
        ...
        if ($this->txtcommission !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_TXTCOMMISSION] = true;
        }
    ...
    public function setOptioncommission($v)
    {
        ...
        if ($this->optioncommission !== $v) {
            ...
            $this->modifiedColumns[AliEcommisionTableMap::COL_OPTIONCOMMISSION] = true;
        }
    ...
    /**
     * Set the value of [status_tranfer] column.
     *
     * @param int $v new value
     * @return $this|\CciOrm\CciOrm\AliEcommision The current object (for fluent API support)
     */
    public function setStatusTranfer($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->status_tranfer !== $v) {
            $this->status_tranfer = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_STATUS_TRANFER] = true;
        }
    ...
    public function setCrate($v)
    {
        ...
        if ($this->crate !== $v) {
            $this->crate = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_CRATE] = true;
        }
    ...
    public function setEcheck($v)
    {
        ...
        if ($this->echeck !== $v) {
            $this->echeck = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_ECHECK] = true;
        }
    ...
    public function setCmbonus($v)
    {
        ...
        if ($this->cmbonus !== $v) {
            $this->cmbonus = $v;
            $this->modifiedColumns[AliEcommisionTableMap::COL_CMBONUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AliEcommisionTableMap::translateFieldName('Sano', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sano = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AliEcommisionTableMap::translateFieldName('Rcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AliEcommisionTableMap::translateFieldName('Sadate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->sadate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AliEcommisionTableMap::translateFieldName('InvCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->inv_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AliEcommisionTableMap::translateFieldName('Mcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AliEcommisionTableMap::translateFieldName('NameF', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_f = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AliEcommisionTableMap::translateFieldName('NameT', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_t = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AliEcommisionTableMap::translateFieldName('Total', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : AliEcommisionTableMap::translateFieldName('Usercode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->usercode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : AliEcommisionTableMap::translateFieldName('Remark', TableMap::TYPE_PHPNAME, $indexType)];
            $this->remark = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : AliEcommisionTableMap::translateFieldName('Trnf', TableMap::TYPE_PHPNAME, $indexType)];
            $this->trnf = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : AliEcommisionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : AliEcommisionTableMap::translateFieldName('SaType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sa_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : AliEcommisionTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : AliEcommisionTableMap::translateFieldName('Lid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : AliEcommisionTableMap::translateFieldName('Dl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : AliEcommisionTableMap::translateFieldName('Cancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cancel = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : AliEcommisionTableMap::translateFieldName('Send', TableMap::TYPE_PHPNAME, $indexType)];
            $this->send = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : AliEcommisionTableMap::translateFieldName('Txtmoney', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtmoney = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : AliEcommisionTableMap::translateFieldName('Chkcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : AliEcommisionTableMap::translateFieldName('Chkfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : AliEcommisionTableMap::translateFieldName('Chktransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : AliEcommisionTableMap::translateFieldName('Chkcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : AliEcommisionTableMap::translateFieldName('Chkcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : AliEcommisionTableMap::translateFieldName('Chkcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : AliEcommisionTableMap::translateFieldName('Chkwithdraw', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkwithdraw = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : AliEcommisionTableMap::translateFieldName('ChktransferIn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer_in = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : AliEcommisionTableMap::translateFieldName('ChktransferOut', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chktransfer_out = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : AliEcommisionTableMap::translateFieldName('Txtcash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : AliEcommisionTableMap::translateFieldName('Txtfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : AliEcommisionTableMap::translateFieldName('Txttransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : AliEcommisionTableMap::translateFieldName('Txtcredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : AliEcommisionTableMap::translateFieldName('Txtcredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : AliEcommisionTableMap::translateFieldName('Txtcredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : AliEcommisionTableMap::translateFieldName('Txtwithdraw', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtwithdraw = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : AliEcommisionTableMap::translateFieldName('TxttransferIn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer_in = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : AliEcommisionTableMap::translateFieldName('TxttransferOut', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txttransfer_out = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : AliEcommisionTableMap::translateFieldName('Optioncash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : AliEcommisionTableMap::translateFieldName('Optionfuture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionfuture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : AliEcommisionTableMap::translateFieldName('Optiontransfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : AliEcommisionTableMap::translateFieldName('Optioncredit1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : AliEcommisionTableMap::translateFieldName('Optioncredit2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : AliEcommisionTableMap::translateFieldName('Optioncredit3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncredit3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : AliEcommisionTableMap::translateFieldName('Optionwithdraw', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optionwithdraw = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : AliEcommisionTableMap::translateFieldName('OptiontransferIn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer_in = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : AliEcommisionTableMap::translateFieldName('OptiontransferOut', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optiontransfer_out = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : AliEcommisionTableMap::translateFieldName('Txtoption', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtoption = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : AliEcommisionTableMap::translateFieldName('Ewallet', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : AliEcommisionTableMap::translateFieldName('EwalletBefore', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_before = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : AliEcommisionTableMap::translateFieldName('EwalletAfter', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ewallet_after = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : AliEcommisionTableMap::translateFieldName('Ipay', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ipay = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : AliEcommisionTableMap::translateFieldName('Checkportal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->checkportal = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : AliEcommisionTableMap::translateFieldName('Bprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : AliEcommisionTableMap::translateFieldName('CancelDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->cancel_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : AliEcommisionTableMap::translateFieldName('UidCancel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid_cancel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : AliEcommisionTableMap::translateFieldName('Locationbase', TableMap::TYPE_PHPNAME, $indexType)];
            $this->locationbase = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : AliEcommisionTableMap::translateFieldName('Chkcommission', TableMap::TYPE_PHPNAME, $indexType)];
            $this->chkcommission = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : AliEcommisionTableMap::translateFieldName('Txtcommission', TableMap::TYPE_PHPNAME, $indexType)];
            $this->txtcommission = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 58 + $startcol : AliEcommisionTableMap::translateFieldName('Optioncommission', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optioncommission = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 59 + $startcol : AliEcommisionTableMap::translateFieldName('StatusTranfer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_tranfer = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 60 + $startcol : AliEcommisionTableMap::translateFieldName('Crate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->crate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 61 + $startcol : AliEcommisionTableMap::translateFieldName('Echeck', TableMap::TYPE_PHPNAME, $indexType)];
            $this->echeck = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 62 + $startcol : AliEcommisionTableMap::translateFieldName('Cmbonus', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 63; // 63 = AliEcommisionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CciOrm\\CciOrm\\AliEcommision'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAliEcommisionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AliEcommision::setDeleted()
     * @see AliEcommision::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAliEcommisionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AliEcommisionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AliEcommisionTableMap::COL_SANO)) {
            $modifiedColumns[':p' . $index++]  = 'sano';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_RCODE)) {
            $modifiedColumns[':p' . $index++]  = 'rcode';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_SADATE)) {
            $modifiedColumns[':p' . $index++]  = 'sadate';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_INV_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'inv_code';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_MCODE)) {
            $modifiedColumns[':p' . $index++]  = 'mcode';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_NAME_F)) {
            $modifiedColumns[':p' . $index++]  = 'name_f';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_NAME_T)) {
            $modifiedColumns[':p' . $index++]  = 'name_t';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'total';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_USERCODE)) {
            $modifiedColumns[':p' . $index++]  = 'usercode';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_REMARK)) {
            $modifiedColumns[':p' . $index++]  = 'remark';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TRNF)) {
            $modifiedColumns[':p' . $index++]  = 'trnf';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_SA_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'sa_type';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_LID)) {
            $modifiedColumns[':p' . $index++]  = 'lid';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_DL)) {
            $modifiedColumns[':p' . $index++]  = 'dl';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'cancel';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_SEND)) {
            $modifiedColumns[':p' . $index++]  = 'send';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTMONEY)) {
            $modifiedColumns[':p' . $index++]  = 'txtMoney';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKCASH)) {
            $modifiedColumns[':p' . $index++]  = 'chkCash';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'chkFuture';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit1';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit2';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'chkCredit3';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKWITHDRAW)) {
            $modifiedColumns[':p' . $index++]  = 'chkWithdraw';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKTRANSFER_IN)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer_in';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKTRANSFER_OUT)) {
            $modifiedColumns[':p' . $index++]  = 'chkTransfer_out';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTCASH)) {
            $modifiedColumns[':p' . $index++]  = 'txtCash';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'txtFuture';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit1';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit2';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'txtCredit3';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTWITHDRAW)) {
            $modifiedColumns[':p' . $index++]  = 'txtWithdraw';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTTRANSFER_IN)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer_in';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTTRANSFER_OUT)) {
            $modifiedColumns[':p' . $index++]  = 'txtTransfer_out';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONCASH)) {
            $modifiedColumns[':p' . $index++]  = 'optionCash';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONFUTURE)) {
            $modifiedColumns[':p' . $index++]  = 'optionFuture';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONTRANSFER)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONCREDIT1)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit1';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONCREDIT2)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit2';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONCREDIT3)) {
            $modifiedColumns[':p' . $index++]  = 'optionCredit3';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONWITHDRAW)) {
            $modifiedColumns[':p' . $index++]  = 'optionWithdraw';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONTRANSFER_IN)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer_in';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONTRANSFER_OUT)) {
            $modifiedColumns[':p' . $index++]  = 'optionTransfer_out';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTOPTION)) {
            $modifiedColumns[':p' . $index++]  = 'txtoption';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_EWALLET)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_EWALLET_BEFORE)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_before';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_EWALLET_AFTER)) {
            $modifiedColumns[':p' . $index++]  = 'ewallet_after';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_IPAY)) {
            $modifiedColumns[':p' . $index++]  = 'ipay';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHECKPORTAL)) {
            $modifiedColumns[':p' . $index++]  = 'checkportal';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_BPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'bprice';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CANCEL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'cancel_date';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_UID_CANCEL)) {
            $modifiedColumns[':p' . $index++]  = 'uid_cancel';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_LOCATIONBASE)) {
            $modifiedColumns[':p' . $index++]  = 'locationbase';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKCOMMISSION)) {
            $modifiedColumns[':p' . $index++]  = 'chkCommission';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTCOMMISSION)) {
            $modifiedColumns[':p' . $index++]  = 'txtCommission';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONCOMMISSION)) {
            $modifiedColumns[':p' . $index++]  = 'optionCommission';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_STATUS_TRANFER)) {
            $modifiedColumns[':p' . $index++]  = 'status_tranfer';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CRATE)) {
            $modifiedColumns[':p' . $index++]  = 'crate';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_ECHECK)) {
            $modifiedColumns[':p' . $index++]  = 'echeck';
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CMBONUS)) {
            $modifiedColumns[':p' . $index++]  = 'cmbonus';
        }

        $sql = sprintf(
            'INSERT INTO ali_ecommision (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'optionCommission':
                        ...
                        break;
                    case 'status_tranfer':
                        $stmt->bindValue($identifier, $this->status_tranfer, PDO::PARAM_INT);
                        break;
                    case 'crate':
    ...
    {
        $pos = AliEcommisionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['AliEcommision'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AliEcommision'][$this->hashCode()] = true;
        $keys = AliEcommisionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSano(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CciOrm\CciOrm\AliEcommision
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[59], $arr)) {
            $this->setStatusTranfer($arr[$keys[59]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CciOrm\CciOrm\AliEcommision The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AliEcommisionTableMap::COL_SANO)) {
            $criteria->add(AliEcommisionTableMap::COL_SANO, $this->sano);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_RCODE)) {
            $criteria->add(AliEcommisionTableMap::COL_RCODE, $this->rcode);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_SADATE)) {
            $criteria->add(AliEcommisionTableMap::COL_SADATE, $this->sadate);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_INV_CODE)) {
            $criteria->add(AliEcommisionTableMap::COL_INV_CODE, $this->inv_code);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_MCODE)) {
            $criteria->add(AliEcommisionTableMap::COL_MCODE, $this->mcode);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_NAME_F)) {
            $criteria->add(AliEcommisionTableMap::COL_NAME_F, $this->name_f);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_NAME_T)) {
            $criteria->add(AliEcommisionTableMap::COL_NAME_T, $this->name_t);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TOTAL)) {
            $criteria->add(AliEcommisionTableMap::COL_TOTAL, $this->total);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_USERCODE)) {
            $criteria->add(AliEcommisionTableMap::COL_USERCODE, $this->usercode);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_REMARK)) {
            $criteria->add(AliEcommisionTableMap::COL_REMARK, $this->remark);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TRNF)) {
            $criteria->add(AliEcommisionTableMap::COL_TRNF, $this->trnf);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_ID)) {
            $criteria->add(AliEcommisionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_SA_TYPE)) {
            $criteria->add(AliEcommisionTableMap::COL_SA_TYPE, $this->sa_type);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_UID)) {
            $criteria->add(AliEcommisionTableMap::COL_UID, $this->uid);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_LID)) {
            $criteria->add(AliEcommisionTableMap::COL_LID, $this->lid);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_DL)) {
            $criteria->add(AliEcommisionTableMap::COL_DL, $this->dl);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CANCEL)) {
            $criteria->add(AliEcommisionTableMap::COL_CANCEL, $this->cancel);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_SEND)) {
            $criteria->add(AliEcommisionTableMap::COL_SEND, $this->send);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTMONEY)) {
            $criteria->add(AliEcommisionTableMap::COL_TXTMONEY, $this->txtmoney);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKCASH)) {
            $criteria->add(AliEcommisionTableMap::COL_CHKCASH, $this->chkcash);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKFUTURE)) {
            $criteria->add(AliEcommisionTableMap::COL_CHKFUTURE, $this->chkfuture);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKTRANSFER)) {
            $criteria->add(AliEcommisionTableMap::COL_CHKTRANSFER, $this->chktransfer);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKCREDIT1)) {
            $criteria->add(AliEcommisionTableMap::COL_CHKCREDIT1, $this->chkcredit1);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKCREDIT2)) {
            $criteria->add(AliEcommisionTableMap::COL_CHKCREDIT2, $this->chkcredit2);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKCREDIT3)) {
            $criteria->add(AliEcommisionTableMap::COL_CHKCREDIT3, $this->chkcredit3);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKWITHDRAW)) {
            $criteria->add(AliEcommisionTableMap::COL_CHKWITHDRAW, $this->chkwithdraw);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKTRANSFER_IN)) {
            $criteria->add(AliEcommisionTableMap::COL_CHKTRANSFER_IN, $this->chktransfer_in);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKTRANSFER_OUT)) {
            $criteria->add(AliEcommisionTableMap::COL_CHKTRANSFER_OUT, $this->chktransfer_out);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTCASH)) {
            $criteria->add(AliEcommisionTableMap::COL_TXTCASH, $this->txtcash);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTFUTURE)) {
            $criteria->add(AliEcommisionTableMap::COL_TXTFUTURE, $this->txtfuture);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTTRANSFER)) {
            $criteria->add(AliEcommisionTableMap::COL_TXTTRANSFER, $this->txttransfer);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTCREDIT1)) {
            $criteria->add(AliEcommisionTableMap::COL_TXTCREDIT1, $this->txtcredit1);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTCREDIT2)) {
            $criteria->add(AliEcommisionTableMap::COL_TXTCREDIT2, $this->txtcredit2);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTCREDIT3)) {
            $criteria->add(AliEcommisionTableMap::COL_TXTCREDIT3, $this->txtcredit3);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTWITHDRAW)) {
            $criteria->add(AliEcommisionTableMap::COL_TXTWITHDRAW, $this->txtwithdraw);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTTRANSFER_IN)) {
            $criteria->add(AliEcommisionTableMap::COL_TXTTRANSFER_IN, $this->txttransfer_in);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTTRANSFER_OUT)) {
            $criteria->add(AliEcommisionTableMap::COL_TXTTRANSFER_OUT, $this->txttransfer_out);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONCASH)) {
            $criteria->add(AliEcommisionTableMap::COL_OPTIONCASH, $this->optioncash);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONFUTURE)) {
            $criteria->add(AliEcommisionTableMap::COL_OPTIONFUTURE, $this->optionfuture);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONTRANSFER)) {
            $criteria->add(AliEcommisionTableMap::COL_OPTIONTRANSFER, $this->optiontransfer);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONCREDIT1)) {
            $criteria->add(AliEcommisionTableMap::COL_OPTIONCREDIT1, $this->optioncredit1);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONCREDIT2)) {
            $criteria->add(AliEcommisionTableMap::COL_OPTIONCREDIT2, $this->optioncredit2);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONCREDIT3)) {
            $criteria->add(AliEcommisionTableMap::COL_OPTIONCREDIT3, $this->optioncredit3);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONWITHDRAW)) {
            $criteria->add(AliEcommisionTableMap::COL_OPTIONWITHDRAW, $this->optionwithdraw);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONTRANSFER_IN)) {
            $criteria->add(AliEcommisionTableMap::COL_OPTIONTRANSFER_IN, $this->optiontransfer_in);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONTRANSFER_OUT)) {
            $criteria->add(AliEcommisionTableMap::COL_OPTIONTRANSFER_OUT, $this->optiontransfer_out);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTOPTION)) {
            $criteria->add(AliEcommisionTableMap::COL_TXTOPTION, $this->txtoption);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_EWALLET)) {
            $criteria->add(AliEcommisionTableMap::COL_EWALLET, $this->ewallet);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_EWALLET_BEFORE)) {
            $criteria->add(AliEcommisionTableMap::COL_EWALLET_BEFORE, $this->ewallet_before);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_EWALLET_AFTER)) {
            $criteria->add(AliEcommisionTableMap::COL_EWALLET_AFTER, $this->ewallet_after);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_IPAY)) {
            $criteria->add(AliEcommisionTableMap::COL_IPAY, $this->ipay);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHECKPORTAL)) {
            $criteria->add(AliEcommisionTableMap::COL_CHECKPORTAL, $this->checkportal);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_BPRICE)) {
            $criteria->add(AliEcommisionTableMap::COL_BPRICE, $this->bprice);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CANCEL_DATE)) {
            $criteria->add(AliEcommisionTableMap::COL_CANCEL_DATE, $this->cancel_date);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_UID_CANCEL)) {
            $criteria->add(AliEcommisionTableMap::COL_UID_CANCEL, $this->uid_cancel);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_LOCATIONBASE)) {
            $criteria->add(AliEcommisionTableMap::COL_LOCATIONBASE, $this->locationbase);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CHKCOMMISSION)) {
            $criteria->add(AliEcommisionTableMap::COL_CHKCOMMISSION, $this->chkcommission);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_TXTCOMMISSION)) {
            $criteria->add(AliEcommisionTableMap::COL_TXTCOMMISSION, $this->txtcommission);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_OPTIONCOMMISSION)) {
            $criteria->add(AliEcommisionTableMap::COL_OPTIONCOMMISSION, $this->optioncommission);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_STATUS_TRANFER)) {
            $criteria->add(AliEcommisionTableMap::COL_STATUS_TRANFER, $this->status_tranfer);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CRATE)) {
            $criteria->add(AliEcommisionTableMap::COL_CRATE, $this->crate);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_ECHECK)) {
            $criteria->add(AliEcommisionTableMap::COL_ECHECK, $this->echeck);
        }
        if ($this->isColumnModified(AliEcommisionTableMap::COL_CMBONUS)) {
            $criteria->add(AliEcommisionTableMap::COL_CMBONUS, $this->cmbonus);
        }
    ...
    {
        $criteria = ChildAliEcommisionQuery::create();
        $criteria->add(AliEcommisionTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CciOrm\CciOrm\AliEcommision (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setStatusTranfer($this->getStatusTranfer());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CciOrm\CciOrm\AliEcommision Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AliEcommisionTableMap::DEFAULT_STRING_FORMAT);
    }
